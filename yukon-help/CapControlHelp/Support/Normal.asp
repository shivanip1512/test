...
<!--
     Generated using $VERSION; from template $TEMPLATENAME;.
     Last updated on $DATE(c);.
-->

<wp:Document xmlns:wp='http://webworks.com/publisher/xml/schema'>
  <wp:Title>
  ...
  <wp:ContactInfo>
    <wp:Item>
      <wp:GotoLink wp:href="http://www.cannontech.com/">
      </wp:GotoLink>
    </wp:Item>
    <wp:Item>
      Cannon Technologies
  ...
  <!--BeginHiddenExpansion $BP80PageASP_Content; EndHiddenExpansion-->
</wp:Document>
