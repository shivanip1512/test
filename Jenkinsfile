                        ...
                        script {
                            ...
                            try{
                                ...
                                def scmVars = checkout([$class: 'GitSCM',
                                                        branches: [[name: 'refs/heads/release/7.2']],
                                                        ...
                                                        submoduleCfg: [],
                                                        userRemoteConfigs: [[refspec: '+refs/heads/release/7.2:refs/remotes/origin/release/7.2', credentialsId: 'PSPLSoftwareBuildSSH', url: 'ssh://git@bitbucket-prod.tcc.etn.com:7999/easd_sw/yukon.git']]])
