...
public final class FileFormatTypes {
    ...
    static {
        defaultValidFormatIds =
            new int[] { STANDARD, CADPXL2, CTICSV, CTIStandard2, IVUE_BI_T65, SIMPLE_TOU, EXTENDED_TOU };

        defaultValidFormatTypes =
            new String[] { STANDARD_STRING, CADPXL2_STRING, CTICSV_STRING, CTI_STANDARD2_STRING, IVUE_BI_T65_STRING,
                SIMPLE_TOU_STRING, EXTENDED_TOU_STRING };
    }
