 ...
 * @author: 
 */
public class DAFRONRecord implements BillingRecordBase 
{
...
/**
 * DAFRONRecord constructor comment.
 */
public DAFRONRecord() {
	super();
}
 ...
 * DAFRONRecord constructor comment.
 */
public DAFRONRecord(String newMeterNumber)
{
	super();
 ...
 * DAFRONRecord constructor comment.
 */
public DAFRONRecord(String newMeterNumber, double reading, java.sql.Timestamp newTimestamp)
{
	super();
	setMeterNumber(newMeterNumber);
 ...
 * DAFRONRecord constructor comment.
 */
public DAFRONRecord(String newMeterNumber, java.sql.Timestamp newTimestamp)
{
	super();
	setMeterNumber(newMeterNumber);
	setDate(newTimestamp);
