...
public class NCDC_HandheldFormat extends FileFormatBase
{
	...
	public boolean retrieveBillingData()
	{
	    ...
	    final Hashtable inputRecordsHashTable = retrieveInputFile();
	    ...
	    SqlStatementBuilder sql = builder.buildSQLStatement(SELECT_COLUMNS, FROM_TABLES, getBillingFileDefaults(), null, validAccPtOffsets, getBillingFileDefaults().getEarliestStartDate());
