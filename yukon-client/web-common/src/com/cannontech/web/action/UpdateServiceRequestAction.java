...
public class UpdateServiceRequestAction implements ActionBase {
	...
	public SOAPMessage process(SOAPMessage reqMsg, HttpSession session) {
        ...
        try {
			...
			com.cannontech.stars.database.data.report.WorkOrderBase order = (com.cannontech.stars.database.data.report.WorkOrderBase) StarsLiteFactory.createDBPersistent( liteOrder );
