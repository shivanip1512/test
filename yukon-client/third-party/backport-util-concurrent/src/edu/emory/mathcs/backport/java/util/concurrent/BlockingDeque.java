 ...
 *  <tr>
 *   <tr>
 *    <td>{@link edu.emory.mathcs.backport.java.util.concurrent.BlockingQueue#put put(e)}</td>
 *    <td>{@link #putLast putLast(e)}</td>
 *   </tr>
 *   <tr>
 *    <td>{@link edu.emory.mathcs.backport.java.util.concurrent.BlockingQueue#take take()}</td>
 *    <td>{@link #takeFirst takeFirst()}</td>
 *   </tr>
 *   <tr>
 *    <td>{@link edu.emory.mathcs.backport.java.util.concurrent.BlockingQueue#offer(Object, long, TimeUnit) offer(e, time. unit)}</td>
 *    <td>{@link #offerLast(Object, long, TimeUnit) offerLast(e, time, unit)}</td>
 *   </tr>
 *   <tr>
 *    <td>{@link edu.emory.mathcs.backport.java.util.concurrent.BlockingQueue#poll(long, TimeUnit) poll(time, unit)}</td>
 *    <td>{@link #pollFirst(long, TimeUnit) pollFirst(time, unit)}</td>
 *   </tr>
 * </table>
 *
...
public interface BlockingDeque extends Deque, BlockingQueue {
     ...
     */
    void putFirst(Object o) throws InterruptedException;
     ...
     * @throws NullPointerException if the specified element is <tt>null</tt>.
     */
    void putLast(Object o) throws InterruptedException;
     ...
     * @throws NullPointerException if the specified element is <tt>null</tt>.
     */
    boolean offerFirst(Object o, long timeout, TimeUnit unit)
     ...
     * @throws NullPointerException if the specified element is <tt>null</tt>.
     */
    boolean offerLast(Object o, long timeout, TimeUnit unit)
        throws InterruptedException;
