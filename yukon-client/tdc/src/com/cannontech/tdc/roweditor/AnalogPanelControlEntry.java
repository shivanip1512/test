...
public class AnalogPanelControlEntry extends ManualEntryJPanel implements RowEditorDialogListener
{
 ...
 */
private AnalogPanelControlEntry() {
	super();
	initialize();
}
/**
 * EditDataPanel constructor comment.
 */
public AnalogPanelControlEntry( EditorDialogData data, Object currentValue, AlarmingRow alarmRow_ )
{
 ...
 * EditDataPanel constructor comment.
 */
public AnalogPanelControlEntry(EditorDialogData data, Object currentValue)
{
...
public void JButtonSendAction_actionPerformed(java.util.EventObject newEvent)
{
    ...
    if( retValue == javax.swing.JOptionPane.YES_OPTION )
    {
        ...
        TDCMainFrame.messageLog.addMessage("Analog output value (" + outputValue + ") was sent successfully for the point '" +
