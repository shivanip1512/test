 ...
 */
public SeasonScheduleLoader(java.util.ArrayList seasons ,String dbAlias) {
	super();
...
public void run()
{
	...
	try
	{
		...
		while (rset.next())
		{
			...
			com.cannontech.database.data.lite.LiteSeasonSchedule ss =
				new com.cannontech.database.data.lite.LiteSeasonSchedule( seasonID );
