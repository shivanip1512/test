...
public class GatewayCertificateExpirationEvaluator extends InfrastructureStatusWarningEvaluator {
        
    @Override
    public InfrastructureWarningType getWarningType() {
        return InfrastructureWarningType.GATEWAY_CERT_EXPIRATION;
    }

    @Override
    public BuiltInAttribute getAttribute() {
        return BuiltInAttribute.CERTIFICATE_EXPIRATION;
    }
