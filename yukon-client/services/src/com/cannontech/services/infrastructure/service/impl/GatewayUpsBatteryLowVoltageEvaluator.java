...
public class GatewayUpsBatteryLowVoltageEvaluator extends InfrastructureStatusWarningEvaluator {
        
    @Override
    public InfrastructureWarningType getWarningType() {
        return InfrastructureWarningType.GATEWAY_UPS_BATTERY_VOLTAGE_LOW;
    }

    @Override
    public BuiltInAttribute getAttribute() {
        return BuiltInAttribute.UPS_BATTERY_VOLTAGE_LOW;
    }
