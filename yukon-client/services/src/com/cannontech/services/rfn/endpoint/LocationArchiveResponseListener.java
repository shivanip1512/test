    ...
    public class Worker extends ConverterBase {
        ...
        protected void processData(RfnDevice device, LocationResponse location) {
            ...
            if (paoLocation == null || lastChangedDate.isAfter(paoLocation.getLastChangedDate())) {
                ...
                endpointEventLogService.locationUpdated(device.getName(), Double.toString(location.getLatitude()),
                    Double.toString(location.getLongitude()), YukonUserContext.system.getYukonUser());
            }
