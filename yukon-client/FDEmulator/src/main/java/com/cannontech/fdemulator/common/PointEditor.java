...
public class PointEditor extends JFrame implements ActionListener {
    ...
    private JComboBox<String> rdexTypeCB;
    private JTextField rdexNameTF;
    private JComboBox<String> rdexIntervalCB;
    private JComboBox<String> rdexFunctionCB;
    ...
    private JComboBox<String> acsTypeCB;
    private JTextField acsRemoteTF;
    private JTextField acsPointTF;
    private JTextField acsCategoryTF;
    private JComboBox<String> acsIntervalCB;
    private JComboBox<String> acsFunctionCB;
    ...
    private JComboBox<String> valmetTypeCB;
    private JTextField valmetNameTF;
    private JTextField valmetPortTF;
    private JComboBox<String> valmetIntervalCB;
    private JComboBox<String> valmetFunctionCB;
    ...
    private void init() throws Exception {
        ...
        acsTypeCB = new JComboBox<String>(new String[] { "Value", "Status", "Control" });
        ...
        acsIntervalCB = new JComboBox<String>(new String[] { "10", "30", "60", "300", "900", "3600" });
        ...
        acsFunctionCB = new JComboBox<String>(new String[] { "RANDOM", "PYRAMID", "DROPOFF" });
        ...
        JComboBox<String> acsIntervalComboBox = new JComboBox<String>();
        ...
        JComboBox<String> acsTypeComboBox = new JComboBox<String>();
        ...
        JComboBox<String> acsFunctionComboBox = new JComboBox<String>();
        ...
        JComboBox<String> acsCategoryComboBox = new JComboBox<String>();
        ...
        JComboBox<String> acsMaxStartComboBox = new JComboBox<String>();
        ...
        rdexTypeCB = new JComboBox<String>(new String[] { "Value", "Status", "Control" });
        ...
        rdexIntervalCB = new JComboBox<String>(new String[] { "10", "30", "60", "300", "900", "3600" });
        ...
        rdexFunctionCB = new JComboBox<String>(new String[] { "RANDOM", "PYRAMID", "DROPOFF" });
        ...
        JComboBox<String> rdexIntervalComboBox = new JComboBox<String>();
        ...
        JComboBox<String> rdexTypeComboBox = new JComboBox<String>();
        ...
        JComboBox<String> rdexFunctionComboBox = new JComboBox<String>();
        ...
        JComboBox<String> rdexMaxStartComboBox = new JComboBox<String>();
        ...
        valmetTypeCB = new JComboBox<String>(new String[] { "Value", "Status", "Control", "Analog Output" });
        ...
        valmetIntervalCB = new JComboBox<String>(new String[] { "10", "30", "60", "300", "900", "3600" });
        ...
        valmetFunctionCB = new JComboBox<String>(new String[] { "RANDOM", "PYRAMID", "DROPOFF" });
        ...
        JComboBox<String> valmetIntervalComboBox = new JComboBox<String>();
        ...
        JComboBox<String> valmetTypeComboBox = new JComboBox<String>();
        ...
        JComboBox<String> valmetFunctionComboBox = new JComboBox<String>();
        ...
        JComboBox<String> valmetMaxStartComboBox = new JComboBox<String>();
    ...
    private void valmetGenerate_actionPerformed() {
        ...
        while (exit != 1) {
            ...
            if (type.equals(null)) {
                ...
                analogPoint = PointFactory.createNewPoint(pointID, PointTypes.STATUS_POINT, "VALMET " + name, virtDevice.getPAObjectID(), new Integer(0));
                ...
                analogPoint = PointFactory.createNewPoint(pointID, PointTypes.STATUS_POINT, "VALMET " + name, virtDevice.getPAObjectID(), new Integer(1));
    ...
    private void valmetSave_actionPerformed() {
        if (valmetediting) {
            ...
            ValmetPoint newpoint = new ValmetPoint(newValmetType, newValmetName, newValmetPort, newValmetInterval, newValmetFunction,
                                                   newValmetMin, newValmetMax, newValmetDelta, newValmetMaxStart);

            String[] points = getValmetFileIO().readFile(new File(valmetFile));

            String oldpoint = oldvalmetpoint.getPointType() + ";" + oldvalmetpoint.getPointName() + 
                    ";" + oldvalmetpoint.getPort() + ";" + oldvalmetpoint.getPointInterval() + 
                    ";" + oldvalmetpoint.getPointFunction() + ";" + oldvalmetpoint.getPointMin() + 
                    ";" + oldvalmetpoint.getPointMax() + ";" + oldvalmetpoint.getPointDelta() + ";" + oldvalmetpoint.getPointMaxStart();

            for (int i = 0; i < points.length; i++) {
                if (oldpoint.equalsIgnoreCase(points[i])) {
                    String newpointstring = newpoint.getPointType() + ";" + newpoint.getPointName() + 
                            ";" + newpoint.getPort() + ";" + newpoint.getPointInterval() + ";" + 
                            newpoint.getPointFunction() + ";" + newpoint.getPointMin() + ";" + 
                            newpoint.getPointMax() + ";" + newpoint.getPointDelta() + ";" + newpoint.getPointMaxStart();
            ...
            ValmetPoint newpoint = new ValmetPoint(valmetTypeCB.getSelectedItem().toString(), valmetNameTF.getText(), valmetPortTF.getText(), 
                                                   valmetIntervalCB.getSelectedItem().toString(), valmetFunctionCB.getSelectedItem().toString(), 
                                                   valmetMinTF.getText(), valmetMaxTF.getText(), valmetDeltaTF.getText(), bool.toString());
    ...
    private void valmetEdit_actionPerformed() {
        ...
        oldvalmetpoint = new ValmetPoint(oldValmetType, oldValmetName, oldValmetPort, oldValmetInterval, oldValmetFunction,
                                         oldValmetMin, oldValmetMax, oldValmetDelta, oldValmetMaxStart);
        valmetediting = true;
        enableValmetFields();
    ...
    private void rdexGenerate_actionPerformed() {
        ...
        while (exit != 1) {
            ...
            if (type.equals(null)) {
                ...
                analogPoint = PointFactory.createNewPoint(pointID, PointTypes.STATUS_POINT, "RDEX " + name, virtDevice.getPAObjectID(), new Integer(0));
                ...
                analogPoint = PointFactory.createNewPoint(pointID, PointTypes.STATUS_POINT, "RDEX " + name, virtDevice.getPAObjectID(), new Integer(1));
    ...
    private void rdexSave_actionPerformed() {
        if (rdexediting) {
            ...
            RdexPoint newpoint = new RdexPoint(newRdexType, newRdexName, newRdexInterval, newRdexFunction,
                                               newRdexMin, newRdexMax, newRdexDelta, newRdexMaxStart);
            String[] points = getRdexFileIO().readFile(new File(rdexFile));

            String oldpoint = oldrdexpoint.getPointType() + ";" + oldrdexpoint.getPointName() + ";" + 
                            oldrdexpoint.getPointInterval() + ";" + oldrdexpoint.getPointFunction() + 
                            ";" + oldrdexpoint.getPointMin() + ";" + oldrdexpoint.getPointMax() + ";" 
                            + oldrdexpoint.getPointDelta() + ";" + oldrdexpoint.getPointMaxStart();
            for (int i = 0; i < points.length; i++) {
                if (oldpoint.equalsIgnoreCase(points[i])) {
                    String newpointstring = newpoint.getPointType() + ";" + newpoint.getPointName() + ";" + 
                            newpoint.getPointInterval() + ";" + newpoint.getPointFunction() + ";" + 
                            newpoint.getPointMin() + ";" + newpoint.getPointMax() + ";" + newpoint.getPointDelta() + ";" + newpoint.getPointMaxStart();
                    points[i] = newpointstring;
                    break;
                }
            }
            ...
            RdexPoint newpoint = new RdexPoint(rdexTypeCB.getSelectedItem().toString(), rdexNameTF.getText(), 
                                               rdexIntervalCB.getSelectedItem().toString(), rdexFunctionCB.getSelectedItem().toString(), 
                                               rdexMinTF.getText(), rdexMaxTF.getText(), rdexDeltaTF.getText(), bool.toString());
    ...
    private void rdexEdit_actionPerformed() {
        ...
        oldrdexpoint = new RdexPoint(oldRdexType, oldRdexName, oldRdexInterval, oldRdexFunction,
                                     oldRdexMin, oldRdexMax, oldRdexDelta, oldRdexMaxStart);
        rdexediting = true;
        enableRdexFields();
    ...
    private void acsGenerate_actionPerformed() {
        ...
        while (exit != 1) {
            ...
            if (type.equals(null)) {
                ...
                analogPoint = PointFactory.createNewPoint(pointID, PointTypes.STATUS_POINT, "ACS " + remote + " " + point + " " + category, virtDevice.getPAObjectID(), new Integer(0));
                ...
                analogPoint = PointFactory.createNewPoint(pointID, PointTypes.STATUS_POINT, "ACS " + remote + " " + point + " " + category, virtDevice.getPAObjectID(), new Integer(1));
    ...
    private void acsSave_actionPerformed() {
        if (acsediting) {
            ...
            ACSPoint newpoint = new ACSPoint(newAcsType, newAcsRemote, newAcsPointNum, newAcsCategory, newAcsInterval, newAcsFunction,
                                             newAcsMin, newAcsMax, newAcsDelta, newAcsMaxStart);
            String[] points = getAcsFileIO().readFile(new File(acsFile));

            String oldpoint = oldacspoint.getPointType() + ";" + oldacspoint.getPointRemote() + ";" + 
                        oldacspoint.getPointNumber() + ";" + oldacspoint.getPointCategory() + 
                        ";" + oldacspoint.getPointInterval() + ";" + oldacspoint.getPointFunction() + 
                        ";" + oldacspoint.getPointMin() + ";" + oldacspoint.getPointMax() + ";" + 
                        oldacspoint.getPointDelta() + ";" + oldacspoint.getPointMaxStart();
            for (int i = 0; i < points.length; i++) {
                if (oldpoint.equalsIgnoreCase(points[i])) {
                    String newpointstring = newpoint.getPointType() + ";" + newpoint.getPointRemote() + ";" + 
                            newpoint.getPointNumber() + ";" + newpoint.getPointCategory() + ";" + 
                            newpoint.getPointInterval() + ";" + newpoint.getPointFunction() + ";" + 
                            newpoint.getPointMin() + ";" + newpoint.getPointMax() + ";" + newpoint.getPointDelta() + ";" + newpoint.getPointMaxStart();
                    points[i] = newpointstring;
                    break;
            ...
            ACSPoint newpoint = new ACSPoint(acsTypeCB.getSelectedItem().toString(), acsRemoteTF.getText(), acsPointTF.getText(), acsCategoryTF.getText(),
                                             acsIntervalCB.getSelectedItem().toString(), acsFunctionCB.getSelectedItem().toString(), acsMinTF.getText(),
                                             acsMaxTF.getText(), acsDeltaTF.getText(), bool.toString());
    ...
    private void acsDelete_actionPerformed() {
        ...
        String del = delType + ";" + delRemote + ";" + delPoint + ";" + delCategory + ";" + delInterval + 
                ";" + delFunction + ";" + delMin + ";" + delMax + ";" + delDelta + ";" + delMaxStart;
        System.out.println("del: " + del);
        int index = vec.indexOf(del);
        vec.remove(index);
        vec.toArray(points);
    ...
    private void acsEdit_actionPerformed() {
        ...
        oldacspoint = new ACSPoint(oldAcsType, oldAcsRemote, oldAcsPoint, oldAcsCategory, oldAcsInterval, oldAcsFunction,
                                   oldAcsMin, oldAcsMax, oldAcsDelta, oldAcsMaxStart);
        acsediting = true;
        enableAcsFields();
