...
public class StarsAMRDetailReport extends YukonReportBase {
    ...
    private RelationalGroup createSortByGroup() {
        ...
        LabelElementFactory factory = ReportFactory.createGroupLabelElementDefault(getModel(),
                StarsAMRDetailModel.ROUTE_NAME_COLUMN);
        ...
        for (int i = StarsAMRDetailModel.ACCOUNT_NUMBER_COLUMN; i < getModel().getColumnNames().length; i++) {
            ...
            factory.setAbsolutePosition(new Point2D.Float(getModel().getColumnProperties(i).getPositionX(), 22)); // override
                                                                                                                  // location,
                                                                                                                  // need to be
                                                                                                                  // lower than
                                                                                                                  // macroroute
    ...
    protected List<RelationalGroup> createGroups() {
        return List.of(createSortByGroup());
    }
