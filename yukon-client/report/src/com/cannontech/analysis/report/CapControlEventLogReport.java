...
public class CapControlEventLogReport extends YukonReportBase {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        report.setDataFactory(new TableDataFactory("CapControlEventLog", dbReport.getModel()));
    ...
    private RelationalGroup createSubBusGroup() {
        ...
        subBusGroup.setName(((CapControlEventLogModel) getModel()).getColumnName(CapControlEventLogModel.SUB_BUS_NAME_COLUMN)
                + ReportFactory.NAME_GROUP);
        ...
        LabelElementFactory factory = ReportFactory.createGroupLabelElementDefault(getModel(),
                CapControlEventLogModel.SUB_BUS_NAME_COLUMN);
        ...
        for (int i = CapControlEventLogModel.FEEDER_NAME_COLUMN; i < getModel().getColumnCount(); i++) {
            ...
            factory.setAbsolutePosition(new Point2D.Float(getModel().getColumnProperties(i).getPositionX(),
                    getModel().getColumnProperties(i).getPositionY() + 18));
            header.addElement(factory.createElement());
        }
    ...
    protected List<RelationalGroup> createGroups() {
        return List.of(createSubBusGroup());
    }
    ...
    protected ItemBand createItemBand() {
        ...
        items.addElement(
                HorizontalLineElementFactory.createHorizontalLine(12, java.awt.Color.decode("#DFDFDF"), new BasicStroke(0.1f)));
