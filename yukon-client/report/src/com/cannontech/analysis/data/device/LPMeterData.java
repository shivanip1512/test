...
public class LPMeterData
{
     ...
     */
    public LPMeterData(MeterAndPointData meterAndPoint, String lastIntervalDemand, String lastIntervalVoltage, String demandRate, String voltageDemandRate) {
        super();
