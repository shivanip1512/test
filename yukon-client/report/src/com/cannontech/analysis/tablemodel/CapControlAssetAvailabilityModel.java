...
public class CapControlAssetAvailabilityModel extends BareDatedReportModelBase<CapControlAssetAvailabilityModel.ModelRow> implements CapControlFilterable {
    ...
    public String getTitle() {
        return "CapControl Asset Availability Report";
    }
    ...
    public StringBuffer buildSQLStatement()
    {
        ...
        sql.append("where text like '%Cannot Decrease%' and datetime > ? and datetime < ? group by subid, feederid) els, ");
        sql.append("(select count(*) as feedcount, feederid from cceventlog ");
        sql.append("where text like '%Cannot Decrease%' and datetime > ? and datetime < ? group by feederid) elf ");
        sql.append("where ");
