...
public class LoadControlVerificationModel extends ReportModelBase
{
	...
	public String getHTMLOptionsTable()
	{
		...
		List objects = ReportFuncs.getObjectsByModelType(ReportFilter.TRANSMITTER, UserUtils.USER_NONE_ID);
		if (objects != null)
		{
		...
		objects = ReportFuncs.getObjectsByModelType(ReportFilter.RECEIVER, UserUtils.USER_NONE_ID);
		if (objects != null)
		{
			for (int j = 0; j < objects.size(); j++)
			{
