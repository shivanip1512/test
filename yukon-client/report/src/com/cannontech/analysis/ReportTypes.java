...
public enum ReportTypes {
    ...
    CAP_BANK_RECENT_MAX_DAILY_OPERATIONS("Cap Bank Recent Max Daily Operations Report", CapBankRecentMaxDailyOpsModel.class, ReportGroup.CAP_CONTROL,
    ...
    CAP_BANK_MAX_OPS_EXCEEDED("Cap Bank Max Ops Exceeded Report", CapBankMaxOpsExceededController.class, ReportGroup.CAP_CONTROL,
