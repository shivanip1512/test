...
import com.cannontech.analysis.tablemodel.SimpleDeviceReportModelBase;
import com.cannontech.web.util.ServletRequestEnumUtils;

public abstract class SimpleDeviceReportControllerBase extends ReportControllerBase {
	...
	public void setRequestParameters(HttpServletRequest req) {
		...
		SimpleDeviceReportModelBase<?> simpleDeviceReportModel= (SimpleDeviceReportModelBase<?>) model;
        ...
        if (filter == ReportFilter.GROUPS) {
            ...
            simpleDeviceReportModel.setGroupsFilter(namesList);
            simpleDeviceReportModel.setDeviceFilter(null);
    	    ...
    	    simpleDeviceReportModel.setGroupsFilter(null);
            simpleDeviceReportModel.setDeviceFilter(deviceNames);
        }
	}
}
