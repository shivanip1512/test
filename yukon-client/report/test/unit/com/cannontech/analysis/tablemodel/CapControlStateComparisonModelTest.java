...
public class CapControlStateComparisonModelTest {
    ...
    public void test_buildSQLStatement_filters() throws Exception {
        ...
        assertEquals(prefix + " where ca.paobjectid in ( 17,18,19 )  Arguments: [CBC 7020, CBC 7022, CBC 7023, CBC 7024, CBC 8020, CBC 8024, CBC DNP, CBC Logical]", 
                getSqlForFilter(17, CapControlStateComparisonModel::setAreaIdsFilter));

        assertEquals(prefix + " where yp1.paobjectid in ( 23,24,25 )  Arguments: [CBC 7020, CBC 7022, CBC 7023, CBC 7024, CBC 8020, CBC 8024, CBC DNP, CBC Logical]", 
                getSqlForFilter(23, CapControlStateComparisonModel::setCapBankIdsFilter));
        
        assertEquals(prefix + " where yp2.paobjectid in ( 29,30,31 )  Arguments: [CBC 7020, CBC 7022, CBC 7023, CBC 7024, CBC 8020, CBC 8024, CBC DNP, CBC Logical]", 
                getSqlForFilter(29, CapControlStateComparisonModel::setFeederIdsFilter));
        
        assertEquals(prefix + "  Arguments: [CBC 7020, CBC 7022, CBC 7023, CBC 7024, CBC 8020, CBC 8024, CBC DNP, CBC Logical]", 
                getSqlForFilter(35, CapControlStateComparisonModel::setStrategyIdsFilter));

        assertEquals(prefix + " where yp3.paobjectid in ( 41,42,43 )  Arguments: [CBC 7020, CBC 7022, CBC 7023, CBC 7024, CBC 8020, CBC 8024, CBC DNP, CBC Logical]", 
                getSqlForFilter(41, CapControlStateComparisonModel::setSubbusIdsFilter));

        assertEquals(prefix + " where yp4.paobjectid in ( 47,48,49 )  Arguments: [CBC 7020, CBC 7022, CBC 7023, CBC 7024, CBC 8020, CBC 8024, CBC DNP, CBC Logical]", 
