                ...
                <p class="Main"><b>Welcome to Consumer Energy Services</b><br>
                  ...
                  <table width="450" border="0" cellspacing="0">
					...
					<form method="post" action="TOU.jsp">  
                      <td width="222"> 
                        <div align="center"> 
                          <input type="submit" name="Monitor" value="Monitor Your Usage">
                          <br>
                          &nbsp; </div>
                      </td>
					  </form>
                      ...
                      <td width="224"> 
                        <div align="center"> 
                          <input type="submit" name="Manage" value="Manage Your Programs">
                          <br>
                          &nbsp; </div>
                      </td>
					  </form>
                        ...
                        <td class="MainHeader"><b>ACCOUNT INFORMATION </b> 
                          <hr>
                            <table width="200" border="0" cellspacing="0" cellpadding="3" align="center">
                              ...
                              <tr> 
                                <td class="TableCell"> <%= primContact.getFirstName() %> <%= primContact.getLastName() %></td>
                              </tr>
                              <tr> 
                                <td class="TableCell"> Home #: <%= primContact.getHomePhone() %> </td>
                              </tr>
                              <tr> 
                      ...
                      <table width="200" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td class="MainHeader"><b>SERVICE ADDRESS</b> 
                          <hr>
                            <table width="200" border="0" cellspacing="0" cellpadding="3" align="center">
                              <tr> 
                                <td class="TableCell"> <%= propAddr.getStreetAddr1() %>, <%= propAddr.getStreetAddr2() %>
                                  </td>
                              </tr>
                              <tr> 
                                <td class="TableCell"> <%= propAddr.getCity() %>, <%= propAddr.getState() %> <%= propAddr.getZip() %></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      ...
                      <table width="200" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td class="MainHeader"><b>BILLING ADDRESS </b> 
                          <hr>
                            <table width="200" border="0" cellspacing="0" cellpadding="3" align="center">
                              <tr> 
                                <td class="TableCell"> <%= billAddr.getStreetAddr1() %>, <%= billAddr.getStreetAddr2() %>
                                  </td>
                              </tr>
                              <tr> 
                                <td class="TableCell"> <%= billAddr.getCity() %>, <%= billAddr.getState() %> <%= billAddr.getZip() %></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
