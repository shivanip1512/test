  ...
  <tr> 
    <td bgcolor="#666699" height="284"> 
      <table width="100%" height="50" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="30%" valign="top" class="TableCell2" height="49"><font size="1">Cannon 
          ...
          <td width="36%" valign="bottom" height="49"> 
            <div class = "TableCell2"></div>
          </td>
            
          <td width="34%" valign="top" height="49"> 
            <div align="right"><img src="../ConsumerStat/Powered_by_Yukon(small)(white_on_readmeter_color).gif" width="139" height="29"></div>
            </td>
          </tr>
        </table><br>
       <table width="682" border="1" cellspacing="0" cellpadding="2" align="center" bgcolor="#FFFFFF" height = "463">
        <tr> 
          <td align = "center"> 
            <table  border="0"  cellpadding = "4" height="412" width="636">
              <tr> 
              ...
              <tr> 
                <td width="407" valign = "top" class = "Main"> 
                  <p><span><b>Consumer Energy Services</b> provides customer specific 
                    ...
                    In addition, since these services require less energy usage, 
                    you play an active role in helping to preserve our natural 
                    environment and it's resources.</span></p> 
...
%>
                ...
                <td width="151" valign = "top" class = "Main"><br> <span><b><font face="Arial, Helvetica, sans-serif" size="2">Use 
                  these features to:</font></b></span><br><br>
  ...
  <tr> 
    <td bgcolor="#666699" height="13" align = "center" valign = "top" class = "TableCell2">Back to:&nbsp;<a class = "Link2" href="../../login.jsp">demo.cannontech.com</a> 
    </td>
  </tr>
  </table>
