  ...
  <tr> 
    <td bgcolor="#666699" height="80"> 
        ...
        <table width="100%" height="75" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="34%" valign="top" class="TableCell2">Cannon Technologies, 
            Inc.<br clear="ALL">
              8301 Golden Valley Road, Suite 300<br>
              Golden Valley, MN 55427<br>
              800-827-7966<i><br clear="ALL">
              </i></td>
        ...
        <tr>
          <td>
            <table width="450" border="0" cellspacing="0" cellpadding="5" align="center">
              <tr> 
                <td width="187"> 
                  <p align="center" class="Main"><b>Welcome to Consumer<br>
                    Energy Services</b></p>
              ...
              <tr> 
				...
				<div class="TableCell"> 
                  If you are currently enrolled in a program, 
                    enter your account number and password.</div>
				  ...
				  <table width="200" border="0" cellspacing="0" cellpadding="3" align="center">
                    ...
                    <tr> 
                      <td width="83"> 
                        <div align="right" class="TableCell">Password:</div>
                      </td>
                      <td width="117"> 
				 ...
				 <div class="TableCell"> 
                  If you need 
                  help or have forgotten your password, click <a href="mailto:info@cannontech.com">here</a>.
				  </div>
                </td>
                <td width="150"> 
                  <table width="130" border="1" cellspacing="0" cellpadding="10" align="center">
					...
					<form method="post" action="ProgramsNew.jsp"> 
                        <td > 
                          <div align="center" class="TableCell"><b>Sign up today!</b><br>
                            <br>
                            Click below to view and sign up for our programs. 
                            <br>
                            <br>
                          </div>
                          <div align="center">
...
<div align="center" class="TableCell2">&copy; 2002 Cannon Technologies, Inc. All 
  rights reserved. </div>
</body>
