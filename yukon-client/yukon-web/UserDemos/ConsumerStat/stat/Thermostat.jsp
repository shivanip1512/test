                          ...
                          <tr> 
                              ...
                              <table width="18%" border="0" cellspacing = "0" cellpadding ="0" height="60" >
                                <tr> 
                                  <td width="52%" height="53"> 
                                    <input type="text" name="tempField" maxlength = "2" class = "tempText1" color:#003366" value = "72" onkeypress = "validateTemp(event)">
                                  </td>
                            ...
                            <td width="31%" height="113" valign="middle"><br>
                              <table width="100" border="0">
                                <tr>
                                  <td class="TableCell" bordercolor="#FFFFFF">The 
                                    last setting you submitted was HOLD at 70&deg;</td>
                                </tr>
                              </table>
                                ...
                                <tr> 
                                  ...
                                  <td width="47%" height="59" valign = "bottom"> 
                                    <table width="34%" border="0" cellpadding = "2" cellspacing = "0">
                                      <tr> 
                                        <td ><img id = "auto" src="ThermImages/Arrow.gif"></td>
                                      ...
                                      <tr> 
                                        <td><img id = "off2" src="ThermImages/Arrow.gif" style="visibility:hidden"></td>
