...
<div align="left"><span class="NavHeader">Trends</span><br>
	...
	if( gData != null )
	{
		for( int i = 0; i < gData.length; i++ )                                                          
		{
			...
			{%>
				<img src="../../WebConfig/<cti:getProperty propertyid="<%=WebClientRole.NAV_BULLET%>"/>" width="12" height="12">&nbsp;<a href="<%=request.getContextPath()%>/operator/Metering/Metering.jsp?<%= "gdefid=" + gData[i][0]%>" class="Link2"><span class="NavText"><%=gData[i][1] %></span></a><br>
			<%}
		}
	}%>
</div>
