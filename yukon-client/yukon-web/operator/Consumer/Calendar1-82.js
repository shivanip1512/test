...
Calendar.prototype.show = function() {
	...
	if (v_Nav == "Yes") {
		...
		this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=2>" + 
				...
				");\">Mnth<\/A></FONT></TD><TD ALIGN=center>");
		/* This is the Print code to give a calendar print function*/		
		/*this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=2>" + 
	...
	if (arguments[4] == null)
		...
		p_type = (typeof(arguments[4]) == "string" && 
					(arguments[4] == "POPUP" || arguments[4] == "INLINE")) ?
						...
						"POPUP";
	if (arguments[5] == null)
		p_custom = "CloseOnSelect=Yes;AppendOrReplace=Replace;AppendChar=';';ReturnData=Date;Title=Calendar;AllowWeekends=Yes;Resizable=No";
	else
