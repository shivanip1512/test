    ...
    <td>
      <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bordercolor="0">
        ...
        <tr> 
		  ...
		  <% String pageName = "WH.jsp"; %>
          <%@ include file="Nav.jsp" %>		  
		  </td>
          <td width="1" bgcolor="#000000"><img src="VerticalRule.gif" width="1"></td>
          <td width="657" valign="top" bgcolor="#FFFFFF"> 
            <div align="center"><% String header = "APPLICANCE - WATER HEATER"; %><%@ include file="InfoSearchBar.jsp" %>
             </div>
            <table width="610" border="0" cellspacing="0" cellpadding="10" align="center">
              <tr> 
                      ...
                      <tr> 
                        ...
                        <td width="200"> 
                          <select name="select3">
                            ...
                            <option selected>Water Heater</option>
                          </select>
                        </td>
                      </tr>
                      <tr> 
                ...
                <form name="form7" method="get" action="ContHist4.jsp">
                  <td width="300" valign="top" bgcolor="#FFFFFF"> 
            ...
            <hr>
            <div align="center"><br>
              <div align="center" class="MainHeader"><b>Hardware Summary</b></div>
              <table width="360" border="1" cellspacing="0" cellpadding="3" align="center">
                ...
                <tr> 
                  <td width="75" class="TableCell" bgcolor="#FFFFFF">Switch</td>
                  <td width="75" class="TableCell" bgcolor="#FFFFFF">LCR 5000</td>
                  <td width="75" class="TableCell" bgcolor="#FFFFFF">12345</td>
                </tr>
              </table>
            </div>
            <p>&nbsp;</p>
