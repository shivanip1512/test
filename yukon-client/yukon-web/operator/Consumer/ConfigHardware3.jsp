...
%>
                        ...
                        <br>
                        <table width="150" border="1" cellspacing="0" cellpadding="3" bgcolor="#CCCCCC" align="center">
                          <tr>
                            <td class="TitleHeader">
                              <div align="center">ExpressCom Addresses<br>
                                <table width="150" border="0" cellspacing="0" cellpadding="3">
                                  <tr> 
                                    ...
                                    <td> 
                                      <input type="text" name="textfield79" size="10" maxlength="10">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="TitleHeader"> 
                                    ...
                                    <td> 
                                      <input type="text" name="textfield710" size="10" maxlength="10">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="TitleHeader"> 
                                      <div align="right">Address 3:</div>
                                    </td>
                                    <td> 
                                      <input type="text" name="textfield711" size="10" maxlength="10">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="TitleHeader"> 
                                      <div align="right">Address 4:</div>
                                    </td>
                                    <td> 
                                      <input type="text" name="textfield712" size="10" maxlength="10">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td class="TitleHeader"> 
                                      <div align="right">Address 5:</div>
                                    </td>
                                    <td> 
                                      <input type="text" name="textfield713" size="10" maxlength="10">
                                    </td>
                                  </tr>
                                </table>
                              </div>
                    ...
                    <td width="285" valign="top">
                      <table width="220" border="1" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC" align="right">
                        <tr> 
                          <td> 
                            <table width="220" border="0" cellspacing="0" cellpadding="3">
                              <tr class="TitleHeader" valign="top"> 
                                <td width="46" class="TitleHeader"> 
                                  <div align="right">Relay:</div>
                                </td>
                                <td width="95"> 
                                  <div align="center">Cold Load Pickup</div>
                                </td>
                                <td width="91"> 
                                  <div align="center">Tamper Detect</div>
                                </td>
                              </tr>
                              <tr> 
                                <td width="46" class="TitleHeader"> 
                              ...
                              <tr> 
                                ...
                                <td width="91"> 
                                  <div align="center">
                                    <input type="text" name="textfield762" size="10" maxlength="10">
                                  </div>
                                </td>
                              </tr>
                              <tr> 
                                ...
                                <td width="91"> 
                                  <div align="center"> 
                                    <input type="text" name="textfield722" size="10" maxlength="10">
                                  </div>
                                </td>
                              </tr>
                              <tr> 
