        ...
        <tr> 
          ...
          <td width="657" valign="top" bgcolor="#FFFFFF"> 
            <div align="center"> 
              ...
              </b><span class="Main">Please answer the following questions<br>
              <br>
              </span>
			  <form method="post" action="Wizard3.jsp">
                ...
                <table class = "TableCell" width="75%" border="1" cellpadding = "3" cellspacing = "0" height="87">
                  ...
                  <tr> 
                    <td width="60%">Do you have central air?</td>
                    <td width="21%"> 
                ...
                <br><table width="150" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <td align = "center"> 
                      ...
                      <input type="submit" name="tab" value="  Next  ">
