...
<table width="100%" border="0" cellpadding="10">
                  ...
                  <td width="56%"> 
                    <p align="center"><font face="Arial, Helvetica, sans-serif" size="2"><b>Welcome 
                      Edward Holland</b><br>
                      You are enrolled in the following programs:</font></p>
                      <div align="center"> 
                        ...
                        <table width="300" border="0" cellspacing="0" cellpadding="3">
                          <tr>
						    <form method="post" action="ProgramDetails.jsp"> 
                            <td> 
                              <div align="center">
                                <input type="submit" name="Programs" value="Program Details">
                              </div>
                            </td>
					      </form>	
                          </tr>
                        ...
                        <tr>
                          ...
                          <td height="58" bgcolor="#CCCCCC"> 
							...
							<table width="190" border="0" cellspacing="0" cellpadding="2">
                              <tr> 
                                <td width="141"> 
                                  <input type="text" name="textfield4" maxlength="8">
                                </td>
                                <td width="49"> 
                ...
                <table width="600" border="0" cellspacing="0">
                  <tr>
                    <td width="107" valign="top"><font face="Arial, Helvetica, sans-serif" size="2">You 
                      may select a specific Temp Setpoint (actual temperature) 
                      or select how many degrees you would like the temperature 
                      to change by. If pre-cooling, also specify the duration 
                      in hours. Then click Set.</font></td>
                    <td width="489"> 
                ...
                <table width="600" border="1" cellpadding="3" cellspacing="0">
                  ...
                  <tr> 
                    <td valign="top" align="center" width="184"> 
                      <p align="center" class="TableCell"><font face="Arial, Helvetica, sans-serif" size="1">Select 
                    ...
                    <td valign="top" align="center" width="183"> 
                      <p align="center" class="TableCell"><font face="Arial, Helvetica, sans-serif" size="1">Select 
                        the time period you would like to opt out of, then click 
                        Submit.</font></p>
                    ...
                    <td valign="top" align="center" width="199"> 
                      <p align="center" class="TableCell"><font face="Arial, Helvetica, sans-serif" size="1">Select 
                        a new program, then click Submit.</font></p>
                      <table width="180" border="0" cellspacing="0" cellpadding="3" align="center">
                        <tr> 
                        ...
                        <tr> 
                          <td width="107"><img src="../SetBack.gif" width="60" height="59"></td>
                          <td width="102">&nbsp;</td>
                        </tr>
                        <tr>
						<form method="post" action="Features.jsp"> 
