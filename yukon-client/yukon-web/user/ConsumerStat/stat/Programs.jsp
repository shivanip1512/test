                ...
                <tr> 
                  ...
                  <form method="get" action="ProgramDetails.jsp">
                    <td width="296" valign="top"> 
                      <div align="center" class="TableCell">Select the check 
                        boxes and corresponding radio button of the programs you 
                        would like to be enrolled in.<br>
                        <span class="TableCell"> <br>
