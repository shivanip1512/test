...
<%
	...
	String manualLink = "Thermostat.jsp?" + thermNoStr;
%>
...
<% } %>
                      ...
                      <table width="478" height="186" background="<%= request.getContextPath() %>/Images/ThermImages/TempBG2.gif" style="background-repeat: no-repeat" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50">
                            <div id="MovingLayer1" style="position:relative; width:30px; height:162px; left:0px; z-index:1; top:5px; display:none" onMouseDown = "beginDrag(event,0,0,getRightBound(1),getLeftBound(1),'showTimeWake()','horizontal','MovingLayer1');setChanged()">
                              <table border="0">
                                ...
                                <tr> 
                                  <td align="center" colspan="2"> <img src="<%= request.getContextPath() %>/Images/ThermImages/ThermW.gif" width="16" height="131"> 
                                  </td>
                                </tr>
                                <tr> 
                                  <td width="50%"> 
                          ...
                          <td width="50">
                            <div id="MovingLayer2" style="position:relative; width:30px; height:162px; left:0px; z-index:2; top:5px; display:none" onMouseDown = "beginDrag(event,0,0,getRightBound(2),getLeftBound(2),'showTimeLeave()','horizontal','MovingLayer2');setChanged()"> 
                              <table border="0">
                                ...
                                <tr> 
                                  <td align="center" colspan="2"> <img src="<%= request.getContextPath() %>/Images/ThermImages/ThermL.gif" width="16" height="131"> 
                                  </td>
                                </tr>
                                <tr> 
                                  <td width="50%"> 
