 ...
 */
	...
	if (!isRecommended) {
		for (int i = 0; i < dftThermoSchedules.getStarsThermostatProgramCount(); i++) {
			if (dftThermoSchedules.getStarsThermostatProgram(i).getThermostatType().getType() == StarsThermostatTypes.COMMERCIAL_TYPE) {
                          ...
                          <td width="50"> 
                            <div id="MovingLayer1" style="position:relative; width:30px; height:162px; left:0px; z-index:1; top:5px; display:none" onMouseDown = "beginDrag(event,0,0,getRightBound(1),getLeftBound(1),'showTimeOccupied()','horizontal','MovingLayer1');setChanged()">
                              <table border="0">
                                ...
                                <tr> 
                                  <td align="center" colspan="2"> <img src="<%= request.getContextPath() %>/WebConfig/yukon/ThermImages/OcTherm.gif" width="16"> 
                                  </td>
                                </tr>
                                <tr> 
                                  <td width="50%"> 
                          ...
                          <td width="50"> 
                            <div id="MovingLayer4" style="position:relative; width:30px; height:162px; left:0px; z-index:4; top:5px; display:none" onMouseDown = "beginDrag(event,0,0,getRightBound(4),getLeftBound(4),'showTimeUnoccupied()','horizontal','MovingLayer4');setChanged()"> 
                              <table border="0">
                                ...
                                <tr> 
                                  <td align="center" colspan="2"> <img src="<%= request.getContextPath() %>/WebConfig/yukon/ThermImages/UnOcTherm.gif" width="16" height="131"> 
                                  </td>
                                </tr>
                                <tr> 
                                  <td width="50%"> 
