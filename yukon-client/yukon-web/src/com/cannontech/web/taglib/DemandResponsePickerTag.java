...
public class DemandResponsePickerTag extends ItemPickerTag {

    private String selectionLinkName = "Done";
    private String excludeIds = "";

    public DemandResponsePickerTag() {
        super();
    }

    public void doTag() throws JspException, IOException {
        startOfTag("/JavaScript/paoPicker.js",
                   "/JavaScript/demandResponsePicker.js");
