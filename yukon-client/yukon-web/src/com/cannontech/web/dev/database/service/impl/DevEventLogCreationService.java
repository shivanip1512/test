...
public class DevEventLogCreationService {
    ...
    public void setup() {
        ...
        executables.put(LogType.ECOBEE, new DevEventLogExecutable() {
            ...
            public void execute(DevEventLog devEventLog) {
                ...
                ecobeeEventLogService.syncIssueUnmodified("123453526", EcobeeDiscrepancyType.EXTRANEOUS_DEVICE.toString(),
                        yukonUser, EcobeeDiscrepancyType.EXTRANEOUS_DEVICE.toString());
    ...
    public static enum LogType implements Displayable {
        ...
        ECOBEE(EcobeeEventLogService.class, 5),
