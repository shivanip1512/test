...
public class BulkImportFileGeneratorController {
    ...
    public String bulkImportFileGenerator(HttpServletRequest request, HttpServletResponse response) throws IOException {

        try {
            String deviceGroupName = ServletRequestUtils.getRequiredStringParameter(request, "deviceGroupName");
            String appendedText = ServletRequestUtils.getRequiredStringParameter(request, "appendedText");
            ...
            List<SimpleDevice> meterPaos = Lists.newArrayList();
