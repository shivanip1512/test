...
public class PxMWSimulatorApiControllerV1 {
    ...
    @GetMapping("api/v1/sites/{id}/devices")
    ...
    @PostMapping("api/v1/security/serviceaccount/token")
    ...
    @PutMapping("api/v1/devices/{id}/commands/{command_instance_id}")
    ...
    @PostMapping("api/v1/devices/timeseries/")
    ...
    @GetMapping("api/v1/accesscontrol/sites")
