...
public class DeviceConfigurationConfigController {
    ...
    private void setupModelMap(ModelMap model,
        ...
        for (PaoType paoType : deviceConfigTypes.getSupportedTypes().keySet()) {
            if (paoDefinitionDao.isAdvancedMetrologyConfigurationType(paoType)) {
                supportsAdvancedMetrology = true;
                break;
            }
        }
