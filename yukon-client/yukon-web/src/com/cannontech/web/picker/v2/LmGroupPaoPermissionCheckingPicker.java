...
public class LmGroupPaoPermissionCheckingPicker extends FilterPaoPicker {

	private LmPaoPermissionCheckingPostProcessingFilterFactory paoPermissionFilterFactory;
	
	@Override
	public SearchResult<UltraLightPao> search(String ss, int start, int count, String extraArgs, YukonUserContext userContext) {
