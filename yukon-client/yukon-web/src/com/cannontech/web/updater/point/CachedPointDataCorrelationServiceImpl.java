...
public class CachedPointDataCorrelationServiceImpl implements CachedPointDataCorrelationService {
    ...
    boolean isMatched(PointValueQualityHolder historicalValue,
        ...
        log.info("Comparing values:" + " historicalValue=" + historicalValue.getValue()
            + " pointUpdateBackingServiceCachedValue=" + pointUpdateBackingServiceCachedValue.getValue()
            + " asyncDataSourceValue=" + asyncDataSourceValue.getValue());
