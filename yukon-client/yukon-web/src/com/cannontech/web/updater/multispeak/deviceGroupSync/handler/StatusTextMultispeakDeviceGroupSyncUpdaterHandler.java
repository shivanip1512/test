...
public class StatusTextMultispeakDeviceGroupSyncUpdaterHandler implements MultispeakDeviceGroupSyncUpdaterHandler {
	...
	public String handle(MultispeakDeviceGroupSyncProgress progress, YukonUserContext userContext) {
		...
		String formatKey = status.getFormatKey();
	...
	public MultispeakDeviceGroupSyncUpdaterTypeEnum getUpdaterType() {
		return MultispeakDeviceGroupSyncUpdaterTypeEnum.STATUS_TEXT;
	}
