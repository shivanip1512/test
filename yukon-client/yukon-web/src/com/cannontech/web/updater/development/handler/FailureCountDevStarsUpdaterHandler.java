...
public class FailureCountDevStarsUpdaterHandler implements DevExecutionUpdaterHandler {
    ...
    public String handle() {
        ...
        int count = devStars.getFailureCount();
    ...
    public DevExecutionUpdaterTypeEnum getUpdaterType() {
        return DevExecutionUpdaterTypeEnum.STARS_FAILURE_COUNT;
    }
