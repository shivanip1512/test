...
public class TotalCountDevStarsUpdaterHandler implements DevExecutionUpdaterHandler {
    ...
    public DevExecutionUpdaterTypeEnum getUpdaterType() {
        return DevExecutionUpdaterTypeEnum.STARS_TOTAL_COUNT;
    }
