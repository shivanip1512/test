...
public class FailureCountDevCapControlUpdaterHandler implements DevExecutionUpdaterHandler {
    ...
    public String handle() {
        ...
        int count = devCapControl.getFailureCount();
    ...
    public DevExecutionUpdaterTypeEnum getUpdaterType() {
        return DevExecutionUpdaterTypeEnum.CC_FAILURE_COUNT;
    }
