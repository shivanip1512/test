...
public class FailureCountDevAMRUpdaterHandler implements DevExecutionUpdaterHandler {
    ...
    public String handle() {
        ...
        int count = devAMR.getFailureCount();
    ...
    public DevExecutionUpdaterTypeEnum getUpdaterType() {
        return DevExecutionUpdaterTypeEnum.AMR_FAILURE_COUNT;
    }
