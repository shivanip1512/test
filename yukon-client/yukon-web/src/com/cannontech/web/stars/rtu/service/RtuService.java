...
public interface RtuService {
     ...
     */
    List<MessageSourceResolvable> generateDuplicatePointsErrorMessages(int paoId);
     ...
     */
    List<MessageSourceResolvable> generateDuplicatePointsErrorMessages(int paoId, PointIdentifier pointIdentifier);
}
