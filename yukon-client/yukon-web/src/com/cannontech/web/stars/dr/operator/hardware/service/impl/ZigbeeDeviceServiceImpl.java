...
public class ZigbeeDeviceServiceImpl implements ZigbeeDeviceService {
    ...
    public List<Pair<InventoryIdentifier, ZigbeeDeviceDto>> buildZigbeeDeviceDtoList(int accountId) {
        ...
        List<ZigbeeDeviceAssignment> assignments =
            gatewayDeviceDao.getZigbeeDevicesForAccount(accountId, deviceTypeIds);
        ...
        for (ZigbeeDeviceAssignment assignment : assignments) {
            ...
            Pair<InventoryIdentifier, ZigbeeDeviceDto> pair =
                new Pair<InventoryIdentifier, ZigbeeDeviceDto>(gateway, dto);
            deviceList.add(pair);
        }
    ...
    public ZigbeeDeviceDto buildZigbeeDeviceDto(int deviceId) {
        ...
        LitePoint linkPt =
            attributeService.getPointForAttribute(new PaoIdentifier(deviceId, PaoType.ZIGBEE_ENDPOINT),
