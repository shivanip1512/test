...
public class OperatorProgramControlHistoryController{
    ...
    public String controlHistory(int accountId, YukonUserContext userContext, ModelMap map) throws ServletRequestBindingException {
    ...
    public String completeHistoryView(int accountId, int programId, YukonUserContext yukonUserContext, ModelMap map) {
        map.addAttribute("accountId", accountId);
    ...
    public String innerCompleteHistoryView(int accountId, int programId, String controlPeriod, YukonUserContext yukonUserContext,
                                           ModelMap map) {
        map.addAttribute("accountId", accountId);
        CustomerAccount customerAccount = customerAccountDao.getById(accountId);
