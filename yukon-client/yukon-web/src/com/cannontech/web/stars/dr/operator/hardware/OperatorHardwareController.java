...
public class OperatorHardwareController {
    ...
    public String create(@ModelAttribute("hardware") Hardware hardware, BindingResult bindingResult, ModelMap model,
        ...
        hardwareModelHelper.creationAttempted(user, accountInfoFragment.getAccountNumber(), hardware, verifyProperties,
            bindingResult);
        ...
        if (!bindingResult.hasErrors()) {
            ...
            flashScope.setConfirm(
                new YukonMessageSourceResolvable("yukon.web.modules.operator.hardware.hardwareCreated"));
            model.addAttribute("inventoryId", inventoryId);
