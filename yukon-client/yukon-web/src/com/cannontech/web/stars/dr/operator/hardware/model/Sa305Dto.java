...
public class Sa305Dto implements AddressingInfo {
    ...
    public void updateFromStarsConfiguration(StarsLMConfiguration config) {
        ...
        group = HardwareConfigurationDto.nullIfZero(sa305.getGroup());
        division = HardwareConfigurationDto.nullIfZero(sa305.getDivision());
        substation = HardwareConfigurationDto.nullIfZero(sa305.getSubstation());
        rate = HardwareConfigurationDto.nullIfZero(sa305.getRateRate());
        rateFamily = HardwareConfigurationDto.nullIfZero(sa305.getRateFamily());
        rateMember = HardwareConfigurationDto.nullIfZero(sa305.getRateMember());
    }
    ...
    public void validate(Errors errors) {
        YukonValidationUtils.checkRange(errors, "addressingInfo.utility", utility,
                                        0, 15, true);
        YukonValidationUtils.checkRange(errors, "addressingInfo.group", group,
                                        0, 63, false);
        YukonValidationUtils.checkRange(errors, "addressingInfo.division", division,
                                        0, 63, false);
        YukonValidationUtils.checkRange(errors, "addressingInfo.substation", substation,
                                        0, 1023, false);
        YukonValidationUtils.checkRange(errors, "addressingInfo.rate", rate,
                                        0, 127, false);
    }
}
