...
public class DisplayableInventoryDaoImpl extends AbstractDisplayableDao implements DisplayableInventoryDao {
    ...
    @Override
    public List<DisplayableInventory> getDisplayableInventory(final CustomerAccount customerAccount) {
        ...
        List<InventoryBase> inventoryList = 
            inventoryBaseDao.getByAccountId(customerAccount.getAccountId());
