...
public class Sa205Dto implements AddressingInfo {
    ...
    public void updateFromStarsConfiguration(StarsLMConfiguration config) {
        ...
        slots[0] = HardwareConfigurationDto.nullIfZero(sa205.getSlot1());
        slots[1] = HardwareConfigurationDto.nullIfZero(sa205.getSlot2());
        slots[2] = HardwareConfigurationDto.nullIfZero(sa205.getSlot3());
        slots[3] = HardwareConfigurationDto.nullIfZero(sa205.getSlot4());
        slots[4] = HardwareConfigurationDto.nullIfZero(sa205.getSlot5());
        slots[5] = HardwareConfigurationDto.nullIfZero(sa205.getSlot6());
    }
    ...
    public void validate(Errors errors) {
        for (int index = 0; index < slots.length; index++) {
            YukonValidationUtils.checkRange(errors, "addressingInfo.slots[" + index + "]",
