...
public class CustIdMspMeterSearchMethodResultProvider extends MspMeterSearchMethodResultProviderBase {
	...
	public List<String> getMeterNumbers(String filterValue) {
		...
		List<Meter> meters = mspObjectDao.getMspMetersByCustId(filterValue, mspVendor);
