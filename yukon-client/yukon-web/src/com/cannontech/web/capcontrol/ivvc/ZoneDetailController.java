...
public class ZoneDetailController {
    ...
    private void setupDeltas(ModelMap model, HttpServletRequest request, int zoneId) throws ServletRequestBindingException {
        ...
        CapBankPointDelta joe0 = new CapBankPointDelta();
        joe0.setPointId(946);
        joe0.setCbcName("Joes CBC");
        joe0.setAffectedDeviceName("Joes CBC");
        pointDeltas.add(joe0);
        CapBankPointDelta joe1 = new CapBankPointDelta();
        joe1.setPointId(948);
        joe1.setCbcName("Joes CBC 1");
        joe1.setAffectedDeviceName("Joes CBC 1");
        pointDeltas.add(joe1);
        CapBankPointDelta joe2 = new CapBankPointDelta();
        joe2.setPointId(948);
        joe2.setCbcName("Joes CBC 2");
        joe2.setAffectedDeviceName("Joes CBC 2");
        pointDeltas.add(joe2);
        CapBankPointDelta joe3 = new CapBankPointDelta();
        joe3.setPointId(948);
        joe3.setCbcName("Joes CBC 3");
        joe3.setAffectedDeviceName("Joes CBC 3");
        pointDeltas.add(joe3);
        CapBankPointDelta joe4 = new CapBankPointDelta();
        joe4.setPointId(948);
        joe4.setCbcName("Joes CBC 4");
        joe4.setAffectedDeviceName("Joes CBC 4");
        pointDeltas.add(joe4);
        CapBankPointDelta joe5 = new CapBankPointDelta();
        joe5.setPointId(948);
        joe5.setCbcName("Joes CBC 5");
        joe5.setAffectedDeviceName("Joes CBC 5");
        pointDeltas.add(joe5);
        CapBankPointDelta joe6 = new CapBankPointDelta();
        joe6.setPointId(948);
        joe6.setCbcName("Joes CBC 6");
        joe6.setAffectedDeviceName("Joes CBC 6");
        pointDeltas.add(joe6);
        CapBankPointDelta joe7 = new CapBankPointDelta();
        joe7.setPointId(948);
        joe7.setCbcName("Joes CBC 7");
        joe7.setAffectedDeviceName("Joes CBC 7");
        pointDeltas.add(joe7);
        CapBankPointDelta joe8 = new CapBankPointDelta();
        joe8.setPointId(948);
        joe8.setCbcName("Joes CBC 8");
        joe8.setAffectedDeviceName("Joes CBC 8");
        pointDeltas.add(joe8);
        CapBankPointDelta joe9 = new CapBankPointDelta();
        joe9.setPointId(948);
        joe9.setCbcName("Joes CBC 9");
        joe9.setAffectedDeviceName("Joes CBC 9");
        pointDeltas.add(joe9);
        CapBankPointDelta joe10 = new CapBankPointDelta();
        joe10.setPointId(948);
        joe10.setCbcName("Joes CBC 10");
        joe10.setAffectedDeviceName("Joes CBC 10");
        pointDeltas.add(joe10);
        CapBankPointDelta joe11 = new CapBankPointDelta();
        joe11.setPointId(948);
        joe11.setCbcName("Joes CBC 11");
        joe11.setAffectedDeviceName("Joes CBC 11");
        pointDeltas.add(joe11);
