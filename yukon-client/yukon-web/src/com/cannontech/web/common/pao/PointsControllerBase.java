...
public abstract class PointsControllerBase {
     ...
     */
    protected String points(ModelMap model, int deviceId, String orderBy, Boolean descending) {
     ...
     */
    protected void download(HttpServletResponse response, YukonUserContext context, int deviceId, String orderBy, Boolean descending) throws IOException {
