...
public class VirtualDevicePaoTypeHandler implements PaoTypeHandler {

    @Autowired private RolePropertyDao rolePropertyDao;
    @Autowired private PaoLoadingService paoLoadingService;

    private final static Set<PaoType> allTypes = ImmutableSet.of(PaoType.VIRTUAL_SYSTEM);
    ...
    public void buildDocument(DocumentBuilder builder, YukonResultSet rs, PaoIdentifier paoIdentifier) throws SQLException {
        ...
        String path = "/stars/virtualDevice/" + paoId;
        String pageName = "virtualDevice.detail";
