...
//                   MatchStyle.all, GlobalSettingType.NEST_USERNAME),
    ...
    DR_BULK_UPDATE(SiteMapCategory.DR, "yukon.web.modules.tools.bulk.updateUpload.pageName", "/bulk/update/upload",
                MatchStyle.all, YukonRoleProperty.BULK_UPDATE_OPERATION),
    DR_SETUP(SiteMapCategory.DR, "yukon.web.modules.dr.setup.pageName", "/dr/setup/list", MatchStyle.all, YukonRoleProperty.DR_SETUP_PERMISSION),
    ...
    COMMCHANNELS(SiteMapCategory.ASSETS, "yukon.web.menu.assets.commChannels", "/stars/device/commChannel/list", MatchStyle.all, YukonRoleProperty.CBC_DATABASE_EDIT),
    ...
    DATA_STREAMING(SiteMapCategory.TOOLS, "yukon.web.menu.tools.dataStreaming", "/tools/dataStreaming/configurations",
            ...
            MasterConfigLicenseKey.RF_DATA_STREAMING_ENABLED),
    ...
    THREAD_DUMP(SiteMapCategory.SUPPORT, "yukon.web.modules.support.threadDump.pageName", "/support/threadDump",
            MatchStyle.all, YukonRole.OPERATOR_ADMINISTRATOR),
    BATTERY_NODE_ANALYSIS(SiteMapCategory.SUPPORT, "yukon.web.modules.support.batteryNodeAnalysis.pageName", "/support/batteryNodeAnalysis/view",
            MatchStyle.all, YukonRole.METERING),
    THIRD_PARTY_LIBRARIES(SiteMapCategory.SUPPORT, "yukon.web.modules.support.thirdPartyLibraries.pageName", "/support/thirdParty/view",
               MatchStyle.all),
