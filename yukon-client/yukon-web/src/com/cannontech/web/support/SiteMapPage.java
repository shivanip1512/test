...
public enum SiteMapPage implements DisplayableEnum {
    ...
    MSP_POWER_SUPPLIER_LOADS(SiteMapCategory.TOOLS, "yukon.web.modules.visualDisplays.loadManagement.siteMapName", "/multispeak/visualDisplays/loadManagement/home",
            MatchStyle.all, OtherPermission.HIDEABLE, GlobalSettingType.MSP_LM_MAPPING_SETUP),
    MSP_PROB_FOR_PEAK_LOAD(SiteMapCategory.TOOLS, "yukon.web.modules.visualDisplays.probabilityForPeakLoad.pageTitle", "/multispeak/visualDisplays/probabilityForPeak/home",
            MatchStyle.all, OtherPermission.HIDEABLE, GlobalSettingType.MSP_LM_MAPPING_SETUP),
