...
public enum SiteMapPage implements DisplayableEnum {
    ...
    IMPORT_AMI(SiteMapCategory.AMI, "yukon.common.device.bulk.bulkHome.legacyImporter", "/amr/bulkimporter/home",
    ...
    CI_CURTAILMENT(SiteMapCategory.DR, "yukon.web.menu.dr.ci", "/cc/programSelect.jsf",
    ...
    MSP_TO_LM_MAPPING(SiteMapCategory.TOOLS, "yukon.web.modules.visualDisplays.loadManagement.siteMapName", "/multispeak/visualDisplays/loadManagement/home",
    ...
    DEVELOPMENT(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.home.pageName", "/support/development/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    UI_DEMO(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.styleguide.pageName", "/support/development/styleguide/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    UI_TOOLKIT(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.uiToolkitDemo.pageName", "/support/development/uiToolkitDemo/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    POINT_INJECTION(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.pointInjection.pageName", "/support/development/pointInjection/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    BULK_POINT_INJECTION(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.bulkPointInjection.pageName", "/support/development/bulkPointInjection/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    SETUP_DATABASE(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.setupDatabase.pageName", "/support/development/setupDatabase/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    MISC_METHODS(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.miscellaneousMethod.pageName", "/support/development/miscellaneousMethod/main",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    RFN_TEST(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.rfnTest.pageName", "/support/development/rfn/viewBase",
            MatchStyle.all, OtherPermission.HIDEABLE, MasterConfigBooleanKeysEnum.DEVELOPMENT_MODE),
    EIM_TEST(SiteMapCategory.DEVELOPMENT, "yukon.web.modules.dev.webServices.eimTest.pageName", "/support/development/eimTest/main",
