...
public class SiteMapHelper {
    ...
    public enum SiteMapPage implements DisplayableEnum {
        ...
        AMI_SCHEDULES(SiteMapCategory.AMI, "yukon.web.modules.amr.billing.jobs.title", "/group/scheduledGroupRequestExecutionResults/jobs", 
                MatchStyle.all, YukonRole.SCHEDULER),
        SCRIPTS(SiteMapCategory.AMI, "yukon.web.menu.config.amr.scheduler", "/macsscheduler/schedules/view", 
                MatchStyle.all, YukonRole.SCHEDULER),
        ...
        WATER_LEAK_REPORT(SiteMapCategory.AMI, "yukon.web.modules.amr.waterLeakReport.report.pageName", "/amr/waterLeakReport/report?initReport=true",
                MatchStyle.all),
        BILLING_SETUP(SiteMapCategory.AMI, "yukon.web.modules.amr.billing.HOME.contextualPageName", "/dynamicBilling/overview",
                MatchStyle.all, YukonRoleProperty.DYNAMIC_BILLING_FILE_SETUP),
        BILLING_SCHEDULES(SiteMapCategory.AMI, "yukon.web.menu.config.amr.billing.schedules", "/scheduledBilling/jobs", 
                MatchStyle.all, YukonRole.APPLICATION_BILLING),
        ...
        VOLT_VAR_MANAGEMENT(SiteMapCategory.VV, "yukon.web.voltVarManagement", "/capcontrol/tier/areas", 
        ...
        DATABASE_INFO(SiteMapCategory.SUPPORT, "yukon.web.modules.support.databaseInfo.pageName", "/support/database/info", 
                MatchStyle.all),
        DATABASE_VALIDATION(SiteMapCategory.SUPPORT, "yukon.web.modules.support.databaseValidate.pageName", "/support/database/validate/home", 
                MatchStyle.all, YukonRoleProperty.ADMIN_VIEW_LOGS),
        EVENTS_CATEGORY(SiteMapCategory.SUPPORT, "yukon.web.menu.support.category", "/common/eventLog/viewByCategory", 
                MatchStyle.all, YukonRoleProperty.ADMIN_EVENT_LOGS),
        EVENTS_TYPE(SiteMapCategory.SUPPORT, "yukon.web.menu.support.type", "/common/eventLog/viewByType", 
                MatchStyle.all, YukonRoleProperty.ADMIN_EVENT_LOGS),
