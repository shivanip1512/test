...
public enum JwsJnlp {
    ...
    TRENDING("trending.jnlp",
             ...
             "graph.jar",
             "/WebConfig/yukon/Icons/GraphTrending64.png"),
    ESUB("esub.jnlp",
         "eSubstation Editor",
         "Allows users to create, modify, and save eSubstation drawings.",
         "com.cannontech.esub.editor.Editor",
         "esub-editor.jar",
         "/WebConfig/yukon/Icons/Esubstation64.png",
         "dbeditor.jar", "esub.jar"),
    COMMANDER("commander.jnlp",
              ...
              "yc.jar",
              "/WebConfig/yukon/Icons/Commander64.png"),
