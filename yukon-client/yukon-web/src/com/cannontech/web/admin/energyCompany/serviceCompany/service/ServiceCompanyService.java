...
public interface ServiceCompanyService {
     ...
     */
    List<ServiceCompanyDesignationCode> getDesignationCodesForServiceCompany(ServiceCompanyDto serviceCompanyDto);
     ...
     */
    void deleteServiceCompany(int serviceCompanyId);
