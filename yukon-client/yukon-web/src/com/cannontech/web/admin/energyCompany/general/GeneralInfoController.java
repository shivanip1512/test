...
public class GeneralInfoController {
    ...
    public String addMember(ModelMap model, YukonUserContext context, FlashScope flash, int ecId, int newMemberId, 
        ...
        LiteYukonUser user = context.getYukonUser();
        if(!energyCompanyService.canManageMembers(user, ecId)) {
    ...
    public String createMember(ModelMap model, YukonUserContext context, FlashScope flash, int ecId) throws Exception {
    ...
    public boolean getCanManageMembers (YukonUserContext context, ModelMap modelMap, int ecId) {
        return energyCompanyService.canManageMembers(context.getYukonUser(), ecId);
    }
