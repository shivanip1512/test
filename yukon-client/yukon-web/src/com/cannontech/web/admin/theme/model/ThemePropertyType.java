...
public enum ThemePropertyType implements DisplayableEnum {
    ...
    LOGIN_BACKGROUND_URL("login-background-url", "/WebConfig/yukon/layout/bg_mountain_1920_420_fade2.jpg", new ImageType()),
    ...
    LOGO_URL("logo-url", "/WebConfig/yukon/layout/eaton_logo.png", new ImageType()),
