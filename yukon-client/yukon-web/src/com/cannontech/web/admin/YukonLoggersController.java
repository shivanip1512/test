...
public class YukonLoggersController {
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK || response.getStatusCode() == HttpStatus.CREATED) {
                flashScope.setConfirm(
                        new YukonMessageSourceResolvable("yukon.common.save.success", logger.getLoggerName()));
            }
            ...
            flashScope.setError(new YukonMessageSourceResolvable("yukon.web.api.save.error", logger.getLoggerName(),
                    ex.getMessage()));
        }
        return redirectLink;
    }
    ...
    public String editLogger(@ModelAttribute YukonLogger logger, @PathVariable Integer loggerId, ModelMap model,
        ...
        try {
            ...
            flashScope.setError(new YukonMessageSourceResolvable("yukon.web.api.retrieve.error", logger.getLoggerName(),
                    ex.getMessage()));
        }
        return "config/addLoggerPopup.jsp";
    }
