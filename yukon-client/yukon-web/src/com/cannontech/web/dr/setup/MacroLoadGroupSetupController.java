    ...
    public String save(@ModelAttribute("macroLoadGroup") MacroLoadGroup macroLoadGroup, BindingResult result,
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                flash.setConfirm(new YukonMessageSourceResolvable("yukon.web.save.success", macroLoadGroup.getName()));
            ...
            flash.setError(new YukonMessageSourceResolvable("yukon.web.save.error", macroLoadGroup.getName(), ex.getMessage()));
            return "redirect:" + setupRedirectLink;
        }
        return null;
    }
