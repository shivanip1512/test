    ...
    public String save(@ModelAttribute("loadGroup") LoadGroupBase loadGroup, BindingResult result, YukonUserContext userContext,
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                flash.setConfirm(new YukonMessageSourceResolvable("yukon.web.save.success", loadGroup.getName()));
            ...
            flash.setError(new YukonMessageSourceResolvable("yukon.web.save.error", loadGroup.getName(), ex.getMessage()));
            return "redirect:" + setupRedirectLink;
        }
        return null;
    }
