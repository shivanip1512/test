    ...
    public String save(@ModelAttribute ControlScenario controlScenario, BindingResult result, FlashScope flash,
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                flash.setConfirm(new YukonMessageSourceResolvable("yukon.web.save.success", controlScenario.getName()));
            ...
            flash.setError(new YukonMessageSourceResolvable("yukon.web.save.error", controlScenario.getName(), ex.getMessage()));
            return "redirect:" + setupRedirectLink;
        }
        return null;
    }
