    ...
    public String save(ModelMap model, @ModelAttribute ControlArea controlArea, @RequestParam List<String> triggerIds, BindingResult result, YukonUserContext userContext,
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                flash.setConfirm(new YukonMessageSourceResolvable("yukon.web.save.success", controlArea.getName()));
            ...
            flash.setError(new YukonMessageSourceResolvable("yukon.web.save.error", controlArea.getName(), ex.getMessage()));
            return "redirect:" + setupRedirectLink;
        }
        return null;
    }
