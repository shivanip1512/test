...
public class LMControlAreaSetupDaoImpl extends AbstractLMSetupDaoImpl <ControlAreaFilteredResult> {

    @Override
    public List<ControlAreaFilteredResult> getDetails(FilterCriteria<LMSetupFilter> criteria) {
        // TODO 
        return null;
    }
