...
public class NotificationGroupApiController {
    ...
    @GetMapping
    public ResponseEntity<Object> getAll(@RequestParam(value = "name", required=false) String name, @DefaultSort(dir = Direction.asc, sort = "NAME") SortingParameters sorting,
