 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class Xfeeders extends PageCodeBase {
	...
	*/
	...
	protected HtmlDataTable tableFeeders;
	...
	protected HtmlDataTable getTableFeeders() {
		if (tableFeeders == null) {
			tableFeeders = (HtmlDataTable) findComponentInRoot("tableFeeders");
		}
		return tableFeeders;
	}
	...
	protected HtmlCommandLink getLinkSubCntrl() {
		if (linkSubCntrl == null) {
			linkSubCntrl =
				(HtmlCommandLink) findComponentInRoot("linkSubCntrl");
		}
		return linkSubCntrl;
	}
