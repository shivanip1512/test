...
Yukon.namespace('Yukon.ArchiveDataAnalysis');

Yukon.ArchiveDataAnalysis = (function() {
   
    archiveDataAnalysisModule = {
            ...
            changeStatus : function (msg) {
                ...
                var statusDiv = row.find('.f-analysis-status');
    ...
    return archiveDataAnalysisModule;
}());
