...
yukon.dr.formula = (function() {
    ...
    _beforeFormSubmit = function (e) {
        ...
        $('.js-drFormula-formulaInputSelect').each(function (index) {
            ...
            if (inputVal === 'TIME_LOOKUP') {
                $('.js-drFormula-notTimeInput_' + tableId).find('input').prop('disabled', true);
            } else {
                $('.js-drFormula-timeInput_' + tableId).find('input').prop('disabled', true);
            }
            
            if (inputVal === 'POINT') {
                $('#formulaWeatherStationTemp_' + tableId).find('select').prop('disabled', true);
                $('#formulaWeatherStationHumidity_' + tableId).find('select').prop('disabled', true);
        ...
        $('.js-drFormula-table, .js-drFormula-function').each(function (index) {
            ...
            $(this).find('.js-drFormula-tableEntries').each(function (index2) {
