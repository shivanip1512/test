...
AjaxAnywhere.prototype.onAfterResponseProcessing = function () {
	...
	var buttons = button_group.getElementsByTagName("input");
		...
		var ptID = document.forms['editorForm'].elements['ptID'];
		if (ptID) {		
			if (!document.forms['editorForm'].elements['paoID'])
				document.getElementById("editorForm").innerHTML +="<input type='hidden' name='paoID'/>";	
			document.forms['editorForm'].elements['paoID'].value = document.forms['editorForm'].elements['ptID'].value;	
		}
};
