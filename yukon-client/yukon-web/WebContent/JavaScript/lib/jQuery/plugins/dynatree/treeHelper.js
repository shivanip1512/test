        ...
        this.init = function() {
            if (!this.initialized) {
              ...
              //expand / collapse toggle link.
                jQuery(document).on('click', '.open_all, .close_all', function(event) {
                ...
                jQuery(document).on('keyup', 'input.searchTree', function(event) {
                ...
                jQuery(document).on('focus', 'input.searchTree', function(event) {
                ...
                jQuery(document).on('blur', 'input.searchTree', function(event) {
                    TreeHelper.search_input = jQuery(event.currentTarget);
