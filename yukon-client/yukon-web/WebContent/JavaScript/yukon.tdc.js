    ...
    tdcMod = {
        ...
        init : function () {
            ...
            $('.f-ack-all').click(function () {
                $.post('/tdc/acknowledgeAll', {}).done(function (data) {
            ...
            $(document).on('click', '.f-ack', function () {
                ...
                $.post('/tdc/acknowledge', args).done(function (data) {
                    $('#latestData').load('/tdc/refresh');
                });
            });
            ...
            $('.f-display-alarm-ack').click(
	    		...
	    		$.post('/tdc/acknowledgeAlarmsForDisplay', data)
	        		.done(function (data) {
	            	yukon.ui.flashSuccess(data.success);
	        	});
			});
           $('.f-one-alarm-ack').click(function (event) {
				...
				var condition = $(this).parent().attr("condition");
                   ...
                   $.post('/tdc/acknowledgeAlarm', data).done(function (data) {});
               });
            ...
            $(document).on('click', '.f-one-alarm-ack-b', function () {
                ...
                var condition = $(this).attr("condition");
                        ...
                        $.post('/tdc/acknowledgeAlarm', data).done(
                                function (data) {
                                });
                    });
            ...
            $(document).on('click', '.f-ack-alarm', function() {
                ...
                $.post('/tdc/acknowledgeAlarm', data).done(function(json) {
            ...
            $(document).on('click', '.f-ack-alarms-for-point', function() {                
                ...
                $.post('/tdc/acknowledgeAlarmsForPoint', data).done(function(data) {  
                    yukon.ui.flashSuccess(data.success);
                    $('#tdc-popup').dialog('close');
                });
            });
