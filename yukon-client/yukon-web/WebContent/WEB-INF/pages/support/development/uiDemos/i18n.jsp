...
Escape for use as a JavaScript string.  This is false by default.  (Like htmlEscape, this attribute escapes
the entire message after arguments have been added.)
...
<p>The "javaScriptEscape" attribute can be used to escape a string for use as a JavaScript string.  I can't imagine
why we would ever want this.</p>
...
<p>This is an DisplayableEnum sorted with a specific value forced to the top and another foced to
the bottom.</p>
