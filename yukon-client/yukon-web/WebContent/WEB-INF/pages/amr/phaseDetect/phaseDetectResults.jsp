                        ...
                        <div style="padding-bottom: 5px;">
		                    ...
		                    <c:if test="${phaseACollection.deviceCount > 0}">
                                <div id="phaseAActionsDiv" style="padding:5px;">
                                    <cti:link href="/spring/bulk/collectionActions" key="yukon.web.modules.amr.phaseDetect.step5.collectionActionLabel" class="small">
	                                ...
	                                <div style="max-height: 300px;overflow: auto;">
	                                    <table>
	                                        ...
	                                        <c:forEach var="meter" items="${phaseABMeters}">
	                                            ...
	                                            <tr>
	                                                <td style="padding-right: 10px;">${meter.name}</td>
	                                                <td>${phaseToReadingMap['A']}<br>${phaseToReadingMap['B']}</td>
	                                            </tr>
	                                        </c:forEach>
	                                    </table>
	                                </div>
	                                ...
	                                <div style="max-height: 300px;overflow: auto;">
	                                    <table>
	                                        ...
	                                        <c:forEach var="meter" items="${phaseACMeters}">
	                                            ...
	                                            <tr>
	                                                <td style="padding-right: 10px;">${meter.name}</td>
	                                                <td>${phaseToReadingMap['A']}<br>${phaseToReadingMap['C']}</td>
	                                            </tr>
	                                        </c:forEach>
	                                    </table>
	                                </div>
	                                ...
	                                <div style="max-height: 300px;overflow: auto;">
	                                    <table>
	                                        ...
	                                        <c:forEach var="meter" items="${phaseBCMeters}">
	                                            ...
	                                            <tr>
	                                                <td style="padding-right: 10px;">${meter.name}</td>
	                                                <td>${phaseToReadingMap['B']}<br>${phaseToReadingMap['C']}</td>
	                                            </tr>
	                                        </c:forEach>
	                                    </table>
	                                </div>
	                                ...
	                                <div style="max-height: 300px;overflow: auto;">
	                                    <table>
	                                        ...
	                                        <c:forEach var="meter" items="${phaseABCDevices}">
	                                            ...
	                                            <tr>
	                                                <td style="padding-right: 10px;">${meter.name}</td>
	                                                <td>${phaseToReadingMap['A']}<br>${phaseToReadingMap['B']}<br>${phaseToReadingMap['C']}</td>
	                                            </tr>
	                                        </c:forEach>
	                                    </table>
	                                </div>
