...
<c:choose>
    ...
    <c:otherwise>
        ...
        <form id="review-form" action="${saveUrl}" method="post">
            <input class="js-page-size" type="hidden" name="itemsPerPage" value="${paging.itemsPerPage}">
             ...
             <c:if test="${!noPoints}">
                <div class="column-12-12 stacked clearfix">
                            ...
                            <div class="column-12-12 clearfix">
                                <div class="column one">
                                    <ul class="simple-list">
                                        <c:forEach items="${displayTypes}" var="displayType" begin="0" step="2">
                                            <li>
                                                <label class="notes">
                                                    <c:set var="check" value="${displayType.checked ? 'checked' : ''}"/>
                                                    <input type="checkbox" class="js-display-type" 
                                                            name="${displayType.rphTag}" ${check}>
                                                    ...
                                                    <cti:dataUpdaterValue type="VALIDATION_PROCESSING" 
                                                        identifier="${displayType.rphTag}_VIOLATIONS" 
                                                        styleClass="badge"/>
                                                </label>
                                            </li>
                                        </c:forEach>
                                ...
                                <div class="column two nogutter">
                                    <ul class="simple-list">
                                        <c:forEach items="${displayTypes}" var="displayType" begin="1" step="2" 
                                                varStatus="index">
                                            <li>
                                                <label class="notes">
                                                    <c:set var="check" value="${displayType.checked ? 'checked' : ''}"/>
                    ...
                    <div class="column two nogutter">
                        ...
                        <a class="fr" href="${reviewUrl}"><i:inline key=".advancedProcessing"/></a>
                    </div>
                </div>
            </c:if>
