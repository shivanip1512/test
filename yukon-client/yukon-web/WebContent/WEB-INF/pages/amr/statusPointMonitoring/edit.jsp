...
<cti:standardPage module="amr" page="statusPointMonitorEditor">
    ...
    <cti:msgScope paths="yukon.common,modules.amr.statusPointMonitor,modules.amr.statusPointMonitorEditor">
        <table class="dn">
            ...
            <tags:sectionContainer2 nameKey="sectionHeader">
                <tags:nameValueContainer2>
                    ...
                    <tags:nameValue2 nameKey=".deviceGroup">
                        ...
                        <tags:deviceGroupNameSelector fieldName="groupName" fieldValue="${statusPointMonitor.groupName}"
                            dataJson="${groupDataJson}" linkGroupName="true" />
                            ...
                            <tr data-row="${status.index}">
                                <td>
                                    <form:select path="processors[${status.index}].prevState" cssClass="js-row-prev-state">
                                        ...
                                        <form:option value="${dontCare}">
                                            <cti:msg2 key=".state.${dontCare}" />
                                        </form:option>
                                        <form:option value="${difference}">
                                            <cti:msg2 key=".state.${difference}" />
                                        </form:option>
                                    </form:select>
                                </td>
                                <td>
