        ...
        <tags:nameValueContainer>
            ...
            <tags:nameValue name="${executionsText}">
                <form name="viewAllExecutionsForm" action="/common/commandRequestExecutionResults/list" method="get">
                    ...
                    <span class="fl">&nbsp;(<cti:dataUpdaterValue type="SCHEDULED_GROUP_REQUEST_EXECUTION" identifier="${jobWrapper.job.id}/CRE_COUNT_FOR_JOB" />)</span>
                    
                    <cti:icon icon="icon-help" id="help_icon"/>
                    <tags:simplePopup id="viewAllExecutionsInfoPopup" title="View All Executions" on="#help_icon">${executionsPopupInfoText}</tags:simplePopup>
