            ...
            <c:otherwise>
                <c:choose>
                    <c:when test="${detail.displayFailurePopup}">
                        <div class="dn js-failure-${deviceId}" data-dialog data-cancel-omit="true"
                        ...
                        <a href="javascript:void(0);" data-popup=".js-failure-${deviceId}"><i:inline
                                key=".statusType.${detail.status}" /></a>
                    </c:when>
                    <c:otherwise>
