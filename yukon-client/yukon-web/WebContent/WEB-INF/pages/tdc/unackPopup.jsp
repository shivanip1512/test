        ...
        <tbody>
            <c:forEach var="alarm" items="${alarms}">
                <tr>
                    ...
                    <td><cti:button id="${alarm.condition}" nameKey="alarm.acknowledge" icon="icon-tick" classes="fr f-ack-alarm" pointId="${alarm.pointId}" condition="${alarm.condition}" renderMode="buttonImage"/></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
