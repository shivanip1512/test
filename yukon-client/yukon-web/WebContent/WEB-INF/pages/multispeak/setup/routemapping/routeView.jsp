...
<form name="routeform" action="${routeUrl}" method="post">
    <table>
        <tr>
            ...
            <td>
                <div style="padding-bottom: 5px">
                    <input type="button" value="&#9650" size="5" class="formSubmit"
                        name="up"
                        onclick="javascript:yukonGeneral_moveOptionPositionInSelect(routeIdSelectList, -1)" />
                </div>
                <div>
                    <input type="button" value="&#9660" size="5" class="formSubmit"
                        name="down"
                        onclick="javascript:yukonGeneral_moveOptionPositionInSelect(routeIdSelectList, 1)" />
                </div>
                <div style="padding-top: 55px">
                    <input type="button" value="Delete" size="5" class="formSubmit"
                        name="remove"
                        onclick="javascript:SubstationToRouteMappings_removeRoute()" />
                </div>
                <div style="padding-top: 15px">
                    <input id="update_button" type="button" class="formSubmit"
        ...
        <tr>
            ...
            <td valign="bottom">
                <input type="button" value="Add" size="5" name="add" class="formSubmit"
