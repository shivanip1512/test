...
<cti:standardPage page="substationToRouteMapping" module="adminSetup">
    ...
    <table>
        <tr>
            ...
            <td valign="top">
                <div id="sub_element">
                    <jsp:include page="/spring/adminSetup/setup/substations/routeMapping/viewSubstation">
            ...
            <td valign="top">
                <div id="route_element">
                    <jsp:include page="/spring/adminSetup/setup/substations/routeMapping/viewRoute">
                        <jsp:param name="view" value="" />
                    </jsp:include>
                </div>
            </td>
