...
<cti:url var="deleteUrl" value="/spring/adminSetup/setup/substations/routeMapping/removeRoute" />
<cti:url var="updateUrl" value="/spring/adminSetup/setup/substations/routeMapping/update" />
