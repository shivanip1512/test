        ...
        <div class="column one">
            ...
            <tags:boxContainer2 nameKey="secretsBox" styleClass="largeContainer">
            	...
            	<div class="PB10" style="line-height:40px;">
            		...
            		<cti:button nameKey="refresh" classes="fr js-refresh-secret" data-secret-number="1" disabled="${!secret1RoatationAllowed}" title="${secret1RotationTitleText}"/>
            	</div>
            	<div style="line-height:40px;">
            		...
            		<cti:button nameKey="refresh" classes="fr js-refresh-secret" data-secret-number="2" disabled="${!secret2RoatationAllowed}" title="${secret2RotationTitleText}"/>
            	</div>
            </tags:boxContainer2>
        </div>
