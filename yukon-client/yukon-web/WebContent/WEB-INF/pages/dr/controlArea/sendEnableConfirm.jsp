...
<%@ taglib uri="http://cannontech.com/tags/cti" prefix="cti"%>
    ...
    <form id="sendEnableForm" action="/spring/dr/controlArea/setEnabled">
        ...
        <div class="actionArea">
            <input type="button" value="<cti:msg key="yukon.web.modules.dr.controlArea.sendEnableConfirm.okButton"/>"
