                 ...
                 <tags:nameValueContainer2>
                    <tags:nameValue2 nameKey=".rampIn">
                     ...
                     <tags:nameValue2 nameKey=".rampInPercent" data-toggle-group="rampInWindow" rowClass="${rampInFieldClass}">
                         <tags:numeric id="js-masterCycle-rampInPercent" path="fields.rampInPercent" size="10" minValue="0" maxValue="100"/>
                     ...
                     <tags:nameValue2 nameKey=".rampInInterval" data-toggle-group="rampInWindow" rowClass="${rampInFieldClass}">
                         <tags:numeric  id="js-masterCycle-rampInInterval" path="fields.rampInIntervalInSeconds" size="10" minValue="-99999" maxValue="99999"/>
                         <i:inline key=".sec" />
                     </tags:nameValue2>
                 </tags:nameValueContainer2>
              </tags:sectionContainer2>
