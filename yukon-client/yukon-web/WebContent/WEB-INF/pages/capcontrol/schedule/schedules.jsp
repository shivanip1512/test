                                ...
                                <td nowrap="nowrap">
                                    <c:choose>
                                        <c:when test="${hasEditingRole}">
                                            <a href="/editor/cbcBase.jsf?type=3&itemid=${item.scheduleID}" class="tierIconLink">
                                                <img class="tierImg" src="/WebConfig/yukon/Icons/pencil.gif" />
                                            </a>
                                            <a href="javascript:removeSchedule(${item.scheduleID}, '${item.scheduleName}');" class="tierIconLink">
                                                <img src="/WebConfig/yukon/Icons/delete.gif " class="tierImg pointer">
                                            </a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="/editor/cbcBase.jsf?type=3&itemid=${item.scheduleID}" class="tierIconLink">
