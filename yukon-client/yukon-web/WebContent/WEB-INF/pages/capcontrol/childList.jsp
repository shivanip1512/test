...
<f:subview id="childList"
	rendered="#{capControlForm.visibleTabs['CBCArea'] || capControlForm.visibleTabs['CBCSubstation'] || capControlForm.visibleTabs['CBCSubstationBus'] || capControlForm.visibleTabs['CBCFeeder']}">
	<f:subview id="paoSubstation"
		...
		<x:htmlTag value="fieldset" styleClass="fieldSet">
			...
			<h:panelGrid id="subBody" columns="2" styleClass="gridLayout"
				rowClasses="gridCell" columnClasses="gridCell, gridCell">
				<x:panelGroup>
					...
					<h:panelGrid columns="1" columnClasses="scrollerCentered">
						<x:dataScroller id="scrollButtons" for="subBusAvailData"
							...
							<f:facet name="first">
	                            <x:graphicImage url="/WebConfig/yukon/Icons/arrow_first.gif" border="1"
	                                title="First page" />
	                        </f:facet>
	                        <f:facet name="last">
	                            <x:graphicImage url="/WebConfig/yukon/Icons/arrow_last.gif" border="1"
	                                title="Last page" />
	                        </f:facet>
	                        <f:facet name="previous">
	                            <x:graphicImage url="/WebConfig/yukon/Icons/resultset_previous.gif"
	                                border="1" title="Previous page" />
	                        </f:facet>
	                        <f:facet name="next">
	                            <x:graphicImage url="/WebConfig/yukon/Icons/resultset_next.gif" border="1"
	                                title="Next page" />
	                        </f:facet>
	                        <f:facet name="fastforward">
	                            <x:graphicImage url="/WebConfig/yukon/Icons/arrow_fastforward.gif" border="1"
	                                title="Next set of pages" />
	                        </f:facet>
	                        <f:facet name="fastrewind">
	                            <x:graphicImage url="/WebConfig/yukon/Icons/arrow_rewind.gif" border="1"
		...
		<x:htmlTag value="fieldset" styleClass="fieldSet">
			...
			<h:panelGrid id="subBody" columns="2" styleClass="gridLayout"
				...
				<x:panelGroup>
					...
					<h:panelGrid columns="1" columnClasses="scrollerCentered">
						<x:dataScroller id="scrollButtons" for="fdrAvailData"
							fastStep="25" pageCountVar="pageCount" pageIndexVar="pageIndex"
							styleClass="scroller" paginator="true" paginatorMaxPages="9"
							paginatorTableClass="paginator"
							paginatorActiveColumnStyle="font-weight:bold;">
		...
		<x:htmlTag value="fieldset" styleClass="fieldSet">
			...
			<h:panelGrid id="fdrBody" columns="2" styleClass="gridLayout"
				...
				<x:panelGroup>
					...
					<h:panelGrid columns="1" columnClasses="scrollerCentered">
						<x:dataScroller id="scrollButtons" for="bankAvailData"
							fastStep="25" pageCountVar="pageCount" pageIndexVar="pageIndex"
							styleClass="scroller" paginator="true" paginatorMaxPages="9"
							paginatorTableClass="paginator"
							paginatorActiveColumnStyle="font-weight:bold;">
