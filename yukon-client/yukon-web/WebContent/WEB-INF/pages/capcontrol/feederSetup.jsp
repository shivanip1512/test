...
(function () {
    ...
    var feederVarPointPicker = new Picker('OK', 'Cancel', '(none selected)', 'varPointPicker', '', 'feederVarPointPicker', 
            'pointId:varPoint;pointName:feederVarPoint;deviceName:feederVarDevice');
    ...
    feederVarPointPicker.idFieldName = '${varPickerIdField}';
    
    var feederVarPhaseBPointPicker = new Picker('OK', 'Cancel', '(none selected)', 'varPointPicker', '', 'feederVarPhaseBPointPicker',
            'pointId:varPhaseBPoint;pointName:feederVarPhaseBPoint;deviceName:feederVarPhaseBDevice');
    ...
    feederVarPhaseBPointPicker.idFieldName = '${varPickerIdField}';
    
    var feederVarPhaseCPointPicker = new Picker('OK', 'Cancel', '(none selected)', 'varPointPicker', '', 'feederVarPhaseCPointPicker',
            'pointId:varPhaseCPoint;pointName:feederVarPhaseCPoint;deviceName:feederVarPhaseCDevice');
    ...
    feederVarPhaseCPointPicker.idFieldName = '${varPickerIdField}';
    
    var feederWattPointPicker = new Picker('OK', 'Cancel', '(none selected)', 'wattPointPicker', '', 'feederWattPointPicker',
            'pointId:wattPoint;pointName:feederWattPoint;deviceName:feederWattDevice');
    ...
    feederWattPointPicker.idFieldName = '${wattPickerIdField}';
    
    var feederVoltPointPicker = new Picker('OK', 'Cancel', '(none selected)', 'voltPointPicker', '', 'feederVoltPointPicker',
            'pointId:voltPoint;pointName:feederVoltPoint;deviceName:feederVoltDevice');
    ...
    feederVoltPointPicker.idFieldName = '${voltPickerIdField}';
    
    yukon.pickers['feederVarPointPicker'] = feederVarPointPicker;
    yukon.pickers['feederVarPhaseBPointPicker'] = feederVarPhaseBPointPicker;
    yukon.pickers['feederVarPhaseCPointPicker'] = feederVarPhaseCPointPicker;
    yukon.pickers['feederWattPointPicker'] = feederWattPointPicker;
    yukon.pickers['feederVoltPointPicker'] = feederVoltPointPicker;
    
    $(function () {
        $('.js-var-point').click(function () {
            yukon.pickers['feederVarPointPicker'].show();
        });
        $('.js-var-phase-b-point').click(function () {
            yukon.pickers['feederVarPhaseBPointPicker'].show();
        });
        $('.js-var-phase-c-point').click(function () {
            yukon.pickers['feederVarPhaseCPointPicker'].show();
        });
        $('.js-watt-point').click(function () {
            yukon.pickers['feederWattPointPicker'].show();
        });
        $('.js-volt-point').click(function () {
            yukon.pickers['feederVoltPointPicker'].show();
        });
    });
                ...
                <x:htmlTag value="fieldset" styleClass="fieldSet">
                    ...
                    <x:div id="feederVarDiv" forceId="true">
                        ...
                        <x:div id="usePhaseDataDiv" forceId="true"
                            ...
                            <h:outputLink styleClass="js-var-phase-b-point"
                                rendered="#{capControlForm.editingAuthorized}"
                            ...
                            <h:outputLink
                                rendered="#{capControlForm.editingAuthorized}"
                                value="javascript:void(0);" styleClass="js-var-phase-c-point">
