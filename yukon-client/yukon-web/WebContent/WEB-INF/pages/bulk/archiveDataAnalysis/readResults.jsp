...
<cti:standardPage module="amr" page="analysisReadResults">
    <cti:breadCrumbs>
        ...
        <%-- ADA Results --%>
        <cti:msg var="adaResultsPageTitle" key="yukon.web.modules.amr.analysisResults.pageName"/>
        <cti:crumbLink url="/spring/bulk/archiveDataAnalysis/results?analysisId=${analysisId}" title="${adaResultsPageTitle}"/>
        <%-- ADA Read Results --%>
        <cti:crumbLink><cti:msg2 key="yukon.web.modules.amr.analysisReadResults.pageName"/></cti:crumbLink>
    </cti:breadCrumbs>
    
    <tags:boxContainer2 nameKey="yukon.web.modules.amr.analysisReadResults">
        ...
        <div style="padding: 0px 0px 20px 0px">
            <tags:resultProgressBar totalCount="${deviceCount}"
                                    ...
                                    progressLabelTextKey="yukon.web.modules.amr.analysisReadResults.progressLabel"
        ...
        <div class="normalBoldLabel">
            <cti:msg key="yukon.web.modules.amr.analysisReadResults.successLabel" />
            <span class="okGreen">
        ...
        <div id="successActionsDiv" style="padding:10px;display:none;">
            <cti:link href="/spring/bulk/collectionActions" key="yukon.web.modules.amr.analysisReadResults.collectionActionOnDevicesLabel" class="small">
        ...
        <%-- FAILURE --%>
        <div class="normalBoldLabel">
            <cti:msg key="yukon.web.modules.amr.analysisReadResults.failureLabel" />
            <span class="errorRed">
