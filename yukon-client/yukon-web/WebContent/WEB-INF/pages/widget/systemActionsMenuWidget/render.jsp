...
<cti:url var="aggregateIntervalReportUrl" value="/tools/aggregateIntervalReport/view"/>

<div>
    <a href="${aggregateIntervalReportUrl}" target="_blank"><i:inline key="yukon.web.modules.tools.aggregateIntervalReport.pageName"/></a><br/>
