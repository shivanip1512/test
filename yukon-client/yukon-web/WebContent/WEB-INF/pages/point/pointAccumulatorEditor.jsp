		...
		<h:column>
			...
			<x:htmlTag value="fieldset" styleClass="fieldSet">
                ...
                <x:panelGrid columns="2">
					...
					<x:inputText id="Multiplier" value="#{ptEditorForm.pointBase.pointAccumulator.multiplier}"
					...
					<x:inputText id="Data_Offset" value="#{ptEditorForm.pointBase.pointAccumulator.dataOffset}"
						required="true" maxlength="16" styleClass="char16Label" >
							<f:validateDoubleRange minimum="-99999999" maximum="99999999" />
					</x:inputText>
				</x:panelGrid>
