...
<cti:standardPage module="dr" page="optOutAdmin">
    ...
    <cti:breadCrumbs>
        <cti:crumbLink url="/operator/Operations.jsp">
            <cti:msg key="yukon.web.modules.dr.scheduledEvents.operationsHome"/>
        </cti:crumbLink>
        <cti:crumbLink><cti:msg key="yukon.web.modules.dr.scheduledEvents.breadcrumb"/></cti:crumbLink>
    </cti:breadCrumbs>
