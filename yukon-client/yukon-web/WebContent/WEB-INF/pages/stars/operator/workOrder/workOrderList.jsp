    ...
    <table class="compactResultsTable callListTable rowHighlighting">
        ...
        <c:forEach var="workOrder" items="${workOrders}">
            <tr>
                ...
                <td><tags:showYukonListEntry value="${workOrder.workOrderBase.workTypeId}" accountId="${accountId}" listName="SERVICE_TYPE"/></td>
                <td><tags:showYukonListEntry value="${workOrder.workOrderBase.currentStateId}" accountId="${accountId}" listName="SERVICE_STATUS"/></td>
