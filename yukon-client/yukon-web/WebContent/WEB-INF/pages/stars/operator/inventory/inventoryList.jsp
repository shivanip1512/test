            ...
            <table class="compactResultsTable rowHighlighting" style="width:100%;">
                ...
                <c:forEach var="result" items="${results.resultList}">
                    ...
                    <tr style="vertical-align:top;" class="<tags:alternateRow odd="" even="altRow"/>">
                        ...
                        <td>
                            <cti:url var="inventoryUrl" value="/spring/stars/operator/inventory/view">
                        ...
                        <td>
                            <c:choose>
                                ...
                                <c:otherwise><cti:msg2 key="${result.identifier.hardwareType}"/></c:otherwise>
                            </c:choose>
                        </td>
                        
                        <td>
                            <spring:escapeBody htmlEscape="true">${result.label}</spring:escapeBody>
                        ...
                        <c:if test="${showAccountNumber}">
                            <c:choose>
                                <c:when test="${result.accountId > 0}">
                                    <td>
                                        <cti:url var="accountUrl" value="/spring/stars/operator/account/view">
                                            <cti:param name="accountId" value="${result.accountId}"/>
                                        </cti:url>
                                        <a href="${accountUrl}"><spring:escapeBody htmlEscape="true">${result.accountNumber}</spring:escapeBody></a>
                                    </td>
                                </c:when>
