...
<%@ taglib tagdir="/WEB-INF/tags" prefix="tags"%>
    ...
    <h3>
        <cti:msg key="yukon.dr.operator.thermostatScheduleConfirm.header" /><br>
        <cti:msg key="${thermostatLabel}" htmlEscape="true"/><br>
    </h3>
    
    
    <cti:msg key="yukon.dr.operator.thermostatScheduleConfirm.introText" /><br>
    <br>
    ...
    <form id="scheduleForm" name="scheduleForm" method="POST" action="/spring/stars/operator/thermostat/schedule/save">
        ...
        <div align="center">
		    <cti:msg key="yukon.dr.operator.thermostatScheduleConfirm.confirmText" /><br><br>
		    <cti:msg var="okText" key="yukon.dr.operator.thermostatScheduleConfirm.ok" />
		    <cti:msg var="cancelText" key="yukon.dr.operator.thermostatScheduleConfirm.cancel" />
		    <input type="submit" value="${okText}"/>
		    <input type="button" value="${cancelText}" onclick="javascript: window.location='${cancelUrl}'"/>
	    </div>
    </form>
