...
<cti:standardPage module="operator" page="changeLogin">
    ...
    <script type="text/javascript">
        ...
        function generatePassword() {
            var generatedPasswordCheckBox = $('generatePasswordCheckBox');
                ...
                new Ajax.Request('/spring/stars/operator/general/generatePassword', 
    ...
    <tags:boxContainer2 key=".changeLogin" styleClass="boxContainer50percent">
        ...
        <form id="deleteForm" action="/spring/stars/operator/general/deleteLogin" method="post">
            <input type="hidden" name="accountId" value="${accountId}">
            <input type="hidden" name="energyCompanyId" value="${energyCompanyId}">
        </form>

        <form:form id="updateForm" action="/spring/stars/operator/general/updateLogin" commandName="changeLoginBackingBean">
            <input type="hidden" name="accountId" value="${accountId}">
            <input type="hidden" name="energyCompanyId" value="${energyCompanyId}">
