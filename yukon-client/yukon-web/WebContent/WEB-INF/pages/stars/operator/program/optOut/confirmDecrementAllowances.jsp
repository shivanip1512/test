...
<h1 class="dialogQuestion">
    <cti:msg2 key=".decrementAllowance.confirm"
        htmlEscape="true" arguments="${hardware.displayName}"/>
</h1>

<cti:url var="decrementAllowancesUrl" value="/spring/stars/operator/program/optOut/decrementAllowances"/>
<form id="confirmForm" action="${decrementAllowancesUrl}">
