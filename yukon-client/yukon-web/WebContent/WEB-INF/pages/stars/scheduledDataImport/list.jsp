                                    ...
                                    <tr id="tr_${jobId}" title="${rowTitle}" data-job-id="${jobId}">
                                        ...
                                        <td class="tar">
                                            <cm:dropdown icon="icon-cog">
                                                ...
                                                <cm:dropdownOption id="disable-schedule-${jobId}" key="yukon.common.disable" classes="js-schedule-toggle" data-job-id="${jobId}" icon="icon-disable"/>
                                                ...
                                                <cm:dropdownOption id="delete-schedule-btn-${jobId}" data-ok-event="yukon:schedule:delete" data-job-id="${jobId}" key=".delete" icon="icon-delete" classes="js-hide-dropdown"/>
