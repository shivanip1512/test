...
<script type="text/javascript">
    ...
    <div align="center">
        ...
        <form id="scheduleForm" name="scheduleForm" method="POST" action="/spring/stars/consumer/thermostat/schedule/confirm">
                    ...
                    <td align="center" valign="bottom" class="Background"> 
                        <table width="90%" border="0" height="8">
                            <tr> 
                                ...
                                <td align="right"> 
                                    <span id="everyDayText" class="timePeriodText" style="display: ${(timeOfWeek != 'WEEKDAY' || scheduleMode != 'ALL')? 'none' : ''}"><cti:msg key="yukon.dr.consumer.thermostat.schedule.EVERYDAY" /></span> 

                                    <span id="weekdayText" class="timePeriodText" style="display: ${(timeOfWeek != 'WEEKDAY' || scheduleMode == 'ALL')? 'none' : ''}"><cti:msg key="yukon.dr.consumer.thermostat.schedule.WEEKDAY" /></span> 
                                    ...
                                    <a id="saturdayLink" class="timePeriodText" style="display: ${(timeOfWeek == 'SATURDAY' || scheduleMode == 'WEEKDAY_SAT_SUN')? '' : 'none'}" href="javascript:changeTimePeriod('SATURDAY')"><cti:msg key="yukon.dr.consumer.thermostat.schedule.SATURDAY" /></a> 
                                    ...
                                    <a id="sundayLink" class="timePeriodText" style="display: ${(timeOfWeek == 'SUNDAY' || scheduleMode == 'WEEKDAY_SAT_SUN')? '' : 'none'}" href="javascript:changeTimePeriod('SUNDAY')"><cti:msg key="yukon.dr.consumer.thermostat.schedule.SUNDAY" /></a> 
                                    ...
                                    <a id="weekendLink" class="timePeriodText" style="display: ${(timeOfWeek == 'WEEKEND' || scheduleMode == 'WEEKDAY_WEEKEND')? '' : 'none'}" href="javascript:changeTimePeriod('WEEKEND')"><cti:msg key="yukon.dr.consumer.thermostat.schedule.WEEKEND" /></a> 
                                </td>
                            </tr>
                        </table>
                    </td>
