    ...
    <table class="contentTable">
        <tr>
            <td class="leftColumn">
                ...
                <br>
                <div id="description2"><cti:msg key="yukon.dr.consumer.general.description2" /></div>
                <br>
                <br>
                <div id="programs"><cti:msg key="yukon.dr.consumer.general.programs" var="programsTitle" />
                            ...
                            <c:otherwise>
                                ...
                                <table cellspacing="0" class="enrolledPrograms">
                                    <c:forEach var="displayableProgram" items="${displayablePrograms}">
                                        ...
                                        <c:set var="isBordered" value="${fn:length(displayablePrograms) != counter}"/>
                                        ...
                                        <tr>
                                            ...
                                            <td class="${tableDataClass}">
                                                ...
                                                <c:if test="${program.chanceOfControl != 'NONE'}">
                                                    <cti:msg key="yukon.dr.consumer.general.chanceOfControl.${program.chanceOfControl}"/>
                                                </c:if>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${displayableControlHistory.controlStatusDisplay}">
                                                                        <td colspan="3"><cti:msg key="${displayableControlHistory.controlHistory.currentStatus.displayKey}"/></td>
                                                                    </c:when>
                                                                    ...
                                                                    <c:when test="${displayableControlHistory.deviceLabelControlStatusDisplay}">
                                                                        ...
                                                                        <td>-</td>
                                                                        <td><cti:msg key="${displayableControlHistory.controlHistory.currentStatus.displayKey}"/></td>
                                                                    </c:when>
