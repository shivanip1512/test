        ...
        <div class="column one">
            <select size="20" class="js-selected-category">
                <c:forEach var="type" items="${categories}">
                    ...
                    <option ${selectedText} value="${type.dbString}"><i:inline key="${type.formatKey}"/></option>
                </c:forEach>
        ...
        <div class="column two nogutter">
            ...
            <cti:checkRolesAndProperties value="MANAGE_CUSTOM_COMMANDS" level="CREATE">      
                <div class="action-area">
                    <cti:button nameKey="add" classes="fr js-add-command" icon="icon-add" disabled="${empty formBean.selectedCategory}"/>
                </div>
