      ...
      <section id="content" role="main" <c:if test="${widePage}">class="wide"</c:if>>
        ...
        <tags:simplePopup title="${alertTitle}" id="yukon_alert_popup">
          ...
          <div class="action-area">
            <button id="yukon_clear_alerts_button">
              <span class="b-label"><cti:msg2 key="yukon.web.alerts.clearall"/></span>
            </button>
          </div>
        </tags:simplePopup>
        <tags:updatedWarning />
          ...
          <nav>
            <ul>
              ...
              <cti:checkRolesAndProperties value="JAVA_WEB_START_LAUNCHER_ENABLED">
                ...
                <d:inline id="yukonApplicationDialog" okEvent="none" nameKey="applications" on="#appsLauncher" options="{width: 400, 'buttons': [], 'position' : 'relative'}">
            ...
            <div class="left">
              <div class="legal">
                ...
                <ul>
                  ...
                  <li><cti:msg2 key=".generatedAt"/>
                    <cti:formatDate type="FULL" value="${currentTime}"/></li>
