...
<%-- POPUP LINK --%>
<div class="dib">
	<a href="javascript:void(0);" title="${warning}" class="f-showSelectedDevices dib" data-function-arguments="{'id':'${id}', 'url':'${selectedDevicesTableUrl}'}"><i class="icon icon-magnifier"></i></a>
</div>
