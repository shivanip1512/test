...
<tags:hideReveal title="${theTitle}" escapeTitle="${pageScope.escapeTitle}" id="${pageScope.id}" showInitially="${pageScope.showInitially}" styleClass="${pageScope.styleClass}"><jsp:doBody/></tags:hideReveal>