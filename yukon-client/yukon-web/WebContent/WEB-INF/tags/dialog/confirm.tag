<%@ tag body-content="empty"
    description="Create an AJAX confirmation dialog. The dialog will trigger 'yukonDialogConfirmOk' or 'yukonDialogConfirmCancel' if the dialog is confirmed or cancelled (repsectively) either via a button click or by calling yukon.dialogConfirm methods directly."%>
