...
<div id="${id}" class="dn" data-dialog data-dialog-tabbed data-width="700" data-height="732" data-title="${text}"
    ...
    <ul>
        ...
        <li><a href="#${id}-group">By Group</a></li>
    ...
    <div id="${id}-group" data-select-by="group">
        ...
        <jsTree:inlineTree id="${id}Group" includeControlBar="true"
