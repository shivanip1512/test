...
<span id="${thisId}">
<cti:msg2 var="titleText" key="${title}" argument="${titleArgument}"/>

<a href="javascript:void(0);" title="${titleText}" style="text-decoration:none;" onclick="widgetActionRefreshImageConfirm_${uniqueId}();">
