...
<c:choose>
    <c:when test="${zone.zoneType == 'THREE_PHASE'}">
        <cti:dataUpdaterCallback function="updateRegulatorThreePhaseTapIndicator('${zone.zoneId}','${zone.zoneType}')"
            initialize="true"
            modeA="${type}/${zone.regulatorA.regulatorId}/MODE"
            modeB="${type}/${zone.regulatorB.regulatorId}/MODE"
            modeC="${type}/${zone.regulatorC.regulatorId}/MODE" 
            tapA="${type}/${zone.regulatorA.regulatorId}/TAP"
            tapB="${type}/${zone.regulatorB.regulatorId}/TAP"
            tapC="${type}/${zone.regulatorC.regulatorId}/TAP"
            tapTooltipA="${type}/${zone.regulatorA.regulatorId}/TAP_TOOLTIP"
            tapTooltipB="${type}/${zone.regulatorB.regulatorId}/TAP_TOOLTIP"
            tapTooltipC="${type}/${zone.regulatorC.regulatorId}/TAP_TOOLTIP"/>
    </c:when>
