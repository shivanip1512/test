...
<%
	...
	StarsLMControlHistory ctrlHist = ServletUtils.getControlHistory( program, appliances, StarsCtrlHistPeriod.NONE, liteEC );
      ...
      <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" bordercolor="0">
        ...
        <tr> 
		  ...
		  <td width="657" valign="top" bgcolor="#FFFFFF"> 
            ...
            <div align="center"><br>
              <% String header = DaoFactory.getAuthDao().getRolePropertyValue(lYukonUser, ResidentialCustomerRole.WEB_TITLE_PROGRAM_CTRL_SUM); %>
