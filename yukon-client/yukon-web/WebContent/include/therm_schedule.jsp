...
<% } %>
                      ...
                      <table width="100%" border="0" height="27">
                        ...
                        <tr> 
						  ...
						  <td class = "TableCell" width="15%"> 
                            <input id="time2" type="text" size="8" value="<%= ampmTimeFormat.format(schedule.getTime2().toDate()) %>" name="time2" onchange="Javascript:setContentChanged(true);timeChange(this,2);">
                          </td>
                          <td class = "TableCell" width="10%">
                            <div align="right">Start At: </div>
                          </td>
						  <td class = "TableCell" width="15%"> 
                            <input id="time3" type="text" size="8" value="<%= ampmTimeFormat.format(schedule.getTime3().toDate()) %>" name="time3" onchange="Javascript:setContentChanged(true);timeChange(this,3);">
                          </td>
                          <td class = "TableCell" width="10%">
                            <div align="right">Start At: </div>
                          </td>
					...
					<noscript>
					  <table width="100%" border="0" class = "TableCell">
					    <tr>
						  ...
						  <td width="15%"> 
                            <input id="temp2" type="text" size="3" name="temp2" onchange="setContentChanged(true)" value="<%= schedule.getTemperature2() %>">
                          </td>
                          <td class = "TableCell" width="10%"> 
                            <div align="right">Temp: </div>
                          </td>
						  <td width="15%"> 
                            <input id="temp3" type="text" size="3" name="temp3" onchange="setContentChanged(true)" value="<%= schedule.getTemperature3() %>">
                          </td>
                          <td class = "TableCell" width="10%"> 
                            <div align="right">Temp: </div></td>
						  <td width="15%"> 
