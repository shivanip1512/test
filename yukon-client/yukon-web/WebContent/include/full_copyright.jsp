...
%>
  <font face="Arial, Helvetica, sans-serif" size="1">Copyright &copy; <%= crYears %>, 
    Cannon Technologies. All rights reserved. All text, images, graphics, 
    code, and other materials on this website are subject to the copyrights and 
    other intellectual property rights of Cannon Technologies. Cannon Technologies
    owns the copyrights in the selection, coordination, and arrangement of 
