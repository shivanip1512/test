...
<f:subview id="feederSub" rendered="#{capControlForm.visibleTabs['CBCSubstation'] || capControlForm.visibleTabs['CBCFeeder']}" >
    ...
    <h:panelGrid id="subBody" columns="2" styleClass="gridLayout" columnClasses="gridColumn" >
		...
		<x:tree2 id="subVarPaoListTree" value="#{capControlForm.varTreeData}" var="node"
			showRootNode="true" varNodeToggler="t"
			showLines="true" showNav="true" clientSideToggle="false" >
		
	        <f:facet name="root">
	        	<x:panelGroup>
		            <h:commandLink id="rootLink" action="#{t.toggleExpanded}" value="#{node.description}"/>
	        	</x:panelGroup>
	        </f:facet>
			...
			<f:facet name="points">
				<x:panelGroup>
                  	<h:graphicImage value="AlarmFlag.gif" rendered="#{capControlForm.PAOBase.capControlSubstationBus.currentVarLoadPointID == node.identifier}" border="0"/>
		...
		<x:tree2 id="subWattListTree" value="#{capControlForm.wattTreeData}" var="node"
			...
			<f:facet name="points">
				<x:panelGroup>
                  	<h:graphicImage value="AlarmFlag.gif" rendered="#{capControlForm.PAOBase.capControlSubstationBus.currentWattLoadPointID == node.identifier}" border="0"/>
		...
		<x:tree2 id="subVoltPaoListTree" value="#{capControlForm.voltTreeData}" var="node"
			showRootNode="true" varNodeToggler="t" showLines="true" showNav="true"
			...
			<f:facet name="points">
				<x:panelGroup>
                  	<h:graphicImage value="AlarmFlag.gif" rendered="#{capControlForm.PAOBase.capControlSubstationBus.currentVoltLoadPointID == node.identifier}" border="0"/>
		            <x:commandLink id="ptLink" value="#{node.description}"
    ...
    <h:panelGrid id="fdrBody" columns="2" styleClass="gridLayout" columnClasses="gridColumn" >
		...
		<x:tree2 id="varPaoListTree" value="#{capControlForm.varTreeData}" var="node"
			...
			<f:facet name="points">
				<x:panelGroup>
                  	<h:graphicImage value="AlarmFlag.gif" rendered="#{capControlForm.PAOBase.capControlFeeder.currentVarLoadPointID == node.identifier}" border="0"/>
		            <x:commandLink id="ptLink" value="#{node.description}"
						actionListener="#{capControlForm.varPtTeeClick}">
			            <f:param name="ptID" value="#{node.identifier}"/>
		            </x:commandLink>	            
		...
		<x:tree2 id="paoWattListTree" value="#{capControlForm.wattTreeData}" var="node"
			...
			<f:facet name="points">
				<x:panelGroup>
                  	<h:graphicImage value="AlarmFlag.gif" rendered="#{capControlForm.PAOBase.capControlFeeder.currentWattLoadPointID == node.identifier}" border="0"/>
		            <x:commandLink id="wPtLink" value="#{node.description}"
						actionListener="#{capControlForm.wattPtTeeClick}">
			            <f:param name="ptID" value="#{node.identifier}"/>
		            </x:commandLink>	            
