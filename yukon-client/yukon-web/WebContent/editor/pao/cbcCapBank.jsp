	...
	<h:panelGrid id="capbankBody" columns="2" styleClass="gridLayout" columnClasses="gridColumn,gridColumn" >
		...
		<h:column>
			...
			<x:selectOneMenu id="bankOperation" onchange="submit();"
				...
				<f:selectItems value="#{capControlForm.capBankOpStates}"/>
			</x:selectOneMenu>
			...
			<x:selectOneMenu id="bankSize"
				...
				<f:selectItems value="#{capControlForm.capBankSizes}"/>
			</x:selectOneMenu>
			...
			<x:tree2 id="capBankPoints" value="#{capControlForm.capBankPoints}" var="node"
				...
				<f:facet name="points">
					<x:panelGroup>
	                  	<h:graphicImage value="AlarmFlag.gif" rendered="#{capControlForm.PAOBase.capBank.controlPointID == node.identifier}" border="0"/>
		...
		<h:column>
			...
			<x:outputText id="cntrlSerNum" styleClass="staticLabel" rendered="#{capControlForm.controllerCBC}"
			...
			<x:outputText id="cntrlRoute" styleClass="staticLabel" rendered="#{capControlForm.controllerCBC}"
					value="#{dbCache.allPAOsMap[capControlForm.cbcDevicesMap[dbCache.allPointsMap[capControlForm.PAOBase.capBank.controlPointID].paobjectID].routeID].paoName}" />
