...
%>
          ...
          <td width="657" valign="top" bgcolor="#FFFFFF"> 
            <div align="center"><% String header = "APPLIANCES - " + Mappings.getApplianceName(appliance.getStarsApplianceCategory().getCategory()); %> <%@ include file="InfoSearchBar.jsp" %>
                  ...
                  <td width="300" valign="top" bgcolor="#FFFFFF"> 
                      <table width="300" border="0" cellspacing="0" cellpadding="1" align="center">
                        <tr> 
                          ...
                          <td width="200"> 
                            <select name="Category">
                              <option <% if (appliance.getStarsApplianceCategory().getCategory().equalsIgnoreCase( com.cannontech.database.db.starsappliance.ApplianceCategory.CATEGORY_AC )) { %>selected<% } %>>Air Conditioner</option>
                              <option <% if (appliance.getStarsApplianceCategory().getCategory().equalsIgnoreCase( com.cannontech.database.db.starsappliance.ApplianceCategory.CATEGORY_WH )) { %>selected<% } %>>Water Heater</option>
                            </select>
                          </td>
                        </tr>
                        <tr> 
                        ...
                        <tr> 
                          ...
                          <td width="200"> 
                            <textarea name="notes" rows="2 wrap="soft" cols="24"><%= appliance.getNotes() %></textarea>
                          </td>
                        </tr>
                      </table>
                      </td>
