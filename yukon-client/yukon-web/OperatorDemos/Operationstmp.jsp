...
<table width="658" border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tr> 
    ...
    <td width="555" bgcolor="#FFFFFF" height="102" valign="top"><img src="MeteringHeader.gif" width="161" height="15"><br>
      <table width="500" border="0" cellspacing="0" cellpadding="3" align="center">
        <tr> 
          <td width="182"><font face="Arial, Helvetica, sans-serif" size="1">Search 
            for Trend:</font></td>
          <td width="107">&nbsp;</td>
          <td width="193">&nbsp;</td>
        </tr>
        <tr> 
          <form method="post" action="Metering/Billing.jsp">
            ...
            <td width="107"> 
              <div align="center"><span class="Main"><a href="Metering/Metering.jsp"><font color="#000000">All Trends</font></a></span></div>
            </td>
            <td width="193"> 
              <div align="left"><span class="Main"><a href="Metering/Billing.jsp"><font color="#000000">Billing</font></a></span></div>
            </td>
          </form>
        </tr>
      </table>
