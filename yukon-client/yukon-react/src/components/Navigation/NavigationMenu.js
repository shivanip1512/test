...
const NavigationMenu = (props) => {
    ...
    return (
        <AppBar position={"sticky"} color={"primary"} style={{ backgroundColor: yukonTheme ? yukonTheme.properties.PAGE_BACKGROUND : "" }}>
            <Toolbar>
                {yukonTheme ? (
                    <img
                        src={"data:image/png;base64," + yukonTheme.properties.LOGO_IMAGE}
                        alt="customerLogo"
                ...
                <form
                    ...
                    method="get"
                    action={props.yukonPath + "/search"}
                    className="yukon-search-form"
                >
