...
java -cp .;%YUKON_BASE%/server/web;tools.jar;common.jar;classes12.jar;jtds.jar;SqlServer.jar;log4j-1.2.4.jar com.cannontech.datagenerator.PointChangeRecorder %1 %2 %3