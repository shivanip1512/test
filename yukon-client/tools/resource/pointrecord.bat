...
java -cp .;%YUKON_BASE%/server/web;tools.jar;common.jar;ojdbc6.jar;jtds.jar;SqlServer.jar;log4j-1.2.4.jar com.cannontech.datagenerator.PointChangeRecorder %1 %2 %3