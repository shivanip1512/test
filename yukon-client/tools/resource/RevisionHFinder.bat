...
java -Djava.class.path=.;%YUKON_BASE%/server/web;ojdbc6.jar;tools.jar;common.jar;jtds.jar;SqlServer.jar;j2ee.jar;log4j-1.2.4.jar;yukonappserver.jar; com.cannontech.tools.custom.RevisionHFinder %1 %2 %3 %4
goto done
