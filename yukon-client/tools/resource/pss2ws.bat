...
java -Djava.class.path=.;%YUKON_BASE%/server/web;classes12.jar;tools.jar;common.jar;jtds.jar;SqlServer.jar;j2ee.jar;log4j-1.2.4.jar;yukonappserver.jar;axis.jar;commons-discovery.jar;commons-httpclient.jar;jaxrpc.jar;saaj.jar;wsdl4j.jar;jaxm-runtime.jar;jaxm-api.jar;commons-logging.jar; com.cannontech.custom.pss2ws.PriceServer %1 %2 %3 %4 %5 %6 %7
goto done
