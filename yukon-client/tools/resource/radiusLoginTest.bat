...
java -classpath %YUKON_BASE%/client/bin/tools.jar;%YUKON_BASE%/client/bin/jradius-client.jar;%YUKON_BASE%/client/bin/ejbonly.jar com.cannontech.test.radius.LoginTest user=yukon pass=yukon rad=127.0.0.1 sec=yukon %1 %2 %3 %4 %5 %6