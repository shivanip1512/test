...
java -Djava.class.path=.;tools.jar;common.jar;jradius-client.jar;yukonappserver.jar;jtds.jar;SqlServer.jar;ojdbc6.jar;log4j-1.2.4.jar;ejbonly.jar com.cannontech.test.radius.LoginTest user=yukon pass=yukon rad=127.0.0.1 sec=yukon %1 %2 %3 %4 %5 %6