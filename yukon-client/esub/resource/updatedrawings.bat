...
java -classpath .;%YUKON_BASE%/server/web;esub-editor.jar;common.jar;jtds.jar;SqlServer.jar;ojdbc6.jar;yukonappserver.jar;jloox2.0.2.jar com.cannontech.esub.tool.UpdateDrawings %1 %2