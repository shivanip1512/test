...
/**
 * Return the DebugOutputTextPane property value.
...
private javax.swing.JScrollPane getDisplayOutputScrollPane() {
	if (ivjDisplayOutputScrollPane == null) {
		try {
			...
			getDisplayOutputScrollPane().setViewportView(getDisplayOutputTextPane());
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
/**
 * Return the DisplayOutputTextPane property value.
 * @return javax.swing.JTextPane
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
private void print()
{
	...
	getDebugOutputTextPane().printAll(printGraphics);
...
private void save()
{
	...
	if( fileChooser.showSaveDialog(parent) == javax.swing.JFileChooser.APPROVE_OPTION )
	{
		...
		try
		{
			...
			pWriter.print( getDebugOutputTextPane().getText() );
			fWriter.close();
		}
		catch( java.io.IOException e )
		{				
