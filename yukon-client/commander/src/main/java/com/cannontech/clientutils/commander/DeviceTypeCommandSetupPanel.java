...
private javax.swing.JList getCategoryList() {
    if (ivjCategoryList == null) {
        try {
            ...
            model.addElement(CommandCategory.DEVICE_GROUP);
            model.addElement(CommandCategory.EXPRESSCOM_SERIAL);
            model.addElement(CommandCategory.SERIALNUMBER);
            model.addElement(CommandCategory.VERSACOM_SERIAL);
