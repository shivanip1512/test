...
import com.cannontech.yukon.api.loadManagement.endpoint.CancelScheduledOptOutRequestEndpoint;
...
public class CancelScheduledOptOutRequestEndpointTest {
    ...
    private static final String RESP_ELEMENT_NAME = "cancelScheduledOptOutResponse";
    private static final String REQU_ELEMENT_NAME = "cancelScheduledOptOutRequest";
    
    private Resource requestSchemaResource = 
        new ClassPathResource("/com/cannontech/yukon/api/loadManagement/schemas/CancelScheduledOptOutRequest.xsd", this.getClass());
    private Resource responseSchemaResource = 
        new ClassPathResource("/com/cannontech/yukon/api/loadManagement/schemas/CancelScheduledOptOutResponse.xsd", this.getClass());
 
    private CancelScheduledOptOutRequestEndpoint impl;
    ...
    public void testInvoke() throws Exception {
        ...
        // ========================================================================================
        requestElement = createRequest(KNOWN_ACCOUNT_NUMBER, TestInventory.SCHEDULED.toString());
        ...
        // ========================================================================================       
        requestElement = createRequest(UNKNOWN_ACCOUNT_NUMBER, TestInventory.SCHEDULED.toString());
        ...
        // ========================================================================================       
        requestElement = createRequest(KNOWN_ACCOUNT_NUMBER, TestInventory.NOT_SCHEDULED.toString());
        outputTemplate = validateAndReturnResponse(requestElement, user);
