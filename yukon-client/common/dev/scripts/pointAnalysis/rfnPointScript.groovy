...
String input_rfn = "../../../src/com/cannontech/amr/rfn/service/pointmapping/rfnPointMapping.xml"
String input_pao = "../../../src/com/cannontech/common/pao/definition/dao/paoDefinition.xml"
...
def paoOutputFile  = new File("paoAnalysis.txt")

def rfnInputFile   = new File(input_rfn)
def rfnOutputFile   = new File("rfnAnalysis.txt")

// after rfn vs pao, now compare against the original XML file
/*
def paoInputFile47957   = new File("c:\\Users\\MB8438\\Desktop\\work\\items\\YUK-11925_XMLpointFiles\\XML\\paoDefinition\\paoDefinition_v47957.xml")
def paoOutputFile47957  = new File("c:\\Users\\MB8438\\Desktop\\work\\items\\YUK-11925_XMLpointFiles\\autoAnalysis\\paoAnalysis_v47957.txt")
def rfnInputFile46349   = new File("c:\\Users\\MB8438\\Desktop\\work\\items\\YUK-11925_XMLpointFiles\\XML\\rfnPointMapping_v46349.xml")
def rfnOutputFile46349  = new File("c:\\Users\\MB8438\\Desktop\\work\\items\\YUK-11925_XMLpointFiles\\autoAnalysis\\rfnAnalysis_v46349.txt")
*/

def paoVrfnOutputFile = new File("paoVSrfnAnalysis.txt")
def paoVrfnOutputFile_ORIGINAL = new File("paoVSrfnAnalysis_ORIGINAL.txt")
...
def printComparison = { paoFileId, rfnFileId, localOutFile ->
    ...
    ptKeys.eachWithIndex{ ptName, ii -> 
        ...
        if( ii != 0 && (ii % 3) == 0 )
            localOut.println ""
        localOut.printf(outputStr, [ptName, pointOffset, pointOffset, pointOffset, ptName])
    }
    localOut.printf PAO_HEADER, "** Point Name **"
    ...
    paoTags.eachWithIndex{ tagId, tagMap, ii -> 
        ...
        if( ii != 0 && (ii % 3) == 0 )
            localOut.println ""
        localOut.printf(outputStr, [tagId, 0])
    }
