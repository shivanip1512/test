...
public class FileExportHistoryTest {
    ...
    public void exportHistoryEntryTest() {
        ExportHistoryEntry entry = new ExportHistoryEntry(0, "filename.csv", "filename.csv", FileExportType.BILLING, "initiator", Instant.now(), "C:\\exportpath");
        String fileMimeTypeCsv = entry.getFileMimeType();
        Assert.assertEquals("text/csv", fileMimeTypeCsv);
        
        ExportHistoryEntry entry2 = new ExportHistoryEntry(0, "filename.xml", "filename.xml", FileExportType.BILLING, "initiator", Instant.now(), "C:\\exportpath");
