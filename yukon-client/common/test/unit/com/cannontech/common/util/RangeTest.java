...
public class RangeTest {
    ...
    private Range<Float> unbounded_float = new Range<Float>();
    private Range<Float> from5Inclusive_toUnbounded_float = new Range<Float>(5f, null);
    private Range<Float> from5Exclusive_toUnbounded_float = new Range<Float>(5f, false, null, false);
    private Range<Float> fromUnbounded_to5Inclusive_float = new Range<Float>(null, 5f);
    private Range<Float> fromUnbounded_to5Exclusive_float = new Range<Float>(null, false, 5f, false);
    private Range<Float> from10Inclusive_toUnbounded_float = new Range<Float>(10f, null);
    private Range<Float> from10Exclusive_toUnbounded_float = new Range<Float>(10f, false, null, false);
    private Range<Float> fromUnbounded_to10Inclusive_float = new Range<Float>(null, 10f);
    private Range<Float> fromUnbounded_to10Exclusive_float = new Range<Float>(null, false, 10f, false);
    private Range<Float> from5Inclusive_to10Inclusive_float = new Range<Float>(5f, 10f);
    private Range<Float> from5Exclusive_to10Exclusive_float = new Range<Float>(5f, false, 10f, false);
    private Range<Float> from5Exclusive_to10Inclusive_float = new Range<Float>(5f, false, 10f, true);
    private Range<Float> from5Inclusive_to10Exclusive_float = new Range<Float>(5f, true, 10f, false);
    private Range<Float> from5Inclusive_to5Inclusive_float = new Range<Float>(5f, true, 5f, true);
    private Range<Float> from5Inclusive_to5Exclusive_float = new Range<Float>(5f, true, 5f, false);
    private Range<Float> from5Exclusive_to5Exclusive_float = new Range<Float>(5f, false, 5f, false);
    private Range<Float> from5Exclusive_to5Inclusive_float = new Range<Float>(5f, false, 5f, true);
    
    private Range<Float> inverted_float = new Range<Float>(10f, false, 5f, false);    
    
    private Range<Integer> unbounded_neg = new Range<Integer>();
    private Range<Integer> fromNeg5Inclusive_toUnbounded_neg = new Range<Integer>(-5, null);
    private Range<Integer> fromNeg5Exclusive_toUnbounded_neg = new Range<Integer>(-5, false, null, false);
    private Range<Integer> fromUnbounded_toNeg5Inclusive_neg = new Range<Integer>(null, -5);
    private Range<Integer> fromUnbounded_toNeg5Exclusive_neg = new Range<Integer>(null, false, -5, false);
    private Range<Integer> fromNeg10Inclusive_toUnbounded_neg = new Range<Integer>(-10, null);
    private Range<Integer> fromNeg10Exclusive_toUnbounded_neg = new Range<Integer>(-10, false, null, false);
    private Range<Integer> fromUnbounded_toNeg10Inclusive_neg = new Range<Integer>(null, -10);
    private Range<Integer> fromUnbounded_toNeg10Exclusive_neg = new Range<Integer>(null, false, -10, false);
    private Range<Integer> fromNeg10Inclusive_toNeg5Inclusive_neg = new Range<Integer>(-10, -5);
    private Range<Integer> fromNeg10Exclusive_toNeg5Exclusive_neg = new Range<Integer>(-10, false, -5, false);
    private Range<Integer> fromNeg10Exclusive_toNeg5Inclusive_neg = new Range<Integer>(-10, false, -5, true);
    private Range<Integer> fromNeg10Inclusive_toNeg5Exclusive_neg = new Range<Integer>(-10, true, -5, false);
    private Range<Integer> fromNeg5Inclusive_toNeg5Inclusive_neg = new Range<Integer>(-5, true, -5, true);
    private Range<Integer> fromNeg5Inclusive_toNeg5Exclusive_neg = new Range<Integer>(-5, true, -5, false);
    private Range<Integer> fromNeg5Exclusive_toNeg5Exclusive_neg = new Range<Integer>(-5, false, -5, false);
    private Range<Integer> fromNeg5Exclusive_toNeg5Inclusive_neg = new Range<Integer>(-5, false, -5, true);
    
    private Range<Integer> inverted_neg = new Range<Integer>(-1, false, -5, false); 
    ...
    public void testBoundedFloat() {
        ...
        // Exclusivity shouldn't matter when not bounded.
        Range<Float> from5Inclusive_toUnbounded_2_float = new Range<Float>(5f, true, null, false);
        assertEquals(from5Inclusive_toUnbounded_float, from5Inclusive_toUnbounded_2_float);
        Range<Float> fromUnbounded_to5Inclusive_2_float = new Range<Float>(null, false, 5f, true);
    ...
    public void testBoundedNeg() {
        ...
        assertFalse(fromNeg5Inclusive_toUnbounded_neg.isUnbounded());

        assertNull(unbounded_neg.getMin());
        assertNull(unbounded_neg.getMax());

        assertNull(fromNeg5Inclusive_toUnbounded_neg.getMax());
        assertNull(fromNeg5Exclusive_toUnbounded_neg.getMax());
        assertNull(fromUnbounded_toNeg5Inclusive_neg.getMin());
        assertNull(fromUnbounded_toNeg5Exclusive_neg.getMin());

        assertNull(fromNeg10Inclusive_toUnbounded_neg.getMax());
        assertNull(fromNeg10Exclusive_toUnbounded_neg.getMax());
        assertNull(fromUnbounded_toNeg10Inclusive_neg.getMin());
        assertNull(fromUnbounded_toNeg10Exclusive_neg.getMin());

        // Exclusivity shouldn't matter when not bounded.
        Range<Integer> from5Inclusive_toUnbounded_2_neg = new Range<Integer>(-5, true, null, false);
        assertEquals(fromNeg5Inclusive_toUnbounded_neg, from5Inclusive_toUnbounded_2_neg);
        Range<Integer> fromUnbounded_to5Inclusive_2_neg = new Range<Integer>(null, false, -5, true);
        assertEquals(fromUnbounded_toNeg5Inclusive_neg, fromUnbounded_to5Inclusive_2_neg);

        assertNotSame(unbounded_neg, fromNeg5Inclusive_toUnbounded_neg);
        assertNotSame(fromNeg5Inclusive_toUnbounded_neg, fromNeg5Exclusive_toUnbounded_neg);
    }
    ...
    public void testValidNeg() {
        ...
        assertTrue(fromNeg5Inclusive_toUnbounded_neg.isValid());
        assertTrue(fromNeg5Inclusive_toUnbounded_neg.isValid() && 
                   !fromNeg5Inclusive_toUnbounded_neg.isEmpty());
        assertTrue(fromNeg5Exclusive_toUnbounded_neg.isValid());
        assertTrue(fromNeg5Exclusive_toUnbounded_neg.isValid() && 
                   !fromNeg5Exclusive_toUnbounded_neg.isEmpty());
        assertTrue(fromUnbounded_toNeg5Inclusive_neg.isValid());
        assertTrue(fromUnbounded_toNeg5Inclusive_neg.isValid() && 
                   !fromUnbounded_toNeg5Inclusive_neg.isEmpty());
        assertTrue(fromUnbounded_toNeg5Exclusive_neg.isValid());
        assertTrue(fromUnbounded_toNeg5Exclusive_neg.isValid() && 
                   !fromUnbounded_toNeg5Exclusive_neg.isEmpty());

        assertTrue(fromNeg5Inclusive_toNeg5Inclusive_neg.isValid());
        assertTrue(fromNeg5Inclusive_toNeg5Inclusive_neg.isValid() && 
                   !fromNeg5Inclusive_toNeg5Inclusive_neg.isEmpty());
        assertTrue(fromNeg5Inclusive_toNeg5Exclusive_neg.isValid());
        assertTrue(!fromNeg5Inclusive_toNeg5Exclusive_neg.isValid() || 
                   fromNeg5Inclusive_toNeg5Exclusive_neg.isEmpty());
        assertTrue(fromNeg5Exclusive_toNeg5Exclusive_neg.isValid());
        assertTrue(!fromNeg5Exclusive_toNeg5Exclusive_neg.isValid() || 
                   fromNeg5Exclusive_toNeg5Exclusive_neg.isEmpty());
        assertTrue(fromNeg5Exclusive_toNeg5Inclusive_neg.isValid());
        assertTrue(!fromNeg5Exclusive_toNeg5Inclusive_neg.isValid() || 
                   fromNeg5Exclusive_toNeg5Inclusive_neg.isEmpty());
    ...
    public void testIntersectsNeg() {
        ...
        assertTrue(fromNeg5Exclusive_toUnbounded_neg.intersects(0));
        assertTrue(fromNeg5Inclusive_toUnbounded_neg.intersects(-5));
        assertFalse(fromNeg5Exclusive_toUnbounded_neg.intersects(-5));
        assertFalse(fromNeg5Inclusive_toUnbounded_neg.intersects(-10));

        assertFalse(fromUnbounded_toNeg5Inclusive_neg.intersects(0));
        assertTrue(fromUnbounded_toNeg5Inclusive_neg.intersects(-5));
        assertFalse(fromUnbounded_toNeg5Exclusive_neg.intersects(-5));
        assertTrue(fromUnbounded_toNeg5Exclusive_neg.intersects(-10));

        assertFalse(fromNeg10Inclusive_toNeg5Inclusive_neg.intersects(0));
        assertTrue(fromNeg10Inclusive_toNeg5Inclusive_neg.intersects(-5));
        assertTrue(fromNeg10Inclusive_toNeg5Inclusive_neg.intersects(-7));
        assertTrue(fromNeg10Inclusive_toNeg5Inclusive_neg.intersects(-10));
        assertFalse(fromNeg10Inclusive_toNeg5Inclusive_neg.intersects(-15));

        assertFalse(fromNeg10Exclusive_toNeg5Exclusive_neg.intersects(0));
        assertFalse(fromNeg10Exclusive_toNeg5Exclusive_neg.intersects(-5));
        assertTrue(fromNeg10Exclusive_toNeg5Exclusive_neg.intersects(-7));
        assertFalse(fromNeg10Exclusive_toNeg5Exclusive_neg.intersects(-10));
        assertFalse(fromNeg10Exclusive_toNeg5Exclusive_neg.intersects(-15));

        assertFalse(fromNeg10Exclusive_toNeg5Inclusive_neg.intersects(0));
        assertTrue(fromNeg10Exclusive_toNeg5Inclusive_neg.intersects(-5));
        assertTrue(fromNeg10Exclusive_toNeg5Inclusive_neg.intersects(-7));
        assertFalse(fromNeg10Exclusive_toNeg5Inclusive_neg.intersects(-10));
        assertFalse(fromNeg10Exclusive_toNeg5Inclusive_neg.intersects(-15));

        assertFalse(fromNeg10Inclusive_toNeg5Exclusive_neg.intersects(0));
        assertFalse(fromNeg10Inclusive_toNeg5Exclusive_neg.intersects(-5));
        assertTrue(fromNeg10Inclusive_toNeg5Exclusive_neg.intersects(-7));
        assertTrue(fromNeg10Inclusive_toNeg5Exclusive_neg.intersects(-10));
        assertFalse(fromNeg10Inclusive_toNeg5Exclusive_neg.intersects(-15));
    }
