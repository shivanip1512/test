...
public class EcobeeZeusCommunicationServiceImplTest {
    ...
    public void test_getSuitableGroupForEnrolment() {
        ...
        groupIDs.add("1234");
        groupIDs.add("2345");
        assertTrue(ReflectionTestUtils.invokeMethod(service, "getSuitableGroupForEnrolment", groupIDs).equals("1234"));
        groupIDs.clear();
        groupIDs.add("3456");
        groupIDs.add("4567");
        assertTrue(StringUtils.isEmpty(ReflectionTestUtils.invokeMethod(service, "getSuitableGroupForEnrolment", groupIDs)));
        groupIDs.clear();
        groupIDs.add("3456");
        groupIDs.add("4567");
        groupIDs.add("2345");
        assertTrue(ReflectionTestUtils.invokeMethod(service, "getSuitableGroupForEnrolment", groupIDs).equals("2345"));
