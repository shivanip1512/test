...
public static void main(String[] args) {
	...
	pReg.setRegFlags( com.cannontech.messaging.message.dispatch.PointRegistrationMessage.REG_ALL_PTS_MASK | com.cannontech.messaging.message.dispatch.PointRegistrationMessage.REG_ALARMS | com.cannontech.messaging.message.dispatch.PointRegistrationMessage.REG_EVENTS );
