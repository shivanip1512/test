 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class LMGroupMacroModel extends AbstractDeviceTreeModel {

/**
 * LMGroupVersacomModel constructor comment.
 * @param root javax.swing.tree.TreeNode
 */
public LMGroupMacroModel() {
	super(new DBTreeNode("Macro Groups"));
}
/**
...
{
	return( type_ == PAOGroups.MACRO_GROUP
