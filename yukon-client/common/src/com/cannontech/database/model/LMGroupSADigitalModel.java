 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class LMGroupSADigitalModel extends DeviceTreeModel 
{
/**
 * LMGroupVersacomModel constructor comment.
 * @param root javax.swing.tree.TreeNode
 */
public LMGroupSADigitalModel() {
	super(new DBTreeNode("SA-Digital Groups"));
}
/**
...
{
	return( type_ == PAOGroups.LM_GROUP_SADIGITAL
