 ...
 */
public class LMGroupExpressComm extends com.cannontech.database.db.DBPersistent 
{
	...
	{		
		...
		else		
		{
			...
			pstmt = conn.prepareStatement(
							"delete "+ LMGroupExpressCommAddress.TABLE_NAME + " from " + 
							LMGroupExpressCommAddress.TABLE_NAME +
							...
							"and addressid > " + LMGroupExpressCommAddress.NONE_ADDRESS_ID );
