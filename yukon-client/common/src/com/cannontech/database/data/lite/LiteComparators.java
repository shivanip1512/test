    ...
    public static Comparator<LiteBase> liteStringComparator = new Comparator<LiteBase>() {
        ...
        public int compare(LiteBase o1, LiteBase o2) {
            ...
            if (o1 instanceof LiteYukonPAObject && o2 instanceof LiteYukonPAObject) {
                ...
                if (thisVal.equalsIgnoreCase(anotherVal)) {
                    // if the Last Names are equal, we need to sort by First
                    // Names
            ...
            } else { // unknown lite type
                throw new IllegalArgumentException("Unhandled lite types or the 2 objects being compared are not the" 
                        + " same object types in comparator of : " + this.getClass().toString());
            }
