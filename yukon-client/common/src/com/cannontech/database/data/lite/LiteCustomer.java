...
/*        if( getLiteContact() != null)
    ...
    public int hashCode() {
        ...
        result = prime * result + ((accountIDs == null) ? 0
                : accountIDs.hashCode());
        result = prime * result + ((additionalContacts == null) ? 0
                : additionalContacts.hashCode());
        result = prime * result + ((altTrackNum == null) ? 0
                : altTrackNum.hashCode());
        result = prime * result + ((customerNumber == null) ? 0
                : customerNumber.hashCode());
        result = prime * result + customerTypeID;
        result = prime * result + energyCompanyID;
        result = prime * result + (extended ? 1231 : 1237);
        result = prime * result + primaryContactID;
        result = prime * result + rateScheduleID;
        result = prime * result + ((temperatureUnit == null) ? 0
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final LiteCustomer other = (LiteCustomer) obj;
        if (accountIDs == null) {
            ...
            return false;
        if (additionalContacts == null) {
            if (other.additionalContacts != null)
                return false;
        } else if (!additionalContacts.equals(other.additionalContacts))
            return false;
        if (altTrackNum == null) {
            if (other.altTrackNum != null)
                return false;
        } else if (!altTrackNum.equals(other.altTrackNum))
            return false;
        if (customerNumber == null) {
            ...
            return false;
        if (customerTypeID != other.customerTypeID)
            return false;
        ...
        if (primaryContactID != other.primaryContactID)
            return false;
        if (rateScheduleID != other.rateScheduleID)
            return false;
