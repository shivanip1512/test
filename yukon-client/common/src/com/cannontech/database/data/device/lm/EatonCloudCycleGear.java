...
public class EatonCloudCycleGear extends com.cannontech.database.db.device.lm.LMProgramDirectGear {

    private static final long serialVersionUID = 1L;

    private EatonCloudCycleType eatonCloudCycleType = null;
    ...
    public void add() throws SQLException {
        ...
        Object addValues[] = { getGearID(), eatonCloudCycleType.name() };
    ...
    public void retrieve() throws SQLException {
        ...
        if (results.length == SETTER_COLUMNS.length) {
            eatonCloudCycleType = EatonCloudCycleType.valueOf((String) results[0]);
        } else {
    ...
    public void update() throws SQLException {
        ...
        try {
            ...
            Object setValues[] = { eatonCloudCycleType.name() };
    ...
    public void setCycleType(String type) {
        eatonCloudCycleType = EatonCloudCycleType.of(type);
    }

    public String getCycleType() {
        return eatonCloudCycleType.toString();
    }
