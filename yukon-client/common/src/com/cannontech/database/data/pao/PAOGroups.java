...
public final static int getDeviceType(String typeString)
{
   ...
   if (isStringDevice(compareString, STRING_CCU_710))
     ...
     return MCT310IM;
	  ...
	  return MCT410GL;
   else if (isStringDevice(compareString, STRING_MCT_420FL))
       return MCT420FL;
   else if (isStringDevice(compareString, STRING_MCT_420FD))
       return MCT420FD;
   else if (isStringDevice(compareString, STRING_MCT_420CL))
       return MCT420CL;
   else if (isStringDevice(compareString, STRING_MCT_420CD))
       return MCT420CD;
   else if (isStringDevice(compareString, STRING_MCT_440_2131B))
       return MCT440_2131B;
   else if (isStringDevice(compareString, STRING_MCT_440_2132B))
       return MCT440_2132B;
      ...
      return MCT470;
       ...
       return MCT430S4;
   else if (isStringDevice(compareString, STRING_MCT_430SL))
       return MCT430SL;
   else if (isStringDevice(compareString, STRING_MCT_430A3))
       return MCT430A3;
   ...
   else if (isStringDevice(compareString, STRING_RDS_TERMINAL))
      return RDS_TERMINAL;
...
public final static String getPAOTypeString(int type)
{
	switch( type )
	{
		...
		case ROUTE_RDS_TERMINAL:
		    return STRING_RDS_TERMINAL_ROUTE;
		case ROUTE_TCU:
			return STRING_TCU;
		case ROUTE_VERSACOM:
		...
		case UDPPORT:
     	...
     	case MCT310IM:
	  	...
	  	case MCT420FL:
	  	    return STRING_MCT_420FL[0];
	  	case MCT420FD:
	  	    return STRING_MCT_420FD[0];
	  	case MCT420CL:
	  	    return STRING_MCT_420CL[0];
	  	case MCT420CD:
	  	    return STRING_MCT_420CD[0];
	  	case MCT410IL:
...
public final static int getPortType(String typeString) 
{
	...
	else if (typeString.equalsIgnoreCase(PortTypes.STRING_UDPPORT))
	{
	    return UDPPORT;
	}
	else
...
public final static int getRouteType(String typeString)
{
	...
	else if( typeString.equalsIgnoreCase(STRING_RDS_TERMINAL_ROUTE)) {
	    return ROUTE_RDS_TERMINAL;
	}
