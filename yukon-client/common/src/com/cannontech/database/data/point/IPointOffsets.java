...
public interface IPointOffsets 
{
   ...
   public static final PointOffset[] ALL_POINT_OFFSETS =
   {
		...
		new PointOffset( PAOGroups.MCT410IL, PointTypes.PULSE_ACCUMULATOR_POINT,
					new int[]{1,20,101,121,141,161},
					new String[] {"kWh","Blink Count","TOU kWh Rate A","TOU kWh Rate B","TOU kWh Rate C","TOU kWh Rate D"} ),
		new PointOffset( PAOGroups.MCT410IL, PointTypes.DEMAND_ACCUMULATOR_POINT, 
					new int[]{1,4,11,14,15,21,24,25,101,104,111,131,151,171},
					new String[] {"kW","Voltage","Peak kW","Max Volts","Min Volts",
						...
						"TOU Peak kW Rate A","TOU Peak kW Rate B","TOU Peak kW Rate C",
						"TOU Peak kW Rate D"} ),
