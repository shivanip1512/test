...
public enum WatchdogWarningType implements DisplayableEnum {
    ...
    CAPCONTROL_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    LOADMANAGEMENT_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    PORTER_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    MACS_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    FDR_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    CALC_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    SCANNER_SERVICE_STATUS(Watchdogs.SERVICE_STATUS),
    NETWORK_MANAGER_STATUS(Watchdogs.SERVICE_STATUS),    
