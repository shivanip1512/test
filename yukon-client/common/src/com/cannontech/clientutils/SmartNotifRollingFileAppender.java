...
/**
 * This customize appender serves logging for the SmartNotifLogger.
...
public class SmartNotifRollingFileAppender extends YukonRollingFileAppender {
    ...
    @PluginFactory
    public static SmartNotifRollingFileAppender createAppender(@PluginAttribute("name") String name,
        ...
        instance = new SmartNotifRollingFileAppender(name, filter, layout, fileName, pattern, policy, strategy, applicationName, directory,manager);
