...
/**
 * This customize appender serves logging for the Rest calls.
 * YukonApiRollingFileAppender does set the pattern required for
...
public class YukonApiRollingFileAppender extends YukonRollingFileAppender {
    ...
    @PluginFactory
    public static YukonApiRollingFileAppender createAppender(@PluginAttribute("name") String name,
        ...
        // Override the strategy with DirectWriteRolloverStrategy if set DefaultRolloverStrategy from
        // yukonLoggign.xml.
        ...
        // Passing fileName as null (1st param) so that manager can generate it dynamically while rolling with
        // the help of pattern.
        ...
        instance = new YukonApiRollingFileAppender(name, filter, layout, fileName, pattern, policy, strategy,
            applicationName, directory, manager);
