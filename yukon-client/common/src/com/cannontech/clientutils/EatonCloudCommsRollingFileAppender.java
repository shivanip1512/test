...
/**
 * This customize appender serves logging for the eatonCloudCommsCommsLogger.
...
public class EatonCloudCommsRollingFileAppender extends YukonRollingFileAppender {
    ...
    @PluginFactory
    public static EatonCloudCommsRollingFileAppender createAppender(@PluginAttribute("name") String name,
        ...
        instance = new EatonCloudCommsRollingFileAppender(name, filter, layout, fileName, pattern, policy, strategy, applicationName, directory,manager);
