...
public class EdgeDrUnicastResponse {
    ...
    private final Map<Integer, String> paoToE2eId;
    private final EdgeDrError error;
    
    public EdgeDrUnicastResponse(String messageGuid, Map<Integer, String> paoToE2eId, EdgeDrError error) {
    ...
    public Map<Integer, String> getPaoToE2eId() {
        return paoToE2eId;
    }
