...
/**
    ...
    2   Not authorized.             
        Attempted to access resources which user is not authorized for. Ensure the thermostat identifiers requested are correct.
    3   Processing error.           
        General catch-all error for a number of internal errors. Additional info may be provided in the message. Check your request. Contact support if persists.
    ...
    5   Invalid request format.     
        An error mapping the request data to internal data objects. Ensure that the properties being sent match properties in the specification.
    ...
    7   Validation error.           
        The update request contained values out of range or too large for the field being updated. See the additional message information as to what caused the validation failure.
    8   Invalid function.   
    ...
    10  Invalid page.   
        The page requested in the request is invalid. Occurs if the page is less than 1 or more than the number of available pages for the request.
    11  Function error. 
        An error occured processing a function. Ensure required properties are provided.
