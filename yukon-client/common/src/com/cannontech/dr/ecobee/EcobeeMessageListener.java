...
public class EcobeeMessageListener {
    ...
    private EcobeeDutyCycleDrParameters buildDutyCycleDrParameters(StreamMessage message) throws JMSException {
        ...
        int randomizationInterval = (rampInOut ? 1800 : 0);
        log.trace("Parsed duty cycle dr parameters. Start time: {} ({}) End time: {} ({}) Ramp in: {} Ramp out:: {} Optional: {}({})", 
                startTime, utcStartTimeSeconds, endTime, utcEndTimeSeconds, rampInOut, optional, mandatoryByte);
        
        return new EcobeeDutyCycleDrParameters(startTime, endTime, dutyCyclePercent, rampInOut, optional, groupId);
    }
