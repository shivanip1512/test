...
public class DRDutyCycleEventRequest {
    ...
    private final DRDutyCycleEventInterval[] intervals;
    
    public DRDutyCycleEventRequest(int eventID, Instant startTime, boolean optOutable,
        ...
        this.intervals = new DRDutyCycleEventInterval[] {new DRDutyCycleEventInterval(sequenceNumber, dutyCycle, durationSeconds)} ;
    }
    
    @JsonCreator
    public DRDutyCycleEventRequest(@JsonProperty("EventID") int eventID,
            ...
            @JsonProperty("DREventInterval") DRDutyCycleEventInterval[] intervals) {
        this.eventID = eventID;
        this.startTime = startTime;
        this.optOutable = optOutable;
        this.randomizationInterval = randomizationInterval;
    ...
    public DRDutyCycleEventInterval[] getIntervals() {
        return intervals;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DRDutyCycleEventRequest other = (DRDutyCycleEventRequest) obj;
