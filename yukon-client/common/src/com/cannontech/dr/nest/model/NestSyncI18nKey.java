...
public enum NestSyncI18nKey {
    ...
    AUTO_ENROLLED_THERMOSTAT(SERIAL_NUMBER, ACCOUNT_NUMBER, GROUP, PROGRAM),
    ...
    CHANGE_GROUP(SERIAL_NUMBER, ACCOUNT_NUMBER, GROUP, PROGRAM, GROUP_FROM),
    THERMOSTAT_IN_WRONG_ACCOUNT(SERIAL_NUMBER, ACCOUNT_NUMBER),
    AUTO_DELETED_THERMOSTAT(SERIAL_NUMBER, ACCOUNT_NUMBER),
