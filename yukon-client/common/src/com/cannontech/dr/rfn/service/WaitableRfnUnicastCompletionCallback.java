...
public class WaitableRfnUnicastCompletionCallback implements RfnUnicastCompletionCallback {

    private static final Logger log = YukonLogManager.getLogger(WaitableRfnUnicastCompletionCallback.class);
    
    private CountDownLatch statusLatch = new CountDownLatch(1);
    private CountDownLatch completeLatch = new CountDownLatch(1);
    
    private RfnUnicastCompletionCallback delegate;
    
    public WaitableRfnUnicastCompletionCallback(RfnUnicastCompletionCallback delegate) {
