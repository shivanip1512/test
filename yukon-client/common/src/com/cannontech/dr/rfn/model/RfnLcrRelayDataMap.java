...
public enum RfnLcrRelayDataMap {
    ...
    RELAY_4("[@id=3]", BuiltInAttribute.RELAY_4_RUN_TIME_DATA_LOG, BuiltInAttribute.RELAY_4_SHED_TIME_DATA_LOG, 4);
    ...
    private static final Set<RfnLcrRelayDataMap> lcr6200RelayMap = ImmutableSet.of(RELAY_1);
    private static final Set<RfnLcrRelayDataMap> lcr6600RelayMap = ImmutableSet.copyOf(values());
