...
public enum RfnLcr6700RelayMap {
    ...
    private static final Set<RfnLcr6700RelayMap> lcr6700RelayMap;
    ...
    static {
        Builder<RfnLcr6700RelayMap> builder = ImmutableSet.builder();
        builder.add(RELAY_RUNTIME_1);
        builder.add(RELAY_RUNTIME_2);
        builder.add(RELAY_RUNTIME_3);
        builder.add(RELAY_SHEDTIME_1);
        builder.add(RELAY_SHEDTIME_2);
        builder.add(RELAY_SHEDTIME_3);
    ...
    public static Set<RfnLcr6700RelayMap> getRelayMapByPaoType(PaoType paoType) throws ParseException {
        if (paoType == PaoType.LCR6700_RFN) {
            ...
            throw new ParseException("No RFN LCR relay mapping data found for pao type: " + paoType.getPaoTypeName(),
                0);
        }
    }
