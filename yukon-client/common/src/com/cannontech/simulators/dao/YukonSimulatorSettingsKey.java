...
public enum YukonSimulatorSettingsKey {
    ...
    DATA_STREAMING_SIMULATOR_NUM_DEV_ERR_VER(1, InputTypeFactory.integerType(), SimulatorType.DATA_STREAMING),
    ...
    DATA_STREAMING_SIMULATOR_NUM_DEV_ERR_CON(1, InputTypeFactory.integerType(), SimulatorType.DATA_STREAMING),
