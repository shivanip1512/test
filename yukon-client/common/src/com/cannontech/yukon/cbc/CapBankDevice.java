...
public class CapBankDevice extends StreamableCapObject
{
	...
	{
		return 
			CBC_DISPLAY.getCapBankValueAt(this, CBCDisplay.CB_NAME_COLUMN).toString();
	}
	
	public String getRenderBankSize()
	{
		return
			CBC_DISPLAY.getCapBankValueAt(this, CBCDisplay.CB_BANK_SIZE_COLUMN).toString();
	}
	
	public Object getRenderTimeStamp()
	{
		return
			CBC_DISPLAY.getCapBankValueAt(this, CBCDisplay.CB_TIME_STAMP_COLUMN);
	}

	public String getRenderAddress()
	{
		return
			CBC_DISPLAY.getCapBankValueAt(this, CBCDisplay.CB_BANK_ADDRESS_COLUMN).toString();
	}

	public String getRenderState()
	{
		return
			CBC_DISPLAY.getCapBankValueAt(this, CBCDisplay.CB_STATUS_COLUMN).toString();
	}
