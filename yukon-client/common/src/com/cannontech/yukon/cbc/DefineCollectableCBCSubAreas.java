...
public class DefineCollectableCBCSubAreas extends DefineCollectableCBCMessage {
    // RogueWave classId
     ...
     */
    public DefineCollectableCBCSubAreas() {
        super();
    }
    ...
    public void restoreGuts(Object obj,
        ...
        ((CBCSubAreas) obj).setAreas(areaNames);
    }
