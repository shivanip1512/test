...
public class CBCVerifySubStation extends CBCMessage {
    ...
    public CBCVerifySubStation() {
        super();
    }

    public CBCVerifySubStation (int _action_, int _subId_, int _strategy_, long _cbInactivityTime_){
        action = _action_;
        subId = _subId_;
        strategy = _strategy_;
