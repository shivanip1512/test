...
public class AccountThermostatScheduleEntryDaoImpl implements AccountThermostatScheduleEntryDao {
    ...
    public void init() {
        ...
        accountThermostatScheduleEntryTemplate = new SimpleTableAccessTemplate<>(yukonJdbcTemplate, nextValueHelper);
    ...
    private RowAndFieldMapper<AccountThermostatScheduleEntry> accountThermostatScheduleEntryRowAndFieldMapper =
        new RowAndFieldMapper<AccountThermostatScheduleEntry>() {
