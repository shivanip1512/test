...
public interface DrJmsMessagingService {
    ...
    /**
     * Pushing Program Status messages to queue ("yukon.notif.obj.dr.DRNotificationMessage")
     */
    public void publishProgramStatusNotice(DrProgramStatusJmsMessage drProgramStatusJmsMessage);
