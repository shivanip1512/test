...
public class AccountSite extends DBPersistent {
    ...
    private com.cannontech.stars.database.db.customer.AccountSite accountSite = null;
    private com.cannontech.database.db.customer.Address streetAddress = null;

    private com.cannontech.stars.database.data.customer.SiteInformation siteInformation = null;
    ...
    public void add() throws java.sql.SQLException {
    	if (getAccountSite().getSiteInformationID().intValue() == com.cannontech.stars.database.db.customer.SiteInformation.NONE_INT) {
	 ...
	 * @return com.cannontech.stars.database.db.customer.AccountSite
	 */
	public com.cannontech.stars.database.db.customer.AccountSite getAccountSite() {
		if (accountSite == null)
			accountSite = new com.cannontech.stars.database.db.customer.AccountSite();
		return accountSite;
	}
	 ...
	 */
	public com.cannontech.stars.database.data.customer.SiteInformation getSiteInformation() {
		if (siteInformation == null)
			siteInformation = new com.cannontech.stars.database.data.customer.SiteInformation();
	...
	public void setAccountSite(
		com.cannontech.stars.database.db.customer.AccountSite accountSite) {
	...
	public void setSiteInformation(
		com.cannontech.stars.database.data.customer.SiteInformation siteInformation) {
