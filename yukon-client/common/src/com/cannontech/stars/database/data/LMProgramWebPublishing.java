...
public class LMProgramWebPublishing extends DBPersistent implements CTIDbChange{
	...
	private com.cannontech.stars.database.db.LMProgramWebPublishing lmProgramWebPublishing = null;
	 ...
	 * @return com.cannontech.stars.database.db.LMProgramWebPublishing
	 */
	public com.cannontech.stars.database.db.LMProgramWebPublishing getLMProgramWebPublishing() {
		if (lmProgramWebPublishing == null)
			lmProgramWebPublishing = new com.cannontech.stars.database.db.LMProgramWebPublishing();
	...
	public void setLmProgramWebPublishing(
		com.cannontech.stars.database.db.LMProgramWebPublishing lmProgramWebPublishing) {
		this.lmProgramWebPublishing = lmProgramWebPublishing;
	}

	/**
	 * Returns the webConfiguration.
	 * @return com.cannontech.stars.database.db.CustomerWebConfiguration
	 */
