...
public class LMHardwareConfiguration extends DBPersistent {
    ...
    private com.cannontech.stars.database.db.hardware.LMHardwareConfiguration lmHardwareConfiguration = null;
	 ...
	 */
	public com.cannontech.stars.database.db.hardware.LMHardwareConfiguration getLMHardwareConfiguration() {
	...
	public void setLMHardwareConfiguration(
		com.cannontech.stars.database.db.hardware.LMHardwareConfiguration lmHardwareConfiguration) {
