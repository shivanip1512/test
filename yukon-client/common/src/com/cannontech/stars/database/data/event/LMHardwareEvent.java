...
public class LMHardwareEvent extends LMCustomerEventBase {
    ...
    private com.cannontech.stars.database.db.event.LMHardwareEvent lmHardwareEvent = null;
    ...
    public static void deleteAllLMHardwareEvents(Integer invID) {
		try {
    		Integer[] eventIDs = com.cannontech.stars.database.db.event.LMHardwareEvent.getAllLMHardwareEventIDs( invID );
    ...
    public static LMHardwareEvent getLastLMHardwareEvent(Integer invID) {
    	try {
	        com.cannontech.stars.database.db.event.LMHardwareEvent eventDB =
	        		com.cannontech.stars.database.db.event.LMHardwareEvent.getLastLMHardwareEvent( invID );
			...
			event = (com.cannontech.stars.database.data.event.LMHardwareEvent)
	 ...
	 * @return com.cannontech.stars.database.db.event.LMHardwareEvent
	 */
	public com.cannontech.stars.database.db.event.LMHardwareEvent getLMHardwareEvent() {
		if (lmHardwareEvent == null)
			lmHardwareEvent = new com.cannontech.stars.database.db.event.LMHardwareEvent();
	...
	public void setLmHardwareEvent(
		com.cannontech.stars.database.db.event.LMHardwareEvent lmHardwareEvent) {
