 ...
 *
 */
public class LiteAccountInfo extends LiteBase {
	...
	public LiteAccountInfo(int accountID, int energyCompanyId) {
	...
	public synchronized List<Integer> getServiceRequestHistory() {
		if (serviceRequestHistory == null) {
		    if (getCustomerAccount() != null) { //Must already have at least the base objects loaded
	            int[] orderIDs = com.cannontech.stars.database.db.report.WorkOrderBase.searchByAccountID(getAccountID());
	            if (orderIDs != null) {
	...
	public synchronized LiteCustomerResidence getCustomerResidence() {
	    if (customerResidence == null) {
	        if (getCustomerAccount() != null) {   //Must already have at least the base objects loaded
	            com.cannontech.stars.database.db.customer.CustomerResidence residence =
	                com.cannontech.stars.database.db.customer.CustomerResidence.getCustomerResidence(getAccountSite().getAccountSiteID());
	            if (residence != null) {
