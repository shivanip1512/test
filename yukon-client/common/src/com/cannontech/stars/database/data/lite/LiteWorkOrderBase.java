...
public class LiteWorkOrderBase extends LiteBase {
	...
	private int serviceCompanyID = com.cannontech.stars.database.db.report.ServiceCompany.NONE_INT;
	...
	public void retrieve()
	{
		try
		{
			SqlStatement stat = new SqlStatement( "SELECT ORDERNUMBER, WORKTYPEID, CURRENTSTATEID, SERVICECOMPANYID, DATEREPORTED, " +
												...
												" FROM " + com.cannontech.stars.database.db.report.WorkOrderBase.TABLE_NAME + " WOB, ECTOWORKORDERMAPPING MAP " +
