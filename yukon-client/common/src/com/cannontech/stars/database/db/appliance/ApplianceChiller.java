...
public class ApplianceChiller extends DBPersistent {
    ...
    public static final String TABLE_NAME = "ApplianceChiller";

    public ApplianceChiller() {
        super();
    }
    ...
    public static ApplianceChiller getApplianceChiller(Integer appID) {
    	...
    	try {
    		...
    		ApplianceChiller app = new ApplianceChiller();
