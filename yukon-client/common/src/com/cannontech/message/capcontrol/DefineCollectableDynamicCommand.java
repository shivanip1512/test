...
public class DefineCollectableDynamicCommand  extends DefineCollectableCapControlCommand {
    ...
    public Comparator getComparator() {
        return new Comparator() {
            public int compare(Object x, Object y) {
                return ((DynamicCommandMessage)x).getCommandType().compareTo(((DynamicCommandMessage)y).getCommandType());
            }
        };
    }
    ...
    @Override
    public Class<DynamicCommandMessage> getJavaClass() {
    ...
    public void saveGuts(Object obj, VirtualOutputStream vstr, CollectableStreamer polystr) throws IOException {
        ...
        DynamicCommandMessage command = (DynamicCommandMessage) obj;
