...
public class LateLoadSessionFactoryBean extends AnnotationSessionFactoryBean {

    private Object sessionFactoryProxy;

    public LateLoadSessionFactoryBean() {
        ...
        sessionFactoryProxy = Proxy.newProxyInstance(LateLoadSessionFactoryBean.class.getClassLoader(), 
