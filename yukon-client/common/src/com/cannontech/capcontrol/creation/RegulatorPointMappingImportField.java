...
public enum RegulatorPointMappingImportField {
    ACTION(InputType.REQUIRED, "ACTION", ImportAction.class, false, true), REGULATOR_NAME(
            InputType.REQUIRED, "REGULATOR NAME", String.class), MAPPING(
            InputType.REQUIRED, "MAPPING", RegulatorPointMapping.class, false,
            true),

    DEVICE_TYPE(InputType.VALUE_DEPENDENT, "DEVICE TYPE", ImportPaoType.class,
            "ACTION", ImportAction.ADD, ImportAction.UPDATE), DEVICE_NAME(
            InputType.VALUE_DEPENDENT, "DEVICE NAME", String.class, "ACTION",
            ImportAction.ADD, ImportAction.UPDATE), POINT_NAME(
            InputType.VALUE_DEPENDENT, "POINT NAME", String.class, "ACTION",
            ImportAction.ADD, ImportAction.UPDATE), ;
    ...
    RegulatorPointMappingImportField(InputType inputType, String name,
            Class<?> typeClass) {
        this(inputType, name, typeClass, false, false);
    }

    RegulatorPointMappingImportField(InputType inputType, String name,
            Class<?> typeClass, boolean nullable, boolean uppercaseValue) {
        this(inputType, name, typeClass, false, false, null);
    }

    RegulatorPointMappingImportField(InputType inputType, String name,
            Class<?> typeClass, String dependedColumnName,
            Object... dependentValues) {
        this(inputType, name, typeClass, false, false, dependedColumnName,
                dependentValues);
    }
