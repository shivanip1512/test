...
public class CapControlImportServiceImpl implements CapControlImportService {
    ...
    private PaoTemplate createCbcPaoTemplate(CbcImportData cbcImportData,
        ...
        YukonPaObjectFields yukonPaObjectFields =
            new YukonPaObjectFields(cbcImportData.getCbcName());
        ...
        case DNP_CBC_6510:
            ...
            if (commChannel == null) {
                ...
                results.add(new CbcImportResult(cbcImportData,
                                                CbcImportResultTypesEnum.INVALID_COMM_CHANNEL));
                return null;
            } else {
                DeviceDirectCommSettingsFields commSettingsFields =
                        new DeviceDirectCommSettingsFields(commChannel.getPaoIdentifier()
                            .getPaoId());
    ...
    private PaoTemplate createHierarchyPaoTemplate(HierarchyImportData hierarchyImportData,
        ...
        default:
            results.add(new HierarchyImportResult(hierarchyImportData,
                                                  HierarchyImportResultTypesEnum.INVALID_TYPE));
            return null;
        }
    ...
    public void createCbcFromTemplate(CbcImportData cbcImportData, List<CbcImportResult> results) {
        ...
        if (templatePao == null) {
            ...
            results
                .add(new CbcImportResult(cbcImportData, CbcImportResultTypesEnum.NO_SUCH_OBJECT));
            return;
        }
        ...
        PaoIdentifier paoIdentifier =
            paoCreationService.createTemplatePao(newCbcTemplate, copyPoints);
    ...
    public void updateCbc(CbcImportData cbcImportData, List<CbcImportResult> results) {
        ...
        if (paoTemplate == null) {
            // There was a problem creating the template. The results list already has the reason
            // why.
            return;
        }
    ...
    public void createHierarchyObject(HierarchyImportData hierarchyImportData,
        ...
        if (pao != null) {
            ...
            results.add(new HierarchyImportResult(hierarchyImportData,
                                                  HierarchyImportResultTypesEnum.OBJECT_EXISTS));
            return;
        }
        ...
        Integer parentId = null;
        if (parentName != null) {
            parentId = getParentId(parentName, PaoCategory.CAPCONTROL, PaoClass.CAPCONTROL);
        }
    ...
    public void updateHierarchyObject(HierarchyImportData hierarchyImportData,
        ...
        if (pao == null) {
            ...
            results.add(new HierarchyImportResult(hierarchyImportData,
                                                  HierarchyImportResultTypesEnum.NO_SUCH_OBJECT));
            return;
        }
        ...
        results.add(new HierarchyImportResult(hierarchyImportData,
                                              HierarchyImportResultTypesEnum.SUCCESS));
    };
