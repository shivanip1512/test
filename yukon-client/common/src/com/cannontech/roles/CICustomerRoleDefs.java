...
public interface CICustomerRoleDefs extends RoleDefs {
	...
	static final int ADMINISTRATOR_PROPERTYID_BASE = RoleDefs.CICUSTOMER_ROLEID_BASE - 500;	
	static final int USER_CONTROL_PROPERTYID_BASE = RoleDefs.CICUSTOMER_ROLEID_BASE - 600;
}
