package com.cannontech.common.requests.util;
...
public class CapControlXmlUtils {
     ...
     * already been parsed in the calling {@link CapControlXmlUtils#parseCbcImportData(Node)}
     ...
     * then calls {@link CapControlXmlUtils#parseCbcJobData(Node, ImportAction)} to parse
     * the remaining data.
     * @param node the node representing a cap control cbc object.
