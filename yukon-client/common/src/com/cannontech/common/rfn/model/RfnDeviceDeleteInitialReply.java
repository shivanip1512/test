...
/**
 * RfnDeviceDeleteInitialReply is sent from NM to Yukon after NM receives a RfnDeviceDeleteRequest
 *     from Yukon. The main purpose is to tell Yukon if its request device is in NM database.
 * 
 * JMS queue name:
 *     reply-to/temporary of the queue through which RfnDeviceDeleteRequest was sent. TBD
 */
...
public class RfnDeviceDeleteInitialReply implements Serializable{
    ...
    public String toString() {
        return String.format("RfnDeviceDeleteInitialReply [replyType=%s, replyMessage=%s]",
                             replyType,
                             replyMessage);
    }
}
