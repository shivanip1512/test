...
public class YukonApiValidationUtils extends ValidationUtils {
     ...
     * +, =, <, >, ?, {, }, \, ", |, / and , ).
     */
    public boolean checkBlacklistedCharacter(Errors errors, String field, String fieldValue, String fieldName) {
     ...
     */
    public boolean checkWhitelistedCharacter(Errors errors, String field, String fieldValue, String fieldName) {
     ...
     */
    public boolean checkIllegalCharacter(Errors errors, String field, String fieldValue, String fieldName) {
     ...
     * checkIsBlank().
     */
    public void checkIsBlankOrExceedsMaxLengthOrBlacklistedChars(Errors errors, String field, String fieldValue,
    ...
    public void checkIsPositiveShort(Errors errors, String field, Short fieldValue) {
    ...
    public void checkIsPositiveInt(Errors errors, String field, Integer fieldValue) {
    ...
    public void checkIsPositiveDouble(Errors errors, String field, Double fieldValue) {
    ...
    public boolean checkIsValidDouble(Errors errors, String field, Double fieldValue) {
    ...
    public void checkIsValidNumber(Errors errors, String field, Number fieldValue) {
        if (fieldValue == null) {
     ...
     */
    public <T extends Comparable<T>> void checkRange(Errors errors, String field, T fieldValue, T min, T max,
            boolean required) {
        if (fieldValue == null) {
            if (required) {
     ...
     */
    public <T extends Comparable<T>> void checkRange(Errors errors, String field, String fieldname, T fieldValue,
    ...
    public void ipHostNameValidator(Errors errors, String field, String fieldValue) {
    ...
    public void validatePort(Errors errors, String field, String fieldName, String fieldValue) {
    ...
    public void checkExactLength(String field, Errors errors, String fieldValue, String fieldName,
            int stringLength) {
     ...
     */
    public boolean checkIsBlank(Errors errors, String field, String fieldValue, String messageArg,
     ...
     * @param fieldAllowsNull
     */
    public void checkIsFieldValueGreaterThenTargetValueInt(String field, Integer fieldValue, int targetValue,
            Errors errors) {
     ...
     */
    public void checkIfEndDateGreaterThenStartDate(String startField, Instant startDate, Instant endDate,
    ...
    public void checkIfLengthDivisibleByTwo(Errors errors, String fieldValue) {
        if (fieldValue.length() % 2 != 0) {
            errors.rejectValue(fieldValue, ApiErrorDetails.INVALID_LENGTH_EVEN.getCodeString(),
                    new Object[] { fieldValue }, fieldValue + " length must be even.");
        }
    }
    ...
    public void checkIsValidHexByteString(Errors errors, String field, String fieldValue, String fieldName, int maxLength) {
        ...
        checkIfLengthDivisibleByTwo(errors, fieldValue);
