...
public interface YukonListEntryTypes 
{
    ...
    public static final int YUK_DEF_ID_DEV_TYPE_LCR_6200C = 1342;
    public static final int YUK_DEF_ID_DEV_TYPE_LCR_6600C = 1343;
    public static final int YUK_DEF_ID_DEV_TYPE_LCR_DISCONNECT_C = 1344;
