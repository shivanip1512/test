...
public interface YukonListEntryTypes 
{
	...
	public static final int YUK_DEF_ID_CUST_ACT_CHANGE_SCHEDULE	= 1109;
	...
	public static final int YUK_DEF_ID_APP_CAT_AC				= 1401;
	public static final int YUK_DEF_ID_APP_CAT_WH				= 1402;
	public static final int YUK_DEF_ID_APP_CAT_HEAT_SYS			= 1403;
	public static final int YUK_DEF_ID_APP_CAT_POOL_PUMP			= 1404;
	public static final int YUK_DEF_ID_APP_CAT_HOT_TUB			= 1405;
	public static final int YUK_DEF_ID_SERV_STAT_UNSCHEDULED		= 1501;
	...
	public static final int YUK_DEF_ID_COC_LIKELY				= 2001;
	public static final int YUK_DEF_ID_COC_UNLIKELY				= 2002;
