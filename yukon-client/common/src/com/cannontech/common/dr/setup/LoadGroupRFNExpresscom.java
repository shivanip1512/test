...
public class LoadGroupRFNExpresscom extends LoadGroupBase<LMGroupExpressCom> {
    ...
    public void buildModel(LMGroupExpressCom lmGroupExpresscom) {
        ...
        setGeo(lmGroupExpresscom.getGeoAddress().getAddress() == 0 ? null : lmGroupExpresscom.getGeoAddress().getAddress());
        setSubstation(lmGroupExpresscom.getSubstationAddress().getAddress() == 0 ? null : lmGroupExpresscom.getSubstationAddress()
                .getAddress());
        ...
        setProgram(lmGroupExpresscom.getProgramAddress().getAddress() == 0 ? null : lmGroupExpresscom.getProgramAddress()
                .getAddress());
        setZip(lmGroupExpresscom.getZipCodeAddress().getAddress() == 0 ? null : lmGroupExpresscom.getZipCodeAddress()
                .getAddress());
        setUser(lmGroupExpresscom.getUserAddress().getAddress() == 0 ? null : lmGroupExpresscom.getUserAddress().getAddress());
        setSplinter(lmGroupExpresscom.getSplinterAddress().getAddress() == 0 ? null : lmGroupExpresscom.getSplinterAddress()
                .getAddress());

        setSerialNumber(lmGroupExpresscom.getLMGroupExpressComm().getSerialNumber().equals("0") ? null : lmGroupExpresscom
                .getLMGroupExpressComm().getSerialNumber());
    ...
    public void buildDBPersistent(LMGroupExpressCom lmGroupExpressCom) {
        ...
        String addressUsageAbbreviation = getAddressUsage().stream().map(e -> e.getAbbreviation()).map(String::valueOf)
