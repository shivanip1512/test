...
public enum HardwareConfigType implements DisplayableEnum {
    ...
    private final static ImmutableSet<HardwareConfigType> supportsServiceInOut = ImmutableSet.of(EXPRESSCOM, VERSACOM, EATON_CLOUD);
    ...
    public int getNumRelays() {
        if (this == ECOBEE || this == NEST || this == HONEYWELL) {
            return 1;
        } else if (this == ITRON || this == EXPRESSCOM) {
            return 8;
        } else {
            return 4;
        }
