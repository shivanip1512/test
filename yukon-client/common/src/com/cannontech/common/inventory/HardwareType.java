...
public enum HardwareType implements DatabaseRepresentationSource{
    ...
    UTILITY_PRO_G2(YukonListEntryTypes.YUK_DEF_ID_DEV_TYPE_UTILITYPRO_G2, InventoryCategory.ONE_WAY_RECEIVER, HardwareClass.THERMOSTAT, HardwareConfigType.EXPRESSCOM, true, true, true),
    UTILITY_PRO_G3(YukonListEntryTypes.YUK_DEF_ID_DEV_TYPE_UTILITYPRO_G3, InventoryCategory.ONE_WAY_RECEIVER, HardwareClass.THERMOSTAT, HardwareConfigType.EXPRESSCOM, true, true, true),
