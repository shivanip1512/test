...
public enum HardwareType implements DatabaseRepresentationSource, DisplayableEnum {
    ...
    LCR_4600(YUK_DEF_ID_DEV_TYPE_LCR_4600, ONE_WAY_RECEIVER, SWITCH, EXPRESSCOM, true, true, true),
    LCR_4700(YUK_DEF_ID_DEV_TYPE_LCR_4700, ONE_WAY_RECEIVER, SWITCH, EXPRESSCOM, true, true, true),
    LCR_3000(YUK_DEF_ID_DEV_TYPE_LCR_3000, ONE_WAY_RECEIVER, SWITCH, VERSACOM, true, true, true),
    LCR_3100(YUK_DEF_ID_DEV_TYPE_LCR_3100, ONE_WAY_RECEIVER, SWITCH, EXPRESSCOM, true, true, true),
