...
public enum HardwareType implements DatabaseRepresentationSource, DisplayableEnum {
    ...
    YUKON_METER(YUK_DEF_ID_DEV_TYPE_ELECTRIC_METER, InventoryCategory.YUKON_METER, METER, DISCONNECT_METER, false, true, false),
    ...
    LCR_DISCONNECT_C(YUK_DEF_ID_DEV_TYPE_LCR_DISCONNECT_C, TWO_WAY_RECEIVER, SWITCH, EATON_CLOUD, false, true, false),
    ...
    private final static ImmutableSet<HardwareType> eatonCloudTypes = ImmutableSet.of(LCR_6200C, LCR_6600C, LCR_DISCONNECT_C);
    ...
    static {
        ...
        starsToPaoMap.put(PaoType.LCR_DISCONNECT_C, LCR_DISCONNECT_C);
    ...
    public boolean isEnrollable() {
        return hardwareClass == SWITCH || hardwareClass == THERMOSTAT || this.equals(YUKON_METER);
    }
    ...
    /**
     * Returns true when type has MacAddress.
     */
    public boolean isSupportsMacAddress() {
        if (isZigbee() || isHoneywell() || isItron()) {
            return true;
        }
        return false;
    }
