...
/* System Opt Outs */
    // Cancel All Opt Out
    @YukonEventLog(transactionality = ExecutorTransactionality.FORCED, category = "stars.optOutAdmin")
    ...
    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void enablingOptOutUsageForToday(@Arg(ArgEnum.username) LiteYukonUser user);

    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void enablingOptOutUsageForTodayByProgram(@Arg(ArgEnum.username) LiteYukonUser user,
                                                     @Arg(ArgEnum.programName) String programName);

    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void disablingOptOutUsageForToday(@Arg(ArgEnum.username) LiteYukonUser user);

    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void disablingOptOutUsageForTodayByProgram(@Arg(ArgEnum.username) LiteYukonUser user,
                                                      @Arg(ArgEnum.programName) String programName);
    ...
    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void countTowardOptOutLimitTodayByProgram(@Arg(ArgEnum.username) LiteYukonUser user,
                                                     @Arg(ArgEnum.programName) String programName);

    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void doNotCountTowardOptOutLimitToday(@Arg(ArgEnum.username) LiteYukonUser user);

    @YukonEventLog(transactionality = ExecutorTransactionality.TRANSACTIONAL, category = "stars.optOutAdmin")
    public void doNotCountTowardOptOutLimitTodayByProgram(@Arg(ArgEnum.username) LiteYukonUser user,
                                                          @Arg(ArgEnum.programName) String programName);
