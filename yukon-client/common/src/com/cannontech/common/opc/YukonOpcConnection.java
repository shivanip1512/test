...
public interface YukonOpcConnection {
    ...
    public YukonOpcItem addReceiveItem(String groupName, String itemName, int pointId,
                                       int pointType, double multiplier, int offset);

    public YukonOpcItem addSendItem(String groupName, String itemName, int pointId, int pointType,
                                    double multiplier, int offset);
