...
public class RfnMetersGroupProvider extends DeviceGroupProviderSqlBase {
    ...
    public SqlFragmentSource getChildDeviceGroupSqlWhereClause(DeviceGroup group, String identifier) {
        ...
        inClause.append("WHERE ypo.Type").in(PaoType.getRfElectricTypes());
    ...
    public boolean isChildDevice(DeviceGroup group, YukonDevice device) {
        return device.getPaoIdentifier().getPaoType().isRfElectric()
