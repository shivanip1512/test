...
public class RfgMetersGroupProvider extends DeviceGroupProviderSqlBase {
    ...
    public SqlFragmentSource getChildDeviceGroupSqlWhereClause(DeviceGroup group, String identifier) {
        ...
        inClause.append("WHERE ypo.Type").in(PaoType.getGasMeterTypes());
    ...
    public boolean isChildDevice(DeviceGroup group, YukonDevice device) {
        return device.getPaoIdentifier().getPaoType().isGasMeter()
