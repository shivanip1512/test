...
public class TypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TypeDescriptor() 
     {
        ...
        //-- _javaConstant
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_javaConstant", "javaConstant", org.exolab.castor.xml.NodeType.Attribute);
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Type target = (Type) object;
                    target.setJavaConstant( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _javaConstant
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
    ...
    } //-- com.cannontech.common.device.definition.model.castor.TypeDescriptor()
    ...
    {
        return com.cannontech.common.device.definition.model.castor.Type.class;
