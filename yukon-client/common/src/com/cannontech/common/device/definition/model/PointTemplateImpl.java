...
/**
 * Implementation class for PointTemplate
 */
public class PointTemplateImpl implements PointTemplate {
    ...
    public PointTemplateImpl() {
    }

    public PointTemplateImpl(String name, int type, int offset, double multiplier,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof PointTemplateImpl == false) {
            return false;
        }
        if (this == obj) {
            return true;
