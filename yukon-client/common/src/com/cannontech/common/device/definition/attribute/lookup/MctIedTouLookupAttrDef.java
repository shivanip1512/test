...
public class MctIedTouLookupAttrDef extends AttributeLookup{
	...
	/** 
	 * Constructor for MctIedTouAttributeDef
	 * Sets the AttributeLookup to mctIedTou.
	 * @param attribute
	 */
	public MctIedTouLookupAttrDef(Attribute attribute) {
		super(attribute);
	}
