...
public enum DeviceRequestType {
    ...
    CELLULAR_CONNECTION_STATUS_REFRESH("Cellular Connection Status Refresh Command", "Command sent to Cellular devices to have them update connection status.", false)
    ;
