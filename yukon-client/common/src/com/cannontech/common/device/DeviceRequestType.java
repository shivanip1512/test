...
public enum DeviceRequestType {
    ...
    METER_COMMAND_STRATEGY_CONNECT_DISCONNECT_COMMAND("Meter Command Strategy Connect/Disconnect Command", "A 'control connect' or 'control disconnect' command sent from the Meter Command Strategy", false),
