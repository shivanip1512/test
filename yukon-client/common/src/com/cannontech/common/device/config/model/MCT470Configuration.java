...
public class MCT470Configuration extends ConfigurationBase {
    ...
    // Options
     ...
     private Boolean zeroUsage = Boolean.FALSE;;
     private Boolean disconnectError = Boolean.FALSE;;
     private Boolean meterReadingCorrupted = Boolean.FALSE;;
     private Boolean transmitterOverheat = Boolean.FALSE;;
