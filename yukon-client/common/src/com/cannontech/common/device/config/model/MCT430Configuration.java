...
public class MCT430Configuration extends ConfigurationBase {
    ...
    // Options
     private Boolean alarmMaskMeter = Boolean.FALSE;
    
     private Boolean powerFailEvent = Boolean.FALSE;
     private Boolean underVoltageEvent = Boolean.FALSE;
     private Boolean overVoltageEvent = Boolean.FALSE;
     private Boolean powerFailCarryover = Boolean.FALSE;
     private Boolean rtcAdjusted = Boolean.FALSE;
     private Boolean holidayFlag = Boolean.FALSE;
     private Boolean dstChange = Boolean.FALSE;
     private Boolean tamperFlag = Boolean.FALSE;
	...
	private Boolean ledTestEnabled = Boolean.FALSE;
	private Boolean disableReconnectButton = Boolean.FALSE;
	private Boolean demandLimitMode = Boolean.FALSE;
	private Boolean disconnectCyclingMode = Boolean.FALSE;
	private Boolean dailyReporting = Boolean.FALSE;
	private Boolean mct410dRevE = Boolean.FALSE;
    ...
    public void setChannel1Type(boolean flag) {
    	if (flag == true)
    	{
    		this.channel1Type = 1;	
    	}
