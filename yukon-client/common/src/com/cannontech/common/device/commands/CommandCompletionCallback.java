...
public interface CommandCompletionCallback<T> {
    ...
    void receivedValue(T command, PointValueHolder value);

    void receivedIntermediateError(T command, SpecificDeviceErrorDescription error);

    void receivedLastError(T command, SpecificDeviceErrorDescription error);

    void receivedIntermediateResultString(T command, String value);
     ...
     */
    void receivedLastResultString(T command, String value);
