...
public enum PaoType implements DisplayableEnum, DatabaseRepresentationSource {
    ...
    RFN500S4AD(DeviceTypes.RFN500S4E_AD, "RFN-500S4AD", PaoCategory.DEVICE, PaoClass.RFMESH),
    RFN500S4AT(DeviceTypes.RFN500S4E_AT, "RFN-500S4AT", PaoCategory.DEVICE, PaoClass.RFMESH),
    RFN500S4AR(DeviceTypes.RFN500S4E_AR, "RFN-500S4AR", PaoCategory.DEVICE, PaoClass.RFMESH),
    RFN500S4RD(DeviceTypes.RFN500S4E_RD, "RFN-500S4RD", PaoCategory.DEVICE, PaoClass.RFMESH),
    RFN500S4RT(DeviceTypes.RFN500S4E_RT, "RFN-500S4RT", PaoCategory.DEVICE, PaoClass.RFMESH),
    RFN500S4RR(DeviceTypes.RFN500S4E_RR, "RFN-500S4RR", PaoCategory.DEVICE, PaoClass.RFMESH),
