...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    DELIVERED_PEAK_DEMAND("Delivered Peak Demand", AttributeGroup.DEMAND),
    DELIVERED_PEAK_DEMAND_RATE_A("Delivered Peak Demand Rate A", AttributeGroup.DEMAND),
    DELIVERED_PEAK_DEMAND_RATE_B("Delivered Peak Demand Rate B", AttributeGroup.DEMAND),
    DELIVERED_PEAK_DEMAND_RATE_C("Delivered Peak Demand Rate C", AttributeGroup.DEMAND),
    DELIVERED_PEAK_DEMAND_RATE_D("Delivered Peak Demand Rate D", AttributeGroup.DEMAND),
