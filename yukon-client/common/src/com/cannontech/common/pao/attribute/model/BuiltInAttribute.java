...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    DELIVERED_COIN_POWER_FACTOR_PEAK_KW("Delivered Coincident Power Factor Peak kW", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KW("Received Coincident Power Factor Peak kW", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR("Delivered Coincident Power Factor Peak kVAr", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR("Received Coincident Power Factor Peak kVAr", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVAR("Sum Coincident Power Factor Peak kVAr", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVA("Delivered Coincident Power Factor Peak kVA", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVA("Received Coincident Power Factor Peak kVA", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVA("Sum Coincident Power Factor Peak kVA", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_A("Delivered Coincident Power Factor Peak kW Rate A", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_A("Received Coincident Power Factor Peak kW Rate A", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_A("Sum Coincident Power Factor Peak kW Rate A", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_A("Delivered Coincident Power Factor Peak kVAr Rate A", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_A("Received Coincident Power Factor Peak kVAr Rate A", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_A("Sum Coincident Power Factor Peak kVAr Rate A", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_A("Delivered Coincident Power Factor Peak kVA Rate A", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_A("Received Coincident Power Factor Peak kVA Rate A", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_A("Sum Coincident Power Factor Peak kVA Rate A", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_B("Delivered Coincident Power Factor Peak kW Rate B", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_B("Received Coincident Power Factor Peak kW Rate B", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_B("Sum Coincident Power Factor Peak kW Rate B", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_B("Delivered Coincident Power Factor Peak kVAr Rate B", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_B("Received Coincident Power Factor Peak kVAr Rate B", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_B("Sum Coincident Power Factor Peak kVAr Rate B", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_B("Delivered Coincident Power Factor Peak kVA Rate B", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_B("Received Coincident Power Factor Peak kVA Rate B", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_B("Sum Coincident Power Factor Peak kVA Rate B", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_C("Delivered Coincident Power Factor Peak kW Rate C", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_C("Received Coincident Power Factor Peak kW Rate C", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_C("Sum Coincident Power Factor Peak kW Rate C", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_C("Delivered Coincident Power Factor Peak kVAr Rate C", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_C("Received Coincident Power Factor Peak kVAr Rate C", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_C("Sum Coincident Power Factor Peak kVAr Rate C", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_C("Delivered Coincident Power Factor Peak kVA Rate C", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_C("Received Coincident Power Factor Peak kVA Rate C", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_C("Sum Coincident Power Factor Peak kVA Rate C", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_D("Delivered Coincident Power Factor Peak kW Rate D", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_D("Received Coincident Power Factor Peak kW Rate D", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_D("Sum Coincident Power Factor Peak kW Rate D", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_D("Delivered Coincident Power Factor Peak kVAr Rate D", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_D("Received Coincident Power Factor Peak kVAr Rate D", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_D("Sum Coincident Power Factor Peak kVAr Rate D", AttributeGroup.REACTIVE),
    DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_D("Delivered Coincident Power Factor Peak kVA Rate D", AttributeGroup.REACTIVE),
    RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_D("Received Coincident Power Factor Peak kVA Rate D", AttributeGroup.REACTIVE),
    SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_D("Sum Coincident Power Factor Peak kVA Rate D", AttributeGroup.REACTIVE),
