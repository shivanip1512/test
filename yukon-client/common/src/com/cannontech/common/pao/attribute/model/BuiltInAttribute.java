...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    ENCODER("Encoder", AttributeGroup.RFN_OTHER_EVENT, false),
    ...
    SUSPECTED_LEAK("Suspected Leak", AttributeGroup.RFN_HARDWARE_EVENT, false),
    TABLE_CRC_ERROR("Table Crc Error", AttributeGroup.RFN_SOFTWARE_EVENT, false),
    TEMPERATURE_OUT_OF_RANGE("Temperature Out Of Range", AttributeGroup.RFN_OTHER_EVENT, false),
