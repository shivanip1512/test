...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    PREVIOUS_AVERAGE_POWER_FACTOR_RATE_B("Previous Average Power Factor Rate B", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_RATE_C("Average Power Factor Rate C", AttributeGroup.REACTIVE),
    PREVIOUS_AVERAGE_POWER_FACTOR_RATE_C("Previous Average Power Factor Rate C", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_RATE_D("Average Power Factor Rate D", AttributeGroup.REACTIVE),
    PREVIOUS_AVERAGE_POWER_FACTOR_RATE_D("Previous Average Power Factor Rate D", AttributeGroup.REACTIVE),
