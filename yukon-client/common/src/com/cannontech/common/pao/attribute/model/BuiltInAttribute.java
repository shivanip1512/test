...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    POWER_FACTOR_ANGLE_PHASE_A("Power Factor Degrees (Phase A)", AttributeGroup.REACTIVE),
    POWER_FACTOR_ANGLE_PHASE_B("Power Factor Degrees (Phase B)", AttributeGroup.REACTIVE),
    POWER_FACTOR_ANGLE_PHASE_C("Power Factor Degrees (Phase C)", AttributeGroup.REACTIVE),
