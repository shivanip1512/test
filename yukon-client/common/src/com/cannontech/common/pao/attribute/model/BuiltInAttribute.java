...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    PEAK_KVA_LAGGING_RATE_A("Peak kVA Lagging Rate A", AttributeGroup.REACTIVE),
    PEAK_KVA_LAGGING_RATE_B("Peak kVA Lagging Rate B", AttributeGroup.REACTIVE),
    PEAK_KVA_LAGGING_RATE_C("Peak kVA Lagging Rate C", AttributeGroup.REACTIVE),
    PEAK_KVA_LAGGING_RATE_D("Peak kVA Lagging Rate D", AttributeGroup.REACTIVE),
    ...
    private static void buildRfnEventAttributeSets() {
        ...
        nonIntervalAttributes = ImmutableSet.of(
                ...
                PEAK_KVA_LAGGING_RATE_A,
                PEAK_KVA_LAGGING_RATE_B,
                PEAK_KVA_LAGGING_RATE_C,
                PEAK_KVA_LAGGING_RATE_D,
                PEAK_KVA_Q12,
                PEAK_KVA_Q12_RATE_A,
                PEAK_KVA_Q12_RATE_B,
                PEAK_KVA_Q12_RATE_C,
