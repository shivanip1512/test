...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    RECEIVED_PEAK_KVA_FROZEN("Received Peak kVA Frozen", AttributeGroup.REACTIVE),
    RECEIVED_PEAK_KVA_FROZEN_RATE_A("Received Peak kVA Frozen Rate A", AttributeGroup.REACTIVE),
    RECEIVED_PEAK_KVA_FROZEN_RATE_B("Received Peak kVA Frozen Rate B", AttributeGroup.REACTIVE),
    RECEIVED_PEAK_KVA_FROZEN_RATE_C("Received Peak kVA Frozen Rate C", AttributeGroup.REACTIVE),
    RECEIVED_PEAK_KVA_FROZEN_RATE_D("Received Peak kVA Frozen Rate D", AttributeGroup.REACTIVE),
    ...
    POWER_FACTOR_COIN_DELIVERED_PEAK_KW("Coincident Power Factor Delivered Peak kW", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_RECEIVED_PEAK_KW("Coincident Power Factor Received Peak kW", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q12("Coincident Power Factor Peak kVAR (Quadrants 1 2)", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q34("Coincident Power Factor Peak kVAR (Quadrants 3 4)", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVAR("Coincident Power Factor Peak Total kVAR", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q14("Coincident Power Factor Peak kVA (Quadrants 1 4)", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q23("Coincident Power Factor Peak kVA (Quadrants 2 3)", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVA("Coincident Power Factor Peak Total kVA", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_DELIVERED_PEAK_KW_RATE_A("Coincident Power Factor Delivered Peak kW Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_RECEIVED_PEAK_KW_RATE_A("Coincident Power Factor Received Peak kW Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KW_RATE_A("Coincident Power Factor Peak Total kW Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q12_RATE_A("Coincident Power Factor Peak kVAR (Quadrants 1 2) Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q34_RATE_A("Coincident Power Factor Peak kVAR (Quadrants 3 4) Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVAR_RATE_A("Coincident Power Factor Peak Total kVAR Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_A("Coincident Power Factor Peak kVA (Quadrants 1 4) Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_A("Coincident Power Factor Peak kVA (Quadrants 2 3) Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVA_RATE_A("Coincident Power Factor Peak Total kVA Rate A", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_DELIVERED_PEAK_KW_RATE_B("Coincident Power Factor Delivered Peak kW Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_RECEIVED_PEAK_KW_RATE_B("Coincident Power Factor Received Peak kW Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KW_RATE_B("Coincident Power Factor Peak Total kW Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q12_RATE_B("Coincident Power Factor Peak kVAR (Quadrants 1 2) Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q34_RATE_B("Coincident Power Factor Peak kVAR (Quadrants 3 4) Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVAR_RATE_B("Coincident Power Factor Peak Total kVAR Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_B("Coincident Power Factor Peak kVA (Quadrants 1 4) Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_B("Coincident Power Factor Peak kVA (Quadrants 2 3) Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVA_RATE_B("Coincident Power Factor Peak Total kVA Rate B", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_DELIVERED_PEAK_KW_RATE_C("Coincident Power Factor Delivered Peak kW Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_RECEIVED_PEAK_KW_RATE_C("Coincident Power Factor Received Peak kW Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KW_RATE_C("Coincident Power Factor Peak Total kW Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q12_RATE_C("Coincident Power Factor Peak kVAR (Quadrants 1 2) Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q34_RATE_C("Coincident Power Factor Peak kVAR (Quadrants 3 4) Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVAR_RATE_C("Coincident Power Factor Peak Total kVAR Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_C("Coincident Power Factor Peak kVA (Quadrants 1 4) Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_C("Coincident Power Factor Peak kVA (Quadrants 2 3) Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVA_RATE_C("Coincident Power Factor Peak Total kVA Rate C", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_DELIVERED_PEAK_KW_RATE_D("Coincident Power Factor Delivered Peak kW Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_RECEIVED_PEAK_KW_RATE_D("Coincident Power Factor Received Peak kW Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KW_RATE_D("Coincident Power Factor Peak Total kW Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q12_RATE_D("Coincident Power Factor Peak kVAR (Quadrants 1 2) Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVAR_Q34_RATE_D("Coincident Power Factor Peak kVAR (Quadrants 3 4) Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVAR_RATE_D("Coincident Power Factor Peak Total kVAR Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_D("Coincident Power Factor Peak kVA (Quadrants 1 4) Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_D("Coincident Power Factor Peak kVA (Quadrants 2 3) Rate D", AttributeGroup.REACTIVE),
    POWER_FACTOR_COIN_PEAK_TOTAL_KVA_RATE_D("Coincident Power Factor Peak Total kVA Rate D", AttributeGroup.REACTIVE),
    ...
    AVERAGE_POWER_FACTOR_FROZEN_RATE_A("Average Power Factor Frozen Rate A", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_RATE_B("Average Power Factor Rate B", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_FROZEN_RATE_B("Average Power Factor Frozen Rate B", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_RATE_C("Average Power Factor Rate C", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_FROZEN_RATE_C("Average Power Factor Frozen Rate C", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_RATE_D("Average Power Factor Rate D", AttributeGroup.REACTIVE),
    AVERAGE_POWER_FACTOR_FROZEN_RATE_D("Average Power Factor Frozen Rate D", AttributeGroup.REACTIVE),
