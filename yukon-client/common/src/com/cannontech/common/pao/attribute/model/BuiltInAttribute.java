...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    Q1_Q2_KVA("Quadrant 1 Quadrant 2 kVA", AttributeGroup.REACTIVE),
    Q3_Q4_KVA("Quadrant 3 Quadrant 4 kVA", AttributeGroup.REACTIVE),
    Q1_Q3_KVA("Quadrant 1 Quadrant 3 kVA", AttributeGroup.REACTIVE),
    Q2_Q4_KVA("Quadrant 2 Quadrant 4 kVA", AttributeGroup.REACTIVE),
    ...
    Q1_Q3_KVAR("Quadrant 1 Quadrant 3 kVAr", AttributeGroup.REACTIVE),
    Q2_Q4_KVAR("Quadrant 2 Quadrant 4 kVAr", AttributeGroup.REACTIVE),
    Q1_Q4_KVAR("Quadrant 1 Quadrant 4 kVAr", AttributeGroup.REACTIVE),
    Q2_Q3_KVAR("Quadrant 2 Quadrant 3 kVAr", AttributeGroup.REACTIVE),
    ...
    SUM_POWER_FACTOR("Sum Power Factor", AttributeGroup.REACTIVE),
