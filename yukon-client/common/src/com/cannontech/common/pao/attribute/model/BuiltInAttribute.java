...
public enum BuiltInAttribute implements Attribute, DisplayableEnum {
    ...
    KVA_Q1_Q2("kVA Quadrant 1 Quadrant 2", AttributeGroup.REACTIVE),
    KVA_Q3_Q4("kVA Quadrant 3 Quadrant 4", AttributeGroup.REACTIVE),
    KVA_Q1_Q3("kVA Quadrant 1 Quadrant 3", AttributeGroup.REACTIVE),
    KVA_Q2_Q4("kVA Quadrant 2 Quadrant 4", AttributeGroup.REACTIVE),
    ...
    KVAR_Q1_Q3("kVAr Quadrant 1 Quadrant 3", AttributeGroup.REACTIVE),
    KVAR_Q2_Q4("kVAr Quadrant 2 Quadrant 4", AttributeGroup.REACTIVE),
    KVAR_Q1_Q4("kVAr Quadrant 1 Quadrant 4", AttributeGroup.REACTIVE),
    KVAR_Q2_Q3("kVAr Quadrant 2 Quadrant 3", AttributeGroup.REACTIVE),
