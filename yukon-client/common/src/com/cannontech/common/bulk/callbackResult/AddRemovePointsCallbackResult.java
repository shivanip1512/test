...
public class AddRemovePointsCallbackResult extends BackgroundProcessBulkProcessorCallback<SimpleDevice> implements BackgroundProcessResultHolder {
	...
	public AddRemovePointsCallbackResult(BackgroundProcessTypeEnum backgroundProcessType,
									String resultsId, 
		...
		super(backgroundProcessType, resultsId, (int)deviceCollection.getDeviceCount());
