...
public final class GraphDaoImpl implements GraphDao {
    ...
    public List<LiteGraphDefinition> getGraphDefinitionsForEnergyCompany(int ecId) {
        ...
        SqlStatementBuilder sql = new SqlStatementBuilder();
        sql.append("select distinct gd.GraphDefinitionId, gd.Name");
        sql.append("from GraphDefinition gd"); 
        sql.append("join GraphCustomerList gcl on gcl.GraphDefinitionId = gd.GraphDefinitionId"); 
        sql.append("join EnergyCompanyCustomerList eccl on eccl.CustomerId = gcl.CustomerId"); 
