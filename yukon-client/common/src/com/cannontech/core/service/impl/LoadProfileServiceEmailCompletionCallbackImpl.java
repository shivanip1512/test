...
public class LoadProfileServiceEmailCompletionCallbackImpl implements LoadProfileService.CompletionCallback {
    ...
    private String base_template_plain = "{statusMsg}\n\n" + "Device Summary\n" + "Device Name: {deviceName}\n" + "Meter Number: {meterNumber}\n" + "Physical Address/Serial Number: {physAddress/serialNumber}\n\n" + "Channel: {channelName}\n" +  "Request Range: {startDate|DATE} to {stopDate|DATE}\n" + "Total Requested Days: {totalDays} \n\n";
    private String base_template_html  = "{statusMsg}<br/><br/>" + "Device Summary<br/>" + "Device Name: {deviceName}<br/>" + "Meter Number: {meterNumber}<br/>" + "Physical Address/Serial Number: {physAddress/serialNumber}<br/><br/>" + "Channel: {channelName}<br/>" +  "Request Range: {startDate|DATE} to {stopDate|DATE}<br/>" + "Total Requested Days: {totalDays}<br/><br/>";
