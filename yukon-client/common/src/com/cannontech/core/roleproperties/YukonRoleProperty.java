...
public enum YukonRoleProperty {
    ...
    COMMAND_MSG_PRIORITY(COMMANDER, CommanderRole.COMMAND_MSG_PRIORITY, integerType()),
    ...
    DBEDITOR_LM(DATABASE_EDITOR, DBEditorRole.DBEDITOR_LM, booleanType()),
    DBEDITOR_SYSTEM(DATABASE_EDITOR, DBEditorRole.DBEDITOR_SYSTEM, booleanType()),
    UTILITY_ID_RANGE(DATABASE_EDITOR, DBEditorRole.UTILITY_ID_RANGE, stringType()),
    TRANS_EXCLUSION(DATABASE_EDITOR, DBEditorRole.TRANS_EXCLUSION, booleanType()),
    PERMIT_LOGIN_EDIT(DATABASE_EDITOR, DBEditorRole.PERMIT_LOGIN_EDIT, booleanType()),
    DATABASE_EDITOR_OPTIONAL_PRODUCT_DEV(DATABASE_EDITOR, DBEditorRole.OPTIONAL_PRODUCT_DEV, stringType()),
    ALLOW_MEMBER_PROGRAMS(DATABASE_EDITOR, DBEditorRole.ALLOW_MEMBER_PROGRAMS, booleanType()),
    ...
    GRAPH_EDIT_GRAPHDEFINITION(TRENDING, TrendingRole.GRAPH_EDIT_GRAPHDEFINITION, booleanType()),
    TRENDING_DISCLAIMER(TRENDING, TrendingRole.TRENDING_DISCLAIMER, stringType()),
    SCAN_NOW_ENABLED(TRENDING, TrendingRole.SCAN_NOW_ENABLED, booleanType()),
    MINIMUM_SCAN_FREQUENCY(TRENDING, TrendingRole.MINIMUM_SCAN_FREQUENCY, integerType()),
    MAXIMUM_DAILY_SCANS(TRENDING, TrendingRole.MAXIMUM_DAILY_SCANS, integerType()),
    ...
    RESIDENTIAL_CONSUMER_INFO_GROUPED_CONTROL_HISTORY_DISPLAY(RESIDENTIAL_CUSTOMER, ResidentialCustomerRole.CONSUMER_INFO_GROUPED_CONTROL_HISTORY_DISPLAY, booleanType()),
    ...
    ALLOW_DR_CONTROL(LM_DIRECT_LOADCONTROL, DirectLoadcontrolRole.ALLOW_CONTROL, booleanType()),
    ...
    ADMIN_AUTO_PROCESS_BATCH_COMMANDS(OPERATOR_ADMINISTRATOR, AdministratorRole.ADMIN_AUTO_PROCESS_BATCH_COMMANDS, booleanType()),
    ...
    DEVICE_DATA_MONITORING(METERING, MeteringRole.DEVICE_DATA_MONITORING, booleanType()),
