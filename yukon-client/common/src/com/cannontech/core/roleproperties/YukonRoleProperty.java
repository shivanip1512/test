...
public enum YukonRoleProperty {
    ...
    DYNAMIC_BILLING_FILE_SETUP(APPLICATION_BILLING, APPLICATION_BILLING
        .getBasePropertyId(), booleanType()),
    ...
    DATABASE_EDITOR_OPTIONAL_PRODUCT_DEV(DATABASE_EDITOR, DATABASE_EDITOR.getBasePropertyId()
                                                          - 10, stringType()),
    ...
    MINIMUM_PASSWORD_LENGTH(PASSWORD_POLICY, PASSWORD_POLICY.getBasePropertyId()
                                             - 2, integerType()),
    ...
    POLICY_RULE_UPPERCASE_CHARACTERS(PASSWORD_POLICY, PASSWORD_POLICY.getBasePropertyId()
                                                      - 51, booleanType()),
    POLICY_RULE_LOWERCASE_CHARACTERS(PASSWORD_POLICY, PASSWORD_POLICY.getBasePropertyId()
                                                      - 52, booleanType()),
    POLICY_RULE_BASE_10_DIGITS(PASSWORD_POLICY, PASSWORD_POLICY.getBasePropertyId()
                                                - 53, booleanType()),
    POLICY_RULE_NONALPHANUMERIC_CHARACTERS(PASSWORD_POLICY, PASSWORD_POLICY.getBasePropertyId()
                                                            - 54, booleanType()),
    ...
    MACS_EDIT(TABULAR_DISPLAY_CONSOLE, TABULAR_DISPLAY_CONSOLE.getBasePropertyId()
                                       - 1, stringType()),
    TDC_MAX_ROWS(TABULAR_DISPLAY_CONSOLE, TABULAR_DISPLAY_CONSOLE.getBasePropertyId()
                                          - 3, integerType()),
    TDC_RIGHTS(TABULAR_DISPLAY_CONSOLE, TABULAR_DISPLAY_CONSOLE.getBasePropertyId()
                                        - 4, stringType()),
    TDC_ALARM_COUNT(TABULAR_DISPLAY_CONSOLE, TABULAR_DISPLAY_CONSOLE.getBasePropertyId()
                                             - 7, integerType()),
    DECIMAL_PLACES(TABULAR_DISPLAY_CONSOLE, TABULAR_DISPLAY_CONSOLE.getBasePropertyId()
                                            - 8, integerType()),
    LC_REDUCTION_COL(TABULAR_DISPLAY_CONSOLE, TABULAR_DISPLAY_CONSOLE.getBasePropertyId()
                                              - 11, booleanType()),
    ...
    CAP_BANK_FIXED_TEXT(CBC_ONELINE_CAP_SETTINGS, CBC_ONELINE_CAP_SETTINGS.getBasePropertyId()
                                                  - 5, stringType()),
    ...
    RESIDENTIAL_CONSUMER_INFO_ACCOUNT_GENERAL(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 1, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_PROGRAMS_CONTROL_HISTORY(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 3, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_PROGRAMS_ENROLLMENT(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 4, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_PROGRAMS_OPT_OUT(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 5, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_HARDWARES_THERMOSTAT(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 6, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_QUESTIONS_UTIL(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 7, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_QUESTIONS_FAQ(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 8, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_CHANGE_LOGIN_USERNAME(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 9, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_THERMOSTATS_ALL(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 10, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_CHANGE_LOGIN_PASSWORD(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 11, booleanType()),
    RESIDENTIAL_CONSUMER_INFO_GROUPED_CONTROL_HISTORY_DISPLAY(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 12, booleanType()),
    RESIDENTIAL_OPT_OUT_PERIOD(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                     - 55, stringType()),
    RESIDENTIAL_OPT_OUT_LIMITS(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                     - 56, stringType()),
    RESIDENTIAL_WEB_LINK_FAQ(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                   - 100, stringType()),
    RESIDENTIAL_CONTACTS_ACCESS(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                      - 197, booleanType()),
    RESIDENTIAL_OPT_OUT_TODAY_ONLY(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                         - 198, booleanType()),
    RESIDENTIAL_SIGN_OUT_ENABLED(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                       - 199, booleanType()),
    RESIDENTIAL_OPT_OUT_ALL_DEVICES(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                          - 201, booleanType()),
    RESIDENTIAL_ENROLLMENT_MULTIPLE_PROGRAMS_PER_CATEGORY(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 202, booleanType()),
    RESIDENTIAL_ENROLLMENT_PER_DEVICE(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER.getBasePropertyId()
                                                            - 203, booleanType()),
    RESIDENTIAL_AUTO_THERMOSTAT_MODE_ENABLED(RESIDENTIAL_CUSTOMER, RESIDENTIAL_CUSTOMER
        .getBasePropertyId() - 300, booleanType()),

    ALLOW_CHECK_CONSTRAINTS(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                             - 4, booleanType()),
    ALLOW_OBSERVE_CONSTRAINTS(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                               - 5, booleanType()),
    ALLOW_OVERRIDE_CONSTRAINT(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                               - 6, booleanType()),
    DEFAULT_CONSTRAINT_SELECTION(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                                  - 7, stringType()),
    ALLOW_STOP_GEAR_ACCESS(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId() - 8, booleanType()),
    IGNORE_PER_PAO_PERMISSIONS(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                                - 9, booleanType()),
    ...
    START_NOW_CHECKED_BY_DEFAULT(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                                  - 39, booleanType()),
    CONTROL_DURATION_DEFAULT(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                              - 40, integerType()),
    SCHEDULE_STOP_CHECKED_BY_DEFAULT(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                                      - 41, booleanType()),
    ...
    SHOW_ASSET_AVAILABILITY(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                             - 44, booleanType()),
    ...
    ENABLE_DISABLE_PROGRAM(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                            - 47, booleanType()),

    ALLOW_LOAD_GROUP_CONTROL(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                              - 45, booleanType()),
    DR_VIEW_CONTROL_AREA_TRIGGER_INFO(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId()
                                                       - 21, booleanType()),
    ...
    TEMPLATE_ROOT(NOTIFICATION_CONFIGURATION, NOTIFICATION_CONFIGURATION
        .getBasePropertyId(), stringType()),

    ADMIN_NM_ACCESS(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                            - 20, booleanType()),
    ADMIN_SUPER_USER(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                             - 19, booleanType()),
    ADMIN_EDIT_ENERGY_COMPANY(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR
        .getBasePropertyId(), booleanType()),
    ADMIN_MANAGE_MEMBERS(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                 - 3, booleanType()),
    ADMIN_VIEW_BATCH_COMMANDS(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                      - 4, booleanType()),
    ADMIN_VIEW_OPT_OUT_EVENTS(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                      - 5, booleanType()),
    ADMIN_MEMBER_LOGIN_CNTRL(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                     - 6, booleanType()),
    ADMIN_MEMBER_ROUTE_SELECT(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                      - 7, booleanType()),

    ADMIN_MULTI_WAREHOUSE(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                  - 9, booleanType()),
    ADMIN_MULTISPEAK_SETUP(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                   - 11, booleanType()),
    ADMIN_LM_USER_ASSIGN(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                 - 12, booleanType()),
    ADMIN_EDIT_CONFIG(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                              - 13, booleanType()),
    ADMIN_VIEW_CONFIG(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                              - 14, booleanType()),
    ADMIN_MANAGE_INDEXES(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                 - 15, booleanType()),
    ADMIN_VIEW_LOGS(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                            - 16, booleanType()),
    ADMIN_DATABASE_MIGRATION(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                                     - 17, booleanType()),
    ADMIN_EVENT_LOGS(OPERATOR_ADMINISTRATOR, OPERATOR_ADMINISTRATOR.getBasePropertyId()
                                             - 18, booleanType()),

    CURTAILMENT_ROLE_EXISTS(CI_CURTAILMENT, CI_CURTAILMENT.getBasePropertyId(), booleanType()),

    OPERATOR_CONSUMER_INFO_ACCOUNT_RESIDENCE(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                            - 2, booleanType()),
    OPERATOR_CONSUMER_INFO_ACCOUNT_CALL_TRACKING(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                                - 3, booleanType()),
    OPERATOR_CONSUMER_INFO_METERING_INTERVAL_DATA(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                                 - 4, booleanType()),
    OPERATOR_CONSUMER_INFO_PROGRAMS_CONTROL_HISTORY(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                                   - 6, booleanType()),
    OPERATOR_CONSUMER_INFO_PROGRAMS_ENROLLMENT(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                              - 7, booleanType()),
    OPERATOR_CONSUMER_INFO_PROGRAMS_OPT_OUT(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                           - 8, booleanType()),
    OPERATOR_CONSUMER_INFO_APPLIANCES(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                     - 9, booleanType()),
    OPERATOR_CONSUMER_INFO_APPLIANCES_CREATE(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                            - 10, booleanType()),
    OPERATOR_CONSUMER_INFO_HARDWARES(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                    - 11, booleanType()),
    OPERATOR_CONSUMER_INFO_HARDWARES_CREATE(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                           - 12, booleanType()),
    OPERATOR_CONSUMER_INFO_HARDWARES_THERMOSTAT(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                               - 13, booleanType()),
    OPERATOR_CONSUMER_INFO_WORK_ORDERS(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                      - 14, booleanType()),
    OPERATOR_CONSUMER_INFO_WS_LM_DATA_ACCESS(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                            - 20, booleanType()),
    OPERATOR_CONSUMER_INFO_WS_LM_CONTROL_ACCESS(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                               - 21, booleanType()),
    OPERATOR_CONSUMER_INFO_ADMIN_CHANGE_LOGIN_USERNAME(CONSUMER_INFO, CONSUMER_INFO
        .getBasePropertyId() - 15, booleanType()),
    OPERATOR_CONSUMER_INFO_ADMIN_CHANGE_LOGIN_PASSWORD(CONSUMER_INFO, CONSUMER_INFO
        .getBasePropertyId() - 19, booleanType()),
    OPERATOR_CONSUMER_INFO_ADMIN_FAQ(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                    - 16, booleanType()),
    OPERATOR_CONSUMER_INFO_THERMOSTATS_ALL(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                          - 17, booleanType()),
    OPERATOR_CONSUMER_INFO_METERING_CREATE(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                          - 18, booleanType()),
    OPERATOR_NEW_ACCOUNT_WIZARD(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                               - 51, booleanType()),
    OPERATOR_IMPORT_CUSTOMER_ACCOUNT(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                    - 52, booleanType()),
    OPERATOR_OPT_OUT_PERIOD(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId() - 57, stringType()),
    OPERATOR_DISABLE_SWITCH_SENDING(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                   - 58, booleanType()),
    OPERATOR_ALLOW_ACCOUNT_EDITING(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                  - 63, booleanType()),

    OPERATOR_OPT_OUT_TODAY_ONLY(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId(1)
                                               - 94, booleanType()),
    OPERATOR_OPT_OUT_ADMIN_STATUS(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId(1)
                                                 - 95, booleanType()),
    OPERATOR_OPT_OUT_ADMIN_CHANGE_ENABLE(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId(1)
                                                        - 96, booleanType()),
    OPERATOR_OPT_OUT_ADMIN_CANCEL_CURRENT(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId(1)
                                                         - 97, booleanType()),
    OPERATOR_OPT_OUT_ADMIN_CHANGE_COUNTS(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId(1)
                                                        - 98, booleanType()),

    // NOTICE: Property IDs for CONSUMER_INFO were split into 2 spaces. Note the (1) in
    // getBasePropertyId.
    ...
    OPERATOR_OPT_OUT_SURVEY_EDIT(CONSUMER_INFO, CONSUMER_INFO.getBasePropertyId()
                                                - 67, booleanType()),
    ...
    GROUP_DISCONNECT_CONTROL(DEVICE_ACTIONS, DEVICE_ACTIONS.getBasePropertyId()
                                             - 14, booleanType()),
    ...
    ODDS_FOR_CONTROL_ROLE_EXISTS(ODDS_FOR_CONTROL, ODDS_FOR_CONTROL
        .getBasePropertyId(), booleanType()),
    ...
    INFRASTRUCTURE_CREATE_AND_UPDATE(DEVICE_MANAGEMENT, DEVICE_MANAGEMENT
        .getBasePropertyId(), booleanType()),
    INFRASTRUCTURE_DELETE(DEVICE_MANAGEMENT, DEVICE_MANAGEMENT.getBasePropertyId()
                                             - 1, booleanType()),
    INFRASTRUCTURE_ADMIN(DEVICE_MANAGEMENT, DEVICE_MANAGEMENT.getBasePropertyId()
                                            - 2, booleanType()),
    INFRASTRUCTURE_VIEW(DEVICE_MANAGEMENT, DEVICE_MANAGEMENT.getBasePropertyId()
                                           - 3, booleanType()),
    ENDPOINT_PERMISSION(DEVICE_MANAGEMENT, DEVICE_MANAGEMENT
        .getBasePropertyId() - 4, InputTypeFactory.enumType(HierarchyPermissionLevel.class)),
        ;
