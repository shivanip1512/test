...
public enum YukonRoleProperty {
    ...
    LM_INDIVIDUAL_SWITCH(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId() - 1, booleanType()),
    ...
    IGNORE_PER_PAO_PERMISSIONS(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId() - 9, booleanType()),
    ...
    DR_VIEW_LOAD_CAPACITY(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId() - 26, booleanType()),
