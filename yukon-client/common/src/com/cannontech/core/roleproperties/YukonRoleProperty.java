...
public enum YukonRoleProperty {
    ...
    MANAGE_CUSTOM_COMMANDS(COMMANDER, COMMANDER.getBasePropertyId() - 20, InputTypeFactory.permissionType(OWNER, CREATE, UPDATE, VIEW, NO_ACCESS)),
    ...
    DER_EDGE_COORDINATOR_PERMISSION(DEMAND_RESPONSE, DEMAND_RESPONSE.getBasePropertyId() - 50, booleanType()),
