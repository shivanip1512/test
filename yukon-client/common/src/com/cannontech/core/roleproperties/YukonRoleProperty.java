...
public enum YukonRoleProperty {
    ...
    ARCHIVED_DATA_EXPORTER(DEVICE_ACTIONS, com.cannontech.roles.operator.DeviceActionsRole.ARCHIVED_DATA_EXPORTER, booleanType()),  
    ...
    SN_ADD_RANGE(INVENTORY, com.cannontech.roles.operator.InventoryRole.SN_ADD_RANGE, booleanType()),
    ...
    INVENTORY_CREATE_HARDWARE(INVENTORY, com.cannontech.roles.operator.InventoryRole.INVENTORY_CREATE_HARDWARE, booleanType()),
    ...
    ALLOW_MULTIPLE_WAREHOUSES(INVENTORY, com.cannontech.roles.operator.InventoryRole.ALLOW_MULTIPLE_WAREHOUSES, booleanType()),
    ...
    METER_EVENTS(METERING, com.cannontech.roles.operator.MeteringRole.METER_EVENTS, booleanType()),
