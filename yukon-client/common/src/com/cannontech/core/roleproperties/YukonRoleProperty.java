...
public enum YukonRoleProperty {
    ...
    VERSACOM_SERIAL_MODEL(COMMANDER, com.cannontech.roles.application.CommanderRole.VERSACOM_SERIAL_MODEL, stringType()),
    EXPRESSCOM_SERIAL_MODEL(COMMANDER, com.cannontech.roles.application.CommanderRole.EXPRESSCOM_SERIAL_MODEL, stringType()),
    DCU_SA205_SERIAL_MODEL(COMMANDER, com.cannontech.roles.application.CommanderRole.DCU_SA205_SERIAL_MODEL, stringType()),
    DCU_SA305_SERIAL_MODEL(COMMANDER, com.cannontech.roles.application.CommanderRole.DCU_SA305_SERIAL_MODEL, stringType()),
    ...
    DOWNLOAD_REPORTS_ENABLE(REPORTING, com.cannontech.roles.application.ReportingRole.DOWNLOAD_REPORTS_ENABLE, stringType()),
    DOWNLOAD_DEFAULT_FILENAME(REPORTING, com.cannontech.roles.application.ReportingRole.DOWNLOAD_DEFAULT_FILENAME, stringType()),
    ADMIN_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.ADMIN_REPORTS_GROUP, stringType()),
    AMR_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.AMR_REPORTS_GROUP, stringType()),
    STATISTICAL_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.STATISTICAL_REPORTS_GROUP, stringType()),
    LOAD_MANAGEMENT_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.LOAD_MANAGEMENT_REPORTS_GROUP, stringType()),
    CAP_CONTROL_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.CAP_CONTROL_REPORTS_GROUP, stringType()),
    DATABASE_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.DATABASE_REPORTS_GROUP, stringType()),
    STARS_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.STARS_REPORTS_GROUP, stringType()),
    OTHER_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.OTHER_REPORTS_GROUP, stringType()),
    SETTLEMENT_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.SETTLEMENT_REPORTS_GROUP, stringType()),
    CI_CURTAILMENT_REPORTS_GROUP(REPORTING, com.cannontech.roles.application.ReportingRole.CI_CURTAILMENT_REPORTS_GROUP, stringType()),
    ...
    HIDE_REPORTS(CBC_SETTINGS, com.cannontech.roles.capcontrol.CBCSettingsRole.HIDE_REPORTS, stringType()),
    HIDE_GRAPHS(CBC_SETTINGS, com.cannontech.roles.capcontrol.CBCSettingsRole.HIDE_GRAPHS, stringType()),
    HIDE_ONELINE(CBC_SETTINGS, com.cannontech.roles.capcontrol.CBCSettingsRole.HIDE_ONELINE, stringType()),
    ...
    RESIDENTIAL_CONSUMER_INFO_ACCOUNT_GENERAL(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_ACCOUNT_GENERAL, stringType()),
    ...
    RESIDENTIAL_CONSUMER_INFO_PROGRAMS_CONTROL_HISTORY(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_PROGRAMS_CONTROL_HISTORY, stringType()),
    RESIDENTIAL_CONSUMER_INFO_PROGRAMS_ENROLLMENT(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_PROGRAMS_ENROLLMENT, stringType()),
    RESIDENTIAL_CONSUMER_INFO_PROGRAMS_OPT_OUT(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_PROGRAMS_OPT_OUT, stringType()),
    RESIDENTIAL_CONSUMER_INFO_HARDWARES_THERMOSTAT(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_HARDWARES_THERMOSTAT, stringType()),
    RESIDENTIAL_CONSUMER_INFO_QUESTIONS_UTIL(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_QUESTIONS_UTIL, stringType()),
    RESIDENTIAL_CONSUMER_INFO_QUESTIONS_FAQ(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONSUMER_INFO_QUESTIONS_FAQ, stringType()),
    ...
    RESIDENTIAL_CONTACTS_ACCESS(RESIDENTIAL_CUSTOMER, com.cannontech.roles.consumer.ResidentialCustomerRole.CONTACTS_ACCESS, stringType()),
    ...
    OPERATOR_CONSUMER_INFO_PROGRAMS_CONTROL_HISTORY(CONSUMER_INFO, com.cannontech.roles.operator.ConsumerInfoRole.CONSUMER_INFO_PROGRAMS_CONTROL_HISTORY, stringType()),
