...
public class CommandMessage extends BaseMessage {
    ...
    public static final int COMM_STATUS = 140; // Vector contains token, deviceid,status (communication result in
                                               // porter, 0 = NORMAL).
    ...
    public static final int ALARM_CATEGORY_REQUEST = 210; // List of category ids - point ids in these alarm categories
                                                          // will be reported
    ...
    /**
     * Insert the method's description here. Creation date: (6/15/00 2:35:20 PM)
    ...
    /**
     * Insert the method's description here. Creation date: (6/15/00 2:34:51 PM)
