...
public class DynamicCommandMessage extends CommandMessage {

    public enum Parameter implements SerializableByIdentifier {
        DEVICE_ID(0), POINT_ID(1), POINT_RESPONSE_DELTA(2), POINT_RESPONSE_STATIC_DELTA(3);
    ...
    public DynamicCommandMessage(DynamicCommandType dynamicCommandType) {
