...
public enum CommandType implements DisplayableEnum {
    ...
    ENABLE_SUBSTATION_BUS(0), DISABLE_SUBSTATION_BUS(1), ENABLE_FEEDER(2), DISABLE_FEEDER(3), ENABLE_CAPBANK(4),
    DISABLE_CAPBANK(5),

    CONFIRM_OPEN(8), CONFIRM_CLOSE(9), REQUEST_ALL_DATA(10), RETURN_CAP_TO_ORIGINAL_FEEDER(11), RESET_DAILY_OPERATIONS(
        12), ENABLE_SUBSTATION(13), DISABLE_SUBSTATION(14), CONFIRM_FEEDER(15), RESET_SYSTEM_OP_COUNTS(16),

    DELETE_ITEM(19), CONFIRM_SUBSTATION_BUS(20), CONFIRM_AREA(21), ENABLE_AREA(22), DISABLE_AREA(23),

    ENABLE_SYSTEM(25), DISABLE_SYSTEM(26), FLIP_7010_CAPBANK(27), SYSTEM_STATUS(28), SEND_OPEN_CAPBANK(29),
    SEND_CLOSE_CAPBANK(30), SEND_ENABLE_OVUV(31), SEND_DISABLE_OVUV(32), SEND_SCAN_2WAY_DEVICE(33), SEND_TIME_SYNC(34),
    CHANGE_OP_STATE(35), AUTO_ENABLE_OVUV(36), AUTO_DISABLE_OVUV(37), RETURN_FEEDER_TO_ORIGINAL_SUBBUS(38),
    CONFIRM_SUBSTATION(39), SEND_ENABLE_TEMPCONTROL(40), SEND_DISABLE_TEMPCONTROL(41), SEND_ENABLE_VARCONTROL(42),
    SEND_DISABLE_VARCONTROL(43), SEND_ENABLE_TIMECONTROL(44), SEND_DISABLE_TIMECONTROL(45),

    SEND_SYNC_CBC_CAPBANK_STATE(53), MOVE_BANK(54), MANUAL_ENTRY(55),

    /* Verify Commands */
    VERIFY_ALL_BANKS(56), VERIFY_FQ_BANKS(57), VERIFY_FAILED_BANKS(58), VERIFY_Q_BANKS(59), VERIFY_INACTIVE_BANKS(60),
    VERIFY_SA_BANKS(61), STOP_VERIFICATION(62), EMERGENCY_VERIFICATION_STOP(63), VERIFY_SELECTED_BANK(64),

    /* Regulator Commands */
    VOLTAGE_REGULATOR_INTEGRITY_SCAN(70), VOLTAGE_REGULATOR_REMOTE_CONTROL_ENABLE(71),
    VOLTAGE_REGULATOR_REMOTE_CONTROL_DISABLE(72), VOLTAGE_REGULATOR_TAP_POSITION_RAISE(73),
    VOLTAGE_REGULATOR_TAP_POSITION_LOWER(74), VOLTAGE_REGULATOR_KEEP_ALIVE_ENABLE(75),
