...
public class PointDataMessage extends BaseMessage implements PointValueQualityHolder {
    ...
    public static final long TAG_POINT_MOA_REPORT = 0x00000400; // This point data message is the result of a
                                                                // registration
    public static final long TAG_POINT_DELAYED_UPDATE = 0x00000800; // Dispatch delay this point data until the time
                                                                    // specified in the message!
    public static final long TAG_POINT_FORCE_UPDATE = 0x00001000; // Dispatch will no matter what copy this into his RT
                                                                  // memory
    public static final long TAG_POINT_MUST_ARCHIVE = 0x00002000; // This data will archive no matter how the point is
                                                                  // set up
    public static final long TAG_POINT_MAY_BE_EXEMPTED = 0x00004000; // This data may be exempted from propagation if
                                                                     // the value element has not changed
