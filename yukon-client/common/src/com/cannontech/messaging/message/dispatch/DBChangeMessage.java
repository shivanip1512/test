 ...
 */
public class DBChangeMessage extends BaseMessage {
    ...
    /*
     * Possible values for the Categories fieldNOTE: If you are using the CHANGE_PAO_DB database field you willfind the
     * needed fields in PAOGRoups.java
     */
     ...
     * DBChangeMsg constructor comment.
     */
    public DBChangeMessage(int id_, int database_, String category_, String objectType_, DbChangeType dbChangeType) {
        super();
     ...
     */
    public DBChangeMessage(int id_, int database_, String category_, DbChangeType dbChangeType) {
