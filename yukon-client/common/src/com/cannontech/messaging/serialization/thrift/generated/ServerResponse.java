...
public class ServerResponse implements org.apache.thrift.TBase<ServerResponse, ServerResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ServerResponse> {
  ...
  public int compareTo(ServerResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_message(), other.isSet_message());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_message()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_hasPayload(), other.isSet_hasPayload());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_hasPayload()) {
