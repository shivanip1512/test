...
public class LMEnergyExchangeHourlyCustomer implements org.apache.thrift.TBase<LMEnergyExchangeHourlyCustomer, LMEnergyExchangeHourlyCustomer._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new LMEnergyExchangeHourlyCustomerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LMEnergyExchangeHourlyCustomerTupleSchemeFactory());
  }
  ...
  public void unset_amountCommitted() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___AMOUNTCOMMITTED_ISSET_ID);
  }
  ...
  public boolean isSet_amountCommitted() {
    return EncodingUtils.testBit(__isset_bitfield, ___AMOUNTCOMMITTED_ISSET_ID);
  }

  public void set_amountCommittedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___AMOUNTCOMMITTED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case _AMOUNT_COMMITTED:
      if (value == null) {
        ...
        set_amountCommitted((Double)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _AMOUNT_COMMITTED:
      return Double.valueOf(get_amountCommitted());
  ...
  public int compareTo(LMEnergyExchangeHourlyCustomer other) {
    ...
    LMEnergyExchangeHourlyCustomer typedOther = (LMEnergyExchangeHourlyCustomer)other;
    ...
    lastComparison = Boolean.valueOf(isSet_amountCommitted()).compareTo(typedOther.isSet_amountCommitted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_amountCommitted()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._amountCommitted, typedOther._amountCommitted);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LMEnergyExchangeHourlyCustomer(");
    boolean first = true;
  ...
  private static class LMEnergyExchangeHourlyCustomerStandardSchemeFactory implements SchemeFactory {
    public LMEnergyExchangeHourlyCustomerStandardScheme getScheme() {
      return new LMEnergyExchangeHourlyCustomerStandardScheme();
    }
  }

  private static class LMEnergyExchangeHourlyCustomerStandardScheme extends StandardScheme<LMEnergyExchangeHourlyCustomer> {
  ...
  private static class LMEnergyExchangeHourlyCustomerTupleSchemeFactory implements SchemeFactory {
    public LMEnergyExchangeHourlyCustomerTupleScheme getScheme() {
      return new LMEnergyExchangeHourlyCustomerTupleScheme();
    }
  }

  private static class LMEnergyExchangeHourlyCustomerTupleScheme extends TupleScheme<LMEnergyExchangeHourlyCustomer> {
