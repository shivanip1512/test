...
public class CapBankDeviceSerializer extends
    ...
    @Override
    protected CCCapBank createThriftEntityInstance(CCPao entityParent) {
    ...
    protected void populateMessageFromThriftEntity(ThriftMessageFactory msgFactory, CCCapBank entity, CapBankDevice msg) {
        ...
        msg.setAlarmInhibit(ConverterHelper.boolToInt(entity.is_alarmInhibitFlag()));
        msg.setControlInhibit(ConverterHelper.boolToInt(entity.is_controlInhibitFlag()));
    ...
    protected void populateThriftEntityFromMessage(ThriftMessageFactory msgFactory, CapBankDevice msg, CCCapBank entity) {
        ...
        entity.set_alarmInhibitFlag(ConverterHelper.intToBool(msg.getAlarmInhibit()));
        entity.set_controlInhibitFlag(ConverterHelper.intToBool(msg.getControlInhibit()));
