...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  public int compareTo(Message other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_messageTime(), other.isSet_messageTime());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_messagePriority(), other.isSet_messagePriority());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_soe(), other.isSet_soe());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_soe()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_usr(), other.isSet_usr());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_usr()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_src(), other.isSet_src());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_src()) {
