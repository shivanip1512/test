...
public class EdgeDrUnicastResponseSerializer extends SimpleThriftSerializer
        implements ThriftByteDeserializer<EdgeDrUnicastResponse> {
    ...
    public EdgeDrUnicastResponse fromBytes(byte[] msgBytes) {
        ...
        return new EdgeDrUnicastResponse(thriftMessage.getMessageGuid(), thriftMessage.getPaoToE2eId(), error);
    }
