...
public class NetworkManagerRequestHeader implements org.apache.thrift.TBase<NetworkManagerRequestHeader, NetworkManagerRequestHeader._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new NetworkManagerRequestHeaderStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NetworkManagerRequestHeaderTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.GROUP_ID,_Fields.EXPIRATION,_Fields.LIFETIME};
  ...
  public int compareTo(NetworkManagerRequestHeader other) {
    ...
    NetworkManagerRequestHeader typedOther = (NetworkManagerRequestHeader)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NetworkManagerRequestHeader(");
    boolean first = true;
  ...
  private static class NetworkManagerRequestHeaderStandardSchemeFactory implements SchemeFactory {
    public NetworkManagerRequestHeaderStandardScheme getScheme() {
      return new NetworkManagerRequestHeaderStandardScheme();
    }
  }

  private static class NetworkManagerRequestHeaderStandardScheme extends StandardScheme<NetworkManagerRequestHeader> {
        ...
        switch (schemeField.id) {
          ...
          case 7: // LIFETIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.lifetime = NetworkManagerMessageLifetime.findByValue(iprot.readI32());
  ...
  private static class NetworkManagerRequestHeaderTupleSchemeFactory implements SchemeFactory {
    public NetworkManagerRequestHeaderTupleScheme getScheme() {
      return new NetworkManagerRequestHeaderTupleScheme();
    }
  }

  private static class NetworkManagerRequestHeaderTupleScheme extends TupleScheme<NetworkManagerRequestHeader> {
