...
public class MCSchedule implements org.apache.thrift.TBase<MCSchedule, MCSchedule._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new MCScheduleStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MCScheduleTupleSchemeFactory());
  }
  ...
  private String _scheduleName; // required
  private String _categoryName; // required
  private String _scheduleType; // required
  private int _holidayScheduleId; // required
  private String _commandFile; // required
  private String _currentState; // required
  private String _startPolicy; // required
  private String _stopPolicy; // required
  private long _lastRunTime; // required
  private String _lastRunStatus; // required
  private int _startDay; // required
  private int _startMonth; // required
  private int _startYear; // required
  private String _startTime; // required
  private String _stopTime; // required
  private String _validWeekDays; // required
  ...
  private String _startCommand; // required
  private String _stopCommand; // required
  ...
  public void unset_scheduleId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___SCHEDULEID_ISSET_ID);
  }

  /** Returns true if field _scheduleId is set (has been assigned a value) and false otherwise */
  public boolean isSet_scheduleId() {
    return EncodingUtils.testBit(__isset_bitfield, ___SCHEDULEID_ISSET_ID);
  }

  public void set_scheduleIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___SCHEDULEID_ISSET_ID, value);
  }
  ...
  public void set_scheduleName(String _scheduleName) {
    this._scheduleName = _scheduleName;
  }
  ...
  public String get_scheduleType() {
    return this._scheduleType;
  }

  public void set_scheduleType(String _scheduleType) {
    this._scheduleType = _scheduleType;
  }
  ...
  public void unset_holidayScheduleId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___HOLIDAYSCHEDULEID_ISSET_ID);
  }
  ...
  public boolean isSet_holidayScheduleId() {
    return EncodingUtils.testBit(__isset_bitfield, ___HOLIDAYSCHEDULEID_ISSET_ID);
  }

  public void set_holidayScheduleIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___HOLIDAYSCHEDULEID_ISSET_ID, value);
  }
  ...
  public void set_commandFile(String _commandFile) {
    this._commandFile = _commandFile;
  }
  ...
  public String get_startPolicy() {
    return this._startPolicy;
  }

  public void set_startPolicy(String _startPolicy) {
    this._startPolicy = _startPolicy;
  }
  ...
  public String get_stopPolicy() {
    return this._stopPolicy;
  }

  public void set_stopPolicy(String _stopPolicy) {
    this._stopPolicy = _stopPolicy;
  }
  ...
  public void unset_lastRunTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___LASTRUNTIME_ISSET_ID);
  }

  /** Returns true if field _lastRunTime is set (has been assigned a value) and false otherwise */
  public boolean isSet_lastRunTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___LASTRUNTIME_ISSET_ID);
  }

  public void set_lastRunTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___LASTRUNTIME_ISSET_ID, value);
  }

  public String get_lastRunStatus() {
    return this._lastRunStatus;
  }

  public void set_lastRunStatus(String _lastRunStatus) {
    this._lastRunStatus = _lastRunStatus;
  }
  ...
  public void unset_startDay() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___STARTDAY_ISSET_ID);
  }

  /** Returns true if field _startDay is set (has been assigned a value) and false otherwise */
  public boolean isSet_startDay() {
    return EncodingUtils.testBit(__isset_bitfield, ___STARTDAY_ISSET_ID);
  }

  public void set_startDayIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___STARTDAY_ISSET_ID, value);
  }
  ...
  public void unset_startMonth() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___STARTMONTH_ISSET_ID);
  }

  /** Returns true if field _startMonth is set (has been assigned a value) and false otherwise */
  public boolean isSet_startMonth() {
    return EncodingUtils.testBit(__isset_bitfield, ___STARTMONTH_ISSET_ID);
  }

  public void set_startMonthIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___STARTMONTH_ISSET_ID, value);
  }
  ...
  public void unset_startYear() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___STARTYEAR_ISSET_ID);
  }

  /** Returns true if field _startYear is set (has been assigned a value) and false otherwise */
  public boolean isSet_startYear() {
    return EncodingUtils.testBit(__isset_bitfield, ___STARTYEAR_ISSET_ID);
  }

  public void set_startYearIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___STARTYEAR_ISSET_ID, value);
  }
  ...
  public String get_validWeekDays() {
    return this._validWeekDays;
  }

  public void set_validWeekDays(String _validWeekDays) {
    this._validWeekDays = _validWeekDays;
  }
  ...
  public void unset_duration() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___DURATION_ISSET_ID);
  }

  /** Returns true if field _duration is set (has been assigned a value) and false otherwise */
  public boolean isSet_duration() {
    return EncodingUtils.testBit(__isset_bitfield, ___DURATION_ISSET_ID);
  }

  public void set_durationIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___DURATION_ISSET_ID, value);
  }
  ...
  public void unset_manualStartTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___MANUALSTARTTIME_ISSET_ID);
  }
  ...
  public boolean isSet_manualStartTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___MANUALSTARTTIME_ISSET_ID);
  }

  public void set_manualStartTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___MANUALSTARTTIME_ISSET_ID, value);
  }
  ...
  public void unset_manualStopTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___MANUALSTOPTIME_ISSET_ID);
  }
  ...
  public boolean isSet_manualStopTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___MANUALSTOPTIME_ISSET_ID);
  }

  public void set_manualStopTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___MANUALSTOPTIME_ISSET_ID, value);
  }
  ...
  public void unset_targetPaoId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___TARGETPAOID_ISSET_ID);
  }

  /** Returns true if field _targetPaoId is set (has been assigned a value) and false otherwise */
  public boolean isSet_targetPaoId() {
    return EncodingUtils.testBit(__isset_bitfield, ___TARGETPAOID_ISSET_ID);
  }

  public void set_targetPaoIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___TARGETPAOID_ISSET_ID, value);
  }

  public String get_startCommand() {
    return this._startCommand;
  }

  public void set_startCommand(String _startCommand) {
    this._startCommand = _startCommand;
  }
  ...
  public String get_stopCommand() {
    return this._stopCommand;
  }

  public void set_stopCommand(String _stopCommand) {
    this._stopCommand = _stopCommand;
  }
  ...
  public void unset_repeatInterval() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___REPEATINTERVAL_ISSET_ID);
  }
  ...
  public boolean isSet_repeatInterval() {
    return EncodingUtils.testBit(__isset_bitfield, ___REPEATINTERVAL_ISSET_ID);
  }

  public void set_repeatIntervalIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___REPEATINTERVAL_ISSET_ID, value);
  }
  ...
  public void unset_currentStartTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___CURRENTSTARTTIME_ISSET_ID);
  }
  ...
  public boolean isSet_currentStartTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___CURRENTSTARTTIME_ISSET_ID);
  }

  public void set_currentStartTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___CURRENTSTARTTIME_ISSET_ID, value);
  }
  ...
  public void unset_currentStopTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___CURRENTSTOPTIME_ISSET_ID);
  }
  ...
  public boolean isSet_currentStopTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___CURRENTSTOPTIME_ISSET_ID);
  }

  public void set_currentStopTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___CURRENTSTOPTIME_ISSET_ID, value);
  }
  ...
  public void unset_templateType() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___TEMPLATETYPE_ISSET_ID);
  }
  ...
  public boolean isSet_templateType() {
    return EncodingUtils.testBit(__isset_bitfield, ___TEMPLATETYPE_ISSET_ID);
  }

  public void set_templateTypeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___TEMPLATETYPE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case _HOLIDAY_SCHEDULE_ID:
      if (value == null) {
        ...
        set_holidayScheduleId((Integer)value);
      }
      break;
    ...
    case _LAST_RUN_STATUS:
      if (value == null) {
        ...
        set_lastRunStatus((String)value);
      }
      break;
    ...
    case _VALID_WEEK_DAYS:
      if (value == null) {
        ...
        set_validWeekDays((String)value);
      }
      break;
    ...
    case _MANUAL_START_TIME:
      if (value == null) {
        ...
        set_manualStartTime((Long)value);
      }
      break;
    ...
    case _REPEAT_INTERVAL:
      if (value == null) {
        ...
        set_repeatInterval((Integer)value);
      }
      break;
    ...
    case _CURRENT_START_TIME:
      if (value == null) {
        ...
        set_currentStartTime((Long)value);
      }
      break;
    ...
    case _CURRENT_STOP_TIME:
      if (value == null) {
        ...
        set_currentStopTime((Long)value);
      }
      break;
    ...
    case _TEMPLATE_TYPE:
      if (value == null) {
        ...
        set_templateType((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _SCHEDULE_ID:
      return Integer.valueOf(get_scheduleId());
    ...
    case _HOLIDAY_SCHEDULE_ID:
      return Integer.valueOf(get_holidayScheduleId());
    ...
    case _LAST_RUN_TIME:
      return Long.valueOf(get_lastRunTime());

    case _LAST_RUN_STATUS:
      return get_lastRunStatus();

    case _START_DAY:
      return Integer.valueOf(get_startDay());

    case _START_MONTH:
      return Integer.valueOf(get_startMonth());

    case _START_YEAR:
      return Integer.valueOf(get_startYear());
    ...
    case _MANUAL_START_TIME:
      return Long.valueOf(get_manualStartTime());

    case _MANUAL_STOP_TIME:
      return Long.valueOf(get_manualStopTime());

    case _TARGET_PAO_ID:
      return Integer.valueOf(get_targetPaoId());
    ...
    case _REPEAT_INTERVAL:
      return Integer.valueOf(get_repeatInterval());

    case _CURRENT_START_TIME:
      return Long.valueOf(get_currentStartTime());

    case _CURRENT_STOP_TIME:
      return Long.valueOf(get_currentStopTime());

    case _TEMPLATE_TYPE:
      return Integer.valueOf(get_templateType());
  ...
  public int compareTo(MCSchedule other) {
    ...
    MCSchedule typedOther = (MCSchedule)other;
    ...
    lastComparison = Boolean.valueOf(isSet_scheduleId()).compareTo(typedOther.isSet_scheduleId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_scheduleId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._scheduleId, typedOther._scheduleId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_scheduleName()).compareTo(typedOther.isSet_scheduleName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_scheduleName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._scheduleName, typedOther._scheduleName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_categoryName()).compareTo(typedOther.isSet_categoryName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_categoryName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._categoryName, typedOther._categoryName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_scheduleType()).compareTo(typedOther.isSet_scheduleType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_scheduleType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._scheduleType, typedOther._scheduleType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_holidayScheduleId()).compareTo(typedOther.isSet_holidayScheduleId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_holidayScheduleId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._holidayScheduleId, typedOther._holidayScheduleId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_commandFile()).compareTo(typedOther.isSet_commandFile());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_commandFile()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._commandFile, typedOther._commandFile);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_currentState()).compareTo(typedOther.isSet_currentState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_currentState()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._currentState, typedOther._currentState);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_startPolicy()).compareTo(typedOther.isSet_startPolicy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_startPolicy()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._startPolicy, typedOther._startPolicy);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_stopPolicy()).compareTo(typedOther.isSet_stopPolicy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_stopPolicy()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._stopPolicy, typedOther._stopPolicy);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_lastRunTime()).compareTo(typedOther.isSet_lastRunTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_lastRunTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._lastRunTime, typedOther._lastRunTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_lastRunStatus()).compareTo(typedOther.isSet_lastRunStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_lastRunStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._lastRunStatus, typedOther._lastRunStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_startDay()).compareTo(typedOther.isSet_startDay());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_startDay()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._startDay, typedOther._startDay);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_startMonth()).compareTo(typedOther.isSet_startMonth());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_startMonth()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._startMonth, typedOther._startMonth);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_startYear()).compareTo(typedOther.isSet_startYear());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_startYear()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._startYear, typedOther._startYear);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSet_validWeekDays()).compareTo(typedOther.isSet_validWeekDays());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_validWeekDays()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._validWeekDays, typedOther._validWeekDays);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_duration()).compareTo(typedOther.isSet_duration());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_duration()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._duration, typedOther._duration);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_manualStartTime()).compareTo(typedOther.isSet_manualStartTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_manualStartTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._manualStartTime, typedOther._manualStartTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_manualStopTime()).compareTo(typedOther.isSet_manualStopTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_manualStopTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._manualStopTime, typedOther._manualStopTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_targetPaoId()).compareTo(typedOther.isSet_targetPaoId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_targetPaoId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._targetPaoId, typedOther._targetPaoId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_startCommand()).compareTo(typedOther.isSet_startCommand());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_startCommand()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._startCommand, typedOther._startCommand);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_stopCommand()).compareTo(typedOther.isSet_stopCommand());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_stopCommand()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._stopCommand, typedOther._stopCommand);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_repeatInterval()).compareTo(typedOther.isSet_repeatInterval());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_repeatInterval()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._repeatInterval, typedOther._repeatInterval);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_currentStartTime()).compareTo(typedOther.isSet_currentStartTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_currentStartTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._currentStartTime, typedOther._currentStartTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_currentStopTime()).compareTo(typedOther.isSet_currentStopTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_currentStopTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._currentStopTime, typedOther._currentStopTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_templateType()).compareTo(typedOther.isSet_templateType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_templateType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._templateType, typedOther._templateType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MCSchedule(");
    boolean first = true;
  ...
  private static class MCScheduleStandardSchemeFactory implements SchemeFactory {
    public MCScheduleStandardScheme getScheme() {
      return new MCScheduleStandardScheme();
    }
  }

  private static class MCScheduleStandardScheme extends StandardScheme<MCSchedule> {
  ...
  private static class MCScheduleTupleSchemeFactory implements SchemeFactory {
    public MCScheduleTupleScheme getScheme() {
      return new MCScheduleTupleScheme();
    }
  }

  private static class MCScheduleTupleScheme extends TupleScheme<MCSchedule> {
