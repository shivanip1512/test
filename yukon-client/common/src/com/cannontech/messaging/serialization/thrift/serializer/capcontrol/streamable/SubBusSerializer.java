...
public class SubBusSerializer extends
    ...
    @Override
    protected CCSubstationBusItem createThrifEntityInstance(CCPao entityParent) {
    ...
    @Override
    protected void populateMessageFromThriftEntity(ThriftMessageFactory msgFactory, CCSubstationBusItem entity, SubBus msg) {
    ...
    @Override
    protected void populateThriftEntityFromMessage(ThriftMessageFactory msgFactory, SubBus msg, CCSubstationBusItem entity) {
