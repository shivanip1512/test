...
public class ControlHistorySerializer extends
    ThriftInheritanceSerializer<ControlHistoryMessage, BaseMessage, LMControlHistory, Message> {

    public ControlHistorySerializer(String messageType, BaseMessageSerializer parentSerializer) {
    ...
    @Override
    protected LMControlHistory createThrifEntityInstance(Message entityParent) {
    ...
    @Override
    protected Message getThriftEntityParent(LMControlHistory entity) {
