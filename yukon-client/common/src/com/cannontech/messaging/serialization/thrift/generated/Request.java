...
public class Request implements org.apache.thrift.TBase<Request, Request._Fields>, java.io.Serializable, Cloneable, Comparable<Request> {
  ...
  public int compareTo(Request other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_commandString(), other.isSet_commandString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_commandString()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_routeId(), other.isSet_routeId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_routeId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_macroOffset(), other.isSet_macroOffset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_attemptNum(), other.isSet_attemptNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_attemptNum()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_groupMessageId(), other.isSet_groupMessageId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_optionsField(), other.isSet_optionsField());
    if (lastComparison != 0) {
      return lastComparison;
    }
