...
public class LMProgramControlWindow implements org.apache.thrift.TBase<LMProgramControlWindow, LMProgramControlWindow._Fields>, java.io.Serializable, Cloneable, Comparable<LMProgramControlWindow> {
  ...
  public int compareTo(LMProgramControlWindow other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_windowNumber(), other.isSet_windowNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_availableStartTime(), other.isSet_availableStartTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_availableStopTime(), other.isSet_availableStopTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
