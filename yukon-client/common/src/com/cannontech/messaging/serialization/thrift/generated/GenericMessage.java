...
public class GenericMessage implements org.apache.thrift.TBase<GenericMessage, GenericMessage._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new GenericMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GenericMessageTupleSchemeFactory());
  }

  private String _messageType; // required
  private ByteBuffer _payload; // required
...
;
  ...
  public ByteBuffer bufferFor_payload() {
    return _payload;
  }

  public void set_payload(byte[] _payload) {
    set_payload(_payload == null ? (ByteBuffer)null : ByteBuffer.wrap(_payload));
  }

  public void set_payload(ByteBuffer _payload) {
    this._payload = _payload;
  }
  ...
  public int compareTo(GenericMessage other) {
    ...
    GenericMessage typedOther = (GenericMessage)other;

    lastComparison = Boolean.valueOf(isSet_messageType()).compareTo(typedOther.isSet_messageType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_messageType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._messageType, typedOther._messageType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GenericMessage(");
    boolean first = true;
  ...
  private static class GenericMessageStandardSchemeFactory implements SchemeFactory {
    public GenericMessageStandardScheme getScheme() {
      return new GenericMessageStandardScheme();
    }
  }

  private static class GenericMessageStandardScheme extends StandardScheme<GenericMessage> {
  ...
  private static class GenericMessageTupleSchemeFactory implements SchemeFactory {
    public GenericMessageTupleScheme getScheme() {
      return new GenericMessageTupleScheme();
    }
  }

  private static class GenericMessageTupleScheme extends TupleScheme<GenericMessage> {
