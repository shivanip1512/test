...
public class RfnMeterReadingData implements org.apache.thrift.TBase<RfnMeterReadingData, RfnMeterReadingData._Fields>, java.io.Serializable, Cloneable, Comparable<RfnMeterReadingData> {
  ...
  public int compareTo(RfnMeterReadingData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetChannelDataList(), other.isSetChannelDataList());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDatedChannelDataList(), other.isSetDatedChannelDataList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDatedChannelDataList()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRecordInterval(), other.isSetRecordInterval());
    if (lastComparison != 0) {
      return lastComparison;
    }
