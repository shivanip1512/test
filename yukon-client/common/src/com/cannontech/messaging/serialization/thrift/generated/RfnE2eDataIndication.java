...
public class RfnE2eDataIndication implements org.apache.thrift.TBase<RfnE2eDataIndication, RfnE2eDataIndication._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new RfnE2eDataIndicationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RfnE2eDataIndicationTupleSchemeFactory());
  }
...
;
  ...
  public int compareTo(RfnE2eDataIndication other) {
    ...
    RfnE2eDataIndication typedOther = (RfnE2eDataIndication)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("RfnE2eDataIndication(");
    boolean first = true;
  ...
  private static class RfnE2eDataIndicationStandardSchemeFactory implements SchemeFactory {
    public RfnE2eDataIndicationStandardScheme getScheme() {
      return new RfnE2eDataIndicationStandardScheme();
    }
  }

  private static class RfnE2eDataIndicationStandardScheme extends StandardScheme<RfnE2eDataIndication> {
  ...
  private static class RfnE2eDataIndicationTupleSchemeFactory implements SchemeFactory {
    public RfnE2eDataIndicationTupleScheme getScheme() {
      return new RfnE2eDataIndicationTupleScheme();
    }
  }

  private static class RfnE2eDataIndicationTupleScheme extends TupleScheme<RfnE2eDataIndication> {
