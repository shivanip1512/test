...
public class NotifAlarm implements org.apache.thrift.TBase<NotifAlarm, NotifAlarm._Fields>, java.io.Serializable, Cloneable, Comparable<NotifAlarm> {
  ...
  public int compareTo(NotifAlarm other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_categoryId(), other.isSet_categoryId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_categoryId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_alarmTimestamp(), other.isSet_alarmTimestamp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_acknowledged(), other.isSet_acknowledged());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_abnormal(), other.isSet_abnormal());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_abnormal()) {
