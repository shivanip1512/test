...
public class CCMessage implements org.apache.thrift.TBase<CCMessage, CCMessage._Fields>, java.io.Serializable, Cloneable, Comparable<CCMessage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CCMessage");

  private static final org.apache.thrift.protocol.TField _BASE_MESSAGE_FIELD_DESC = new org.apache.thrift.protocol.TField("_baseMessage", org.apache.thrift.protocol.TType.STRUCT, (short)1);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CCMessageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CCMessageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CCMessage.class, metaDataMap);
  }
   ...
   */
  public CCMessage(CCMessage other) {
  ...
  public CCMessage deepCopy() {
    return new CCMessage(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof CCMessage)
      return this.equals((CCMessage)that);
    return false;
  }

  public boolean equals(CCMessage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CCMessage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CCMessage(");
    boolean first = true;
  ...
  private static class CCMessageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CCMessageStandardScheme getScheme() {
      return new CCMessageStandardScheme();
    }
  }

  private static class CCMessageStandardScheme extends org.apache.thrift.scheme.StandardScheme<CCMessage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CCMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CCMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CCMessageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CCMessageTupleScheme getScheme() {
      return new CCMessageTupleScheme();
    }
  }

  private static class CCMessageTupleScheme extends org.apache.thrift.scheme.TupleScheme<CCMessage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CCMessage struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      struct._baseMessage.write(oprot);
    }

    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CCMessage struct) throws org.apache.thrift.TException {
