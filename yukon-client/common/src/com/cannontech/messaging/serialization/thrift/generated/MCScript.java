...
public class MCScript implements org.apache.thrift.TBase<MCScript, MCScript._Fields>, java.io.Serializable, Cloneable, Comparable<MCScript> {
  ...
  private @org.apache.thrift.annotation.Nullable java.lang.String _contents; // required
  ...
  public void set_contents(@org.apache.thrift.annotation.Nullable java.lang.String _contents) {
    this._contents = _contents;
  }
  ...
  public int compareTo(MCScript other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_name(), other.isSet_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_name()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_contents(), other.isSet_contents());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_contents()) {
