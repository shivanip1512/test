...
public class MCScript implements org.apache.thrift.TBase<MCScript, MCScript._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new MCScriptStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MCScriptTupleSchemeFactory());
  }
  ...
  private String _contents; // required
  ...
  public int compareTo(MCScript other) {
    ...
    MCScript typedOther = (MCScript)other;
    ...
    lastComparison = Boolean.valueOf(isSet_contents()).compareTo(typedOther.isSet_contents());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_contents()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._contents, typedOther._contents);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MCScript(");
    boolean first = true;
  ...
  private static class MCScriptStandardSchemeFactory implements SchemeFactory {
    public MCScriptStandardScheme getScheme() {
      return new MCScriptStandardScheme();
    }
  }

  private static class MCScriptStandardScheme extends StandardScheme<MCScript> {
  ...
  private static class MCScriptTupleSchemeFactory implements SchemeFactory {
    public MCScriptTupleScheme getScheme() {
      return new MCScriptTupleScheme();
    }
  }

  private static class MCScriptTupleScheme extends TupleScheme<MCScript> {
