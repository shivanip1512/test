...
public class LMMessage implements org.apache.thrift.TBase<LMMessage, LMMessage._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new LMMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LMMessageTupleSchemeFactory());
  }
  ...
  public int compareTo(LMMessage other) {
    ...
    LMMessage typedOther = (LMMessage)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LMMessage(");
    boolean first = true;
  ...
  private static class LMMessageStandardSchemeFactory implements SchemeFactory {
    public LMMessageStandardScheme getScheme() {
      return new LMMessageStandardScheme();
    }
  }

  private static class LMMessageStandardScheme extends StandardScheme<LMMessage> {
  ...
  private static class LMMessageTupleSchemeFactory implements SchemeFactory {
    public LMMessageTupleScheme getScheme() {
      return new LMMessageTupleScheme();
    }
  }

  private static class LMMessageTupleScheme extends TupleScheme<LMMessage> {
