...
public class EdgeDrUnicastRequest implements org.apache.thrift.TBase<EdgeDrUnicastRequest, EdgeDrUnicastRequest._Fields>, java.io.Serializable, Cloneable, Comparable<EdgeDrUnicastRequest> {
  ...
  public int compareTo(EdgeDrUnicastRequest other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetQueuePriority()).compareTo(other.isSetQueuePriority());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQueuePriority()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNetworkPriority()).compareTo(other.isSetNetworkPriority());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNetworkPriority()) {
