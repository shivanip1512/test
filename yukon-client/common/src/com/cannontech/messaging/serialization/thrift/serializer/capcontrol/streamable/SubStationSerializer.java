...
public class SubStationSerializer extends
    ...
    @Override
    protected CCSubstationItem createThriftEntityInstance(CCPao entityParent) {
    ...
    @Override
    protected void populateMessageFromThriftEntity(ThriftMessageFactory msgFactory, CCSubstationItem entity,
                                                   SubStation msg) {
    ...
    @Override
    protected void populateThriftEntityFromMessage(ThriftMessageFactory msgFactory, SubStation msg,
                                                   CCSubstationItem entity) {
        // For legacy reasons, the parentId is defined at this level in the Thrift Entity.
        // It is therefore here that the parent field "parentId" is populated in this object
