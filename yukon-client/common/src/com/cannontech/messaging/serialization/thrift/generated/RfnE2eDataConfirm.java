...
public class RfnE2eDataConfirm implements org.apache.thrift.TBase<RfnE2eDataConfirm, RfnE2eDataConfirm._Fields>, java.io.Serializable, Cloneable, Comparable<RfnE2eDataConfirm> {
  ...
  public int compareTo(RfnE2eDataConfirm other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetE2eProtocol(), other.isSetE2eProtocol());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetApplicationServiceId(), other.isSetApplicationServiceId());
    if (lastComparison != 0) {
      return lastComparison;
    }
