...
public class LMDynamicControlAreaData implements org.apache.thrift.TBase<LMDynamicControlAreaData, LMDynamicControlAreaData._Fields>, java.io.Serializable, Cloneable, Comparable<LMDynamicControlAreaData> {
  ...
  public int compareTo(LMDynamicControlAreaData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_nextCheckTime(), other.isSet_nextCheckTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_controlAreaState(), other.isSet_controlAreaState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_currentPriority(), other.isSet_currentPriority());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_currentDailyStartTime(), other.isSet_currentDailyStartTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_currentDailyStopTime(), other.isSet_currentDailyStopTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_triggers(), other.isSet_triggers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_triggers()) {
