...
public class CCState implements org.apache.thrift.TBase<CCState, CCState._Fields>, java.io.Serializable, Cloneable, Comparable<CCState> {
  ...
  public int compareTo(CCState other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_foregroundColor(), other.isSet_foregroundColor());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_backgroundColor(), other.isSet_backgroundColor());
    if (lastComparison != 0) {
      return lastComparison;
    }
