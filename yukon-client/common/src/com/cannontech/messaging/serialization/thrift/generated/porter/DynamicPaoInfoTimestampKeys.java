...
public enum DynamicPaoInfoTimestampKeys implements org.apache.thrift.TEnum {
  RFN_VOLTAGE_PROFILE_ENABLED_UNTIL(0);

  private final int value;

  private DynamicPaoInfoTimestampKeys(int value) {
    this.value = value;
  }
  ...
  public static DynamicPaoInfoTimestampKeys findByValue(int value) { 
    switch (value) {
      case 0:
