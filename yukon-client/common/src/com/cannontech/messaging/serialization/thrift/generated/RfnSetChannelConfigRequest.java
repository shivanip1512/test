...
public class RfnSetChannelConfigRequest implements org.apache.thrift.TBase<RfnSetChannelConfigRequest, RfnSetChannelConfigRequest._Fields>, java.io.Serializable, Cloneable, Comparable<RfnSetChannelConfigRequest> {
  ...
  public int compareTo(RfnSetChannelConfigRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetReportingInterval(), other.isSetReportingInterval());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetRecordingInterval(), other.isSetRecordingInterval());
    if (lastComparison != 0) {
      return lastComparison;
    }
