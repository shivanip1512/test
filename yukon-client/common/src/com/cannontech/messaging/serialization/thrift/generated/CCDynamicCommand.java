...
public class CCDynamicCommand implements org.apache.thrift.TBase<CCDynamicCommand, CCDynamicCommand._Fields>, java.io.Serializable, Cloneable, Comparable<CCDynamicCommand> {
  ...
  public int compareTo(CCDynamicCommand other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_commandType(), other.isSet_commandType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_longParameters(), other.isSet_longParameters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_longParameters()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_doubleParameters(), other.isSet_doubleParameters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_doubleParameters()) {
