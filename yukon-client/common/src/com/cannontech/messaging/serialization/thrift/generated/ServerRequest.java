...
public class ServerRequest implements org.apache.thrift.TBase<ServerRequest, ServerRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new ServerRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ServerRequestTupleSchemeFactory());
  }
  ...
  public int compareTo(ServerRequest other) {
    ...
    ServerRequest typedOther = (ServerRequest)other;
  ...
  private static class ServerRequestStandardSchemeFactory implements SchemeFactory {
    public ServerRequestStandardScheme getScheme() {
      return new ServerRequestStandardScheme();
    }
  }

  private static class ServerRequestStandardScheme extends StandardScheme<ServerRequest> {
  ...
  private static class ServerRequestTupleSchemeFactory implements SchemeFactory {
    public ServerRequestTupleScheme getScheme() {
      return new ServerRequestTupleScheme();
    }
  }

  private static class ServerRequestTupleScheme extends TupleScheme<ServerRequest> {
