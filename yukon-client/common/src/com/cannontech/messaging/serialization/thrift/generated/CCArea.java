...
public class CCArea implements org.apache.thrift.TBase<CCArea, CCArea._Fields>, java.io.Serializable, Cloneable, Comparable<CCArea> {
  ...
  public int compareTo(CCArea other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_substationIds(), other.isSet_substationIds());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_substationIds()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_pfDisplayValue(), other.isSet_pfDisplayValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_estPfDisplayValue(), other.isSet_estPfDisplayValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_voltReductionControlValue(), other.isSet_voltReductionControlValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_childVoltReductionFlag(), other.isSet_childVoltReductionFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
