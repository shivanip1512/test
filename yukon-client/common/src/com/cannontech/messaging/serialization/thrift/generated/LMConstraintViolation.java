...
public class LMConstraintViolation implements org.apache.thrift.TBase<LMConstraintViolation, LMConstraintViolation._Fields>, java.io.Serializable, Cloneable, Comparable<LMConstraintViolation> {
  ...
  public int compareTo(LMConstraintViolation other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_errorCode(), other.isSet_errorCode());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_doubleParams(), other.isSet_doubleParams());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_doubleParams()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_integerParams(), other.isSet_integerParams());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_integerParams()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_stringParams(), other.isSet_stringParams());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_stringParams()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_datetimeParams(), other.isSet_datetimeParams());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_datetimeParams()) {
  ...
  private static class LMConstraintViolationTupleScheme extends org.apache.thrift.scheme.TupleScheme<LMConstraintViolation> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LMConstraintViolation struct) throws org.apache.thrift.TException {
      ...
      struct.set_errorCodeIsSet(true);
      {
        org.apache.thrift.protocol.TList _list20 = iprot.readListBegin(org.apache.thrift.protocol.TType.DOUBLE);
