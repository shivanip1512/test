...
public class Return implements org.apache.thrift.TBase<Return, Return._Fields>, java.io.Serializable, Cloneable, Comparable<Return> {
  ...
  public int compareTo(Return other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_resultString(), other.isSet_resultString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_resultString()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_expectMore(), other.isSet_expectMore());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_expectMore()) {
