...
public class Return implements org.apache.thrift.TBase<Return, Return._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new ReturnStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReturnTupleSchemeFactory());
  }

  private com.cannontech.messaging.serialization.thrift.generated.Multi _baseMessage; // required
  private int _deviceId; // required
  private String _commandString; // required
  private String _resultString; // required
  ...
  public void set_baseMessage(com.cannontech.messaging.serialization.thrift.generated.Multi _baseMessage) {
    this._baseMessage = _baseMessage;
  }
  ...
  public void unset_expectMore() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___EXPECTMORE_ISSET_ID);
  }

  /** Returns true if field _expectMore is set (has been assigned a value) and false otherwise */
  public boolean isSet_expectMore() {
    return EncodingUtils.testBit(__isset_bitfield, ___EXPECTMORE_ISSET_ID);
  }

  public void set_expectMoreIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___EXPECTMORE_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _EXPECT_MORE:
      return Boolean.valueOf(is_expectMore());
  ...
  public int compareTo(Return other) {
    ...
    Return typedOther = (Return)other;
    ...
    lastComparison = Boolean.valueOf(isSet_resultString()).compareTo(typedOther.isSet_resultString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_resultString()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._resultString, typedOther._resultString);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSet_expectMore()).compareTo(typedOther.isSet_expectMore());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_expectMore()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._expectMore, typedOther._expectMore);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ReturnStandardSchemeFactory implements SchemeFactory {
    public ReturnStandardScheme getScheme() {
      return new ReturnStandardScheme();
    }
  }

  private static class ReturnStandardScheme extends StandardScheme<Return> {
  ...
  private static class ReturnTupleSchemeFactory implements SchemeFactory {
    public ReturnTupleScheme getScheme() {
      return new ReturnTupleScheme();
    }
  }

  private static class ReturnTupleScheme extends TupleScheme<Return> {
