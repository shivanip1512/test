...
public class EdgeDrDataNotificationDeserializer extends SimpleThriftSerializer
        implements ThriftByteDeserializer<EdgeDrDataNotification> {
    ...
    public EdgeDrDataNotification fromBytes(byte[] msgBytes) {
        ...
        return new EdgeDrDataNotification(thriftMessage.getPaoId(), thriftMessage.getPayload(), thriftMessage.getE2eId(), error);
    }
