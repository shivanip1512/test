...
public class CCVerifyInactiveBanks implements org.apache.thrift.TBase<CCVerifyInactiveBanks, CCVerifyInactiveBanks._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new CCVerifyInactiveBanksStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CCVerifyInactiveBanksTupleSchemeFactory());
  }
  ...
  public void unset_bankInactiveTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___BANKINACTIVETIME_ISSET_ID);
  }
  ...
  public boolean isSet_bankInactiveTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___BANKINACTIVETIME_ISSET_ID);
  }

  public void set_bankInactiveTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___BANKINACTIVETIME_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case _BANK_INACTIVE_TIME:
      if (value == null) {
        ...
        set_bankInactiveTime((Integer)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _BANK_INACTIVE_TIME:
      return Integer.valueOf(get_bankInactiveTime());
  ...
  public int compareTo(CCVerifyInactiveBanks other) {
    ...
    CCVerifyInactiveBanks typedOther = (CCVerifyInactiveBanks)other;
    ...
    lastComparison = Boolean.valueOf(isSet_bankInactiveTime()).compareTo(typedOther.isSet_bankInactiveTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_bankInactiveTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._bankInactiveTime, typedOther._bankInactiveTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CCVerifyInactiveBanks(");
    boolean first = true;
  ...
  private static class CCVerifyInactiveBanksStandardSchemeFactory implements SchemeFactory {
    public CCVerifyInactiveBanksStandardScheme getScheme() {
      return new CCVerifyInactiveBanksStandardScheme();
    }
  }

  private static class CCVerifyInactiveBanksStandardScheme extends StandardScheme<CCVerifyInactiveBanks> {
  ...
  private static class CCVerifyInactiveBanksTupleSchemeFactory implements SchemeFactory {
    public CCVerifyInactiveBanksTupleScheme getScheme() {
      return new CCVerifyInactiveBanksTupleScheme();
    }
  }

  private static class CCVerifyInactiveBanksTupleScheme extends TupleScheme<CCVerifyInactiveBanks> {
