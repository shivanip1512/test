...
public class LMControlAreaItem implements org.apache.thrift.TBase<LMControlAreaItem, LMControlAreaItem._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField _DEF_DAILY_START_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("_defDailyStartTime", org.apache.thrift.protocol.TType.I64, (short)11);
  private static final org.apache.thrift.protocol.TField _DEF_DAILY_STOP_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("_defDailyStopTime", org.apache.thrift.protocol.TType.I64, (short)12);
  ...
  private static final org.apache.thrift.protocol.TField _CURRENT_DAILY_START_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("_currentDailyStartTime", org.apache.thrift.protocol.TType.I64, (short)20);
  private static final org.apache.thrift.protocol.TField _CURRENT_DAILY_STOP_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("_currentDailyStopTime", org.apache.thrift.protocol.TType.I64, (short)21);
  ...
  static {
    schemes.put(StandardScheme.class, new LMControlAreaItemStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LMControlAreaItemTupleSchemeFactory());
  }
  ...
  private String _defOperationalState; // required
  private int _controlInterval; // required
  private int _minResponseTime; // required
  private long _defDailyStartTime; // required
  private long _defDailyStopTime; // required
  ...
  private long _currentDailyStartTime; // required
  private long _currentDailyStopTime; // required
  private List<LMControlAreaTrigger> _lmControlAreaTriggers; // required
  private List<com.cannontech.messaging.serialization.thrift.generated.GenericMessage> _lmPrograms; // required
  ...
  public LMControlAreaItem(
    ...
    List<LMControlAreaTrigger> _lmControlAreaTriggers,
    List<com.cannontech.messaging.serialization.thrift.generated.GenericMessage> _lmPrograms)
  {
    this();
    this._paoId = _paoId;
    set_paoIdIsSet(true);
  ...
  public LMControlAreaItem(LMControlAreaItem other) {
    ...
    if (other.isSet_lmControlAreaTriggers()) {
      List<LMControlAreaTrigger> __this___lmControlAreaTriggers = new ArrayList<LMControlAreaTrigger>();
    ...
    if (other.isSet_lmPrograms()) {
      List<com.cannontech.messaging.serialization.thrift.generated.GenericMessage> __this___lmPrograms = new ArrayList<com.cannontech.messaging.serialization.thrift.generated.GenericMessage>();
  ...
  public String get_defOperationalState() {
    return this._defOperationalState;
  }

  public void set_defOperationalState(String _defOperationalState) {
    this._defOperationalState = _defOperationalState;
  }
  ...
  public void unset_controlInterval() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___CONTROLINTERVAL_ISSET_ID);
  }
  ...
  public boolean isSet_controlInterval() {
    return EncodingUtils.testBit(__isset_bitfield, ___CONTROLINTERVAL_ISSET_ID);
  }

  public void set_controlIntervalIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___CONTROLINTERVAL_ISSET_ID, value);
  }
  ...
  public void unset_minResponseTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___MINRESPONSETIME_ISSET_ID);
  }
  ...
  public boolean isSet_minResponseTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___MINRESPONSETIME_ISSET_ID);
  }

  public void set_minResponseTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___MINRESPONSETIME_ISSET_ID, value);
  }

  public long get_defDailyStartTime() {
    return this._defDailyStartTime;
  }

  public void set_defDailyStartTime(long _defDailyStartTime) {
    this._defDailyStartTime = _defDailyStartTime;
    set_defDailyStartTimeIsSet(true);
  }

  public void unset_defDailyStartTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___DEFDAILYSTARTTIME_ISSET_ID);
  }
  ...
  public boolean isSet_defDailyStartTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___DEFDAILYSTARTTIME_ISSET_ID);
  }

  public void set_defDailyStartTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___DEFDAILYSTARTTIME_ISSET_ID, value);
  }

  public long get_defDailyStopTime() {
    return this._defDailyStopTime;
  }

  public void set_defDailyStopTime(long _defDailyStopTime) {
    this._defDailyStopTime = _defDailyStopTime;
    set_defDailyStopTimeIsSet(true);
  }

  public void unset_defDailyStopTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___DEFDAILYSTOPTIME_ISSET_ID);
  }
  ...
  public boolean isSet_defDailyStopTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___DEFDAILYSTOPTIME_ISSET_ID);
  }

  public void set_defDailyStopTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___DEFDAILYSTOPTIME_ISSET_ID, value);
  }
  ...
  public void unset_requireAllTriggersActiveFlag() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___REQUIREALLTRIGGERSACTIVEFLAG_ISSET_ID);
  }
  ...
  public boolean isSet_requireAllTriggersActiveFlag() {
    return EncodingUtils.testBit(__isset_bitfield, ___REQUIREALLTRIGGERSACTIVEFLAG_ISSET_ID);
  }

  public void set_requireAllTriggersActiveFlagIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___REQUIREALLTRIGGERSACTIVEFLAG_ISSET_ID, value);
  }
  ...
  public void unset_updatedFlag() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___UPDATEDFLAG_ISSET_ID);
  }

  /** Returns true if field _updatedFlag is set (has been assigned a value) and false otherwise */
  public boolean isSet_updatedFlag() {
    return EncodingUtils.testBit(__isset_bitfield, ___UPDATEDFLAG_ISSET_ID);
  }

  public void set_updatedFlagIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___UPDATEDFLAG_ISSET_ID, value);
  }
  ...
  public void unset_controlAreaStatusPointId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___CONTROLAREASTATUSPOINTID_ISSET_ID);
  }
  ...
  public boolean isSet_controlAreaStatusPointId() {
    return EncodingUtils.testBit(__isset_bitfield, ___CONTROLAREASTATUSPOINTID_ISSET_ID);
  }

  public void set_controlAreaStatusPointIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___CONTROLAREASTATUSPOINTID_ISSET_ID, value);
  }
  ...
  public long get_currentDailyStartTime() {
    return this._currentDailyStartTime;
  }

  public void set_currentDailyStartTime(long _currentDailyStartTime) {
    this._currentDailyStartTime = _currentDailyStartTime;
    set_currentDailyStartTimeIsSet(true);
  }
  ...
  public long get_currentDailyStopTime() {
    return this._currentDailyStopTime;
  }

  public void set_currentDailyStopTime(long _currentDailyStopTime) {
    this._currentDailyStopTime = _currentDailyStopTime;
    set_currentDailyStopTimeIsSet(true);
  }
  ...
  public void addTo_lmControlAreaTriggers(LMControlAreaTrigger elem) {
    if (this._lmControlAreaTriggers == null) {
      this._lmControlAreaTriggers = new ArrayList<LMControlAreaTrigger>();
    }
    this._lmControlAreaTriggers.add(elem);
  }

  public List<LMControlAreaTrigger> get_lmControlAreaTriggers() {
    return this._lmControlAreaTriggers;
  }

  public void set_lmControlAreaTriggers(List<LMControlAreaTrigger> _lmControlAreaTriggers) {
    this._lmControlAreaTriggers = _lmControlAreaTriggers;
  }
  ...
  public void addTo_lmPrograms(com.cannontech.messaging.serialization.thrift.generated.GenericMessage elem) {
    if (this._lmPrograms == null) {
      this._lmPrograms = new ArrayList<com.cannontech.messaging.serialization.thrift.generated.GenericMessage>();
    }
    this._lmPrograms.add(elem);
  }

  public List<com.cannontech.messaging.serialization.thrift.generated.GenericMessage> get_lmPrograms() {
    return this._lmPrograms;
  }

  public void set_lmPrograms(List<com.cannontech.messaging.serialization.thrift.generated.GenericMessage> _lmPrograms) {
    this._lmPrograms = _lmPrograms;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case _DEF_OPERATIONAL_STATE:
      if (value == null) {
        ...
        set_defOperationalState((String)value);
      }
      break;
    ...
    case _CONTROL_INTERVAL:
      if (value == null) {
        ...
        set_controlInterval((Integer)value);
      }
      break;
    ...
    case _MIN_RESPONSE_TIME:
      if (value == null) {
        ...
        set_minResponseTime((Integer)value);
      }
      break;
    ...
    case _DEF_DAILY_START_TIME:
      if (value == null) {
        ...
        set_defDailyStartTime((Long)value);
      }
      break;
    ...
    case _DEF_DAILY_STOP_TIME:
      if (value == null) {
        ...
        set_defDailyStopTime((Long)value);
      }
      break;
    ...
    case _REQUIRE_ALL_TRIGGERS_ACTIVE_FLAG:
      if (value == null) {
        ...
        set_requireAllTriggersActiveFlag((Boolean)value);
      }
      break;
    ...
    case _CONTROL_AREA_STATUS_POINT_ID:
      if (value == null) {
        ...
        set_controlAreaStatusPointId((Integer)value);
      }
      break;
    ...
    case _CURRENT_DAILY_START_TIME:
      if (value == null) {
        ...
        set_currentDailyStartTime((Long)value);
      }
      break;
    ...
    case _CURRENT_DAILY_STOP_TIME:
      if (value == null) {
        ...
        set_currentDailyStopTime((Long)value);
      }
      break;
    ...
    case _LM_CONTROL_AREA_TRIGGERS:
      if (value == null) {
        ...
        set_lmControlAreaTriggers((List<LMControlAreaTrigger>)value);
      }
      break;
    ...
    case _LM_PROGRAMS:
      if (value == null) {
        ...
        set_lmPrograms((List<com.cannontech.messaging.serialization.thrift.generated.GenericMessage>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _CONTROL_INTERVAL:
      return Integer.valueOf(get_controlInterval());

    case _MIN_RESPONSE_TIME:
      return Integer.valueOf(get_minResponseTime());

    case _DEF_DAILY_START_TIME:
      return Long.valueOf(get_defDailyStartTime());

    case _DEF_DAILY_STOP_TIME:
      return Long.valueOf(get_defDailyStopTime());

    case _REQUIRE_ALL_TRIGGERS_ACTIVE_FLAG:
      return Boolean.valueOf(is_requireAllTriggersActiveFlag());
    ...
    case _UPDATED_FLAG:
      return Boolean.valueOf(is_updatedFlag());

    case _CONTROL_AREA_STATUS_POINT_ID:
      return Integer.valueOf(get_controlAreaStatusPointId());
    ...
    case _CURRENT_DAILY_START_TIME:
      return Long.valueOf(get_currentDailyStartTime());

    case _CURRENT_DAILY_STOP_TIME:
      return Long.valueOf(get_currentDailyStopTime());
  ...
  public int compareTo(LMControlAreaItem other) {
    ...
    LMControlAreaItem typedOther = (LMControlAreaItem)other;
    ...
    lastComparison = Boolean.valueOf(isSet_defOperationalState()).compareTo(typedOther.isSet_defOperationalState());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_defOperationalState()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._defOperationalState, typedOther._defOperationalState);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_controlInterval()).compareTo(typedOther.isSet_controlInterval());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_controlInterval()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._controlInterval, typedOther._controlInterval);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_minResponseTime()).compareTo(typedOther.isSet_minResponseTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_minResponseTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._minResponseTime, typedOther._minResponseTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_defDailyStartTime()).compareTo(typedOther.isSet_defDailyStartTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_defDailyStartTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._defDailyStartTime, typedOther._defDailyStartTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_defDailyStopTime()).compareTo(typedOther.isSet_defDailyStopTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_defDailyStopTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._defDailyStopTime, typedOther._defDailyStopTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_requireAllTriggersActiveFlag()).compareTo(typedOther.isSet_requireAllTriggersActiveFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_requireAllTriggersActiveFlag()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._requireAllTriggersActiveFlag, typedOther._requireAllTriggersActiveFlag);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSet_updatedFlag()).compareTo(typedOther.isSet_updatedFlag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_updatedFlag()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._updatedFlag, typedOther._updatedFlag);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_controlAreaStatusPointId()).compareTo(typedOther.isSet_controlAreaStatusPointId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_controlAreaStatusPointId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._controlAreaStatusPointId, typedOther._controlAreaStatusPointId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSet_lmControlAreaTriggers()).compareTo(typedOther.isSet_lmControlAreaTriggers());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_lmControlAreaTriggers()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._lmControlAreaTriggers, typedOther._lmControlAreaTriggers);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_lmPrograms()).compareTo(typedOther.isSet_lmPrograms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_lmPrograms()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._lmPrograms, typedOther._lmPrograms);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("LMControlAreaItem(");
    boolean first = true;
  ...
  private static class LMControlAreaItemStandardSchemeFactory implements SchemeFactory {
    public LMControlAreaItemStandardScheme getScheme() {
      return new LMControlAreaItemStandardScheme();
    }
  }

  private static class LMControlAreaItemStandardScheme extends StandardScheme<LMControlAreaItem> {
        ...
        switch (schemeField.id) {
          ...
          case 11: // _DEF_DAILY_START_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct._defDailyStartTime = iprot.readI64();
          ...
          case 12: // _DEF_DAILY_STOP_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct._defDailyStopTime = iprot.readI64();
          ...
          case 20: // _CURRENT_DAILY_START_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct._currentDailyStartTime = iprot.readI64();
          ...
          case 21: // _CURRENT_DAILY_STOP_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct._currentDailyStopTime = iprot.readI64();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct._lmControlAreaTriggers = new ArrayList<LMControlAreaTrigger>(_list96.size);
                for (int _i97 = 0; _i97 < _list96.size; ++_i97)
                {
                  LMControlAreaTrigger _elem98; // required
                  _elem98 = new LMControlAreaTrigger();
                  _elem98.read(iprot);
                  struct._lmControlAreaTriggers.add(_elem98);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct._lmPrograms = new ArrayList<com.cannontech.messaging.serialization.thrift.generated.GenericMessage>(_list99.size);
                for (int _i100 = 0; _i100 < _list99.size; ++_i100)
                {
                  com.cannontech.messaging.serialization.thrift.generated.GenericMessage _elem101; // required
                  _elem101 = new com.cannontech.messaging.serialization.thrift.generated.GenericMessage();
                  _elem101.read(iprot);
                  struct._lmPrograms.add(_elem101);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LMControlAreaItem struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct._defDailyStartTime);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(_DEF_DAILY_STOP_TIME_FIELD_DESC);
      oprot.writeI64(struct._defDailyStopTime);
      oprot.writeFieldEnd();
      ...
      oprot.writeI64(struct._currentDailyStartTime);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(_CURRENT_DAILY_STOP_TIME_FIELD_DESC);
      oprot.writeI64(struct._currentDailyStopTime);
      oprot.writeFieldEnd();
  ...
  private static class LMControlAreaItemTupleSchemeFactory implements SchemeFactory {
    public LMControlAreaItemTupleScheme getScheme() {
      return new LMControlAreaItemTupleScheme();
    }
  }

  private static class LMControlAreaItemTupleScheme extends TupleScheme<LMControlAreaItem> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LMControlAreaItem struct) throws org.apache.thrift.TException {
      ...
      struct.set_currentDailyStopTimeIsSet(true);
      {
        ...
        struct._lmControlAreaTriggers = new ArrayList<LMControlAreaTrigger>(_list106.size);
        for (int _i107 = 0; _i107 < _list106.size; ++_i107)
        {
          LMControlAreaTrigger _elem108; // required
          _elem108 = new LMControlAreaTrigger();
          _elem108.read(iprot);
          struct._lmControlAreaTriggers.add(_elem108);
        }
      }
      struct.set_lmControlAreaTriggersIsSet(true);
      {
        org.apache.thrift.protocol.TList _list109 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct._lmPrograms = new ArrayList<com.cannontech.messaging.serialization.thrift.generated.GenericMessage>(_list109.size);
        for (int _i110 = 0; _i110 < _list109.size; ++_i110)
        {
          com.cannontech.messaging.serialization.thrift.generated.GenericMessage _elem111; // required
          _elem111 = new com.cannontech.messaging.serialization.thrift.generated.GenericMessage();
          _elem111.read(iprot);
          struct._lmPrograms.add(_elem111);
        }
      }
      struct.set_lmProgramsIsSet(true);
    }
