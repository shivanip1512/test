...
public class MCVerifyScript implements org.apache.thrift.TBase<MCVerifyScript, MCVerifyScript._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MCVerifyScript");
  ...
  static {
    schemes.put(StandardScheme.class, new MCVerifyScriptStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MCVerifyScriptTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MCVerifyScript.class, metaDataMap);
  }

  public MCVerifyScript() {
  }
   ...
   */
  public MCVerifyScript(MCVerifyScript other) {
  ...
  public MCVerifyScript deepCopy() {
    return new MCVerifyScript(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MCVerifyScript)
      return this.equals((MCVerifyScript)that);
    return false;
  }

  public boolean equals(MCVerifyScript that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MCVerifyScript other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    MCVerifyScript typedOther = (MCVerifyScript)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MCVerifyScript(");
    boolean first = true;
  ...
  private static class MCVerifyScriptStandardSchemeFactory implements SchemeFactory {
    public MCVerifyScriptStandardScheme getScheme() {
      return new MCVerifyScriptStandardScheme();
    }
  }

  private static class MCVerifyScriptStandardScheme extends StandardScheme<MCVerifyScript> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MCVerifyScript struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MCVerifyScript struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MCVerifyScriptTupleSchemeFactory implements SchemeFactory {
    public MCVerifyScriptTupleScheme getScheme() {
      return new MCVerifyScriptTupleScheme();
    }
  }

  private static class MCVerifyScriptTupleScheme extends TupleScheme<MCVerifyScript> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MCVerifyScript struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MCVerifyScript struct) throws org.apache.thrift.TException {
