...
public class DirectGroupBaseSerializer extends ThriftSerializer<LMDirectGroupBase, LMGroupBase> {
    ...
    @Override
    public Class<LMDirectGroupBase> getTargetMessageClass() {
        return LMDirectGroupBase.class;
    }

    @Override
    protected LMDirectGroupBase createMessageInstance() {
        return null;
    }

    @Override
    protected LMGroupBase createThriftEntityInstance() {
        return new LMGroupBase();
    }

    @Override
    protected void populateMessageFromThriftEntity(ThriftMessageFactory msgFactory, LMGroupBase entity,
                                                   LMDirectGroupBase msg) {
    ...
    @Override
    protected void populateThriftEntityFromMessage(ThriftMessageFactory msgFactory, LMDirectGroupBase msg,
                                                   LMGroupBase entity) {
        /*
