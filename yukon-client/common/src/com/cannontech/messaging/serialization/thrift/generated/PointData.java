...
public class PointData implements org.apache.thrift.TBase<PointData, PointData._Fields>, java.io.Serializable, Cloneable, Comparable<PointData> {
  ...
  public int compareTo(PointData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_type(), other.isSet_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_type()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_quality(), other.isSet_quality());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_quality()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_str(), other.isSet_str());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_str()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_time(), other.isSet_time());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_time()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_millis(), other.isSet_millis());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_millis()) {
