...
public class Trace implements org.apache.thrift.TBase<Trace, Trace._Fields>, java.io.Serializable, Cloneable, Comparable<Trace> {
  ...
  public int compareTo(Trace other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_end(), other.isSet_end());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_end()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_attributes(), other.isSet_attributes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_attributes()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_trace(), other.isSet_trace());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_trace()) {
