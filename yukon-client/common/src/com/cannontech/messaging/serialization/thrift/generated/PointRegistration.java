...
public class PointRegistration implements org.apache.thrift.TBase<PointRegistration, PointRegistration._Fields>, java.io.Serializable, Cloneable, Comparable<PointRegistration> {
  ...
  public int compareTo(PointRegistration other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_regFlags(), other.isSet_regFlags());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_regFlags()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_pointList(), other.isSet_pointList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_pointList()) {
