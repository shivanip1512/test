...
public class RequestCancel implements org.apache.thrift.TBase<RequestCancel, RequestCancel._Fields>, java.io.Serializable, Cloneable, Comparable<RequestCancel> {
  ...
  public int compareTo(RequestCancel other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_RequestId(), other.isSet_RequestId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_RequestId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_RequestIdCount(), other.isSet_RequestIdCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_UserMessageId(), other.isSet_UserMessageId());
    if (lastComparison != 0) {
      return lastComparison;
    }
