...
public class CCChangeOpState implements org.apache.thrift.TBase<CCChangeOpState, CCChangeOpState._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new CCChangeOpStateStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CCChangeOpStateTupleSchemeFactory());
  }

  private com.cannontech.messaging.serialization.thrift.generated.CCItemCommand _baseMessage; // required
  private String _opStateName; // required
  ...
  public String get_opStateName() {
    return this._opStateName;
  }

  public void set_opStateName(String _opStateName) {
    this._opStateName = _opStateName;
  }
  ...
  public int compareTo(CCChangeOpState other) {
    ...
    CCChangeOpState typedOther = (CCChangeOpState)other;
    ...
    lastComparison = Boolean.valueOf(isSet_opStateName()).compareTo(typedOther.isSet_opStateName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opStateName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._opStateName, typedOther._opStateName);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CCChangeOpState(");
    boolean first = true;
  ...
  private static class CCChangeOpStateStandardSchemeFactory implements SchemeFactory {
    public CCChangeOpStateStandardScheme getScheme() {
      return new CCChangeOpStateStandardScheme();
    }
  }

  private static class CCChangeOpStateStandardScheme extends StandardScheme<CCChangeOpState> {
  ...
  private static class CCChangeOpStateTupleSchemeFactory implements SchemeFactory {
    public CCChangeOpStateTupleScheme getScheme() {
      return new CCChangeOpStateTupleScheme();
    }
  }

  private static class CCChangeOpStateTupleScheme extends TupleScheme<CCChangeOpState> {
