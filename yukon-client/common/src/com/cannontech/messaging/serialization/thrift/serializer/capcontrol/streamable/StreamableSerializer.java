...
public class StreamableSerializer extends ThriftSerializer<StreamableCapObject, CCPao> {
    ...
    @Override
    protected CCPao createThrifEntityInstance() {
        return new CCPao();
    }

    @Override
    protected void populateMessageFromThriftEntity(ThriftMessageFactory msgFactory, CCPao entity, StreamableCapObject msg) {
        msg.setCcDescription(entity.get_paoDescription());
    ...
    @Override
    protected void populateThriftEntityFromMessage(ThriftMessageFactory msgFactory, StreamableCapObject msg, CCPao entity) {
        entity.set_disableFlag(msg.getCcDisableFlag());
        entity.set_paoCategory(msg.getCcCategory());
        entity.set_paoClass(msg.getCcClass());
        entity.set_paoDescription(msg.getCcDescription());
