...
public class LMManualControlResponse implements org.apache.thrift.TBase<LMManualControlResponse, LMManualControlResponse._Fields>, java.io.Serializable, Cloneable, Comparable<LMManualControlResponse> {
  ...
  public int compareTo(LMManualControlResponse other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_constraintViolations(), other.isSet_constraintViolations());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_constraintViolations()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_bestFitAction(), other.isSet_bestFitAction());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_bestFitAction()) {
