...
public class NotifCurtailmentEventDelete implements org.apache.thrift.TBase<NotifCurtailmentEventDelete, NotifCurtailmentEventDelete._Fields>, java.io.Serializable, Cloneable, Comparable<NotifCurtailmentEventDelete> {
  ...
  public int compareTo(NotifCurtailmentEventDelete other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_curtailmentEventId(), other.isSet_curtailmentEventId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_deleteStart(), other.isSet_deleteStart());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_deleteStop(), other.isSet_deleteStop());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_deleteStop()) {
