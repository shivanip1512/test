...
public class LMEatonCloudStopCommand implements org.apache.thrift.TBase<LMEatonCloudStopCommand, LMEatonCloudStopCommand._Fields>, java.io.Serializable, Cloneable, Comparable<LMEatonCloudStopCommand> {
  ...
  public int compareTo(LMEatonCloudStopCommand other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_restoreTime(), other.isSet_restoreTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_stopType(), other.isSet_stopType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_stopType()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_vRelayId(), other.isSet_vRelayId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_vRelayId()) {
