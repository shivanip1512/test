...
public class LMEcobeeSetpointControlCommand implements org.apache.thrift.TBase<LMEcobeeSetpointControlCommand, LMEcobeeSetpointControlCommand._Fields>, java.io.Serializable, Cloneable, Comparable<LMEcobeeSetpointControlCommand> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("LMEcobeeSetpointControlCommand");
  ...
  private static final org.apache.thrift.protocol.TField _TEMPERATURE_OFFSET_FIELD_DESC = new org.apache.thrift.protocol.TField("_temperatureOffset", org.apache.thrift.protocol.TType.I32, (short)7);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new LMEcobeeSetpointControlCommandStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new LMEcobeeSetpointControlCommandTupleSchemeFactory();
  ...
  private int _temperatureOffset; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    _TEMPERATURE_OFFSET((short)7, "_temperatureOffset");
  ...
  private static final int ___ISMANDATORY_ISSET_ID = 4;
  private static final int ___TEMPERATUREOFFSET_ISSET_ID = 5;
  ...
  static {
    ...
    tmpMap.put(_Fields._TEMPERATURE_OFFSET, new org.apache.thrift.meta_data.FieldMetaData("_temperatureOffset", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(LMEcobeeSetpointControlCommand.class, metaDataMap);
  }

  public LMEcobeeSetpointControlCommand() {
  }
    ...
    int _temperatureOffset)
  {
    ...
    this._temperatureOffset = _temperatureOffset;
    set_temperatureOffsetIsSet(true);
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public LMEcobeeSetpointControlCommand(LMEcobeeSetpointControlCommand other) {
    ...
    this._temperatureOffset = other._temperatureOffset;
  }

  public LMEcobeeSetpointControlCommand deepCopy() {
    return new LMEcobeeSetpointControlCommand(this);
  }
  ...
  public void clear() {
    ...
    set_temperatureOffsetIsSet(false);
    this._temperatureOffset = 0;
  }
  ...
  public int get_temperatureOffset() {
    return this._temperatureOffset;
  }

  public void set_temperatureOffset(int _temperatureOffset) {
    this._temperatureOffset = _temperatureOffset;
    set_temperatureOffsetIsSet(true);
  }

  public void unset_temperatureOffset() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, ___TEMPERATUREOFFSET_ISSET_ID);
  }

  /** Returns true if field _temperatureOffset is set (has been assigned a value) and false otherwise */
  public boolean isSet_temperatureOffset() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, ___TEMPERATUREOFFSET_ISSET_ID);
  }

  public void set_temperatureOffsetIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, ___TEMPERATUREOFFSET_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case _TEMPERATURE_OFFSET:
      if (value == null) {
        unset_temperatureOffset();
      } else {
        set_temperatureOffset((java.lang.Integer)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case _TEMPERATURE_OFFSET:
      return isSet_temperatureOffset();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof LMEcobeeSetpointControlCommand)
      return this.equals((LMEcobeeSetpointControlCommand)that);
    return false;
  }

  public boolean equals(LMEcobeeSetpointControlCommand that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present__temperatureOffset = true;
    boolean that_present__temperatureOffset = true;
    if (this_present__temperatureOffset || that_present__temperatureOffset) {
      if (!(this_present__temperatureOffset && that_present__temperatureOffset))
        return false;
      if (this._temperatureOffset != that._temperatureOffset)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + _temperatureOffset;

    return hashCode;
  }

  @Override
  public int compareTo(LMEcobeeSetpointControlCommand other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_programId(), other.isSet_programId());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_groupId(), other.isSet_groupId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_groupId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_controlStartDateTime(), other.isSet_controlStartDateTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_controlEndDateTime(), other.isSet_controlEndDateTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_temperatureOption(), other.isSet_temperatureOption());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_temperatureOption()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_isMandatory(), other.isSet_isMandatory());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_temperatureOffset(), other.isSet_temperatureOffset());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_temperatureOffset()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._temperatureOffset, other._temperatureOffset);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("LMEcobeeSetpointControlCommand(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("_temperatureOffset:");
    sb.append(this._temperatureOffset);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSet_temperatureOffset()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field '_temperatureOffset' is unset! Struct:" + toString());
    }
  ...
  private static class LMEcobeeSetpointControlCommandStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public LMEcobeeSetpointControlCommandStandardScheme getScheme() {
      return new LMEcobeeSetpointControlCommandStandardScheme();
    }
  }

  private static class LMEcobeeSetpointControlCommandStandardScheme extends org.apache.thrift.scheme.StandardScheme<LMEcobeeSetpointControlCommand> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, LMEcobeeSetpointControlCommand struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // _TEMPERATURE_OFFSET
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct._temperatureOffset = iprot.readI32();
              struct.set_temperatureOffsetIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LMEcobeeSetpointControlCommand struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(_TEMPERATURE_OFFSET_FIELD_DESC);
      oprot.writeI32(struct._temperatureOffset);
      oprot.writeFieldEnd();
  ...
  private static class LMEcobeeSetpointControlCommandTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public LMEcobeeSetpointControlCommandTupleScheme getScheme() {
      return new LMEcobeeSetpointControlCommandTupleScheme();
    }
  }

  private static class LMEcobeeSetpointControlCommandTupleScheme extends org.apache.thrift.scheme.TupleScheme<LMEcobeeSetpointControlCommand> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, LMEcobeeSetpointControlCommand struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, LMEcobeeSetpointControlCommand struct) throws org.apache.thrift.TException {
