...
public class LMCommand implements org.apache.thrift.TBase<LMCommand, LMCommand._Fields>, java.io.Serializable, Cloneable, Comparable<LMCommand> {
  ...
  public int compareTo(LMCommand other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_number(), other.isSet_number());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_number()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_count(), other.isSet_count());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_count()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_auxId(), other.isSet_auxId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_auxId()) {
