...
public class LMEnergyExchangeControl implements org.apache.thrift.TBase<LMEnergyExchangeControl, LMEnergyExchangeControl._Fields>, java.io.Serializable, Cloneable, Comparable<LMEnergyExchangeControl> {
  ...
  public int compareTo(LMEnergyExchangeControl other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_offerDate(), other.isSet_offerDate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_offerDate()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_expirationDatetime(), other.isSet_expirationDatetime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_amountsRequested(), other.isSet_amountsRequested());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_amountsRequested()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_pricesOffered(), other.isSet_pricesOffered());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_pricesOffered()) {
