...
public class QueueData implements org.apache.thrift.TBase<QueueData, QueueData._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new QueueDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueueDataTupleSchemeFactory());
  }
  ...
  public void unset_queueCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___QUEUECOUNT_ISSET_ID);
  }

  /** Returns true if field _queueCount is set (has been assigned a value) and false otherwise */
  public boolean isSet_queueCount() {
    return EncodingUtils.testBit(__isset_bitfield, ___QUEUECOUNT_ISSET_ID);
  }

  public void set_queueCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___QUEUECOUNT_ISSET_ID, value);
  }
  ...
  public void unset_rate() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___RATE_ISSET_ID);
  }

  /** Returns true if field _rate is set (has been assigned a value) and false otherwise */
  public boolean isSet_rate() {
    return EncodingUtils.testBit(__isset_bitfield, ___RATE_ISSET_ID);
  }

  public void set_rateIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___RATE_ISSET_ID, value);
  }
  ...
  public void unset_aTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___ATIME_ISSET_ID);
  }

  /** Returns true if field _aTime is set (has been assigned a value) and false otherwise */
  public boolean isSet_aTime() {
    return EncodingUtils.testBit(__isset_bitfield, ___ATIME_ISSET_ID);
  }

  public void set_aTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___ATIME_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _QUEUE_COUNT:
      return Integer.valueOf(get_queueCount());

    case _RATE:
      return Integer.valueOf(get_rate());
  ...
  public int compareTo(QueueData other) {
    ...
    QueueData typedOther = (QueueData)other;
    ...
    lastComparison = Boolean.valueOf(isSet_queueCount()).compareTo(typedOther.isSet_queueCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_queueCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._queueCount, typedOther._queueCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_rate()).compareTo(typedOther.isSet_rate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_rate()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._rate, typedOther._rate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSet_aTime()).compareTo(typedOther.isSet_aTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_aTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._aTime, typedOther._aTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class QueueDataStandardSchemeFactory implements SchemeFactory {
    public QueueDataStandardScheme getScheme() {
      return new QueueDataStandardScheme();
    }
  }

  private static class QueueDataStandardScheme extends StandardScheme<QueueData> {
  ...
  private static class QueueDataTupleSchemeFactory implements SchemeFactory {
    public QueueDataTupleScheme getScheme() {
      return new QueueDataTupleScheme();
    }
  }

  private static class QueueDataTupleScheme extends TupleScheme<QueueData> {
