...
public class QueueData implements org.apache.thrift.TBase<QueueData, QueueData._Fields>, java.io.Serializable, Cloneable, Comparable<QueueData> {
  ...
  public int compareTo(QueueData other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_queueCount(), other.isSet_queueCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_queueCount()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_rate(), other.isSet_rate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_rate()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_aTime(), other.isSet_aTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_aTime()) {
