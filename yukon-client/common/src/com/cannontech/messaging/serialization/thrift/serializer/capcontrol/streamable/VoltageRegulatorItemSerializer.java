...
public class VoltageRegulatorItemSerializer extends
    ...
    @Override
    protected CCVoltageRegulatorItem createThriftEntityInstance(CCPao entityParent) {
    ...
    @Override
    protected void populateMessageFromThriftEntity(ThriftMessageFactory msgFactory, CCVoltageRegulatorItem entity,
                                                   VoltageRegulatorFlags msg) {
    ...
    @Override
    protected void populateThriftEntityFromMessage(ThriftMessageFactory msgFactory, VoltageRegulatorFlags msg,
                                                   CCVoltageRegulatorItem entity) {
