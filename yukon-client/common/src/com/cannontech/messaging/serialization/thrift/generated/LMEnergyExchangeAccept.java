...
public class LMEnergyExchangeAccept implements org.apache.thrift.TBase<LMEnergyExchangeAccept, LMEnergyExchangeAccept._Fields>, java.io.Serializable, Cloneable, Comparable<LMEnergyExchangeAccept> {
  ...
  public int compareTo(LMEnergyExchangeAccept other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_acceptStatus(), other.isSet_acceptStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_acceptStatus()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_ipAddressOfAcceptUser(), other.isSet_ipAddressOfAcceptUser());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_ipAddressOfAcceptUser()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_userIdName(), other.isSet_userIdName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_userIdName()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_nameOfAcceptPerson(), other.isSet_nameOfAcceptPerson());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_nameOfAcceptPerson()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_energyExchangeNotes(), other.isSet_energyExchangeNotes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_energyExchangeNotes()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_amountsCommitted(), other.isSet_amountsCommitted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_amountsCommitted()) {
