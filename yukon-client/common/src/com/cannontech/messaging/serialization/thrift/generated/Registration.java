...
public class Registration implements org.apache.thrift.TBase<Registration, Registration._Fields>, java.io.Serializable, Cloneable, Comparable<Registration> {
  ...
  public int compareTo(Registration other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_appName(), other.isSet_appName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_appName()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_appId(), other.isSet_appId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_appId()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_appIsUnique(), other.isSet_appIsUnique());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSet_appExpirationDelay(), other.isSet_appExpirationDelay());
    if (lastComparison != 0) {
      return lastComparison;
    }
