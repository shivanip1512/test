...
public class Command implements org.apache.thrift.TBase<Command, Command._Fields>, java.io.Serializable, Cloneable, Comparable<Command> {
  ...
  private java.lang.String _opString; // required
  private int _opArgCount; // required
  private java.util.List<java.lang.Integer> _opArgList; // required
  ...
  public void set_opString(java.lang.String _opString) {
    this._opString = _opString;
  }
  ...
  public void set_opArgList(java.util.List<java.lang.Integer> _opArgList) {
    this._opArgList = _opArgList;
  }
