...
public class Command implements org.apache.thrift.TBase<Command, Command._Fields>, java.io.Serializable, Cloneable, Comparable<Command> {
  ...
  public int compareTo(Command other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_operation(), other.isSet_operation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_operation()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_opString(), other.isSet_opString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opString()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_opArgCount(), other.isSet_opArgCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opArgCount()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSet_opArgList(), other.isSet_opArgList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opArgList()) {
