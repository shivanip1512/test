...
public class Command implements org.apache.thrift.TBase<Command, Command._Fields>, java.io.Serializable, Cloneable {
  ...
  private String _opString; // required
  private int _opArgCount; // required
  private List<Integer> _opArgList; // required
  ...
  public Command(Command other) {
    ...
    if (other.isSet_opArgList()) {
      List<Integer> __this___opArgList = new ArrayList<Integer>();
      for (Integer other_element : other._opArgList) {
        __this___opArgList.add(other_element);
      }
  ...
  public void unset_operation() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___OPERATION_ISSET_ID);
  }

  /** Returns true if field _operation is set (has been assigned a value) and false otherwise */
  public boolean isSet_operation() {
    return EncodingUtils.testBit(__isset_bitfield, ___OPERATION_ISSET_ID);
  }

  public void set_operationIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___OPERATION_ISSET_ID, value);
  }

  public String get_opString() {
    return this._opString;
  }

  public void set_opString(String _opString) {
    this._opString = _opString;
  }
  ...
  public void unset_opArgCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, ___OPARGCOUNT_ISSET_ID);
  }

  /** Returns true if field _opArgCount is set (has been assigned a value) and false otherwise */
  public boolean isSet_opArgCount() {
    return EncodingUtils.testBit(__isset_bitfield, ___OPARGCOUNT_ISSET_ID);
  }

  public void set_opArgCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, ___OPARGCOUNT_ISSET_ID, value);
  }
  ...
  public java.util.Iterator<Integer> get_opArgListIterator() {
    return (this._opArgList == null) ? null : this._opArgList.iterator();
  }

  public void addTo_opArgList(int elem) {
    if (this._opArgList == null) {
      this._opArgList = new ArrayList<Integer>();
    }
    this._opArgList.add(elem);
  }

  public List<Integer> get_opArgList() {
    return this._opArgList;
  }

  public void set_opArgList(List<Integer> _opArgList) {
    this._opArgList = _opArgList;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case _OP_ARG_LIST:
      if (value == null) {
        ...
        set_opArgList((List<Integer>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case _OPERATION:
      return Integer.valueOf(get_operation());

    case _OP_STRING:
      return get_opString();

    case _OP_ARG_COUNT:
      return Integer.valueOf(get_opArgCount());
  ...
  public int compareTo(Command other) {
    ...
    lastComparison = Boolean.valueOf(isSet_operation()).compareTo(typedOther.isSet_operation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_operation()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._operation, typedOther._operation);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_opString()).compareTo(typedOther.isSet_opString());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opString()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._opString, typedOther._opString);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_opArgCount()).compareTo(typedOther.isSet_opArgCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opArgCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._opArgCount, typedOther._opArgCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSet_opArgList()).compareTo(typedOther.isSet_opArgList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_opArgList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._opArgList, typedOther._opArgList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct._opArgList = new ArrayList<Integer>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  int _elem2; // required
                  _elem2 = iprot.readI32();
                  struct._opArgList.add(_elem2);
                }
                iprot.readListEnd();
              }
  ...
  private static class CommandTupleScheme extends TupleScheme<Command> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Command struct) throws org.apache.thrift.TException {
      ...
      struct.set_opArgCountIsSet(true);
      {
        ...
        struct._opArgList = new ArrayList<Integer>(_list5.size);
        for (int _i6 = 0; _i6 < _list5.size; ++_i6)
        {
          int _elem7; // required
          _elem7 = iprot.readI32();
          struct._opArgList.add(_elem7);
        }
      }
      struct.set_opArgListIsSet(true);
    }
