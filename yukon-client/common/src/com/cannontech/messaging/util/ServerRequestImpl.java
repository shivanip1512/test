...
public class ServerRequestImpl implements ServerRequest 
{
    ...
    private class InnerServerRequest implements MessageListener {
        ...
        private ServerRequestMessage _requestMsg;  
        private ServerResponseMessage _responseMsg;        
        InnerServerRequest(IServerConnection conn, ServerRequestMessage reqMsg) {
            _connection = conn;
            _requestMsg = reqMsg;
        }
         ...
         * @throws Exception
         */
        private synchronized ServerResponseMessage execute(long timeout) {
            try { 
            ...
            if(_responseMsg == null) {
                _responseMsg = ServerResponseMessage.createTimeoutResp();
        ...
        public synchronized void messageReceived(MessageEvent e) {
            ...
            if(msg instanceof ServerResponseMessage) {
                ServerResponseMessage responseMsg = (ServerResponseMessage) msg;
                if (log.isDebugEnabled()) {
     ...
     */
    public ServerResponseMessage makeServerRequest(IServerConnection conn, BaseMessage msg) {
     ...
     */
    public ServerResponseMessage makeServerRequest(IServerConnection conn, BaseMessage msg, long timeout) {
