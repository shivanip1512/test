...
public enum ManagedService {
    ...
    IOT_PUBLISHER_SERVICE("IOT Publisher Service", ServiceType.CONTEXT_FILE_TYPE, "classpath:com/cannontech/services/iot/context/iotPublisherServiceContext.xml"),
    ;
