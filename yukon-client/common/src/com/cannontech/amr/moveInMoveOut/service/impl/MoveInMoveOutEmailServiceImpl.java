...
public class MoveInMoveOutEmailServiceImpl implements MoveInMoveOutEmailService {
    ...
    private final String scheduledMsg = "A meter reading for {prevMeterName} is scheduled for {startDate}.";
    ...
    public void createMoveInSuccessEmail(MoveInResultObj moveInResultObj,
        ...
        msgData.put("statusMsg",
                    "Move in request for " + moveInResultObj.getNewMeter()
                                                            .getName() + " is complete.");
    ...
    public void createMoveInScheduleEmail(MoveInFormObj moveInFormObj,
            LiteYukonUser liteYukonUser) {
        ...
        msgData.put("prevMeterNumber", moveInFormObj.getPreviousMeter()
                                                    .getMeterNumber());
        msgData.put("prevMeterName", moveInFormObj.getPreviousMeter().getName());
        
        Date moveInDate = new Date(moveInFormObj.getMoveInDate()
                                    .getTime() - 1);
    ...
    public void createMoveInFailureEmail(MoveInResultObj moveInResultObj,
        ...
        msgData.put("statusMsg",
                    "The system was not able to process the move in request for " + moveInResultObj.getPreviousMeter()
    ...
    public void createMoveOutSuccessEmail(MoveOutResultObj moveOutResultObj,
        ...
        msgData.put("status", "completed");
        msgData.put("statusMsg",
                    "Move out request for " + moveOutResultObj.getPreviousMeter()
                                                              .getName() + " is complete.");
    ...
    public void createMoveOutScheduleEmail(MoveOutFormObj moveOutFormObj,
            LiteYukonUser liteYukonUser) {
        Map<String, Object> msgData = new TreeMap<String, Object>();
        msgData.put("status", "scheduled");
        ...
        msgData.put("prevMeterNumber", moveOutFormObj.getMeter()
                                                     .getMeterNumber());
        msgData.put("prevMeterName", moveOutFormObj.getMeter().getName());
    ...
    public void createMoveOutFailureEmail(MoveOutResultObj moveOutResultObj,
        ...
        msgData.put("status", "failed");
        msgData.put("statusMsg",
                    "The system was not able to process the move out request for " + moveOutResultObj.getPreviousMeter()
                                                                                                     .getName() + " for the following reasons.");
    ...
    private void setDatesMoveOut(MoveOutResultObj moveOutResultObj,
        ...
        Date moveOutDate = new Date(moveOutResultObj.getMoveOutDate().getTime() - 1);
        String moveOutDateStr = dateFormattingService.formatDate(moveOutDate,
                                              DateFormatEnum.DATE,
                                              liteYukonUser);
        ...
        msgData.put("stopDate", moveOutDateStr);
        msgData.put("startDate", currentReadDateStr);
    }

    private void setDatesMoveIn(MoveInResultObj moveInResultObj,
            Map<String, Object> msgData, LiteYukonUser liteYukonUser) {
        Date moveInDate = new Date(moveInResultObj.getMoveInDate().getTime() - 1);
        String moveInDateStr = dateFormattingService.formatDate(moveInDate,
                                                              DateFormatEnum.DATE,
                                                              liteYukonUser);
