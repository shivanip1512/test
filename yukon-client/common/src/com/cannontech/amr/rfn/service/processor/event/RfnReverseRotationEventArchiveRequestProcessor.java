...
public class RfnReverseRotationEventArchiveRequestProcessor extends RfnEventConditionDataProcessorHelper
    ...
    @Override
    public <T extends RfnEvent> void process(RfnMeter meter, T event,
                                             List<? super PointData> pointDatas) {
        int rawClearedState = rfnMeterEventService.getRawClearedStateForEvent(event);
        rfnMeterEventService.processAttributePointData(meter,
                                                       pointDatas,
    ...
    public RfnConditionType getRfnConditionType() {
        return RfnConditionType.REVERSE_ROTATION;
    }
