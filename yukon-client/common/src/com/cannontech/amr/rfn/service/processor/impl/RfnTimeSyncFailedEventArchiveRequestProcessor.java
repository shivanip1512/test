...
public class RfnTimeSyncFailedEventArchiveRequestProcessor extends RfnEventConditionDataProcessorHelper
    ...
    public void process(RfnDevice device, RfnEvent event, List<? super PointData> pointDatas, Instant now) {
        ...
        rfnMeterEventService.processAttributePointData(device, 
                                                       pointDatas, 
                                                       BuiltInAttribute.TIME_SYNC_FAILED, 
                                                       instantOf(event), 
                                                       rawClearedState,
                                                       now);
    }
    ...
    public RfnConditionType getRfnConditionType() {
        return RfnConditionType.TIME_SYNC_FAILED;
    }
