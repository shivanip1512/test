...
public enum DeviceError {
    ...
    USER_NOT_AUTHORIZED(EATON_CLOUD, 10003),
    DEVICE_NOT_CONFIGURED(EATON_CLOUD, 10004),
    PROFILE_NOT_FOUND(EATON_CLOUD, 10005),
    CHANNELS_ARE_INVALID(EATON_CLOUD, 10006),
    CHANNEL_METHOD_NOT_AVAILABLE(EATON_CLOUD, 10007),
    NO_CHANNELS_DEFINED(EATON_CLOUD, 10008),
    CHANNEL_METHOD_PARAMS_NOT_VALID(EATON_CLOUD, 10009),
    CHANNEL_METHOD_PARAMS_NOT_WRITABLE(EATON_CLOUD, 10010),
    DEVICE_NOT_FOUND(EATON_CLOUD, 10011),
    COMMAND_TIMED_OUT(EATON_CLOUD, 10012),
    COMMAND_FAILURE(EATON_CLOUD, 10013),
    ;
