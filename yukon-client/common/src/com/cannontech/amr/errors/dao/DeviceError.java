...
public enum DeviceError {
    ...
    INVALID_METER_PROGRAM(YUKON_SYSTEM, 335),
    METER_PROGRAM_NOT_FOUND(YUKON_SYSTEM, 336),
    METER_PROGRAM_PASSWORD_ERROR(YUKON_SYSTEM, 337),
    METER_PROGRAM_RESPONSE_TIMEOUT(YUKON_SYSTEM, 338),
    METER_PROGRAM_ERROR_RESPONSE(YUKON_SYSTEM, 339),

    // Eaton Cloud
    NO_RESPONSE_FROM_DEVICE(EATON_CLOUD, 1100),
    NO_RESPONSE_DUE_TO_RESTART(EATON_CLOUD, 1101),
    JOB_CREATION_FAILED(EATON_CLOUD, 1102),
    USER_NOT_AUTHORIZED(EATON_CLOUD, 1103),
    DEVICE_NOT_CONFIGURED(EATON_CLOUD, 1104),
    PROFILE_NOT_FOUND(EATON_CLOUD, 1105),
    CHANNELS_ARE_INVALID(EATON_CLOUD, 1106),
    CHANNEL_METHOD_NOT_AVAILABLE(EATON_CLOUD, 1107),
    NO_CHANNELS_DEFINED(EATON_CLOUD, 1108),
    CHANNEL_METHOD_PARAMS_NOT_VALID(EATON_CLOUD, 1109),
    CHANNEL_METHOD_PARAMS_NOT_WRITABLE(EATON_CLOUD, 1110),
    DEVICE_NOT_FOUND(EATON_CLOUD, 1111),
    COMMAND_TIMED_OUT(EATON_CLOUD, 1112),
    COMMAND_FAILURE(EATON_CLOUD, 1113),
