...
public class MockCBCWizardModel implements CBCCreationModel {
    ...
    private MockCBCWizardModel nestedWizard = null;


    /**
     * 
     */
    public MockCBCWizardModel() {
        super();
    }
     ...
     */
    public MockCBCWizardModel getNestedWizard() {
        
        if( nestedWizard == null )
            nestedWizard = new MockCBCWizardModel();
