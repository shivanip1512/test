...
public static void main(java.lang.String[] args) {
	try {
		...
		FeederPopUp aFeederPopUp;
		aFeederPopUp = new FeederPopUp(new com.cannontech.cbc.data.CBCClientConnection());
		frame.setContentPane(aFeederPopUp);
		frame.setSize(aFeederPopUp.getSize());
