...
set MSP_URL=--timeout -1 C:\Users\E9816170\dev\svn\yukon_trunk\multispeak\wsdl\v3_0_ab\
set MSP_DEPLOY_FILE=com\cannontech\multispeak\deploy\service\deploy.wsdd
set AXIS_LIB=C:\Users\E9816170\dev\svn\yukon_trunk\third-party\
set AXIS_PROJECT_LIB=C:\Users\E9816170\dev\svn\yukon_trunk\axis\lib\endorsed\
REM set URL_EXT=.asmx?WSDL
set URL_EXT=.wsdl
set AXISCLASSPATH=%AXIS_LIB%\axis.jar;%AXIS_LIB%\commons-discovery-0.5.jar;%AXIS_LIB%\commons-logging-1.1.3.jar;%AXIS_LIB%\jaxrpc.jar;%AXIS_LIB%\saaj.jar;%AXIS_LIB%\log4j-1.2.17.jar;%AXIS_PROJECT_LIB\xml-apis-2.6.2.jar;%AXIS_PROJECT_LIB\xercesImpl-2.6.2.jar;%AXIS_LIB%\wsdl4j-1.6.3.jar;%AXIS_LIB%\mailapi-1.5.1.jar;%AXIS_LIB%\activation.jar;
...
REM This puts the server-config.wsdd in C:\Users\E9816170\dev\svn\yukon_trunk\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\yukon-web\WEB-INF
REM had to copy it out of there and put into eclipse workspace
