...
set MSP_URL=--timeout -1 http://www.multispeak.org/interface/30t/
...
java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side %MSP_URL%9_OA_SCADA%URL_EXT% -p%MSP_PACKAGE%
copy /Y %MSP_DEPLOY_FILE% ..\deploy\oa_scada_deploy.wsdd

java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side %MSP_URL%3_LM_SCADA%URL_EXT% -p%MSP_PACKAGE%
copy /Y %MSP_DEPLOY_FILE% ..\deploy\lm_scada_deploy.wsdd
...
java -cp %AXISCLASSPATH% org.apache.axis.client.AdminClient -l%endpoint% ..\deploy\oa_scada_deploy.wsdd
java -cp %AXISCLASSPATH% org.apache.axis.client.AdminClient -l%endpoint% ..\deploy\lm_scada_deploy.wsdd