...
java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side --skeletonDeploy true ..\wsdl/27_MR_OA.wsdl -pcom.cannontech.multispeak
copy /Y com\cannontech\multispeak\deploy.wsdd ..\deploy\mr_oa_deploy.wsdd

java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side --skeletonDeploy true ..\wsdl/27_OA_MR.wsdl -pcom.cannontech.multispeak
copy /Y com\cannontech\multispeak\deploy.wsdd ..\deploy\oa_mr_deploy.wsdd
...
java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side --skeletonDeploy true ..\wsdl/2B_CB_CD.wsdl -pcom.cannontech.multispeak
copy /Y com\cannontech\multispeak\deploy.wsdd ..\deploy\cb_cd_deploy.wsdd

java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side --skeletonDeploy true ..\wsdl/2B_CD_CB.wsdl -pcom.cannontech.multispeak
copy /Y com\cannontech\multispeak\deploy.wsdd ..\deploy\cd_cb_deploy.wsdd

java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side --skeletonDeploy true ..\wsdl/4_EA_MR.wsdl -pcom.cannontech.multispeak
copy /Y com\cannontech\multispeak\deploy.wsdd ..\deploy\ea_mr_deploy.wsdd

java -cp %AXISCLASSPATH% org.apache.axis.wsdl.WSDL2Java --server-side --skeletonDeploy true ..\wsdl/4_MR_EA.wsdl -pcom.cannontech.multispeak
copy /Y com\cannontech\multispeak\deploy.wsdd ..\deploy\mr_ea_deploy.wsdd
...
java -cp %AXISCLASSPATH% org.apache.axis.client.AdminClient -l%endpoint% ..\deploy\oa_mr_deploy.wsdd
...
java -cp %AXISCLASSPATH% org.apache.axis.client.AdminClient -l%endpoint% ..\deploy\cb_cd_deploy.wsdd
java -cp %AXISCLASSPATH% org.apache.axis.client.AdminClient -l%endpoint% ..\deploy\cd_cb_deploy.wsdd

java -cp %AXISCLASSPATH% org.apache.axis.client.AdminClient -l%endpoint% ..\deploy\ea_mr_deploy.wsdd
