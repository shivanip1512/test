...
public class ServiceLocationChangedNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfServiceLocation changedServiceLocations;

    public ServiceLocationChangedNotification() {
    }

    public ServiceLocationChangedNotification(
           com.cannontech.multispeak.ArrayOfServiceLocation changedServiceLocations) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfServiceLocation getChangedServiceLocations() {
        return changedServiceLocations;
    }
     ...
     */
    public void setChangedServiceLocations(com.cannontech.multispeak.ArrayOfServiceLocation changedServiceLocations) {
        this.changedServiceLocations = changedServiceLocations;
    }
