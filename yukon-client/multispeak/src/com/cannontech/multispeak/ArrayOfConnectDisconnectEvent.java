...
public class ArrayOfConnectDisconnectEvent  implements java.io.Serializable {
    private com.cannontech.multispeak.ConnectDisconnectEvent[] connectDisconnectEvent;

    public ArrayOfConnectDisconnectEvent() {
    }

    public ArrayOfConnectDisconnectEvent(
           com.cannontech.multispeak.ConnectDisconnectEvent[] connectDisconnectEvent) {
     ...
     */
    public com.cannontech.multispeak.ConnectDisconnectEvent[] getConnectDisconnectEvent() {
        return connectDisconnectEvent;
    }
     ...
     */
    public void setConnectDisconnectEvent(com.cannontech.multispeak.ConnectDisconnectEvent[] connectDisconnectEvent) {
        this.connectDisconnectEvent = connectDisconnectEvent;
    }

    public com.cannontech.multispeak.ConnectDisconnectEvent getConnectDisconnectEvent(int i) {
        return this.connectDisconnectEvent[i];
    }

    public void setConnectDisconnectEvent(int i, com.cannontech.multispeak.ConnectDisconnectEvent _value) {
