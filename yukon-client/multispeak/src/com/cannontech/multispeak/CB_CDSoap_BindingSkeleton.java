/**
 * CB_CDSoap_BindingSkeleton.java
 *
...
public class CB_CDSoap_BindingSkeleton implements com.cannontech.multispeak.CB_CDSoap_PortType, org.apache.axis.wsdl.Skeleton {
    private com.cannontech.multispeak.CB_CDSoap_PortType impl;
    ...
    */
    ...
    static {
        ...
        _oper = new org.apache.axis.description.OperationDesc("modifyCBDataForCustomer", _params, new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ModifyCBDataForCustomerResult"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ArrayOfErrorObject"));
        ...
        _oper = new org.apache.axis.description.OperationDesc("modifyCBDataForServiceLocation", _params, new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ModifyCBDataForServiceLocationResult"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ArrayOfErrorObject"));
        ...
        _oper = new org.apache.axis.description.OperationDesc("modifyCBDataForMeter", _params, new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ModifyCBDataForMeterResult"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ArrayOfErrorObject"));
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "meterNo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false), 
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "stateChange"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "loadActionCode"), com.cannontech.multispeak.LoadActionCode.class, false, false), 
        };
        _oper = new org.apache.axis.description.OperationDesc("CDStateChangedNotification", _params, null);
        _oper.setElementQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "CDStateChangedNotification"));
        _oper.setSoapAction("http://www.multispeak.org/Version_3.0/CDStateChangedNotification");
        _myOperationsList.add(_oper);
        if (_myOperations.get("CDStateChangedNotification") == null) {
            _myOperations.put("CDStateChangedNotification", new java.util.ArrayList());
        }
        ((java.util.List)_myOperations.get("CDStateChangedNotification")).add(_oper);
    }

    public CB_CDSoap_BindingSkeleton() {
        this.impl = new com.cannontech.multispeak.CB_CDSoap_BindingImpl();
    }

    public CB_CDSoap_BindingSkeleton(com.cannontech.multispeak.CB_CDSoap_PortType impl) {
        this.impl = impl;
    }
    ...
    {
        com.cannontech.multispeak.ArrayOfErrorObject ret = impl.modifyCBDataForCustomer(customerData);
        return ret;
    }
    ...
    {
        com.cannontech.multispeak.ArrayOfErrorObject ret = impl.modifyCBDataForServiceLocation(serviceLocationData);
        return ret;
    }
    ...
    {
        com.cannontech.multispeak.ArrayOfErrorObject ret = impl.modifyCBDataForMeter(meterData);
        return ret;
    }
    ...
    {
        impl.CDStateChangedNotification(meterNo, stateChange);
    }
