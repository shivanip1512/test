...
public class ODDeviceChangedNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfErrorObject ODDeviceChangedNotificationResult;

    public ODDeviceChangedNotificationResponse() {
    }

    public ODDeviceChangedNotificationResponse(
           com.cannontech.multispeak.ArrayOfErrorObject ODDeviceChangedNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfErrorObject getODDeviceChangedNotificationResult() {
        return ODDeviceChangedNotificationResult;
    }
     ...
     */
    public void setODDeviceChangedNotificationResult(com.cannontech.multispeak.ArrayOfErrorObject ODDeviceChangedNotificationResult) {
        this.ODDeviceChangedNotificationResult = ODDeviceChangedNotificationResult;
    }
        ...
        _equals = true && 
            ((this.ODDeviceChangedNotificationResult==null && other.getODDeviceChangedNotificationResult()==null) || 
             (this.ODDeviceChangedNotificationResult!=null &&
              this.ODDeviceChangedNotificationResult.equals(other.getODDeviceChangedNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getODDeviceChangedNotificationResult() != null) {
            _hashCode += getODDeviceChangedNotificationResult().hashCode();
        }
