...
public class GetSubstationNamesResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfString getSubstationNamesResult;

    public GetSubstationNamesResponse() {
    }

    public GetSubstationNamesResponse(
           com.cannontech.multispeak.ArrayOfString getSubstationNamesResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfString getGetSubstationNamesResult() {
        return getSubstationNamesResult;
    }
     ...
     */
    public void setGetSubstationNamesResult(com.cannontech.multispeak.ArrayOfString getSubstationNamesResult) {
        this.getSubstationNamesResult = getSubstationNamesResult;
    }
