...
public class CDStateChangedNotification  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.LoadActionCode stateChange;
    ...
    public CDStateChangedNotification(
           ...
           com.cannontech.multispeak.LoadActionCode stateChange) {
     ...
     * @return stateChange
     */
    public com.cannontech.multispeak.LoadActionCode getStateChange() {
        return stateChange;
    }
     ...
     * @param stateChange
     */
    public void setStateChange(com.cannontech.multispeak.LoadActionCode stateChange) {
        this.stateChange = stateChange;
    }
