...
public class CD_CBLocator extends org.apache.axis.client.Service implements com.cannontech.multispeak.CD_CB {
    ...
    private java.lang.String CD_CBSoap_address = "http://www.turtletech.com/multispeakws/2B_CD_CB.asmx";
    ...
    public com.cannontech.multispeak.CD_CBSoap_PortType getCD_CBSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.cannontech.multispeak.CD_CBSoap_PortType getCD_CBSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.CD_CBSoap_BindingStub _stub = new com.cannontech.multispeak.CD_CBSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cannontech.multispeak.CD_CBSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.CD_CBSoap_BindingStub _stub = new com.cannontech.multispeak.CD_CBSoap_BindingStub(new java.net.URL(CD_CBSoap_address), this);
                _stub.setPortName(getCD_CBSoapWSDDServiceName());
                return _stub;
            }
        }
