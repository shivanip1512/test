...
public enum MspLoadActionCode {
    ...
    DISCONNECT(LoadActionCode.DISCONNECT, RfnDisconnectStatusState.DISCONNECTED,
               Disconnect410State.CONFIRMED_DISCONNECTED, "control disconnect"),
    // TODO DISCONNECT_CONFIRMED is a fake enum to support the possible unconfirmed disconnected PLC lookup
    // DISCONNECT_CONFIRMED(LoadActionCode.Disconnect, RFNDisconnectStatusState.DISCONNECTED,
    // Disconnect410State.UNCONFIRMED_DISCONNECTED, "control disconnect"),
    ...
    UNKNOWN(LoadActionCode.UNKNOWN, RfnDisconnectStatusState.UNKNOWN, Disconnect410State.UNCONFIRMED_DISCONNECTED),
    // Old CDEvent code mapped PLC unconfirmedDisconnect to LoadActionCode.Disconnect....
    ;
    ...
    private MspLoadActionCode(LoadActionCode loadActionCode, RfnDisconnectStatusState rfnState,
            Disconnect410State plcState) {
        this(loadActionCode, rfnState, plcState, null);
    }

    private MspLoadActionCode(LoadActionCode loadActionCode, RfnDisconnectStatusState rfnState,
            Disconnect410State plcState, String plcCommandString) {
