...
public enum MspLoadActionCode {
    ...
    CONNECT(LoadActionCodeKind.CONNECT, RfnDisconnectStatusState.CONNECTED, Disconnect410State.CONNECTED, "control connect"),
    DISCONNECT(LoadActionCodeKind.DISCONNECT, RfnDisconnectStatusState.DISCONNECTED, Disconnect410State.CONFIRMED_DISCONNECTED, "control disconnect"),
...
//    CLOSED(LoadActionCode.Closed),                                      //not supported
    ...
    private MspLoadActionCode(LoadActionCodeKind loadActionCode,
