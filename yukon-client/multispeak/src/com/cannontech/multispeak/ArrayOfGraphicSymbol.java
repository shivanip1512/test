...
public class ArrayOfGraphicSymbol  implements java.io.Serializable {
    private com.cannontech.multispeak.GraphicSymbol[] graphicSymbol;

    public ArrayOfGraphicSymbol() {
    }
    ...
    /**
     * Gets the graphicSymbol value for this ArrayOfGraphicSymbol.
     * 
    ...
    /**
     * Sets the graphicSymbol value for this ArrayOfGraphicSymbol.
     * 
     * @param graphicSymbol
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfGraphicSymbol)) return false;
        ArrayOfGraphicSymbol other = (ArrayOfGraphicSymbol) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfGraphicSymbol.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ArrayOfGraphicSymbol"));
