...
public class ReadingChangedNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfMeterRead changedMeterReads;

    public ReadingChangedNotification() {
    }

    public ReadingChangedNotification(
           com.cannontech.multispeak.ArrayOfMeterRead changedMeterReads) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfMeterRead getChangedMeterReads() {
        return changedMeterReads;
    }
     ...
     */
    public void setChangedMeterReads(com.cannontech.multispeak.ArrayOfMeterRead changedMeterReads) {
        this.changedMeterReads = changedMeterReads;
    }
