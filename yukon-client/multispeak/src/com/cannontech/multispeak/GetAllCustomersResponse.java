...
public class GetAllCustomersResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfCustomer getAllCustomersResult;

    public GetAllCustomersResponse() {
    }

    public GetAllCustomersResponse(
           com.cannontech.multispeak.ArrayOfCustomer getAllCustomersResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfCustomer getGetAllCustomersResult() {
        return getAllCustomersResult;
    }
     ...
     */
    public void setGetAllCustomersResult(com.cannontech.multispeak.ArrayOfCustomer getAllCustomersResult) {
        this.getAllCustomersResult = getAllCustomersResult;
    }
