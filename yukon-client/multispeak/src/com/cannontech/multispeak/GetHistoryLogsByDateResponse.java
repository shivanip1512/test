...
public class GetHistoryLogsByDateResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfHistoryLog getHistoryLogsByDateResult;

    public GetHistoryLogsByDateResponse() {
    }

    public GetHistoryLogsByDateResponse(
           com.cannontech.multispeak.ArrayOfHistoryLog getHistoryLogsByDateResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfHistoryLog getGetHistoryLogsByDateResult() {
        return getHistoryLogsByDateResult;
    }
     ...
     */
    public void setGetHistoryLogsByDateResult(com.cannontech.multispeak.ArrayOfHistoryLog getHistoryLogsByDateResult) {
        this.getHistoryLogsByDateResult = getHistoryLogsByDateResult;
    }
        ...
        _equals = true && 
            ((this.getHistoryLogsByDateResult==null && other.getGetHistoryLogsByDateResult()==null) || 
             (this.getHistoryLogsByDateResult!=null &&
              this.getHistoryLogsByDateResult.equals(other.getGetHistoryLogsByDateResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetHistoryLogsByDateResult() != null) {
            _hashCode += getGetHistoryLogsByDateResult().hashCode();
        }
