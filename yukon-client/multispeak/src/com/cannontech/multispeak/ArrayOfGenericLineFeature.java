...
public class ArrayOfGenericLineFeature  implements java.io.Serializable {
    private com.cannontech.multispeak.GenericLineFeature[] genericLineFeature;

    public ArrayOfGenericLineFeature() {
    }

    public ArrayOfGenericLineFeature(
           com.cannontech.multispeak.GenericLineFeature[] genericLineFeature) {
     ...
     */
    public com.cannontech.multispeak.GenericLineFeature[] getGenericLineFeature() {
        return genericLineFeature;
    }
     ...
     */
    public void setGenericLineFeature(com.cannontech.multispeak.GenericLineFeature[] genericLineFeature) {
        this.genericLineFeature = genericLineFeature;
    }

    public com.cannontech.multispeak.GenericLineFeature getGenericLineFeature(int i) {
        return this.genericLineFeature[i];
    }

    public void setGenericLineFeature(int i, com.cannontech.multispeak.GenericLineFeature _value) {
