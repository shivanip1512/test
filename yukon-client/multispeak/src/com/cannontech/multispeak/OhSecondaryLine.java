...
public class OhSecondaryLine  extends com.cannontech.multispeak.MspElectricLine  implements java.io.Serializable {
    private com.cannontech.multispeak.OhSecondaryLineSecondaryType secondaryType;
    ...
    public OhSecondaryLine(
           com.cannontech.multispeak.OhSecondaryLineSecondaryType secondaryType,
     ...
     */
    public com.cannontech.multispeak.OhSecondaryLineSecondaryType getSecondaryType() {
        return secondaryType;
    }
     ...
     * @param secondaryType
     */
    public void setSecondaryType(com.cannontech.multispeak.OhSecondaryLineSecondaryType secondaryType) {
        this.secondaryType = secondaryType;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ohSecondaryLineSecondaryType"));
