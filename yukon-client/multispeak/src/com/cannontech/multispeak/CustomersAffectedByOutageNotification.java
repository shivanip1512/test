...
public class CustomersAffectedByOutageNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfCustomersAffectedByOutage newOutages;

    public CustomersAffectedByOutageNotification() {
    }

    public CustomersAffectedByOutageNotification(
           com.cannontech.multispeak.ArrayOfCustomersAffectedByOutage newOutages) {
     ...
     * @return newOutages
     */
    public com.cannontech.multispeak.ArrayOfCustomersAffectedByOutage getNewOutages() {
        return newOutages;
    }
     ...
     * @param newOutages
     */
    public void setNewOutages(com.cannontech.multispeak.ArrayOfCustomersAffectedByOutage newOutages) {
        this.newOutages = newOutages;
    }
