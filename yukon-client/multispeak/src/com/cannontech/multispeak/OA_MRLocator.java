...
public class OA_MRLocator extends org.apache.axis.client.Service implements com.cannontech.multispeak.OA_MR {
    ...
    private java.lang.String OA_MRSoap_address = "http://www.turtletech.com/multispeakws/27_OA_MR.asmx";
    ...
    public com.cannontech.multispeak.OA_MRSoap_PortType getOA_MRSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.OA_MRSoap_BindingStub _stub = new com.cannontech.multispeak.OA_MRSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cannontech.multispeak.OA_MRSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.OA_MRSoap_BindingStub _stub = new com.cannontech.multispeak.OA_MRSoap_BindingStub(new java.net.URL(OA_MRSoap_address), this);
                _stub.setPortName(getOA_MRSoapWSDDServiceName());
                return _stub;
            }
        }
