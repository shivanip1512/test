...
public class PingURLResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfErrorObject pingURLResult;

    public PingURLResponse() {
    }

    public PingURLResponse(
           com.cannontech.multispeak.ArrayOfErrorObject pingURLResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfErrorObject getPingURLResult() {
        return pingURLResult;
    }
     ...
     * @param pingURLResult
     */
    public void setPingURLResult(com.cannontech.multispeak.ArrayOfErrorObject pingURLResult) {
        this.pingURLResult = pingURLResult;
    }
