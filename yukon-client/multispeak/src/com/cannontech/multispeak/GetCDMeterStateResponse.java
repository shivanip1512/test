...
public class GetCDMeterStateResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.LoadActionCode getCDMeterStateResult;

    public GetCDMeterStateResponse() {
    }

    public GetCDMeterStateResponse(
           com.cannontech.multispeak.LoadActionCode getCDMeterStateResult) {
     ...
     */
    public com.cannontech.multispeak.LoadActionCode getGetCDMeterStateResult() {
        return getCDMeterStateResult;
    }
     ...
     */
    public void setGetCDMeterStateResult(com.cannontech.multispeak.LoadActionCode getCDMeterStateResult) {
        this.getCDMeterStateResult = getCDMeterStateResult;
    }
