...
public abstract class FormattedBlockBase extends FormattedBlock{
     ...
     * @return
     */
    private  com.cannontech.msp.beans.v3.SyntaxItem buildSyntaxItem (
            SyntaxItem syntaxItem, int position) {
        
        com.cannontech.msp.beans.v3.SyntaxItem mspSyntaxItem = 
            new  com.cannontech.msp.beans.v3.SyntaxItem();
