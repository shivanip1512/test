package com.cannontech.multispeak.block.data.load.v5;
...
public class LoadBlock implements Block {
    ...
    public LoadBlock(String meterNumber, double loadProfileDemand, Date loadProfileDemandDateTime, double kVAr,
            Date kVArDateTime, double voltage, Date voltageDateTime, double voltageProfile, Date voltageProfileDateTime) {
        super();
