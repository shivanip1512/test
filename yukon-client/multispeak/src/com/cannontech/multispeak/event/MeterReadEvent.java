...
public class MeterReadEvent extends MultispeakEvent {
    ...
    public void eventNotification() {
        ...
        try {
            ...
            ReadingChangedNotificationResponse response =
                cbClient.readingChangedNotification(getMspVendor(), getResponseUrl(), readChangeNotification);
            if (response != null) {
                ...
                CTILogger.info("Response not recieved for (" + getResponseUrl() + "): Meter Number "
                    + getDevice().getMeterRead().getObjectID());
            }
        } catch (MultispeakWebServiceClientException multispeakWebServiceClientException) {
            CTILogger.error("MultispeakWebServiceClientException " + multispeakWebServiceClientException);
        }
    }
