...
public interface MspMeterDao {
    /**
     * Returns all AMR _supported_ meters (those paoIds having both DeviceMeterGroup and DeviceCarrierSettings
     * db entries)
     * 
     * @param lastReceived
     * @param maxRecords
    ...
    /**
     * Returns disconnect/connect supported meters
     * 
     * @param lastReceived
     * @param maxRecords
     * @return
    ...
    /**
     * @return true if meter supports disconnect/connect
     */
     ...
     * however, the business logic of the calling methods must instead take care of checking if the
     * model/manufacturer
