...
public interface MspRawPointHistoryDao {
     ...
     * @return MspBlock
     */
    public MspBlockReturnList retrieveBlock(ReadBy readBy, List<String> meterNos,
    ...
    public MspBlockReturnList retrieveLatestBlock(ReadBy readBy,
            FormattedBlockProcessingService<Block> blockProcessingService, List<String> meterNos, String lastReceived,
            int maxRecords);
}