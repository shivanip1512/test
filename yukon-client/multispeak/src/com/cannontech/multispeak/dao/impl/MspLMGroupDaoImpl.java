...
public class MspLMGroupDaoImpl implements MspLMGroupDao {
    ...
    static {
        ...
        joinClause =
            " JOIN YukonPaobject routePao on grp.RouteId = PaobjectId "
    ...
    private final ParameterizedRowMapper<MspLMGroupCommunications> mspLMGroupCommunicationsMapper =
        new ParameterizedRowMapper<MspLMGroupCommunications>() {
            @Override
    ...
    @Override
    public MspLMGroupStatus getStatus(List<MspLMGroupCommunications> mspLMGroupCommunications) {
        ...
        // Can sum together all status, if status sum is greater then 0, then we know we have some bad
        // statuses.
    ...
    private Set<Integer> getAllStatusPoints(List<MspLMGroupCommunications> mspLMGroupCommunications) {
        ...
        for (MspLMGroupCommunications mspLMGroupCommunication : mspLMGroupCommunications) {
            try {
                LitePoint commStatusPoint =
                    pointDao.getLitePointIdByDeviceId_Offset_PointType(mspLMGroupCommunication.getTransmitterId(),
    ...
    private MspLMGroupCommunications createMspLMGroupCommunicationsMapping(ResultSet rset) throws SQLException {
        ...
        MspLMGroupCommunications mspLMGroupCommunications =
            new MspLMGroupCommunications(lmGroupId, routeId, transId, disabled);
