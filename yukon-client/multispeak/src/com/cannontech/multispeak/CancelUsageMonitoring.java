...
public class CancelUsageMonitoring  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfString meterNos;

    public CancelUsageMonitoring() {
    }
    ...
    /**
     * Gets the meterNos value for this CancelUsageMonitoring.
     * 
     * @return meterNos
     */
    ...
    /**
     * Sets the meterNos value for this CancelUsageMonitoring.
     * 
     * @param meterNos
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CancelUsageMonitoring)) return false;
        CancelUsageMonitoring other = (CancelUsageMonitoring) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CancelUsageMonitoring.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">CancelUsageMonitoring"));
