...
public class MultispeakVendor
{
    ...
    public static final int SERVICE_LOCATION_WITH_REGISTER_NO_PAONAME = 6;
    ...
    public static String SERVICE_LOCATION_WITH_REGISTER_NO_STRING = "Service Location_With Register_)";
    ...
    public static String[] paoNameAliasStrings = new String[]{
           ...
           SERVICE_LOCATION_WITH_REGISTER_NO_STRING
       };
