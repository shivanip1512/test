...
public class GetUplineCircuitElementsResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfCircuitElement getUplineCircuitElementsResult;

    public GetUplineCircuitElementsResponse() {
    }

    public GetUplineCircuitElementsResponse(
           com.cannontech.multispeak.ArrayOfCircuitElement getUplineCircuitElementsResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfCircuitElement getGetUplineCircuitElementsResult() {
        return getUplineCircuitElementsResult;
    }
     ...
     */
    public void setGetUplineCircuitElementsResult(com.cannontech.multispeak.ArrayOfCircuitElement getUplineCircuitElementsResult) {
        this.getUplineCircuitElementsResult = getUplineCircuitElementsResult;
    }
        ...
        _equals = true && 
            ((this.getUplineCircuitElementsResult==null && other.getGetUplineCircuitElementsResult()==null) || 
             (this.getUplineCircuitElementsResult!=null &&
              this.getUplineCircuitElementsResult.equals(other.getGetUplineCircuitElementsResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetUplineCircuitElementsResult() != null) {
            _hashCode += getGetUplineCircuitElementsResult().hashCode();
        }
