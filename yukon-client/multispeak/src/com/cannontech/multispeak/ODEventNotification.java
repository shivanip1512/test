...
public class ODEventNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfOutageDetectionEvent ODEvents;

    public ODEventNotification() {
    }

    public ODEventNotification(
           com.cannontech.multispeak.ArrayOfOutageDetectionEvent ODEvents) {
     ...
     * @return ODEvents
     */
    public com.cannontech.multispeak.ArrayOfOutageDetectionEvent getODEvents() {
        return ODEvents;
    }
     ...
     * @param ODEvents
     */
    public void setODEvents(com.cannontech.multispeak.ArrayOfOutageDetectionEvent ODEvents) {
        this.ODEvents = ODEvents;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((this.ODEvents==null && other.getODEvents()==null) || 
             (this.ODEvents!=null &&
              this.ODEvents.equals(other.getODEvents())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        int _hashCode = 1;
        if (getODEvents() != null) {
            _hashCode += getODEvents().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ArrayOfOutageDetectionEvent"));
