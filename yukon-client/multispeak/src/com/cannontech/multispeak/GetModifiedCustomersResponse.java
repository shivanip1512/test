...
public class GetModifiedCustomersResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfCustomer getModifiedCustomersResult;

    public GetModifiedCustomersResponse() {
    }

    public GetModifiedCustomersResponse(
           com.cannontech.multispeak.ArrayOfCustomer getModifiedCustomersResult) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfCustomer getGetModifiedCustomersResult() {
        return getModifiedCustomersResult;
    }
     ...
     */
    public void setGetModifiedCustomersResult(com.cannontech.multispeak.ArrayOfCustomer getModifiedCustomersResult) {
        this.getModifiedCustomersResult = getModifiedCustomersResult;
    }
