...
public class OA_MRSoap_BindingStub extends org.apache.axis.client.Stub implements com.cannontech.multispeak.OA_MRSoap_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.cannontech.multispeak.OutageEventStatus.class);
    ...
    public OA_MRSoap_BindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public OA_MRSoap_BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public OA_MRSoap_BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings0() {
            ...
            cls = com.cannontech.multispeak.GetActiveOutages.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.cannontech.multispeak.GetActiveOutagesResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.cannontech.multispeak.GetOutageEventStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.cannontech.multispeak.GetOutageEventStatusByOutageLocation.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.cannontech.multispeak.GetOutageEventStatusByOutageLocationResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.cannontech.multispeak.GetOutageEventStatusResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {outageEventID});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.cannontech.multispeak.OutageEventStatus) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.cannontech.multispeak.OutageEventStatus) org.apache.axis.utils.JavaUtils.convert(_resp, com.cannontech.multispeak.OutageEventStatus.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
