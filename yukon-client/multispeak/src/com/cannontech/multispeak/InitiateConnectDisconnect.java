...
public class InitiateConnectDisconnect  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfConnectDisconnectEvent cdEvents;

    public InitiateConnectDisconnect() {
    }

    public InitiateConnectDisconnect(
           com.cannontech.multispeak.ArrayOfConnectDisconnectEvent cdEvents) {
     ...
     * @return cdEvents
     */
    public com.cannontech.multispeak.ArrayOfConnectDisconnectEvent getCdEvents() {
        return cdEvents;
    }
     ...
     * @param cdEvents
     */
    public void setCdEvents(com.cannontech.multispeak.ArrayOfConnectDisconnectEvent cdEvents) {
        this.cdEvents = cdEvents;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((this.cdEvents==null && other.getCdEvents()==null) || 
             (this.cdEvents!=null &&
              this.cdEvents.equals(other.getCdEvents())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        int _hashCode = 1;
        if (getCdEvents() != null) {
            _hashCode += getCdEvents().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "ArrayOfConnectDisconnectEvent"));
