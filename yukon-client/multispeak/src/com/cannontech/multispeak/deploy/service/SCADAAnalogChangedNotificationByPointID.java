/**
 * SCADAAnalogChangedNotificationByPointID.java
 *
...
public class SCADAAnalogChangedNotificationByPointID  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ScadaAnalog scadaAnalog;

    public SCADAAnalogChangedNotificationByPointID() {
    }
    ...
    /**
     * Gets the scadaAnalog value for this SCADAAnalogChangedNotificationByPointID.
     * 
     * @return scadaAnalog
     */
    ...
    /**
     * Sets the scadaAnalog value for this SCADAAnalogChangedNotificationByPointID.
     * 
     * @param scadaAnalog
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SCADAAnalogChangedNotificationByPointID)) return false;
        SCADAAnalogChangedNotificationByPointID other = (SCADAAnalogChangedNotificationByPointID) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SCADAAnalogChangedNotificationByPointID.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">SCADAAnalogChangedNotificationByPointID"));
