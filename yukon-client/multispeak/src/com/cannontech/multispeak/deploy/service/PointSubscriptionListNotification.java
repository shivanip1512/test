...
public class PointSubscriptionListNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.PointSubscriptionListListItem[] pointList;
    ...
    public PointSubscriptionListNotification(
           com.cannontech.multispeak.deploy.service.PointSubscriptionListListItem[] pointList,
     ...
     * @return pointList
     */
    public com.cannontech.multispeak.deploy.service.PointSubscriptionListListItem[] getPointList() {
        return pointList;
    }
     ...
     * @param pointList
     */
    public void setPointList(com.cannontech.multispeak.deploy.service.PointSubscriptionListListItem[] pointList) {
        this.pointList = pointList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">pointSubscriptionList>listItem"));
