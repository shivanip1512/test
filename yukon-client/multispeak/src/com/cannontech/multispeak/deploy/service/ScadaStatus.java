...
public class ScadaStatus  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.QualityDescription quality;

    private com.cannontech.multispeak.deploy.service.StatusIdentifier status;
    ...
    public ScadaStatus(
           ...
           com.cannontech.multispeak.deploy.service.StatusIdentifier status,
     ...
     * @return status
     */
    public com.cannontech.multispeak.deploy.service.StatusIdentifier getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.cannontech.multispeak.deploy.service.StatusIdentifier status) {
        this.status = status;
    }
