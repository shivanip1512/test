...
public class GetAllCircuitElementsResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.CircuitElement[] getAllCircuitElementsResult;

    public GetAllCircuitElementsResponse() {
    }

    public GetAllCircuitElementsResponse(
           com.cannontech.multispeak.deploy.service.CircuitElement[] getAllCircuitElementsResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.CircuitElement[] getGetAllCircuitElementsResult() {
        return getAllCircuitElementsResult;
    }
     ...
     */
    public void setGetAllCircuitElementsResult(com.cannontech.multispeak.deploy.service.CircuitElement[] getAllCircuitElementsResult) {
        this.getAllCircuitElementsResult = getAllCircuitElementsResult;
    }
        ...
        _equals = true && 
            ((this.getAllCircuitElementsResult==null && other.getGetAllCircuitElementsResult()==null) || 
             (this.getAllCircuitElementsResult!=null &&
              java.util.Arrays.equals(this.getAllCircuitElementsResult, other.getGetAllCircuitElementsResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetAllCircuitElementsResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetAllCircuitElementsResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetAllCircuitElementsResult(), i);
                if (obj != null &&
