...
public class MeterReading  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.ReadingStatus[] status;

    private com.cannontech.multispeak.deploy.service.Registers[] registers;
    ...
    public MeterReading(
           ...
           com.cannontech.multispeak.deploy.service.ReadingStatus[] status,
           com.cannontech.multispeak.deploy.service.Registers[] registers) {
     ...
     * @return status
     */
    public com.cannontech.multispeak.deploy.service.ReadingStatus[] getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.cannontech.multispeak.deploy.service.ReadingStatus[] status) {
        this.status = status;
    }

    public com.cannontech.multispeak.deploy.service.ReadingStatus getStatus(int i) {
        return this.status[i];
    }

    public void setStatus(int i, com.cannontech.multispeak.deploy.service.ReadingStatus _value) {
     ...
     * @return registers
     */
    public com.cannontech.multispeak.deploy.service.Registers[] getRegisters() {
        return registers;
    }
     ...
     * @param registers
     */
    public void setRegisters(com.cannontech.multispeak.deploy.service.Registers[] registers) {
        this.registers = registers;
    }

    public com.cannontech.multispeak.deploy.service.Registers getRegisters(int i) {
        return this.registers[i];
    }

    public void setRegisters(int i, com.cannontech.multispeak.deploy.service.Registers _value) {
