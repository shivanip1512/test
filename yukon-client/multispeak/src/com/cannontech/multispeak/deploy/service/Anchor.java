...
public class Anchor  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    private java.lang.Double lead;

    private com.cannontech.multispeak.deploy.service.AnchorStatus status;
    ...
    public Anchor(
           ...
           com.cannontech.multispeak.deploy.service.AnchorStatus status) {
        super(
            objectID,
            verb,
            errorString,
     ...
     * @return status
     */
    public com.cannontech.multispeak.deploy.service.AnchorStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.cannontech.multispeak.deploy.service.AnchorStatus status) {
        this.status = status;
    }
