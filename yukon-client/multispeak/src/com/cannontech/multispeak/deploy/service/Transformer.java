...
public class Transformer  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.TestInstance[] pcbTestList;
    ...
    public Transformer(
           ...
           com.cannontech.multispeak.deploy.service.TestInstance[] pcbTestList) {
        super(
            objectID,
            verb,
            errorString,
     ...
     * @return pcbTestList
     */
    public com.cannontech.multispeak.deploy.service.TestInstance[] getPcbTestList() {
        return pcbTestList;
    }
     ...
     * @param pcbTestList
     */
    public void setPcbTestList(com.cannontech.multispeak.deploy.service.TestInstance[] pcbTestList) {
        this.pcbTestList = pcbTestList;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.pcbTestList==null && other.getPcbTestList()==null) || 
             (this.pcbTestList!=null &&
              java.util.Arrays.equals(this.pcbTestList, other.getPcbTestList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPcbTestList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPcbTestList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPcbTestList(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "testInstance"));
        typeDesc.addFieldDesc(elemField);
    }
