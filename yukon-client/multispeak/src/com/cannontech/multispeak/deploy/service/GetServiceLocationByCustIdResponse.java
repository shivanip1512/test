...
public class GetServiceLocationByCustIdResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByCustIdResult;

    public GetServiceLocationByCustIdResponse() {
    }

    public GetServiceLocationByCustIdResponse(
           com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByCustIdResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ServiceLocation[] getGetServiceLocationByCustIdResult() {
        return getServiceLocationByCustIdResult;
    }
     ...
     */
    public void setGetServiceLocationByCustIdResult(com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByCustIdResult) {
        this.getServiceLocationByCustIdResult = getServiceLocationByCustIdResult;
    }
        ...
        _equals = true && 
            ((this.getServiceLocationByCustIdResult==null && other.getGetServiceLocationByCustIdResult()==null) || 
             (this.getServiceLocationByCustIdResult!=null &&
              java.util.Arrays.equals(this.getServiceLocationByCustIdResult, other.getGetServiceLocationByCustIdResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetServiceLocationByCustIdResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetServiceLocationByCustIdResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetServiceLocationByCustIdResult(), i);
                if (obj != null &&
