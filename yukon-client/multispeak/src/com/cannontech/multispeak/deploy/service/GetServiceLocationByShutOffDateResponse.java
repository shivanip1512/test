...
public class GetServiceLocationByShutOffDateResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByShutOffDateResult;

    public GetServiceLocationByShutOffDateResponse() {
    }

    public GetServiceLocationByShutOffDateResponse(
           com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByShutOffDateResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ServiceLocation[] getGetServiceLocationByShutOffDateResult() {
        return getServiceLocationByShutOffDateResult;
    }
     ...
     */
    public void setGetServiceLocationByShutOffDateResult(com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByShutOffDateResult) {
        this.getServiceLocationByShutOffDateResult = getServiceLocationByShutOffDateResult;
    }
        ...
        _equals = true && 
            ((this.getServiceLocationByShutOffDateResult==null && other.getGetServiceLocationByShutOffDateResult()==null) || 
             (this.getServiceLocationByShutOffDateResult!=null &&
              java.util.Arrays.equals(this.getServiceLocationByShutOffDateResult, other.getGetServiceLocationByShutOffDateResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetServiceLocationByShutOffDateResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetServiceLocationByShutOffDateResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetServiceLocationByShutOffDateResult(), i);
                if (obj != null &&
