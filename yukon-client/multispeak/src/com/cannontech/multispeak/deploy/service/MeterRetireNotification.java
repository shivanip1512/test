...
public class MeterRetireNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.Meter[] retiredMeters;

    public MeterRetireNotification() {
    }

    public MeterRetireNotification(
           com.cannontech.multispeak.deploy.service.Meter[] retiredMeters) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.Meter[] getRetiredMeters() {
        return retiredMeters;
    }
     ...
     * @param retiredMeters
     */
    public void setRetiredMeters(com.cannontech.multispeak.deploy.service.Meter[] retiredMeters) {
        this.retiredMeters = retiredMeters;
    }
        ...
        _equals = true && 
            ((this.retiredMeters==null && other.getRetiredMeters()==null) || 
             (this.retiredMeters!=null &&
              java.util.Arrays.equals(this.retiredMeters, other.getRetiredMeters())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getRetiredMeters() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getRetiredMeters());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getRetiredMeters(), i);
                if (obj != null &&
