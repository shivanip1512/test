...
public class MeasurementType  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.TimeSpan timeSpan;

    private java.util.Calendar stopTime;

    private com.cannontech.multispeak.deploy.service.DurationDescription durationDescription;

    private com.cannontech.multispeak.deploy.service.UnitPrefix unitPrefix;

    private com.cannontech.multispeak.deploy.service.Accountability quadrant;
    ...
    public MeasurementType(
           ...
           com.cannontech.multispeak.deploy.service.TimeSpan timeSpan,
           java.util.Calendar stopTime,
           com.cannontech.multispeak.deploy.service.DurationDescription durationDescription,
           com.cannontech.multispeak.deploy.service.UnitPrefix unitPrefix,
           com.cannontech.multispeak.deploy.service.Accountability quadrant,
     ...
     * @return timeSpan
     */
    public com.cannontech.multispeak.deploy.service.TimeSpan getTimeSpan() {
        return timeSpan;
    }
     ...
     * @param timeSpan
     */
    public void setTimeSpan(com.cannontech.multispeak.deploy.service.TimeSpan timeSpan) {
        this.timeSpan = timeSpan;
    }
     ...
     */
    public com.cannontech.multispeak.deploy.service.DurationDescription getDurationDescription() {
        return durationDescription;
    }
     ...
     */
    public void setDurationDescription(com.cannontech.multispeak.deploy.service.DurationDescription durationDescription) {
        this.durationDescription = durationDescription;
    }
     ...
     * @return quadrant
     */
    public com.cannontech.multispeak.deploy.service.Accountability getQuadrant() {
        return quadrant;
    }
     ...
     * @param quadrant
     */
    public void setQuadrant(com.cannontech.multispeak.deploy.service.Accountability quadrant) {
        this.quadrant = quadrant;
    }
