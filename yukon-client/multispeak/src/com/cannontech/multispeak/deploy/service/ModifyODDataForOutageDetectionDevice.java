...
public class ModifyODDataForOutageDetectionDevice  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.OutageDetectionDevice oDDevice;

    public ModifyODDataForOutageDetectionDevice() {
    }

    public ModifyODDataForOutageDetectionDevice(
           com.cannontech.multispeak.deploy.service.OutageDetectionDevice oDDevice) {
     ...
     * @return oDDevice
     */
    public com.cannontech.multispeak.deploy.service.OutageDetectionDevice getODDevice() {
        return oDDevice;
    }
     ...
     * @param oDDevice
     */
    public void setODDevice(com.cannontech.multispeak.deploy.service.OutageDetectionDevice oDDevice) {
        this.oDDevice = oDDevice;
    }
