...
public class CB_CDLocator extends org.apache.axis.client.Service implements com.cannontech.multispeak.deploy.service.CB_CD {
    ...
    public com.cannontech.multispeak.deploy.service.CB_CDSoap_PortType getCB_CDSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.cannontech.multispeak.deploy.service.CB_CDSoap_PortType getCB_CDSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.deploy.service.CB_CDSoap12Stub _stub = new com.cannontech.multispeak.deploy.service.CB_CDSoap12Stub(portAddress, this);
    ...
    public com.cannontech.multispeak.deploy.service.CB_CDSoap_PortType getCB_CDSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.cannontech.multispeak.deploy.service.CB_CDSoap_PortType getCB_CDSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.deploy.service.CB_CDSoap_BindingStub _stub = new com.cannontech.multispeak.deploy.service.CB_CDSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cannontech.multispeak.deploy.service.CB_CDSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.deploy.service.CB_CDSoap12Stub _stub = new com.cannontech.multispeak.deploy.service.CB_CDSoap12Stub(new java.net.URL(CB_CDSoap12_address), this);
                _stub.setPortName(getCB_CDSoap12WSDDServiceName());
                return _stub;
            }
            if (com.cannontech.multispeak.deploy.service.CB_CDSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.deploy.service.CB_CDSoap_BindingStub _stub = new com.cannontech.multispeak.deploy.service.CB_CDSoap_BindingStub(new java.net.URL(CB_CDSoap_address), this);
                _stub.setPortName(getCB_CDSoapWSDDServiceName());
                return _stub;
            }
        }
