...
public class InitiateODEventRequestByObjectResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] initiateODEventRequestByObjectResult;

    public InitiateODEventRequestByObjectResponse() {
    }

    public InitiateODEventRequestByObjectResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] initiateODEventRequestByObjectResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getInitiateODEventRequestByObjectResult() {
        return initiateODEventRequestByObjectResult;
    }
     ...
     */
    public void setInitiateODEventRequestByObjectResult(com.cannontech.multispeak.deploy.service.ErrorObject[] initiateODEventRequestByObjectResult) {
        this.initiateODEventRequestByObjectResult = initiateODEventRequestByObjectResult;
    }
        ...
        _equals = true && 
            ((this.initiateODEventRequestByObjectResult==null && other.getInitiateODEventRequestByObjectResult()==null) || 
             (this.initiateODEventRequestByObjectResult!=null &&
              java.util.Arrays.equals(this.initiateODEventRequestByObjectResult, other.getInitiateODEventRequestByObjectResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getInitiateODEventRequestByObjectResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getInitiateODEventRequestByObjectResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getInitiateODEventRequestByObjectResult(), i);
                if (obj != null &&
