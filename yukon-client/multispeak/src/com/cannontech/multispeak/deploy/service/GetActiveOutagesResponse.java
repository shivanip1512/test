...
public class GetActiveOutagesResponse  implements java.io.Serializable {
    private java.lang.String[] getActiveOutagesResult;

    public GetActiveOutagesResponse() {
    }

    public GetActiveOutagesResponse(
           java.lang.String[] getActiveOutagesResult) {
     ...
     */
    public java.lang.String[] getGetActiveOutagesResult() {
        return getActiveOutagesResult;
    }
     ...
     */
    public void setGetActiveOutagesResult(java.lang.String[] getActiveOutagesResult) {
        this.getActiveOutagesResult = getActiveOutagesResult;
    }
        ...
        _equals = true && 
            ((this.getActiveOutagesResult==null && other.getGetActiveOutagesResult()==null) || 
             (this.getActiveOutagesResult!=null &&
              java.util.Arrays.equals(this.getActiveOutagesResult, other.getGetActiveOutagesResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetActiveOutagesResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetActiveOutagesResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetActiveOutagesResult(), i);
                if (obj != null &&
