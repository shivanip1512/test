...
public class CustomersAffectedByOutageNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] customersAffectedByOutageNotificationResult;

    public CustomersAffectedByOutageNotificationResponse() {
    }

    public CustomersAffectedByOutageNotificationResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] customersAffectedByOutageNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getCustomersAffectedByOutageNotificationResult() {
        return customersAffectedByOutageNotificationResult;
    }
     ...
     */
    public void setCustomersAffectedByOutageNotificationResult(com.cannontech.multispeak.deploy.service.ErrorObject[] customersAffectedByOutageNotificationResult) {
        this.customersAffectedByOutageNotificationResult = customersAffectedByOutageNotificationResult;
    }
        ...
        _equals = true && 
            ((this.customersAffectedByOutageNotificationResult==null && other.getCustomersAffectedByOutageNotificationResult()==null) || 
             (this.customersAffectedByOutageNotificationResult!=null &&
              java.util.Arrays.equals(this.customersAffectedByOutageNotificationResult, other.getCustomersAffectedByOutageNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCustomersAffectedByOutageNotificationResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCustomersAffectedByOutageNotificationResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCustomersAffectedByOutageNotificationResult(), i);
                if (obj != null &&
