...
public class GetServiceLocationByServiceStatusResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByServiceStatusResult;

    public GetServiceLocationByServiceStatusResponse() {
    }

    public GetServiceLocationByServiceStatusResponse(
           com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByServiceStatusResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ServiceLocation[] getGetServiceLocationByServiceStatusResult() {
        return getServiceLocationByServiceStatusResult;
    }
     ...
     */
    public void setGetServiceLocationByServiceStatusResult(com.cannontech.multispeak.deploy.service.ServiceLocation[] getServiceLocationByServiceStatusResult) {
        this.getServiceLocationByServiceStatusResult = getServiceLocationByServiceStatusResult;
    }
        ...
        _equals = true && 
            ((this.getServiceLocationByServiceStatusResult==null && other.getGetServiceLocationByServiceStatusResult()==null) || 
             (this.getServiceLocationByServiceStatusResult!=null &&
              java.util.Arrays.equals(this.getServiceLocationByServiceStatusResult, other.getGetServiceLocationByServiceStatusResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetServiceLocationByServiceStatusResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetServiceLocationByServiceStatusResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetServiceLocationByServiceStatusResult(), i);
                if (obj != null &&
