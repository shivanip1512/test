...
public class GetCustomerByNameResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.Customer[] getCustomerByNameResult;

    public GetCustomerByNameResponse() {
    }

    public GetCustomerByNameResponse(
           com.cannontech.multispeak.deploy.service.Customer[] getCustomerByNameResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.Customer[] getGetCustomerByNameResult() {
        return getCustomerByNameResult;
    }
     ...
     */
    public void setGetCustomerByNameResult(com.cannontech.multispeak.deploy.service.Customer[] getCustomerByNameResult) {
        this.getCustomerByNameResult = getCustomerByNameResult;
    }
        ...
        _equals = true && 
            ((this.getCustomerByNameResult==null && other.getGetCustomerByNameResult()==null) || 
             (this.getCustomerByNameResult!=null &&
              java.util.Arrays.equals(this.getCustomerByNameResult, other.getGetCustomerByNameResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetCustomerByNameResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetCustomerByNameResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetCustomerByNameResult(), i);
                if (obj != null &&
