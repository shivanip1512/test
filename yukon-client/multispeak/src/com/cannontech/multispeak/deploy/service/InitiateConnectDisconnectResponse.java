...
public class InitiateConnectDisconnectResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] initiateConnectDisconnectResult;

    public InitiateConnectDisconnectResponse() {
    }

    public InitiateConnectDisconnectResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] initiateConnectDisconnectResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getInitiateConnectDisconnectResult() {
        return initiateConnectDisconnectResult;
    }
     ...
     */
    public void setInitiateConnectDisconnectResult(com.cannontech.multispeak.deploy.service.ErrorObject[] initiateConnectDisconnectResult) {
        this.initiateConnectDisconnectResult = initiateConnectDisconnectResult;
    }
        ...
        _equals = true && 
            ((this.initiateConnectDisconnectResult==null && other.getInitiateConnectDisconnectResult()==null) || 
             (this.initiateConnectDisconnectResult!=null &&
              java.util.Arrays.equals(this.initiateConnectDisconnectResult, other.getInitiateConnectDisconnectResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getInitiateConnectDisconnectResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getInitiateConnectDisconnectResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getInitiateConnectDisconnectResult(), i);
                if (obj != null &&
