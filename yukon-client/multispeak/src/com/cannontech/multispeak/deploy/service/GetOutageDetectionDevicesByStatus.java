...
public class GetOutageDetectionDevicesByStatus  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.OutageDetectDeviceStatus oDDStatus;
    ...
    public GetOutageDetectionDevicesByStatus(
           com.cannontech.multispeak.deploy.service.OutageDetectDeviceStatus oDDStatus,
     ...
     * @return oDDStatus
     */
    public com.cannontech.multispeak.deploy.service.OutageDetectDeviceStatus getODDStatus() {
        return oDDStatus;
    }
     ...
     * @param oDDStatus
     */
    public void setODDStatus(com.cannontech.multispeak.deploy.service.OutageDetectDeviceStatus oDDStatus) {
        this.oDDStatus = oDDStatus;
    }
