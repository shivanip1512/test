...
public class GetOutageDetectionDevicesByTypeResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getOutageDetectionDevicesByTypeResult;

    public GetOutageDetectionDevicesByTypeResponse() {
    }

    public GetOutageDetectionDevicesByTypeResponse(
           com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getOutageDetectionDevicesByTypeResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getGetOutageDetectionDevicesByTypeResult() {
        return getOutageDetectionDevicesByTypeResult;
    }
     ...
     */
    public void setGetOutageDetectionDevicesByTypeResult(com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getOutageDetectionDevicesByTypeResult) {
        this.getOutageDetectionDevicesByTypeResult = getOutageDetectionDevicesByTypeResult;
    }
        ...
        _equals = true && 
            ((this.getOutageDetectionDevicesByTypeResult==null && other.getGetOutageDetectionDevicesByTypeResult()==null) || 
             (this.getOutageDetectionDevicesByTypeResult!=null &&
              java.util.Arrays.equals(this.getOutageDetectionDevicesByTypeResult, other.getGetOutageDetectionDevicesByTypeResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetOutageDetectionDevicesByTypeResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetOutageDetectionDevicesByTypeResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetOutageDetectionDevicesByTypeResult(), i);
                if (obj != null &&
