...
public class CancelDisconnectedStatusResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] cancelDisconnectedStatusResult;

    public CancelDisconnectedStatusResponse() {
    }

    public CancelDisconnectedStatusResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] cancelDisconnectedStatusResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getCancelDisconnectedStatusResult() {
        return cancelDisconnectedStatusResult;
    }
     ...
     */
    public void setCancelDisconnectedStatusResult(com.cannontech.multispeak.deploy.service.ErrorObject[] cancelDisconnectedStatusResult) {
        this.cancelDisconnectedStatusResult = cancelDisconnectedStatusResult;
    }
        ...
        _equals = true && 
            ((this.cancelDisconnectedStatusResult==null && other.getCancelDisconnectedStatusResult()==null) || 
             (this.cancelDisconnectedStatusResult!=null &&
              java.util.Arrays.equals(this.cancelDisconnectedStatusResult, other.getCancelDisconnectedStatusResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCancelDisconnectedStatusResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCancelDisconnectedStatusResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCancelDisconnectedStatusResult(), i);
                if (obj != null &&
