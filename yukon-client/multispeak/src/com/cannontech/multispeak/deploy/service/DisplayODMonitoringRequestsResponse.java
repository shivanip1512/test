...
public class DisplayODMonitoringRequestsResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ObjectRef[] displayODMonitoringRequestsResult;

    public DisplayODMonitoringRequestsResponse() {
    }

    public DisplayODMonitoringRequestsResponse(
           com.cannontech.multispeak.deploy.service.ObjectRef[] displayODMonitoringRequestsResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ObjectRef[] getDisplayODMonitoringRequestsResult() {
        return displayODMonitoringRequestsResult;
    }
     ...
     */
    public void setDisplayODMonitoringRequestsResult(com.cannontech.multispeak.deploy.service.ObjectRef[] displayODMonitoringRequestsResult) {
        this.displayODMonitoringRequestsResult = displayODMonitoringRequestsResult;
    }
        ...
        _equals = true && 
            ((this.displayODMonitoringRequestsResult==null && other.getDisplayODMonitoringRequestsResult()==null) || 
             (this.displayODMonitoringRequestsResult!=null &&
              java.util.Arrays.equals(this.displayODMonitoringRequestsResult, other.getDisplayODMonitoringRequestsResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDisplayODMonitoringRequestsResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getDisplayODMonitoringRequestsResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDisplayODMonitoringRequestsResult(), i);
                if (obj != null &&
