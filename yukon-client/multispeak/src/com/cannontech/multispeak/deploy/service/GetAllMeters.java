...
public class GetAllMeters  implements java.io.Serializable {
    ...
    /**
     * Gets the lastReceived value for this GetAllMeters.
     * 
     * @return lastReceived
     */
    ...
    /**
     * Sets the lastReceived value for this GetAllMeters.
     * 
     * @param lastReceived
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAllMeters)) return false;
        GetAllMeters other = (GetAllMeters) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAllMeters.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">GetAllMeters"));
