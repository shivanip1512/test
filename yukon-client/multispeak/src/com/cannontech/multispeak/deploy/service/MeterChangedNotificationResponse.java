...
public class MeterChangedNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] meterChangedNotificationResult;

    public MeterChangedNotificationResponse() {
    }

    public MeterChangedNotificationResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] meterChangedNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getMeterChangedNotificationResult() {
        return meterChangedNotificationResult;
    }
     ...
     */
    public void setMeterChangedNotificationResult(com.cannontech.multispeak.deploy.service.ErrorObject[] meterChangedNotificationResult) {
        this.meterChangedNotificationResult = meterChangedNotificationResult;
    }
        ...
        _equals = true && 
            ((this.meterChangedNotificationResult==null && other.getMeterChangedNotificationResult()==null) || 
             (this.meterChangedNotificationResult!=null &&
              java.util.Arrays.equals(this.meterChangedNotificationResult, other.getMeterChangedNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterChangedNotificationResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMeterChangedNotificationResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMeterChangedNotificationResult(), i);
                if (obj != null &&
