...
public class MeterAddNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] meterAddNotificationResult;

    public MeterAddNotificationResponse() {
    }

    public MeterAddNotificationResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] meterAddNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getMeterAddNotificationResult() {
        return meterAddNotificationResult;
    }
     ...
     */
    public void setMeterAddNotificationResult(com.cannontech.multispeak.deploy.service.ErrorObject[] meterAddNotificationResult) {
        this.meterAddNotificationResult = meterAddNotificationResult;
    }
        ...
        _equals = true && 
            ((this.meterAddNotificationResult==null && other.getMeterAddNotificationResult()==null) || 
             (this.meterAddNotificationResult!=null &&
              java.util.Arrays.equals(this.meterAddNotificationResult, other.getMeterAddNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterAddNotificationResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMeterAddNotificationResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMeterAddNotificationResult(), i);
                if (obj != null &&
