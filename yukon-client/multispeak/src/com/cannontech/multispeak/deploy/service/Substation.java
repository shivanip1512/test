...
public class Substation  extends com.cannontech.multispeak.deploy.service.MspElectricPoint  implements java.io.Serializable {
    private java.lang.String zMin;

    private java.lang.String zMax;

    private com.cannontech.multispeak.deploy.service.ZUnit units;

    private com.cannontech.multispeak.deploy.service.ComplexNum posSeqZ;

    private com.cannontech.multispeak.deploy.service.ComplexNum zeroSeqZ;

    private com.cannontech.multispeak.deploy.service.ComplexNum negSeqZ;
    ...
    private com.cannontech.multispeak.deploy.service.LdCon ldCon;

    private java.lang.Boolean isRegulated;

    private com.cannontech.multispeak.deploy.service.FeederObject[] feederList;
    ...
    public Substation(
           ...
           com.cannontech.multispeak.deploy.service.ZUnit units,
           com.cannontech.multispeak.deploy.service.ComplexNum posSeqZ,
           com.cannontech.multispeak.deploy.service.ComplexNum zeroSeqZ,
           com.cannontech.multispeak.deploy.service.ComplexNum negSeqZ,
     ...
     * @return units
     */
    public com.cannontech.multispeak.deploy.service.ZUnit getUnits() {
        return units;
    }
     ...
     * @param units
     */
    public void setUnits(com.cannontech.multispeak.deploy.service.ZUnit units) {
        this.units = units;
    }
     ...
     * @return posSeqZ
     */
    public com.cannontech.multispeak.deploy.service.ComplexNum getPosSeqZ() {
        return posSeqZ;
    }
     ...
     * @param posSeqZ
     */
    public void setPosSeqZ(com.cannontech.multispeak.deploy.service.ComplexNum posSeqZ) {
        this.posSeqZ = posSeqZ;
    }
     ...
     * @return zeroSeqZ
     */
    public com.cannontech.multispeak.deploy.service.ComplexNum getZeroSeqZ() {
        return zeroSeqZ;
    }
     ...
     * @param zeroSeqZ
     */
    public void setZeroSeqZ(com.cannontech.multispeak.deploy.service.ComplexNum zeroSeqZ) {
        this.zeroSeqZ = zeroSeqZ;
    }
     ...
     * @return negSeqZ
     */
    public com.cannontech.multispeak.deploy.service.ComplexNum getNegSeqZ() {
        return negSeqZ;
    }
     ...
     * @param negSeqZ
     */
    public void setNegSeqZ(com.cannontech.multispeak.deploy.service.ComplexNum negSeqZ) {
        this.negSeqZ = negSeqZ;
    }
     ...
     * @return ldCon
     */
    public com.cannontech.multispeak.deploy.service.LdCon getLdCon() {
        return ldCon;
    }
     ...
     * @param ldCon
     */
    public void setLdCon(com.cannontech.multispeak.deploy.service.LdCon ldCon) {
        this.ldCon = ldCon;
    }
     ...
     * @return feederList
     */
    public com.cannontech.multispeak.deploy.service.FeederObject[] getFeederList() {
        return feederList;
    }
     ...
     * @param feederList
     */
    public void setFeederList(com.cannontech.multispeak.deploy.service.FeederObject[] feederList) {
        this.feederList = feederList;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFeederList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getFeederList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getFeederList(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "feederObject"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
