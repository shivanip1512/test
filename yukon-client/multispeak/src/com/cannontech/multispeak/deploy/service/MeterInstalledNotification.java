/**
 * MeterInstalledNotification.java
 *
...
public class MeterInstalledNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.Meter[] addedMeters;

    public MeterInstalledNotification() {
    }
    ...
    /**
     * Gets the addedMeters value for this MeterInstalledNotification.
     * 
     * @return addedMeters
     */
    ...
    /**
     * Sets the addedMeters value for this MeterInstalledNotification.
     * 
     * @param addedMeters
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MeterInstalledNotification)) return false;
        MeterInstalledNotification other = (MeterInstalledNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MeterInstalledNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">MeterInstalledNotification"));
