...
public class LoadSection  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.LoadDistr loadDistr;

    private java.lang.Float loadGrowth;

    private com.cannontech.multispeak.deploy.service.LoadInterruptibleType interruptibleType;

    private com.cannontech.multispeak.deploy.service.AllocatedLoad[] allocated;
    ...
    public LoadSection(
           ...
           com.cannontech.multispeak.deploy.service.LoadDistr loadDistr,
           java.lang.Float loadGrowth,
           com.cannontech.multispeak.deploy.service.LoadInterruptibleType interruptibleType,
           com.cannontech.multispeak.deploy.service.AllocatedLoad[] allocated) {
     ...
     * @return loadDistr
     */
    public com.cannontech.multispeak.deploy.service.LoadDistr getLoadDistr() {
        return loadDistr;
    }
     ...
     * @param loadDistr
     */
    public void setLoadDistr(com.cannontech.multispeak.deploy.service.LoadDistr loadDistr) {
        this.loadDistr = loadDistr;
    }
     ...
     */
    public com.cannontech.multispeak.deploy.service.LoadInterruptibleType getInterruptibleType() {
        return interruptibleType;
    }
     ...
     */
    public void setInterruptibleType(com.cannontech.multispeak.deploy.service.LoadInterruptibleType interruptibleType) {
        this.interruptibleType = interruptibleType;
    }
     ...
     * @return allocated
     */
    public com.cannontech.multispeak.deploy.service.AllocatedLoad[] getAllocated() {
        return allocated;
    }
     ...
     * @param allocated
     */
    public void setAllocated(com.cannontech.multispeak.deploy.service.AllocatedLoad[] allocated) {
        this.allocated = allocated;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.allocated==null && other.getAllocated()==null) || 
             (this.allocated!=null &&
              java.util.Arrays.equals(this.allocated, other.getAllocated())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAllocated() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAllocated());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAllocated(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "allocatedLoad"));
        typeDesc.addFieldDesc(elemField);
    }
