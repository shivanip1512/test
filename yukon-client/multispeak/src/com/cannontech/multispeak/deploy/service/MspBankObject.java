...
public abstract class MspBankObject  extends com.cannontech.multispeak.deploy.service.MspElectricPoint  implements java.io.Serializable {
    public MspBankObject() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MspBankObject)) return false;
        MspBankObject other = (MspBankObject) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MspBankObject.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "mspBankObject"));
    }
