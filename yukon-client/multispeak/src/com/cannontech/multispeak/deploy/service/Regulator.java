...
public class Regulator  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.MspPhase phase;
    ...
    public Regulator(
           ...
           com.cannontech.multispeak.deploy.service.MspPhase phase,
           java.lang.Float kva) {
        super(
            objectID,
            verb,
     ...
     * @return phase
     */
    public com.cannontech.multispeak.deploy.service.MspPhase getPhase() {
        return phase;
    }
     ...
     * @param phase
     */
    public void setPhase(com.cannontech.multispeak.deploy.service.MspPhase phase) {
        this.phase = phase;
    }
