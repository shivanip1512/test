...
public class GetSchedules  implements java.io.Serializable {
    ...
    /**
     * Gets the lastReceived value for this GetSchedules.
     * 
     * @return lastReceived
     */
    ...
    /**
     * Sets the lastReceived value for this GetSchedules.
     * 
     * @param lastReceived
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSchedules)) return false;
        GetSchedules other = (GetSchedules) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSchedules.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">GetSchedules"));
