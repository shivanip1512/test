...
public class ChannelBlock  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.Status status;

    private com.cannontech.multispeak.deploy.service.Interval[] interval;
    ...
    public ChannelBlock(
           com.cannontech.multispeak.deploy.service.Status status,
           com.cannontech.multispeak.deploy.service.Interval[] interval,
     ...
     * @return status
     */
    public com.cannontech.multispeak.deploy.service.Status getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.cannontech.multispeak.deploy.service.Status status) {
        this.status = status;
    }
     ...
     * @return interval
     */
    public com.cannontech.multispeak.deploy.service.Interval[] getInterval() {
        return interval;
    }
     ...
     * @param interval
     */
    public void setInterval(com.cannontech.multispeak.deploy.service.Interval[] interval) {
        this.interval = interval;
    }

    public com.cannontech.multispeak.deploy.service.Interval getInterval(int i) {
        return this.interval[i];
    }

    public void setInterval(int i, com.cannontech.multispeak.deploy.service.Interval _value) {
