/**
 * GetModifiedCircuitElements.java
 *
...
public class GetModifiedCircuitElements  implements java.io.Serializable {
    private java.lang.String previousSessionID;

    private java.lang.String lastReceived;

    public GetModifiedCircuitElements() {
    }
    ...
    /**
     * Gets the previousSessionID value for this GetModifiedCircuitElements.
     * 
    ...
    /**
     * Sets the previousSessionID value for this GetModifiedCircuitElements.
     * 
    ...
    /**
     * Gets the lastReceived value for this GetModifiedCircuitElements.
     * 
     * @return lastReceived
     */
    ...
    /**
     * Sets the lastReceived value for this GetModifiedCircuitElements.
     * 
     * @param lastReceived
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetModifiedCircuitElements)) return false;
        GetModifiedCircuitElements other = (GetModifiedCircuitElements) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetModifiedCircuitElements.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">GetModifiedCircuitElements"));
