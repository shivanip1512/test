...
public class MeterExchangeNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] meterExchangeNotificationResult;

    public MeterExchangeNotificationResponse() {
    }

    public MeterExchangeNotificationResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] meterExchangeNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getMeterExchangeNotificationResult() {
        return meterExchangeNotificationResult;
    }
     ...
     */
    public void setMeterExchangeNotificationResult(com.cannontech.multispeak.deploy.service.ErrorObject[] meterExchangeNotificationResult) {
        this.meterExchangeNotificationResult = meterExchangeNotificationResult;
    }
        ...
        _equals = true && 
            ((this.meterExchangeNotificationResult==null && other.getMeterExchangeNotificationResult()==null) || 
             (this.meterExchangeNotificationResult!=null &&
              java.util.Arrays.equals(this.meterExchangeNotificationResult, other.getMeterExchangeNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterExchangeNotificationResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMeterExchangeNotificationResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMeterExchangeNotificationResult(), i);
                if (obj != null &&
