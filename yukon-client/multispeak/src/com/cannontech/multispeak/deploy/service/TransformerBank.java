...
public class TransformerBank  extends com.cannontech.multispeak.deploy.service.MspBankObject  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.WdgCode wdgCode;

    private java.lang.String transDescr;

    private com.cannontech.multispeak.deploy.service.Mounting mounting;

    private java.lang.Float vInput;

    private java.lang.Float vOut;

    private com.cannontech.multispeak.deploy.service.Config sourceSideConfig;

    private java.lang.Float tertVolts;

    private com.cannontech.multispeak.deploy.service.ObjectRef tertChild;
    ...
    public TransformerBank(
           ...
           com.cannontech.multispeak.deploy.service.Config sourceSideConfig,
           java.lang.Float tertVolts,
           com.cannontech.multispeak.deploy.service.ObjectRef tertChild,
     ...
     * @return wdgCode
     */
    public com.cannontech.multispeak.deploy.service.WdgCode getWdgCode() {
        return wdgCode;
    }
     ...
     * @param wdgCode
     */
    public void setWdgCode(com.cannontech.multispeak.deploy.service.WdgCode wdgCode) {
        this.wdgCode = wdgCode;
    }
     ...
     * @return mounting
     */
    public com.cannontech.multispeak.deploy.service.Mounting getMounting() {
        return mounting;
    }
     ...
     * @param mounting
     */
    public void setMounting(com.cannontech.multispeak.deploy.service.Mounting mounting) {
        this.mounting = mounting;
    }
     ...
     */
    public com.cannontech.multispeak.deploy.service.Config getSourceSideConfig() {
        return sourceSideConfig;
    }
     ...
     */
    public void setSourceSideConfig(com.cannontech.multispeak.deploy.service.Config sourceSideConfig) {
        this.sourceSideConfig = sourceSideConfig;
    }
     ...
     * @return tertChild
     */
    public com.cannontech.multispeak.deploy.service.ObjectRef getTertChild() {
        return tertChild;
    }
     ...
     * @param tertChild
     */
    public void setTertChild(com.cannontech.multispeak.deploy.service.ObjectRef tertChild) {
        this.tertChild = tertChild;
    }
     ...
     */
    public com.cannontech.multispeak.deploy.service.Transformer[] getTransformerList() {
        return transformerList;
    }
     ...
     */
    public void setTransformerList(com.cannontech.multispeak.deploy.service.Transformer[] transformerList) {
        this.transformerList = transformerList;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getTransformerList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getTransformerList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getTransformerList(), i);
                if (obj != null &&
