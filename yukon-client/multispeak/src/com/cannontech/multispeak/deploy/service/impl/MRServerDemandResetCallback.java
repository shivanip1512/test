...
public class MRServerDemandResetCallback extends DemandResetVerificationCallback {
    ...
    public MRServerDemandResetCallback(MspObjectDao mspObjectDao, MultispeakEventLogService multispeakEventLogService,
            MultispeakVendor vendor, Map<PaoIdentifier, String> meterNumbersByPaoId, String responseURL,
    ...
    public void initiated(Results results) {
        ...
        for (YukonPao device : drErrors.keySet()) {
            ...
            errors.add(mspObjectDao.getErrorObject(meterNumber, error.getPorter(), "Meter", "initiateDemandReset",
    ...
    public void verified(SimpleDevice device, Instant pointDataTimeStamp) {
        ...
        try {
            ...
            MeterEventNotificationResponse meterEventNotificationResponse =
                cbClient.meterEventNotification(vendor, responseUrl, meterEventNotification);

            ErrorObject[] errObjects = null;
            if (meterEventNotificationResponse != null) {
                ArrayOfErrorObject arrayOfErrorObject =
                    meterEventNotificationResponse.getMeterEventNotificationResult();
            ...
            multispeakEventLogService.notificationResponse("initiateDemandReset", transactionId, meterNumber,
                "Reset and Verified", errObjects.length, responseUrl);
