...
public class Channel  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ChannelBlock[] blockList;
    ...
    public Channel(
           com.cannontech.multispeak.deploy.service.ChannelBlock[] blockList,
     ...
     * @return blockList
     */
    public com.cannontech.multispeak.deploy.service.ChannelBlock[] getBlockList() {
        return blockList;
    }
     ...
     * @param blockList
     */
    public void setBlockList(com.cannontech.multispeak.deploy.service.ChannelBlock[] blockList) {
        this.blockList = blockList;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getBlockList() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getBlockList(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "block"));
