...
public class EventInstance  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.MeterEvent meterEvent;
    ...
    public EventInstance(
           ...
           com.cannontech.multispeak.deploy.service.MeterEvent meterEvent) {
    ...
    /**
     * Gets the extensions value for this EventInstance.
     * 
     * @return extensions
     */
    ...
    /**
     * Sets the extensions value for this EventInstance.
     * 
     * @param extensions
     */
    ...
    /**
     * Gets the meterNo value for this EventInstance.
     * 
     * @return meterNo
     */
    ...
    /**
     * Sets the meterNo value for this EventInstance.
     * 
     * @param meterNo
     */
    ...
    /**
     * Gets the serviceType value for this EventInstance.
     * 
     * @return serviceType
     */
    ...
    /**
     * Sets the serviceType value for this EventInstance.
     * 
     * @param serviceType
     */
    ...
    /**
     * Gets the meterID value for this EventInstance.
     * 
     * @return meterID
     */
    ...
    /**
     * Sets the meterID value for this EventInstance.
     * 
     * @param meterID
     */
    ...
    /**
     * Gets the meterEvent value for this EventInstance.
     * 
     * @return meterEvent
     */
    public com.cannontech.multispeak.deploy.service.MeterEvent getMeterEvent() {
        return meterEvent;
    }


    /**
     * Sets the meterEvent value for this EventInstance.
     * 
     * @param meterEvent
     */
    public void setMeterEvent(com.cannontech.multispeak.deploy.service.MeterEvent meterEvent) {
        this.meterEvent = meterEvent;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EventInstance)) return false;
        ...
        _equals = true && 
            ...
            ((this.meterEvent==null && other.getMeterEvent()==null) || 
             (this.meterEvent!=null &&
              this.meterEvent.equals(other.getMeterEvent())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterEvent() != null) {
            _hashCode += getMeterEvent().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EventInstance.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "eventInstance"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("meterEvent");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "meterEvent"));
