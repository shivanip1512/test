...
public class RequestPaymentExtension  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.PaymentExtension[] extensionList;

    public RequestPaymentExtension() {
    }
    ...
    /**
     * Gets the extensionList value for this RequestPaymentExtension.
     * 
    ...
    /**
     * Sets the extensionList value for this RequestPaymentExtension.
     * 
     * @param extensionList
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RequestPaymentExtension)) return false;
        RequestPaymentExtension other = (RequestPaymentExtension) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RequestPaymentExtension.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">RequestPaymentExtension"));
