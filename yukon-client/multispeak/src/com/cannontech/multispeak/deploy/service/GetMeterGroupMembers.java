...
public class GetMeterGroupMembers  implements java.io.Serializable {
    private java.lang.String meterGroupName;

    public GetMeterGroupMembers() {
    }
    ...
    /**
     * Gets the meterGroupName value for this GetMeterGroupMembers.
     * 
    ...
    /**
     * Sets the meterGroupName value for this GetMeterGroupMembers.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetMeterGroupMembers)) return false;
        GetMeterGroupMembers other = (GetMeterGroupMembers) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetMeterGroupMembers.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">GetMeterGroupMembers"));
