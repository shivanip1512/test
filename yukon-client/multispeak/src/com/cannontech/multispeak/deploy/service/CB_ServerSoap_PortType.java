...
public interface CB_ServerSoap_PortType extends java.rmi.Remote {
    ...
    /**
     * Allow client to Modify CB data for a specific customer object.
    ...
    /**
     * Allow client to Modify CB data for the Service Location object.
     * If this transaction fails, CB returns information in a SOAPFault.
     */
    ...
    /**
     * Allow client to Modify CB data for the Meter object.  If this
    ...
    /**
     * Publisher notifies CB of a change in the History Log by sending
     * the changed historyLog object.  CB returns information about failed
     ...
     * failed transactions in an array of errorObjects. (Optional)
     */
