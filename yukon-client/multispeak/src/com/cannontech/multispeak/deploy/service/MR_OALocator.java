...
public class MR_OALocator extends org.apache.axis.client.Service implements com.cannontech.multispeak.deploy.service.MR_OA {
    ...
    private java.lang.String MR_OASoap12_address = "http://www.multispeak.org/interface/30p/27_MR_OA.asmx";
    ...
    public com.cannontech.multispeak.deploy.service.MR_OASoap_PortType getMR_OASoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.deploy.service.MR_OASoap12Stub _stub = new com.cannontech.multispeak.deploy.service.MR_OASoap12Stub(portAddress, this);
    ...
    private java.lang.String MR_OASoap_address = "http://www.multispeak.org/interface/30p/27_MR_OA.asmx";
    ...
    public com.cannontech.multispeak.deploy.service.MR_OASoap_PortType getMR_OASoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.deploy.service.MR_OASoap_BindingStub _stub = new com.cannontech.multispeak.deploy.service.MR_OASoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cannontech.multispeak.deploy.service.MR_OASoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.deploy.service.MR_OASoap12Stub _stub = new com.cannontech.multispeak.deploy.service.MR_OASoap12Stub(new java.net.URL(MR_OASoap12_address), this);
                _stub.setPortName(getMR_OASoap12WSDDServiceName());
                return _stub;
            }
            if (com.cannontech.multispeak.deploy.service.MR_OASoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.deploy.service.MR_OASoap_BindingStub _stub = new com.cannontech.multispeak.deploy.service.MR_OASoap_BindingStub(new java.net.URL(MR_OASoap_address), this);
                _stub.setPortName(getMR_OASoapWSDDServiceName());
                return _stub;
            }
        }
