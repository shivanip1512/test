...
public class GetModifiedCustomers  implements java.io.Serializable {
    private java.lang.String previousSessionID;

    private java.lang.String lastReceived;

    public GetModifiedCustomers() {
    }
    ...
    /**
     * Gets the previousSessionID value for this GetModifiedCustomers.
     * 
    ...
    /**
     * Sets the previousSessionID value for this GetModifiedCustomers.
     * 
    ...
    /**
     * Gets the lastReceived value for this GetModifiedCustomers.
     * 
     * @return lastReceived
     */
    ...
    /**
     * Sets the lastReceived value for this GetModifiedCustomers.
     * 
     * @param lastReceived
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetModifiedCustomers)) return false;
        GetModifiedCustomers other = (GetModifiedCustomers) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetModifiedCustomers.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">GetModifiedCustomers"));
