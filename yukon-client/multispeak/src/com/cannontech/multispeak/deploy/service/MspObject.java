...
public abstract class MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.Action verb;  // attribute
     ...
     * @return verb
     */
    public com.cannontech.multispeak.deploy.service.Action getVerb() {
        return verb;
    }
     ...
     * @param verb
     */
    public void setVerb(com.cannontech.multispeak.deploy.service.Action verb) {
        this.verb = verb;
    }
