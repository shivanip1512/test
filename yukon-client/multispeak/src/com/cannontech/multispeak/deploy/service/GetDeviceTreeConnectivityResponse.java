...
public class GetDeviceTreeConnectivityResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.CircuitElement[] getDeviceTreeConnectivityResult;

    public GetDeviceTreeConnectivityResponse() {
    }

    public GetDeviceTreeConnectivityResponse(
           com.cannontech.multispeak.deploy.service.CircuitElement[] getDeviceTreeConnectivityResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.CircuitElement[] getGetDeviceTreeConnectivityResult() {
        return getDeviceTreeConnectivityResult;
    }
     ...
     */
    public void setGetDeviceTreeConnectivityResult(com.cannontech.multispeak.deploy.service.CircuitElement[] getDeviceTreeConnectivityResult) {
        this.getDeviceTreeConnectivityResult = getDeviceTreeConnectivityResult;
    }
        ...
        _equals = true && 
            ((this.getDeviceTreeConnectivityResult==null && other.getGetDeviceTreeConnectivityResult()==null) || 
             (this.getDeviceTreeConnectivityResult!=null &&
              java.util.Arrays.equals(this.getDeviceTreeConnectivityResult, other.getGetDeviceTreeConnectivityResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetDeviceTreeConnectivityResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetDeviceTreeConnectivityResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetDeviceTreeConnectivityResult(), i);
                if (obj != null &&
