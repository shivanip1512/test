...
public class MeterConnectivityNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.MeterConnectivity[] newConnectivity;

    public MeterConnectivityNotification() {
    }

    public MeterConnectivityNotification(
           com.cannontech.multispeak.deploy.service.MeterConnectivity[] newConnectivity) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.MeterConnectivity[] getNewConnectivity() {
        return newConnectivity;
    }
     ...
     */
    public void setNewConnectivity(com.cannontech.multispeak.deploy.service.MeterConnectivity[] newConnectivity) {
        this.newConnectivity = newConnectivity;
    }
        ...
        _equals = true && 
            ((this.newConnectivity==null && other.getNewConnectivity()==null) || 
             (this.newConnectivity!=null &&
              java.util.Arrays.equals(this.newConnectivity, other.getNewConnectivity())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getNewConnectivity() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getNewConnectivity());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getNewConnectivity(), i);
                if (obj != null &&
