...
public class CB_MRLocator extends org.apache.axis.client.Service implements com.cannontech.multispeak.deploy.service.CB_MR {
    ...
    public com.cannontech.multispeak.deploy.service.CB_MRSoap_PortType getCB_MRSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.deploy.service.CB_MRSoap_BindingStub _stub = new com.cannontech.multispeak.deploy.service.CB_MRSoap_BindingStub(portAddress, this);
    ...
    public com.cannontech.multispeak.deploy.service.CB_MRSoap_PortType getCB_MRSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.deploy.service.CB_MRSoap12Stub _stub = new com.cannontech.multispeak.deploy.service.CB_MRSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cannontech.multispeak.deploy.service.CB_MRSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.deploy.service.CB_MRSoap_BindingStub _stub = new com.cannontech.multispeak.deploy.service.CB_MRSoap_BindingStub(new java.net.URL(CB_MRSoap_address), this);
                _stub.setPortName(getCB_MRSoapWSDDServiceName());
                return _stub;
            }
            if (com.cannontech.multispeak.deploy.service.CB_MRSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.deploy.service.CB_MRSoap12Stub _stub = new com.cannontech.multispeak.deploy.service.CB_MRSoap12Stub(new java.net.URL(CB_MRSoap12_address), this);
                _stub.setPortName(getCB_MRSoap12WSDDServiceName());
                return _stub;
            }
        }
