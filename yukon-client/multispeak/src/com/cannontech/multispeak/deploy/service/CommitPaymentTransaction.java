...
public class CommitPaymentTransaction  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.PaymentTransaction[] transactions;

    public CommitPaymentTransaction() {
    }
    ...
    /**
     * Gets the transactions value for this CommitPaymentTransaction.
     * 
     * @return transactions
     */
    ...
    /**
     * Sets the transactions value for this CommitPaymentTransaction.
     * 
     * @param transactions
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CommitPaymentTransaction)) return false;
        CommitPaymentTransaction other = (CommitPaymentTransaction) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CommitPaymentTransaction.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">CommitPaymentTransaction"));
