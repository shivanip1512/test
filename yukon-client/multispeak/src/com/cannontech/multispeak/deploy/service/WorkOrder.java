...
public class WorkOrder  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.ActionCode actionCode;

    private java.lang.String laborCategoryID;

    private java.lang.Float atc;

    private com.cannontech.multispeak.deploy.service.LoadDistrict loadDistrict;
    ...
    private com.cannontech.multispeak.deploy.service.Station[] stationList;
    ...
    public WorkOrder(
           ...
           com.cannontech.multispeak.deploy.service.ActionCode actionCode,
           java.lang.String laborCategoryID,
           java.lang.Float atc,
           com.cannontech.multispeak.deploy.service.LoadDistrict loadDistrict,
     ...
     * @return actionCode
     */
    public com.cannontech.multispeak.deploy.service.ActionCode getActionCode() {
        return actionCode;
    }
     ...
     * @param actionCode
     */
    public void setActionCode(com.cannontech.multispeak.deploy.service.ActionCode actionCode) {
        this.actionCode = actionCode;
    }
     ...
     * @return loadDistrict
     */
    public com.cannontech.multispeak.deploy.service.LoadDistrict getLoadDistrict() {
        return loadDistrict;
    }
     ...
     * @param loadDistrict
     */
    public void setLoadDistrict(com.cannontech.multispeak.deploy.service.LoadDistrict loadDistrict) {
        this.loadDistrict = loadDistrict;
    }
     ...
     * @return stationList
     */
    public com.cannontech.multispeak.deploy.service.Station[] getStationList() {
        return stationList;
    }
     ...
     * @param stationList
     */
    public void setStationList(com.cannontech.multispeak.deploy.service.Station[] stationList) {
        this.stationList = stationList;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getStationList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getStationList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getStationList(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "station"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
