...
public class GetOutagedODDevicesResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getOutagedODDevicesResult;

    public GetOutagedODDevicesResponse() {
    }

    public GetOutagedODDevicesResponse(
           com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getOutagedODDevicesResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getGetOutagedODDevicesResult() {
        return getOutagedODDevicesResult;
    }
     ...
     */
    public void setGetOutagedODDevicesResult(com.cannontech.multispeak.deploy.service.OutageDetectionDevice[] getOutagedODDevicesResult) {
        this.getOutagedODDevicesResult = getOutagedODDevicesResult;
    }
        ...
        _equals = true && 
            ((this.getOutagedODDevicesResult==null && other.getGetOutagedODDevicesResult()==null) || 
             (this.getOutagedODDevicesResult!=null &&
              java.util.Arrays.equals(this.getOutagedODDevicesResult, other.getGetOutagedODDevicesResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetOutagedODDevicesResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetOutagedODDevicesResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetOutagedODDevicesResult(), i);
                if (obj != null &&
