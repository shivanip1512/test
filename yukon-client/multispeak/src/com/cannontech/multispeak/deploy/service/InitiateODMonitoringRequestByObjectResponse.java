...
public class InitiateODMonitoringRequestByObjectResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] initiateODMonitoringRequestByObjectResult;

    public InitiateODMonitoringRequestByObjectResponse() {
    }

    public InitiateODMonitoringRequestByObjectResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] initiateODMonitoringRequestByObjectResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getInitiateODMonitoringRequestByObjectResult() {
        return initiateODMonitoringRequestByObjectResult;
    }
     ...
     */
    public void setInitiateODMonitoringRequestByObjectResult(com.cannontech.multispeak.deploy.service.ErrorObject[] initiateODMonitoringRequestByObjectResult) {
        this.initiateODMonitoringRequestByObjectResult = initiateODMonitoringRequestByObjectResult;
    }
        ...
        _equals = true && 
            ((this.initiateODMonitoringRequestByObjectResult==null && other.getInitiateODMonitoringRequestByObjectResult()==null) || 
             (this.initiateODMonitoringRequestByObjectResult!=null &&
              java.util.Arrays.equals(this.initiateODMonitoringRequestByObjectResult, other.getInitiateODMonitoringRequestByObjectResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getInitiateODMonitoringRequestByObjectResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getInitiateODMonitoringRequestByObjectResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getInitiateODMonitoringRequestByObjectResult(), i);
                if (obj != null &&
