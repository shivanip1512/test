...
public class CustomerChangedNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] customerChangedNotificationResult;

    public CustomerChangedNotificationResponse() {
    }

    public CustomerChangedNotificationResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] customerChangedNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getCustomerChangedNotificationResult() {
        return customerChangedNotificationResult;
    }
     ...
     */
    public void setCustomerChangedNotificationResult(com.cannontech.multispeak.deploy.service.ErrorObject[] customerChangedNotificationResult) {
        this.customerChangedNotificationResult = customerChangedNotificationResult;
    }
        ...
        _equals = true && 
            ((this.customerChangedNotificationResult==null && other.getCustomerChangedNotificationResult()==null) || 
             (this.customerChangedNotificationResult!=null &&
              java.util.Arrays.equals(this.customerChangedNotificationResult, other.getCustomerChangedNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCustomerChangedNotificationResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCustomerChangedNotificationResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCustomerChangedNotificationResult(), i);
                if (obj != null &&
