...
public class CancelUsageMonitoringResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] cancelUsageMonitoringResult;

    public CancelUsageMonitoringResponse() {
    }

    public CancelUsageMonitoringResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] cancelUsageMonitoringResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getCancelUsageMonitoringResult() {
        return cancelUsageMonitoringResult;
    }
     ...
     */
    public void setCancelUsageMonitoringResult(com.cannontech.multispeak.deploy.service.ErrorObject[] cancelUsageMonitoringResult) {
        this.cancelUsageMonitoringResult = cancelUsageMonitoringResult;
    }
        ...
        _equals = true && 
            ((this.cancelUsageMonitoringResult==null && other.getCancelUsageMonitoringResult()==null) || 
             (this.cancelUsageMonitoringResult!=null &&
              java.util.Arrays.equals(this.cancelUsageMonitoringResult, other.getCancelUsageMonitoringResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCancelUsageMonitoringResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCancelUsageMonitoringResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCancelUsageMonitoringResult(), i);
                if (obj != null &&
