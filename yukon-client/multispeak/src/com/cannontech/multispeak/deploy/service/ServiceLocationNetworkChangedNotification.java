/**
 * ServiceLocationNetworkChangedNotification.java
 *
...
public class ServiceLocationNetworkChangedNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ServiceLocation[] changedServiceLocations;

    public ServiceLocationNetworkChangedNotification() {
    }
    ...
    /**
     * Gets the changedServiceLocations value for this ServiceLocationNetworkChangedNotification.
     * 
    ...
    /**
     * Sets the changedServiceLocations value for this ServiceLocationNetworkChangedNotification.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ServiceLocationNetworkChangedNotification)) return false;
        ServiceLocationNetworkChangedNotification other = (ServiceLocationNetworkChangedNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ServiceLocationNetworkChangedNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">ServiceLocationNetworkChangedNotification"));
