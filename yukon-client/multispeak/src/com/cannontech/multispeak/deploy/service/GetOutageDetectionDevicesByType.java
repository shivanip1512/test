...
public class GetOutageDetectionDevicesByType  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.OutageDetectDeviceType oDDType;
    ...
    public GetOutageDetectionDevicesByType(
           com.cannontech.multispeak.deploy.service.OutageDetectDeviceType oDDType,
     ...
     * @return oDDType
     */
    public com.cannontech.multispeak.deploy.service.OutageDetectDeviceType getODDType() {
        return oDDType;
    }
     ...
     * @param oDDType
     */
    public void setODDType(com.cannontech.multispeak.deploy.service.OutageDetectDeviceType oDDType) {
        this.oDDType = oDDType;
    }
