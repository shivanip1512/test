...
public class MeterGroup  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    private java.lang.String groupName;

    private java.lang.String[] meterList;
     ...
     * @return meterList
     */
    public java.lang.String[] getMeterList() {
        return meterList;
    }
     ...
     * @param meterList
     */
    public void setMeterList(java.lang.String[] meterList) {
        this.meterList = meterList;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.meterList==null && other.getMeterList()==null) || 
             (this.meterList!=null &&
              java.util.Arrays.equals(this.meterList, other.getMeterList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMeterList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMeterList(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "meterID"));
        typeDesc.addFieldDesc(elemField);
    }
