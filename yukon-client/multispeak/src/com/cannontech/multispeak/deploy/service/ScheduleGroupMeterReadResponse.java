...
public class ScheduleGroupMeterReadResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] scheduleGroupMeterReadResult;

    public ScheduleGroupMeterReadResponse() {
    }

    public ScheduleGroupMeterReadResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] scheduleGroupMeterReadResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getScheduleGroupMeterReadResult() {
        return scheduleGroupMeterReadResult;
    }
     ...
     */
    public void setScheduleGroupMeterReadResult(com.cannontech.multispeak.deploy.service.ErrorObject[] scheduleGroupMeterReadResult) {
        this.scheduleGroupMeterReadResult = scheduleGroupMeterReadResult;
    }
        ...
        _equals = true && 
            ((this.scheduleGroupMeterReadResult==null && other.getScheduleGroupMeterReadResult()==null) || 
             (this.scheduleGroupMeterReadResult!=null &&
              java.util.Arrays.equals(this.scheduleGroupMeterReadResult, other.getScheduleGroupMeterReadResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getScheduleGroupMeterReadResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getScheduleGroupMeterReadResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getScheduleGroupMeterReadResult(), i);
                if (obj != null &&
