...
public class MeterExchangeNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.MeterExchange[] meterChangeout;

    public MeterExchangeNotification() {
    }

    public MeterExchangeNotification(
           com.cannontech.multispeak.deploy.service.MeterExchange[] meterChangeout) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.MeterExchange[] getMeterChangeout() {
        return meterChangeout;
    }
     ...
     */
    public void setMeterChangeout(com.cannontech.multispeak.deploy.service.MeterExchange[] meterChangeout) {
        this.meterChangeout = meterChangeout;
    }
        ...
        _equals = true && 
            ((this.meterChangeout==null && other.getMeterChangeout()==null) || 
             (this.meterChangeout!=null &&
              java.util.Arrays.equals(this.meterChangeout, other.getMeterChangeout())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterChangeout() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMeterChangeout());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMeterChangeout(), i);
                if (obj != null &&
