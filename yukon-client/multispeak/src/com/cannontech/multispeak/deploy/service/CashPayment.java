...
public class CashPayment  implements java.io.Serializable {
    ...
    /**
     * Gets the tender value for this CashPayment.
     * 
     * @return tender
     */
    ...
    /**
     * Sets the tender value for this CashPayment.
     * 
     * @param tender
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "cashPayment"));
