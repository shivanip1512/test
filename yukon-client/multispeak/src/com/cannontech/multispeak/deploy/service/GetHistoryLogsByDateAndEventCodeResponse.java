...
public class GetHistoryLogsByDateAndEventCodeResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.HistoryLog[] getHistoryLogsByDateAndEventCodeResult;

    public GetHistoryLogsByDateAndEventCodeResponse() {
    }

    public GetHistoryLogsByDateAndEventCodeResponse(
           com.cannontech.multispeak.deploy.service.HistoryLog[] getHistoryLogsByDateAndEventCodeResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.HistoryLog[] getGetHistoryLogsByDateAndEventCodeResult() {
        return getHistoryLogsByDateAndEventCodeResult;
    }
     ...
     */
    public void setGetHistoryLogsByDateAndEventCodeResult(com.cannontech.multispeak.deploy.service.HistoryLog[] getHistoryLogsByDateAndEventCodeResult) {
        this.getHistoryLogsByDateAndEventCodeResult = getHistoryLogsByDateAndEventCodeResult;
    }
        ...
        _equals = true && 
            ((this.getHistoryLogsByDateAndEventCodeResult==null && other.getGetHistoryLogsByDateAndEventCodeResult()==null) || 
             (this.getHistoryLogsByDateAndEventCodeResult!=null &&
              java.util.Arrays.equals(this.getHistoryLogsByDateAndEventCodeResult, other.getGetHistoryLogsByDateAndEventCodeResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetHistoryLogsByDateAndEventCodeResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetHistoryLogsByDateAndEventCodeResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetHistoryLogsByDateAndEventCodeResult(), i);
                if (obj != null &&
