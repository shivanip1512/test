...
public class GetUplineMeterConnectivityResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.MeterConnectivity[] getUplineMeterConnectivityResult;

    public GetUplineMeterConnectivityResponse() {
    }

    public GetUplineMeterConnectivityResponse(
           com.cannontech.multispeak.deploy.service.MeterConnectivity[] getUplineMeterConnectivityResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.MeterConnectivity[] getGetUplineMeterConnectivityResult() {
        return getUplineMeterConnectivityResult;
    }
     ...
     */
    public void setGetUplineMeterConnectivityResult(com.cannontech.multispeak.deploy.service.MeterConnectivity[] getUplineMeterConnectivityResult) {
        this.getUplineMeterConnectivityResult = getUplineMeterConnectivityResult;
    }
        ...
        _equals = true && 
            ((this.getUplineMeterConnectivityResult==null && other.getGetUplineMeterConnectivityResult()==null) || 
             (this.getUplineMeterConnectivityResult!=null &&
              java.util.Arrays.equals(this.getUplineMeterConnectivityResult, other.getGetUplineMeterConnectivityResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetUplineMeterConnectivityResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetUplineMeterConnectivityResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetUplineMeterConnectivityResult(), i);
                if (obj != null &&
