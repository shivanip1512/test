...
public class PowerMonitor  extends com.cannontech.multispeak.deploy.service.MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.deploy.service.PmEventCode eventCode;
    ...
    public PowerMonitor(
           ...
           com.cannontech.multispeak.deploy.service.PmEventCode eventCode,
     ...
     * @return eventCode
     */
    public com.cannontech.multispeak.deploy.service.PmEventCode getEventCode() {
        return eventCode;
    }
     ...
     * @param eventCode
     */
    public void setEventCode(com.cannontech.multispeak.deploy.service.PmEventCode eventCode) {
        this.eventCode = eventCode;
    }
