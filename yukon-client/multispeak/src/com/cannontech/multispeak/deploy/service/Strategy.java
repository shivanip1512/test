...
public class Strategy  implements java.io.Serializable {
    ...
    /**
     * Gets the strategyName value for this Strategy.
     * 
     * @return strategyName
     */
    ...
    /**
     * Sets the strategyName value for this Strategy.
     * 
     * @param strategyName
     */
    ...
    /**
     * Gets the applicationPointList value for this Strategy.
     * 
    ...
    /**
     * Sets the applicationPointList value for this Strategy.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "strategy"));
