...
public class InitiateUsageMonitoringResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.ErrorObject[] initiateUsageMonitoringResult;

    public InitiateUsageMonitoringResponse() {
    }

    public InitiateUsageMonitoringResponse(
           com.cannontech.multispeak.deploy.service.ErrorObject[] initiateUsageMonitoringResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.ErrorObject[] getInitiateUsageMonitoringResult() {
        return initiateUsageMonitoringResult;
    }
     ...
     */
    public void setInitiateUsageMonitoringResult(com.cannontech.multispeak.deploy.service.ErrorObject[] initiateUsageMonitoringResult) {
        this.initiateUsageMonitoringResult = initiateUsageMonitoringResult;
    }
        ...
        _equals = true && 
            ((this.initiateUsageMonitoringResult==null && other.getInitiateUsageMonitoringResult()==null) || 
             (this.initiateUsageMonitoringResult!=null &&
              java.util.Arrays.equals(this.initiateUsageMonitoringResult, other.getInitiateUsageMonitoringResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getInitiateUsageMonitoringResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getInitiateUsageMonitoringResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getInitiateUsageMonitoringResult(), i);
                if (obj != null &&
