...
public class MeterRemoveNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.Meter[] removedMeters;

    public MeterRemoveNotification() {
    }

    public MeterRemoveNotification(
           com.cannontech.multispeak.deploy.service.Meter[] removedMeters) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.Meter[] getRemovedMeters() {
        return removedMeters;
    }
     ...
     * @param removedMeters
     */
    public void setRemovedMeters(com.cannontech.multispeak.deploy.service.Meter[] removedMeters) {
        this.removedMeters = removedMeters;
    }
        ...
        _equals = true && 
            ((this.removedMeters==null && other.getRemovedMeters()==null) || 
             (this.removedMeters!=null &&
              java.util.Arrays.equals(this.removedMeters, other.getRemovedMeters())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getRemovedMeters() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getRemovedMeters());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getRemovedMeters(), i);
                if (obj != null &&
