...
public class GetLatestReadingsResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.deploy.service.MeterRead[] getLatestReadingsResult;

    public GetLatestReadingsResponse() {
    }

    public GetLatestReadingsResponse(
           com.cannontech.multispeak.deploy.service.MeterRead[] getLatestReadingsResult) {
     ...
     */
    public com.cannontech.multispeak.deploy.service.MeterRead[] getGetLatestReadingsResult() {
        return getLatestReadingsResult;
    }
     ...
     */
    public void setGetLatestReadingsResult(com.cannontech.multispeak.deploy.service.MeterRead[] getLatestReadingsResult) {
        this.getLatestReadingsResult = getLatestReadingsResult;
    }
        ...
        _equals = true && 
            ((this.getLatestReadingsResult==null && other.getGetLatestReadingsResult()==null) || 
             (this.getLatestReadingsResult!=null &&
              java.util.Arrays.equals(this.getLatestReadingsResult, other.getGetLatestReadingsResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetLatestReadingsResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetLatestReadingsResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetLatestReadingsResult(), i);
                if (obj != null &&
