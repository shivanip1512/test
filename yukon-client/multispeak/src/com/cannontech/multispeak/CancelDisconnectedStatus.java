...
public class CancelDisconnectedStatus  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfString meterNos;

    public CancelDisconnectedStatus() {
    }
    ...
    /**
     * Gets the meterNos value for this CancelDisconnectedStatus.
     * 
     * @return meterNos
     */
    ...
    /**
     * Sets the meterNos value for this CancelDisconnectedStatus.
     * 
     * @param meterNos
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CancelDisconnectedStatus)) return false;
        CancelDisconnectedStatus other = (CancelDisconnectedStatus) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CancelDisconnectedStatus.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">CancelDisconnectedStatus"));
