...
public class CB_CDLocator extends org.apache.axis.client.Service implements com.cannontech.multispeak.CB_CD {
    ...
    private java.lang.String CB_CDSoap_address = "http://www.turtletech.com/multispeakws/2B_CB_CD.asmx";
    ...
    public com.cannontech.multispeak.CB_CDSoap_PortType getCB_CDSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.cannontech.multispeak.CB_CDSoap_PortType getCB_CDSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cannontech.multispeak.CB_CDSoap_BindingStub _stub = new com.cannontech.multispeak.CB_CDSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cannontech.multispeak.CB_CDSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cannontech.multispeak.CB_CDSoap_BindingStub _stub = new com.cannontech.multispeak.CB_CDSoap_BindingStub(new java.net.URL(CB_CDSoap_address), this);
                _stub.setPortName(getCB_CDSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("CB_CDSoap".equals(inputPortName)) {
            return getCB_CDSoap();
        }
        else  {
