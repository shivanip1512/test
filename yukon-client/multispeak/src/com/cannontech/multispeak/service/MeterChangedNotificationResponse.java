...
public class MeterChangedNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject meterChangedNotificationResult;

    public MeterChangedNotificationResponse() {
    }

    public MeterChangedNotificationResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject meterChangedNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getMeterChangedNotificationResult() {
        return meterChangedNotificationResult;
    }
     ...
     */
    public void setMeterChangedNotificationResult(com.cannontech.multispeak.service.ArrayOfErrorObject meterChangedNotificationResult) {
        this.meterChangedNotificationResult = meterChangedNotificationResult;
    }
