...
public class BilledUsage  extends com.cannontech.multispeak.service.MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.service.UsageItemList usageItemList;
    ...
    public BilledUsage(
           ...
           com.cannontech.multispeak.service.UsageItemList usageItemList) {
     ...
     */
    public com.cannontech.multispeak.service.UsageItemList getUsageItemList() {
        return usageItemList;
    }
     ...
     * @param usageItemList
     */
    public void setUsageItemList(com.cannontech.multispeak.service.UsageItemList usageItemList) {
        this.usageItemList = usageItemList;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.usageItemList==null && other.getUsageItemList()==null) || 
             (this.usageItemList!=null &&
              this.usageItemList.equals(other.getUsageItemList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getUsageItemList() != null) {
            _hashCode += getUsageItemList().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "usageItemList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
