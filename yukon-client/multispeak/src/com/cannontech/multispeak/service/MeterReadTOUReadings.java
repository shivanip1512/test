...
public class MeterReadTOUReadings  implements java.io.Serializable {
    private com.cannontech.multispeak.service.TOUReading[] TOUReading;

    public MeterReadTOUReadings() {
    }

    public MeterReadTOUReadings(
           com.cannontech.multispeak.service.TOUReading[] TOUReading) {
     ...
     * @return TOUReading
     */
    public com.cannontech.multispeak.service.TOUReading[] getTOUReading() {
        return TOUReading;
    }
     ...
     * @param TOUReading
     */
    public void setTOUReading(com.cannontech.multispeak.service.TOUReading[] TOUReading) {
        this.TOUReading = TOUReading;
    }

    public com.cannontech.multispeak.service.TOUReading getTOUReading(int i) {
        return this.TOUReading[i];
    }

    public void setTOUReading(int i, com.cannontech.multispeak.service.TOUReading _value) {
