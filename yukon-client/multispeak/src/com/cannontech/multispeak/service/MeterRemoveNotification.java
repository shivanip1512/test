...
public class MeterRemoveNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfMeter removedMeters;

    public MeterRemoveNotification() {
    }

    public MeterRemoveNotification(
           com.cannontech.multispeak.service.ArrayOfMeter removedMeters) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfMeter getRemovedMeters() {
        return removedMeters;
    }
     ...
     * @param removedMeters
     */
    public void setRemovedMeters(com.cannontech.multispeak.service.ArrayOfMeter removedMeters) {
        this.removedMeters = removedMeters;
    }
