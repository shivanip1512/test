...
public class ArrayOfWarehouseLocation  implements java.io.Serializable {
    private com.cannontech.multispeak.service.WarehouseLocation[] warehouseLocation;

    public ArrayOfWarehouseLocation() {
    }

    public ArrayOfWarehouseLocation(
           com.cannontech.multispeak.service.WarehouseLocation[] warehouseLocation) {
     ...
     */
    public com.cannontech.multispeak.service.WarehouseLocation[] getWarehouseLocation() {
        return warehouseLocation;
    }
     ...
     */
    public void setWarehouseLocation(com.cannontech.multispeak.service.WarehouseLocation[] warehouseLocation) {
        this.warehouseLocation = warehouseLocation;
    }

    public com.cannontech.multispeak.service.WarehouseLocation getWarehouseLocation(int i) {
        return this.warehouseLocation[i];
    }

    public void setWarehouseLocation(int i, com.cannontech.multispeak.service.WarehouseLocation _value) {
