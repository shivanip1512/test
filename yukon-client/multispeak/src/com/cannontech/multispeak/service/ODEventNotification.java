...
public class ODEventNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfOutageDetectionEvent ODEvents;

    public ODEventNotification() {
    }

    public ODEventNotification(
           com.cannontech.multispeak.service.ArrayOfOutageDetectionEvent ODEvents) {
     ...
     * @return ODEvents
     */
    public com.cannontech.multispeak.service.ArrayOfOutageDetectionEvent getODEvents() {
        return ODEvents;
    }
     ...
     * @param ODEvents
     */
    public void setODEvents(com.cannontech.multispeak.service.ArrayOfOutageDetectionEvent ODEvents) {
        this.ODEvents = ODEvents;
    }
