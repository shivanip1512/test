...
public class ArrayOfCustomersAffectedByOutage  implements java.io.Serializable {
    private com.cannontech.multispeak.service.CustomersAffectedByOutage[] customersAffectedByOutage;

    public ArrayOfCustomersAffectedByOutage() {
    }

    public ArrayOfCustomersAffectedByOutage(
           com.cannontech.multispeak.service.CustomersAffectedByOutage[] customersAffectedByOutage) {
     ...
     */
    public com.cannontech.multispeak.service.CustomersAffectedByOutage[] getCustomersAffectedByOutage() {
        return customersAffectedByOutage;
    }
     ...
     */
    public void setCustomersAffectedByOutage(com.cannontech.multispeak.service.CustomersAffectedByOutage[] customersAffectedByOutage) {
        this.customersAffectedByOutage = customersAffectedByOutage;
    }

    public com.cannontech.multispeak.service.CustomersAffectedByOutage getCustomersAffectedByOutage(int i) {
        return this.customersAffectedByOutage[i];
    }

    public void setCustomersAffectedByOutage(int i, com.cannontech.multispeak.service.CustomersAffectedByOutage _value) {
