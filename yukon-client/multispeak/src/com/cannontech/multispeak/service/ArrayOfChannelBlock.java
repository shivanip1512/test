...
public class ArrayOfChannelBlock  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ChannelBlock[] block;

    public ArrayOfChannelBlock() {
    }

    public ArrayOfChannelBlock(
           com.cannontech.multispeak.service.ChannelBlock[] block) {
           this.block = block;
    }
     ...
     * @return block
     */
    public com.cannontech.multispeak.service.ChannelBlock[] getBlock() {
        return block;
    }
     ...
     * @param block
     */
    public void setBlock(com.cannontech.multispeak.service.ChannelBlock[] block) {
        this.block = block;
    }

    public com.cannontech.multispeak.service.ChannelBlock getBlock(int i) {
        return this.block[i];
    }

    public void setBlock(int i, com.cannontech.multispeak.service.ChannelBlock _value) {
        this.block[i] = _value;
    }
