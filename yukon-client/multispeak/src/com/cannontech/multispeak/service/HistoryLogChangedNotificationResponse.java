...
public class HistoryLogChangedNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject historyLogChangedNotificationResult;

    public HistoryLogChangedNotificationResponse() {
    }

    public HistoryLogChangedNotificationResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject historyLogChangedNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getHistoryLogChangedNotificationResult() {
        return historyLogChangedNotificationResult;
    }
     ...
     */
    public void setHistoryLogChangedNotificationResult(com.cannontech.multispeak.service.ArrayOfErrorObject historyLogChangedNotificationResult) {
        this.historyLogChangedNotificationResult = historyLogChangedNotificationResult;
    }
