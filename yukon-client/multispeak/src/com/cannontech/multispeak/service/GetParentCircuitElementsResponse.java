...
public class GetParentCircuitElementsResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfCircuitElement getParentCircuitElementsResult;

    public GetParentCircuitElementsResponse() {
    }

    public GetParentCircuitElementsResponse(
           com.cannontech.multispeak.service.ArrayOfCircuitElement getParentCircuitElementsResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfCircuitElement getGetParentCircuitElementsResult() {
        return getParentCircuitElementsResult;
    }
     ...
     */
    public void setGetParentCircuitElementsResult(com.cannontech.multispeak.service.ArrayOfCircuitElement getParentCircuitElementsResult) {
        this.getParentCircuitElementsResult = getParentCircuitElementsResult;
    }
        ...
        _equals = true && 
            ((this.getParentCircuitElementsResult==null && other.getGetParentCircuitElementsResult()==null) || 
             (this.getParentCircuitElementsResult!=null &&
              this.getParentCircuitElementsResult.equals(other.getGetParentCircuitElementsResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetParentCircuitElementsResult() != null) {
            _hashCode += getGetParentCircuitElementsResult().hashCode();
        }
