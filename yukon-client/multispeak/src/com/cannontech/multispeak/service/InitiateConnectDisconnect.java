...
public class InitiateConnectDisconnect  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfConnectDisconnectEvent cdEvents;

    public InitiateConnectDisconnect() {
    }

    public InitiateConnectDisconnect(
           com.cannontech.multispeak.service.ArrayOfConnectDisconnectEvent cdEvents) {
     ...
     * @return cdEvents
     */
    public com.cannontech.multispeak.service.ArrayOfConnectDisconnectEvent getCdEvents() {
        return cdEvents;
    }
     ...
     * @param cdEvents
     */
    public void setCdEvents(com.cannontech.multispeak.service.ArrayOfConnectDisconnectEvent cdEvents) {
        this.cdEvents = cdEvents;
    }
