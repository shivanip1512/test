...
public class ArrayOfCDCustomer  implements java.io.Serializable {
    private com.cannontech.multispeak.service.CDCustomer[] CDCustomer;

    public ArrayOfCDCustomer() {
    }

    public ArrayOfCDCustomer(
           com.cannontech.multispeak.service.CDCustomer[] CDCustomer) {
     ...
     * @return CDCustomer
     */
    public com.cannontech.multispeak.service.CDCustomer[] getCDCustomer() {
        return CDCustomer;
    }
     ...
     * @param CDCustomer
     */
    public void setCDCustomer(com.cannontech.multispeak.service.CDCustomer[] CDCustomer) {
        this.CDCustomer = CDCustomer;
    }

    public com.cannontech.multispeak.service.CDCustomer getCDCustomer(int i) {
        return this.CDCustomer[i];
    }

    public void setCDCustomer(int i, com.cannontech.multispeak.service.CDCustomer _value) {
