/**
 * ModifyCBDataForServiceLocationResponse.java
 *
...
public class ModifyCBDataForServiceLocationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject modifyCBDataForServiceLocationResult;

    public ModifyCBDataForServiceLocationResponse() {
    }

    public ModifyCBDataForServiceLocationResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject modifyCBDataForServiceLocationResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getModifyCBDataForServiceLocationResult() {
        return modifyCBDataForServiceLocationResult;
    }
     ...
     */
    public void setModifyCBDataForServiceLocationResult(com.cannontech.multispeak.service.ArrayOfErrorObject modifyCBDataForServiceLocationResult) {
        this.modifyCBDataForServiceLocationResult = modifyCBDataForServiceLocationResult;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModifyCBDataForServiceLocationResponse)) return false;
        ModifyCBDataForServiceLocationResponse other = (ModifyCBDataForServiceLocationResponse) obj;
        ...
        _equals = true && 
            ((this.modifyCBDataForServiceLocationResult==null && other.getModifyCBDataForServiceLocationResult()==null) || 
             (this.modifyCBDataForServiceLocationResult!=null &&
              this.modifyCBDataForServiceLocationResult.equals(other.getModifyCBDataForServiceLocationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getModifyCBDataForServiceLocationResult() != null) {
            _hashCode += getModifyCBDataForServiceLocationResult().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModifyCBDataForServiceLocationResponse.class, true);
