...
public class MeterConnectivityNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfMeterConnectivity newConnectivity;

    public MeterConnectivityNotification() {
    }

    public MeterConnectivityNotification(
           com.cannontech.multispeak.service.ArrayOfMeterConnectivity newConnectivity) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfMeterConnectivity getNewConnectivity() {
        return newConnectivity;
    }
     ...
     */
    public void setNewConnectivity(com.cannontech.multispeak.service.ArrayOfMeterConnectivity newConnectivity) {
        this.newConnectivity = newConnectivity;
    }
