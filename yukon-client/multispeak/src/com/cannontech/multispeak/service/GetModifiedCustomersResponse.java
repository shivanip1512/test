...
public class GetModifiedCustomersResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfCustomer getModifiedCustomersResult;

    public GetModifiedCustomersResponse() {
    }

    public GetModifiedCustomersResponse(
           com.cannontech.multispeak.service.ArrayOfCustomer getModifiedCustomersResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfCustomer getGetModifiedCustomersResult() {
        return getModifiedCustomersResult;
    }
     ...
     */
    public void setGetModifiedCustomersResult(com.cannontech.multispeak.service.ArrayOfCustomer getModifiedCustomersResult) {
        this.getModifiedCustomersResult = getModifiedCustomersResult;
    }
        ...
        _equals = true && 
            ((this.getModifiedCustomersResult==null && other.getGetModifiedCustomersResult()==null) || 
             (this.getModifiedCustomersResult!=null &&
              this.getModifiedCustomersResult.equals(other.getGetModifiedCustomersResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetModifiedCustomersResult() != null) {
            _hashCode += getGetModifiedCustomersResult().hashCode();
        }
