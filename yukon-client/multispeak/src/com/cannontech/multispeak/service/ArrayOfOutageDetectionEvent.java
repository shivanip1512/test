...
public class ArrayOfOutageDetectionEvent  implements java.io.Serializable {
    private com.cannontech.multispeak.service.OutageDetectionEvent[] outageDetectionEvent;

    public ArrayOfOutageDetectionEvent() {
    }

    public ArrayOfOutageDetectionEvent(
           com.cannontech.multispeak.service.OutageDetectionEvent[] outageDetectionEvent) {
     ...
     */
    public com.cannontech.multispeak.service.OutageDetectionEvent[] getOutageDetectionEvent() {
        return outageDetectionEvent;
    }
     ...
     */
    public void setOutageDetectionEvent(com.cannontech.multispeak.service.OutageDetectionEvent[] outageDetectionEvent) {
        this.outageDetectionEvent = outageDetectionEvent;
    }

    public com.cannontech.multispeak.service.OutageDetectionEvent getOutageDetectionEvent(int i) {
        return this.outageDetectionEvent[i];
    }

    public void setOutageDetectionEvent(int i, com.cannontech.multispeak.service.OutageDetectionEvent _value) {
