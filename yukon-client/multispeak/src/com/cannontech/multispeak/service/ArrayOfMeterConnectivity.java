...
public class ArrayOfMeterConnectivity  implements java.io.Serializable {
    private com.cannontech.multispeak.service.MeterConnectivity[] meterConnectivity;

    public ArrayOfMeterConnectivity() {
    }

    public ArrayOfMeterConnectivity(
           com.cannontech.multispeak.service.MeterConnectivity[] meterConnectivity) {
     ...
     */
    public com.cannontech.multispeak.service.MeterConnectivity[] getMeterConnectivity() {
        return meterConnectivity;
    }
     ...
     */
    public void setMeterConnectivity(com.cannontech.multispeak.service.MeterConnectivity[] meterConnectivity) {
        this.meterConnectivity = meterConnectivity;
    }

    public com.cannontech.multispeak.service.MeterConnectivity getMeterConnectivity(int i) {
        return this.meterConnectivity[i];
    }

    public void setMeterConnectivity(int i, com.cannontech.multispeak.service.MeterConnectivity _value) {
