...
public class MeterRetireNotificationResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject meterRetireNotificationResult;

    public MeterRetireNotificationResponse() {
    }

    public MeterRetireNotificationResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject meterRetireNotificationResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getMeterRetireNotificationResult() {
        return meterRetireNotificationResult;
    }
     ...
     */
    public void setMeterRetireNotificationResult(com.cannontech.multispeak.service.ArrayOfErrorObject meterRetireNotificationResult) {
        this.meterRetireNotificationResult = meterRetireNotificationResult;
    }
        ...
        _equals = true && 
            ((this.meterRetireNotificationResult==null && other.getMeterRetireNotificationResult()==null) || 
             (this.meterRetireNotificationResult!=null &&
              this.meterRetireNotificationResult.equals(other.getMeterRetireNotificationResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getMeterRetireNotificationResult() != null) {
            _hashCode += getMeterRetireNotificationResult().hashCode();
        }
