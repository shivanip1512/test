...
public class ArrayOfCapacitor  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Capacitor[] capacitor;

    public ArrayOfCapacitor() {
    }

    public ArrayOfCapacitor(
           com.cannontech.multispeak.service.Capacitor[] capacitor) {
     ...
     * @return capacitor
     */
    public com.cannontech.multispeak.service.Capacitor[] getCapacitor() {
        return capacitor;
    }
     ...
     * @param capacitor
     */
    public void setCapacitor(com.cannontech.multispeak.service.Capacitor[] capacitor) {
        this.capacitor = capacitor;
    }

    public com.cannontech.multispeak.service.Capacitor getCapacitor(int i) {
        return this.capacitor[i];
    }

    public void setCapacitor(int i, com.cannontech.multispeak.service.Capacitor _value) {
