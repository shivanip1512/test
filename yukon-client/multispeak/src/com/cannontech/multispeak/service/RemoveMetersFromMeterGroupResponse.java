...
public class RemoveMetersFromMeterGroupResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject removeMetersFromMeterGroupResult;

    public RemoveMetersFromMeterGroupResponse() {
    }

    public RemoveMetersFromMeterGroupResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject removeMetersFromMeterGroupResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getRemoveMetersFromMeterGroupResult() {
        return removeMetersFromMeterGroupResult;
    }
     ...
     */
    public void setRemoveMetersFromMeterGroupResult(com.cannontech.multispeak.service.ArrayOfErrorObject removeMetersFromMeterGroupResult) {
        this.removeMetersFromMeterGroupResult = removeMetersFromMeterGroupResult;
    }
        ...
        _equals = true && 
            ((this.removeMetersFromMeterGroupResult==null && other.getRemoveMetersFromMeterGroupResult()==null) || 
             (this.removeMetersFromMeterGroupResult!=null &&
              this.removeMetersFromMeterGroupResult.equals(other.getRemoveMetersFromMeterGroupResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getRemoveMetersFromMeterGroupResult() != null) {
            _hashCode += getRemoveMetersFromMeterGroupResult().hashCode();
        }
