...
public class ExtensionsList  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ExtensionsItem[] extensionsItem;

    public ExtensionsList() {
    }

    public ExtensionsList(
           com.cannontech.multispeak.service.ExtensionsItem[] extensionsItem) {
     ...
     */
    public com.cannontech.multispeak.service.ExtensionsItem[] getExtensionsItem() {
        return extensionsItem;
    }
     ...
     */
    public void setExtensionsItem(com.cannontech.multispeak.service.ExtensionsItem[] extensionsItem) {
        this.extensionsItem = extensionsItem;
    }

    public com.cannontech.multispeak.service.ExtensionsItem getExtensionsItem(int i) {
        return this.extensionsItem[i];
    }

    public void setExtensionsItem(int i, com.cannontech.multispeak.service.ExtensionsItem _value) {
