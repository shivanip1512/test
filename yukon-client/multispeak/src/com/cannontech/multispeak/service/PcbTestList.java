...
public class PcbTestList  implements java.io.Serializable {
    private com.cannontech.multispeak.service.TestInstance[] testInstance;

    public PcbTestList() {
    }

    public PcbTestList(
           com.cannontech.multispeak.service.TestInstance[] testInstance) {
     ...
     * @return testInstance
     */
    public com.cannontech.multispeak.service.TestInstance[] getTestInstance() {
        return testInstance;
    }
     ...
     * @param testInstance
     */
    public void setTestInstance(com.cannontech.multispeak.service.TestInstance[] testInstance) {
        this.testInstance = testInstance;
    }

    public com.cannontech.multispeak.service.TestInstance getTestInstance(int i) {
        return this.testInstance[i];
    }

    public void setTestInstance(int i, com.cannontech.multispeak.service.TestInstance _value) {
