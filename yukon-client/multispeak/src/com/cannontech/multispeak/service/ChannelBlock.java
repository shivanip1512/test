...
public class ChannelBlock  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Status status;
    private com.cannontech.multispeak.service.Interval[] interval;
    ...
    public ChannelBlock(
           com.cannontech.multispeak.service.Status status,
           com.cannontech.multispeak.service.Interval[] interval,
     ...
     * @return status
     */
    public com.cannontech.multispeak.service.Status getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.cannontech.multispeak.service.Status status) {
        this.status = status;
    }
     ...
     * @return interval
     */
    public com.cannontech.multispeak.service.Interval[] getInterval() {
        return interval;
    }
     ...
     * @param interval
     */
    public void setInterval(com.cannontech.multispeak.service.Interval[] interval) {
        this.interval = interval;
    }

    public com.cannontech.multispeak.service.Interval getInterval(int i) {
        return this.interval[i];
    }

    public void setInterval(int i, com.cannontech.multispeak.service.Interval _value) {
