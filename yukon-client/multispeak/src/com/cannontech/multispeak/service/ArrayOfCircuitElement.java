...
public class ArrayOfCircuitElement  implements java.io.Serializable {
    private com.cannontech.multispeak.service.CircuitElement[] circuitElement;

    public ArrayOfCircuitElement() {
    }

    public ArrayOfCircuitElement(
           com.cannontech.multispeak.service.CircuitElement[] circuitElement) {
     ...
     */
    public com.cannontech.multispeak.service.CircuitElement[] getCircuitElement() {
        return circuitElement;
    }
     ...
     */
    public void setCircuitElement(com.cannontech.multispeak.service.CircuitElement[] circuitElement) {
        this.circuitElement = circuitElement;
    }

    public com.cannontech.multispeak.service.CircuitElement getCircuitElement(int i) {
        return this.circuitElement[i];
    }

    public void setCircuitElement(int i, com.cannontech.multispeak.service.CircuitElement _value) {
