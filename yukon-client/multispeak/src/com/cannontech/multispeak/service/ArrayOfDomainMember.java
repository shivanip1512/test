...
public class ArrayOfDomainMember  implements java.io.Serializable {
    private com.cannontech.multispeak.service.DomainMember[] domainMember;

    public ArrayOfDomainMember() {
    }

    public ArrayOfDomainMember(
           com.cannontech.multispeak.service.DomainMember[] domainMember) {
     ...
     * @return domainMember
     */
    public com.cannontech.multispeak.service.DomainMember[] getDomainMember() {
        return domainMember;
    }
     ...
     * @param domainMember
     */
    public void setDomainMember(com.cannontech.multispeak.service.DomainMember[] domainMember) {
        this.domainMember = domainMember;
    }

    public com.cannontech.multispeak.service.DomainMember getDomainMember(int i) {
        return this.domainMember[i];
    }

    public void setDomainMember(int i, com.cannontech.multispeak.service.DomainMember _value) {
