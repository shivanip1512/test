...
public class ArrayOfAllocatedLoad  implements java.io.Serializable {
    private com.cannontech.multispeak.service.AllocatedLoad[] allocatedLoad;

    public ArrayOfAllocatedLoad() {
    }

    public ArrayOfAllocatedLoad(
           com.cannontech.multispeak.service.AllocatedLoad[] allocatedLoad) {
     ...
     */
    public com.cannontech.multispeak.service.AllocatedLoad[] getAllocatedLoad() {
        return allocatedLoad;
    }
     ...
     * @param allocatedLoad
     */
    public void setAllocatedLoad(com.cannontech.multispeak.service.AllocatedLoad[] allocatedLoad) {
        this.allocatedLoad = allocatedLoad;
    }

    public com.cannontech.multispeak.service.AllocatedLoad getAllocatedLoad(int i) {
        return this.allocatedLoad[i];
    }

    public void setAllocatedLoad(int i, com.cannontech.multispeak.service.AllocatedLoad _value) {
