...
public class ArrayOfLaborComponent  implements java.io.Serializable {
    private com.cannontech.multispeak.service.LaborComponent[] laborComponent;

    public ArrayOfLaborComponent() {
    }

    public ArrayOfLaborComponent(
           com.cannontech.multispeak.service.LaborComponent[] laborComponent) {
     ...
     */
    public com.cannontech.multispeak.service.LaborComponent[] getLaborComponent() {
        return laborComponent;
    }
     ...
     */
    public void setLaborComponent(com.cannontech.multispeak.service.LaborComponent[] laborComponent) {
        this.laborComponent = laborComponent;
    }

    public com.cannontech.multispeak.service.LaborComponent getLaborComponent(int i) {
        return this.laborComponent[i];
    }

    public void setLaborComponent(int i, com.cannontech.multispeak.service.LaborComponent _value) {
