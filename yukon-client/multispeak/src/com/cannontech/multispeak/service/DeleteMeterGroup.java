...
public class DeleteMeterGroup  implements java.io.Serializable {
    private java.lang.String meterGroupID;

    public DeleteMeterGroup() {
    }
    ...
    /**
     * Gets the meterGroupID value for this DeleteMeterGroup.
     * 
     * @return meterGroupID
     */
    ...
    /**
     * Sets the meterGroupID value for this DeleteMeterGroup.
     * 
     * @param meterGroupID
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteMeterGroup)) return false;
        DeleteMeterGroup other = (DeleteMeterGroup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteMeterGroup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">DeleteMeterGroup"));
