...
public abstract class MspElectricPoint  extends com.cannontech.multispeak.service.MspConnectivityPoint  implements java.io.Serializable {
    private com.cannontech.multispeak.service.PhaseCd phaseCode;
    private com.cannontech.multispeak.service.MspLoadGroup load;
    ...
    public MspElectricPoint(
           ...
           com.cannontech.multispeak.service.MspLoadGroup load) {
     ...
     * @return load
     */
    public com.cannontech.multispeak.service.MspLoadGroup getLoad() {
        return load;
    }
     ...
     * @param load
     */
    public void setLoad(com.cannontech.multispeak.service.MspLoadGroup load) {
        this.load = load;
    }
