...
public class ArrayOfEmployee  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Employee[] employee;

    public ArrayOfEmployee() {
    }

    public ArrayOfEmployee(
           com.cannontech.multispeak.service.Employee[] employee) {
     ...
     * @return employee
     */
    public com.cannontech.multispeak.service.Employee[] getEmployee() {
        return employee;
    }
     ...
     * @param employee
     */
    public void setEmployee(com.cannontech.multispeak.service.Employee[] employee) {
        this.employee = employee;
    }

    public com.cannontech.multispeak.service.Employee getEmployee(int i) {
        return this.employee[i];
    }

    public void setEmployee(int i, com.cannontech.multispeak.service.Employee _value) {
