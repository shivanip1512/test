...
public class ArrayOfGenericPointFeature  implements java.io.Serializable {
    private com.cannontech.multispeak.service.GenericPointFeature[] genericPointFeature;

    public ArrayOfGenericPointFeature() {
    }

    public ArrayOfGenericPointFeature(
           com.cannontech.multispeak.service.GenericPointFeature[] genericPointFeature) {
     ...
     */
    public com.cannontech.multispeak.service.GenericPointFeature[] getGenericPointFeature() {
        return genericPointFeature;
    }
     ...
     */
    public void setGenericPointFeature(com.cannontech.multispeak.service.GenericPointFeature[] genericPointFeature) {
        this.genericPointFeature = genericPointFeature;
    }

    public com.cannontech.multispeak.service.GenericPointFeature getGenericPointFeature(int i) {
        return this.genericPointFeature[i];
    }

    public void setGenericPointFeature(int i, com.cannontech.multispeak.service.GenericPointFeature _value) {
