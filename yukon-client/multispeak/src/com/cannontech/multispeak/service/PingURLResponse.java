...
public class PingURLResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject pingURLResult;

    public PingURLResponse() {
    }

    public PingURLResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject pingURLResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getPingURLResult() {
        return pingURLResult;
    }
     ...
     * @param pingURLResult
     */
    public void setPingURLResult(com.cannontech.multispeak.service.ArrayOfErrorObject pingURLResult) {
        this.pingURLResult = pingURLResult;
    }
        ...
        _equals = true && 
            ((this.pingURLResult==null && other.getPingURLResult()==null) || 
             (this.pingURLResult!=null &&
              this.pingURLResult.equals(other.getPingURLResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPingURLResult() != null) {
            _hashCode += getPingURLResult().hashCode();
        }
