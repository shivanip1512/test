...
public class ArrayOfGenericAnnotationFeature  implements java.io.Serializable {
    private com.cannontech.multispeak.service.GenericAnnotationFeature[] genericAnnotationFeature;

    public ArrayOfGenericAnnotationFeature() {
    }

    public ArrayOfGenericAnnotationFeature(
           com.cannontech.multispeak.service.GenericAnnotationFeature[] genericAnnotationFeature) {
     ...
     */
    public com.cannontech.multispeak.service.GenericAnnotationFeature[] getGenericAnnotationFeature() {
        return genericAnnotationFeature;
    }
     ...
     */
    public void setGenericAnnotationFeature(com.cannontech.multispeak.service.GenericAnnotationFeature[] genericAnnotationFeature) {
        this.genericAnnotationFeature = genericAnnotationFeature;
    }

    public com.cannontech.multispeak.service.GenericAnnotationFeature getGenericAnnotationFeature(int i) {
        return this.genericAnnotationFeature[i];
    }

    public void setGenericAnnotationFeature(int i, com.cannontech.multispeak.service.GenericAnnotationFeature _value) {
