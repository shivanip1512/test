...
public class ArrayOfUsageInstance  implements java.io.Serializable {
    private com.cannontech.multispeak.service.UsageInstance[] usageInstance;

    public ArrayOfUsageInstance() {
    }

    public ArrayOfUsageInstance(
           com.cannontech.multispeak.service.UsageInstance[] usageInstance) {
     ...
     */
    public com.cannontech.multispeak.service.UsageInstance[] getUsageInstance() {
        return usageInstance;
    }
     ...
     * @param usageInstance
     */
    public void setUsageInstance(com.cannontech.multispeak.service.UsageInstance[] usageInstance) {
        this.usageInstance = usageInstance;
    }

    public com.cannontech.multispeak.service.UsageInstance getUsageInstance(int i) {
        return this.usageInstance[i];
    }

    public void setUsageInstance(int i, com.cannontech.multispeak.service.UsageInstance _value) {
