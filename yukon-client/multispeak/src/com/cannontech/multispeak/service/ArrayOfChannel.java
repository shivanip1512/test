...
public class ArrayOfChannel  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Channel[] channel;

    public ArrayOfChannel() {
    }

    public ArrayOfChannel(
           com.cannontech.multispeak.service.Channel[] channel) {
     ...
     * @return channel
     */
    public com.cannontech.multispeak.service.Channel[] getChannel() {
        return channel;
    }
     ...
     * @param channel
     */
    public void setChannel(com.cannontech.multispeak.service.Channel[] channel) {
        this.channel = channel;
    }

    public com.cannontech.multispeak.service.Channel getChannel(int i) {
        return this.channel[i];
    }

    public void setChannel(int i, com.cannontech.multispeak.service.Channel _value) {
