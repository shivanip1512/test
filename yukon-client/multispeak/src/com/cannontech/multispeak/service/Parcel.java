...
public class Parcel  extends com.cannontech.multispeak.service.MspPolygonObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.service.PremiseList premiseList;
    ...
    public Parcel(
           ...
           com.cannontech.multispeak.service.PremiseList premiseList) {
     ...
     * @return premiseList
     */
    public com.cannontech.multispeak.service.PremiseList getPremiseList() {
        return premiseList;
    }
     ...
     * @param premiseList
     */
    public void setPremiseList(com.cannontech.multispeak.service.PremiseList premiseList) {
        this.premiseList = premiseList;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.premiseList==null && other.getPremiseList()==null) || 
             (this.premiseList!=null &&
              this.premiseList.equals(other.getPremiseList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPremiseList() != null) {
            _hashCode += getPremiseList().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "premiseList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
