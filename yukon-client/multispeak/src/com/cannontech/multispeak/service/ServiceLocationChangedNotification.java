...
public class ServiceLocationChangedNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfServiceLocation changedServiceLocations;

    public ServiceLocationChangedNotification() {
    }

    public ServiceLocationChangedNotification(
           com.cannontech.multispeak.service.ArrayOfServiceLocation changedServiceLocations) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfServiceLocation getChangedServiceLocations() {
        return changedServiceLocations;
    }
     ...
     */
    public void setChangedServiceLocations(com.cannontech.multispeak.service.ArrayOfServiceLocation changedServiceLocations) {
        this.changedServiceLocations = changedServiceLocations;
    }
        ...
        _equals = true && 
            ((this.changedServiceLocations==null && other.getChangedServiceLocations()==null) || 
             (this.changedServiceLocations!=null &&
              this.changedServiceLocations.equals(other.getChangedServiceLocations())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getChangedServiceLocations() != null) {
            _hashCode += getChangedServiceLocations().hashCode();
        }
