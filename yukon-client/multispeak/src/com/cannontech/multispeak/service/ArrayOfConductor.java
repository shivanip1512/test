...
public class ArrayOfConductor  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Conductor[] conductor;

    public ArrayOfConductor() {
    }

    public ArrayOfConductor(
           com.cannontech.multispeak.service.Conductor[] conductor) {
     ...
     * @return conductor
     */
    public com.cannontech.multispeak.service.Conductor[] getConductor() {
        return conductor;
    }
     ...
     * @param conductor
     */
    public void setConductor(com.cannontech.multispeak.service.Conductor[] conductor) {
        this.conductor = conductor;
    }

    public com.cannontech.multispeak.service.Conductor getConductor(int i) {
        return this.conductor[i];
    }

    public void setConductor(int i, com.cannontech.multispeak.service.Conductor _value) {
