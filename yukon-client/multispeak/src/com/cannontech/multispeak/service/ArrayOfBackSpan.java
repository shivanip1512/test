...
public class ArrayOfBackSpan  implements java.io.Serializable {
    private com.cannontech.multispeak.service.BackSpan[] backSpan;

    public ArrayOfBackSpan() {
    }

    public ArrayOfBackSpan(
           com.cannontech.multispeak.service.BackSpan[] backSpan) {
     ...
     * @return backSpan
     */
    public com.cannontech.multispeak.service.BackSpan[] getBackSpan() {
        return backSpan;
    }
     ...
     * @param backSpan
     */
    public void setBackSpan(com.cannontech.multispeak.service.BackSpan[] backSpan) {
        this.backSpan = backSpan;
    }

    public com.cannontech.multispeak.service.BackSpan getBackSpan(int i) {
        return this.backSpan[i];
    }

    public void setBackSpan(int i, com.cannontech.multispeak.service.BackSpan _value) {
