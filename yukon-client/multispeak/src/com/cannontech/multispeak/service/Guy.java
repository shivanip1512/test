...
public class Guy  extends com.cannontech.multispeak.service.MspPointObject  implements java.io.Serializable {
    private com.cannontech.multispeak.service.GuyStatus status;
    private com.cannontech.multispeak.service.AnchorList anchorList;
    private com.cannontech.multispeak.service.GuyGuyType guyType;
    private com.cannontech.multispeak.service.GuyGuyAgainst guyAgainst;
    ...
    public Guy(
           com.cannontech.multispeak.service.GuyStatus status,
           com.cannontech.multispeak.service.AnchorList anchorList,
           com.cannontech.multispeak.service.GuyGuyType guyType,
           com.cannontech.multispeak.service.GuyGuyAgainst guyAgainst,
     ...
     * @return status
     */
    public com.cannontech.multispeak.service.GuyStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.cannontech.multispeak.service.GuyStatus status) {
        this.status = status;
    }
     ...
     * @return anchorList
     */
    public com.cannontech.multispeak.service.AnchorList getAnchorList() {
        return anchorList;
    }
     ...
     * @param anchorList
     */
    public void setAnchorList(com.cannontech.multispeak.service.AnchorList anchorList) {
        this.anchorList = anchorList;
    }
     ...
     * @return guyType
     */
    public com.cannontech.multispeak.service.GuyGuyType getGuyType() {
        return guyType;
    }
     ...
     * @param guyType
     */
    public void setGuyType(com.cannontech.multispeak.service.GuyGuyType guyType) {
        this.guyType = guyType;
    }
     ...
     * @return guyAgainst
     */
    public com.cannontech.multispeak.service.GuyGuyAgainst getGuyAgainst() {
        return guyAgainst;
    }
     ...
     * @param guyAgainst
     */
    public void setGuyAgainst(com.cannontech.multispeak.service.GuyGuyAgainst guyAgainst) {
        this.guyAgainst = guyAgainst;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.anchorList==null && other.getAnchorList()==null) || 
             (this.anchorList!=null &&
              this.anchorList.equals(other.getAnchorList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAnchorList() != null) {
            _hashCode += getAnchorList().hashCode();
        }
        if (getGuyType() != null) {
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "anchorList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
