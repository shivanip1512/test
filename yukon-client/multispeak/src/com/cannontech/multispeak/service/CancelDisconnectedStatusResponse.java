...
public class CancelDisconnectedStatusResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfErrorObject cancelDisconnectedStatusResult;

    public CancelDisconnectedStatusResponse() {
    }

    public CancelDisconnectedStatusResponse(
           com.cannontech.multispeak.service.ArrayOfErrorObject cancelDisconnectedStatusResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfErrorObject getCancelDisconnectedStatusResult() {
        return cancelDisconnectedStatusResult;
    }
     ...
     */
    public void setCancelDisconnectedStatusResult(com.cannontech.multispeak.service.ArrayOfErrorObject cancelDisconnectedStatusResult) {
        this.cancelDisconnectedStatusResult = cancelDisconnectedStatusResult;
    }
