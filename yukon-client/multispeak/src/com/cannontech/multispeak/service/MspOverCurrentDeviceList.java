...
public class MspOverCurrentDeviceList  implements java.io.Serializable {
    ...
    public com.cannontech.multispeak.service.MspOverCurrentDevice getMspOverCurrentDevice(int i) {
        return this.mspOverCurrentDevice[i];
    }

    public void setMspOverCurrentDevice(int i, com.cannontech.multispeak.service.MspOverCurrentDevice _value) {
