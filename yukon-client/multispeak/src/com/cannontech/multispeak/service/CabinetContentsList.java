...
public class CabinetContentsList  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ObjectRef[] cabinetContentsItem;

    public CabinetContentsList() {
    }

    public CabinetContentsList(
           com.cannontech.multispeak.service.ObjectRef[] cabinetContentsItem) {
     ...
     */
    public com.cannontech.multispeak.service.ObjectRef[] getCabinetContentsItem() {
        return cabinetContentsItem;
    }
     ...
     */
    public void setCabinetContentsItem(com.cannontech.multispeak.service.ObjectRef[] cabinetContentsItem) {
        this.cabinetContentsItem = cabinetContentsItem;
    }

    public com.cannontech.multispeak.service.ObjectRef getCabinetContentsItem(int i) {
        return this.cabinetContentsItem[i];
    }

    public void setCabinetContentsItem(int i, com.cannontech.multispeak.service.ObjectRef _value) {
