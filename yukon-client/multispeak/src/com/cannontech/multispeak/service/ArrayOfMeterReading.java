...
public class ArrayOfMeterReading  implements java.io.Serializable {
    private com.cannontech.multispeak.service.MeterReading[] meterReading;

    public ArrayOfMeterReading() {
    }

    public ArrayOfMeterReading(
           com.cannontech.multispeak.service.MeterReading[] meterReading) {
     ...
     * @return meterReading
     */
    public com.cannontech.multispeak.service.MeterReading[] getMeterReading() {
        return meterReading;
    }
     ...
     * @param meterReading
     */
    public void setMeterReading(com.cannontech.multispeak.service.MeterReading[] meterReading) {
        this.meterReading = meterReading;
    }

    public com.cannontech.multispeak.service.MeterReading getMeterReading(int i) {
        return this.meterReading[i];
    }

    public void setMeterReading(int i, com.cannontech.multispeak.service.MeterReading _value) {
