...
public interface MultispeakMeterService {
     ...
     */
    public LoadActionCode CDMeterState(MultispeakVendor mspVendor, YukonMeter meter)
            throws MultispeakWebServiceException;

    /**
     * This is a workaround method for SEDC. This method is used to perform an actual meter interrogation and
     * then return
     ...
     * @throws MultispeakWebServiceException
     */
    public ErrorObject[] odEvent(MultispeakVendor mspVendor, String[] meterNumbers, String transactionID,
            String responseUrl) throws MultispeakWebServiceException;
     ...
     * @return ErrorObject [] Array of errorObjects for meters that cannot be found, etc.
     */
    public ErrorObject[] meterReadEvent(MultispeakVendor mspVendor, String[] meterNumbers, String transactionID,
            String responseUrl);
     ...
     * @return ErrorObject [] Array of errorObjects for meters that cannot be found, etc.
     */
    public ErrorObject[] blockMeterReadEvent(MultispeakVendor mspVendor, String meterNumber,
            FormattedBlockProcessingService<Block> blockProcessingService, String transactionId, String responseUrl);

    /**
     * Send a disconnect/connect request to Porter (PLC) or submit to queue (RFN) for each meter in
     * meterNumbers.
     * 
     * @return ErrorObject [] Array of errorObjects for meters that cannot be found, etc.
     */
    public ErrorObject[] cdEvent(MultispeakVendor mspVendor, ConnectDisconnectEvent[] cdEvents, String transactionID,
            String responseURL) throws MultispeakWebServiceException;
     ...
     * </ul>
     * This is done in the initialize() method. The user can override these defaults using cparms. The syntax
     * for this is "MSP_OUTAGE_EVENT_TYPE_CONFIG_xxx : errCode1, errorCode2, etc" where "xxx" is the name of
     * the OutageEventType that is being overridden.
     * <p>
     * Example: "MSP_OUTAGE_EVENT_TYPE_CONFIG_OUTAGE : 17". This will remove the error code 17 from any other
     * OutageEventType it is associated with and assign 17 to the OutageEventType.Outage map entry. So, since
     * 17 is by default an error code associated with OutageEventType.Restoration... including this cparm
     * would remove 17 from the Restoration map entry and re-assign it to OutageEventType.Outage entry.
     * <p>
