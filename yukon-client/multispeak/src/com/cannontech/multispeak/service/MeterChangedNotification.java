...
public class MeterChangedNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfMeter changedMeters;

    public MeterChangedNotification() {
    }

    public MeterChangedNotification(
           com.cannontech.multispeak.service.ArrayOfMeter changedMeters) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfMeter getChangedMeters() {
        return changedMeters;
    }
     ...
     * @param changedMeters
     */
    public void setChangedMeters(com.cannontech.multispeak.service.ArrayOfMeter changedMeters) {
        this.changedMeters = changedMeters;
    }
        ...
        _equals = true && 
            ((this.changedMeters==null && other.getChangedMeters()==null) || 
             (this.changedMeters!=null &&
              this.changedMeters.equals(other.getChangedMeters())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getChangedMeters() != null) {
            _hashCode += getChangedMeters().hashCode();
        }
