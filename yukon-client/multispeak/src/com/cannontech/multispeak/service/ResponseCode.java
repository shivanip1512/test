...
public class ResponseCode implements java.io.Serializable {
    ...
    public static final ResponseCode Failure = new ResponseCode(_Failure);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "responseCode"));
    }
    /**
