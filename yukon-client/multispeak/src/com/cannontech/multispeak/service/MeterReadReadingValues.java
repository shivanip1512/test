...
public class MeterReadReadingValues  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ReadingValue[] readingValue;

    public MeterReadReadingValues() {
    }

    public MeterReadReadingValues(
           com.cannontech.multispeak.service.ReadingValue[] readingValue) {
     ...
     * @return readingValue
     */
    public com.cannontech.multispeak.service.ReadingValue[] getReadingValue() {
        return readingValue;
    }
     ...
     * @param readingValue
     */
    public void setReadingValue(com.cannontech.multispeak.service.ReadingValue[] readingValue) {
        this.readingValue = readingValue;
    }

    public com.cannontech.multispeak.service.ReadingValue getReadingValue(int i) {
        return this.readingValue[i];
    }

    public void setReadingValue(int i, com.cannontech.multispeak.service.ReadingValue _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">meterRead>readingValues"));
