...
public class ArrayOfMaterialComponent  implements java.io.Serializable {
    private com.cannontech.multispeak.service.MaterialComponent[] materialComponent;

    public ArrayOfMaterialComponent() {
    }

    public ArrayOfMaterialComponent(
           com.cannontech.multispeak.service.MaterialComponent[] materialComponent) {
     ...
     */
    public com.cannontech.multispeak.service.MaterialComponent[] getMaterialComponent() {
        return materialComponent;
    }
     ...
     */
    public void setMaterialComponent(com.cannontech.multispeak.service.MaterialComponent[] materialComponent) {
        this.materialComponent = materialComponent;
    }

    public com.cannontech.multispeak.service.MaterialComponent getMaterialComponent(int i) {
        return this.materialComponent[i];
    }

    public void setMaterialComponent(int i, com.cannontech.multispeak.service.MaterialComponent _value) {
