...
public class BillingDetail  extends com.cannontech.multispeak.service.MspObject  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.service.ChargeItemList chargeItemList;
    ...
    public BillingDetail(
           ...
           com.cannontech.multispeak.service.ChargeItemList chargeItemList,
     ...
     */
    public com.cannontech.multispeak.service.ChargeItemList getChargeItemList() {
        return chargeItemList;
    }
     ...
     */
    public void setChargeItemList(com.cannontech.multispeak.service.ChargeItemList chargeItemList) {
        this.chargeItemList = chargeItemList;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.chargeItemList==null && other.getChargeItemList()==null) || 
             (this.chargeItemList!=null &&
              this.chargeItemList.equals(other.getChargeItemList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getChargeItemList() != null) {
            _hashCode += getChargeItemList().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", "chargeItemList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
