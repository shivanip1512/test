...
public class ArrayOfMeasurementType  implements java.io.Serializable {
    private com.cannontech.multispeak.service.MeasurementType[] measurementType;

    public ArrayOfMeasurementType() {
    }

    public ArrayOfMeasurementType(
           com.cannontech.multispeak.service.MeasurementType[] measurementType) {
     ...
     */
    public com.cannontech.multispeak.service.MeasurementType[] getMeasurementType() {
        return measurementType;
    }
     ...
     */
    public void setMeasurementType(com.cannontech.multispeak.service.MeasurementType[] measurementType) {
        this.measurementType = measurementType;
    }

    public com.cannontech.multispeak.service.MeasurementType getMeasurementType(int i) {
        return this.measurementType[i];
    }

    public void setMeasurementType(int i, com.cannontech.multispeak.service.MeasurementType _value) {
