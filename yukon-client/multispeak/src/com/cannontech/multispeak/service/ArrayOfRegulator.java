...
public class ArrayOfRegulator  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Regulator[] regulator;

    public ArrayOfRegulator() {
    }

    public ArrayOfRegulator(
           com.cannontech.multispeak.service.Regulator[] regulator) {
     ...
     * @return regulator
     */
    public com.cannontech.multispeak.service.Regulator[] getRegulator() {
        return regulator;
    }
     ...
     * @param regulator
     */
    public void setRegulator(com.cannontech.multispeak.service.Regulator[] regulator) {
        this.regulator = regulator;
    }

    public com.cannontech.multispeak.service.Regulator getRegulator(int i) {
        return this.regulator[i];
    }

    public void setRegulator(int i, com.cannontech.multispeak.service.Regulator _value) {
