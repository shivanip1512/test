...
public class ArrayOfErrorObject  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ErrorObject[] errorObject;

    public ArrayOfErrorObject() {
    }

    public ArrayOfErrorObject(
           com.cannontech.multispeak.service.ErrorObject[] errorObject) {
     ...
     * @return errorObject
     */
    public com.cannontech.multispeak.service.ErrorObject[] getErrorObject() {
        return errorObject;
    }
     ...
     * @param errorObject
     */
    public void setErrorObject(com.cannontech.multispeak.service.ErrorObject[] errorObject) {
        this.errorObject = errorObject;
    }

    public com.cannontech.multispeak.service.ErrorObject getErrorObject(int i) {
        return this.errorObject[i];
    }

    public void setErrorObject(int i, com.cannontech.multispeak.service.ErrorObject _value) {
