...
public class ArrayOfEquipment  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Equipment[] equipment;

    public ArrayOfEquipment() {
    }

    public ArrayOfEquipment(
           com.cannontech.multispeak.service.Equipment[] equipment) {
     ...
     * @return equipment
     */
    public com.cannontech.multispeak.service.Equipment[] getEquipment() {
        return equipment;
    }
     ...
     * @param equipment
     */
    public void setEquipment(com.cannontech.multispeak.service.Equipment[] equipment) {
        this.equipment = equipment;
    }

    public com.cannontech.multispeak.service.Equipment getEquipment(int i) {
        return this.equipment[i];
    }

    public void setEquipment(int i, com.cannontech.multispeak.service.Equipment _value) {
