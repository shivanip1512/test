...
public class ArrayOfHistoryLog  implements java.io.Serializable {
    private com.cannontech.multispeak.service.HistoryLog[] historyLog;

    public ArrayOfHistoryLog() {
    }

    public ArrayOfHistoryLog(
           com.cannontech.multispeak.service.HistoryLog[] historyLog) {
     ...
     * @return historyLog
     */
    public com.cannontech.multispeak.service.HistoryLog[] getHistoryLog() {
        return historyLog;
    }
     ...
     * @param historyLog
     */
    public void setHistoryLog(com.cannontech.multispeak.service.HistoryLog[] historyLog) {
        this.historyLog = historyLog;
    }

    public com.cannontech.multispeak.service.HistoryLog getHistoryLog(int i) {
        return this.historyLog[i];
    }

    public void setHistoryLog(int i, com.cannontech.multispeak.service.HistoryLog _value) {
