...
public class LinkedTransformer  implements java.io.Serializable {
    ...
    private com.cannontech.multispeak.service.LinkedTransformerUnitList unitList;
    ...
    public LinkedTransformer(
           ...
           com.cannontech.multispeak.service.LinkedTransformerUnitList unitList) {
           this.bankID = bankID;
     ...
     * @return unitList
     */
    public com.cannontech.multispeak.service.LinkedTransformerUnitList getUnitList() {
        return unitList;
    }
     ...
     * @param unitList
     */
    public void setUnitList(com.cannontech.multispeak.service.LinkedTransformerUnitList unitList) {
        this.unitList = unitList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">linkedTransformer>unitList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
