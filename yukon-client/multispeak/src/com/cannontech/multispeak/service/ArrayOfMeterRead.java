...
public class ArrayOfMeterRead  implements java.io.Serializable {
    private com.cannontech.multispeak.service.MeterRead[] meterRead;

    public ArrayOfMeterRead() {
    }

    public ArrayOfMeterRead(
           com.cannontech.multispeak.service.MeterRead[] meterRead) {
     ...
     * @return meterRead
     */
    public com.cannontech.multispeak.service.MeterRead[] getMeterRead() {
        return meterRead;
    }
     ...
     * @param meterRead
     */
    public void setMeterRead(com.cannontech.multispeak.service.MeterRead[] meterRead) {
        this.meterRead = meterRead;
    }

    public com.cannontech.multispeak.service.MeterRead getMeterRead(int i) {
        return this.meterRead[i];
    }

    public void setMeterRead(int i, com.cannontech.multispeak.service.MeterRead _value) {
