...
public class ModifyODDataForOutageDetectionDevice  implements java.io.Serializable {
    private com.cannontech.multispeak.service.OutageDetectionDevice oDDevice;

    public ModifyODDataForOutageDetectionDevice() {
    }

    public ModifyODDataForOutageDetectionDevice(
           com.cannontech.multispeak.service.OutageDetectionDevice oDDevice) {
     ...
     * @return oDDevice
     */
    public com.cannontech.multispeak.service.OutageDetectionDevice getODDevice() {
        return oDDevice;
    }
     ...
     * @param oDDevice
     */
    public void setODDevice(com.cannontech.multispeak.service.OutageDetectionDevice oDDevice) {
        this.oDDevice = oDDevice;
    }
