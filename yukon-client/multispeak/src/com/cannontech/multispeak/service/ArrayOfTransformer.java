...
public class ArrayOfTransformer  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Transformer[] transformer;

    public ArrayOfTransformer() {
    }

    public ArrayOfTransformer(
           com.cannontech.multispeak.service.Transformer[] transformer) {
     ...
     * @return transformer
     */
    public com.cannontech.multispeak.service.Transformer[] getTransformer() {
        return transformer;
    }
     ...
     * @param transformer
     */
    public void setTransformer(com.cannontech.multispeak.service.Transformer[] transformer) {
        this.transformer = transformer;
    }

    public com.cannontech.multispeak.service.Transformer getTransformer(int i) {
        return this.transformer[i];
    }

    public void setTransformer(int i, com.cannontech.multispeak.service.Transformer _value) {
