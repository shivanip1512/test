...
public class ArrayOfCustomer  implements java.io.Serializable {
    private com.cannontech.multispeak.service.Customer[] customer;

    public ArrayOfCustomer() {
    }

    public ArrayOfCustomer(
           com.cannontech.multispeak.service.Customer[] customer) {
     ...
     * @return customer
     */
    public com.cannontech.multispeak.service.Customer[] getCustomer() {
        return customer;
    }
     ...
     * @param customer
     */
    public void setCustomer(com.cannontech.multispeak.service.Customer[] customer) {
        this.customer = customer;
    }

    public com.cannontech.multispeak.service.Customer getCustomer(int i) {
        return this.customer[i];
    }

    public void setCustomer(int i, com.cannontech.multispeak.service.Customer _value) {
