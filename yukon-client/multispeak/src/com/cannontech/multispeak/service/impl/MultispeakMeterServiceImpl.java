...
public class MultispeakMeterServiceImpl implements MultispeakMeterService, MessageListener {
    ...
    public MeterRead getLatestReadingInterrogate(MultispeakVendor mspVendor, YukonMeter meter, String responseUrl) {
        ...
        multispeakEventLogService.initiateMeterRead(meterNumber, meter, "getLatestReadingByMeterNo", mspVendor.getCompanyName());
    ...
    @Override
    public synchronized ErrorObject[] odEvent(MultispeakVendor mspVendor, String[] meterNumbers, String transactionID,
            String responseUrl) throws RemoteException {
        
        if (mspVendor.getUrl() == null || mspVendor.getUrl().equalsIgnoreCase(CtiUtilities.STRING_NONE)) {
        ...
        for (String meterNumber : meterNumbers) {
            ...
            try {
                ...
                if (!canInitiatePorterRequest) {
                    ...
                    long id = generateMessageID();
                    ODEvent event = new ODEvent(mspVendor, id, transactionID, responseUrl);
                    getEventsMap().put(new Long(id), event);
    ...
    public synchronized ErrorObject[] meterReadEvent(final MultispeakVendor mspVendor, String[] meterNumbers,
        ...
        for (String meterNumber : meterNumbers) {
            ...
            try {
                ...
                multispeakEventLogService.initiateMeterRead(meterNumber, meter, "initiateMeterReadByMeterNumber", mspVendor.getCompanyName());
            } catch (NotFoundException e) {
    ...
    public synchronized ErrorObject[] blockMeterReadEvent(final MultispeakVendor mspVendor, String meterNumber,
        ...
        multispeakEventLogService.initiateMeterRead(meterNumber, paoToRead, "initiateMeterReadByMeterNoAndType", mspVendor.getCompanyName());
    ...
    public ErrorObject[] meterRemove(MultispeakVendor mspVendor, Meter[] removeMeters) {
        ...
        for (Meter mspMeter : removeMeters) {
            ...
            try {
                ...
                // ...is this logging superfluous?
                multispeakEventLogService.meterRemoved(meter.getMeterNumber(), meter, METER_REMOVE_STRING, mspVendor.getCompanyName());
            } catch (NotFoundException e) {
