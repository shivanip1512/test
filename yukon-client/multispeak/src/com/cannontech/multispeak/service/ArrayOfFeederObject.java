...
public class ArrayOfFeederObject  implements java.io.Serializable {
    private com.cannontech.multispeak.service.FeederObject[] feederObject;

    public ArrayOfFeederObject() {
    }

    public ArrayOfFeederObject(
           com.cannontech.multispeak.service.FeederObject[] feederObject) {
     ...
     * @return feederObject
     */
    public com.cannontech.multispeak.service.FeederObject[] getFeederObject() {
        return feederObject;
    }
     ...
     * @param feederObject
     */
    public void setFeederObject(com.cannontech.multispeak.service.FeederObject[] feederObject) {
        this.feederObject = feederObject;
    }

    public com.cannontech.multispeak.service.FeederObject getFeederObject(int i) {
        return this.feederObject[i];
    }

    public void setFeederObject(int i, com.cannontech.multispeak.service.FeederObject _value) {
