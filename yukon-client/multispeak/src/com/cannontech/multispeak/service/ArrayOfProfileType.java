...
public class ArrayOfProfileType  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ProfileType[] loadProfile;

    public ArrayOfProfileType() {
    }

    public ArrayOfProfileType(
           com.cannontech.multispeak.service.ProfileType[] loadProfile) {
     ...
     * @return loadProfile
     */
    public com.cannontech.multispeak.service.ProfileType[] getLoadProfile() {
        return loadProfile;
    }
     ...
     * @param loadProfile
     */
    public void setLoadProfile(com.cannontech.multispeak.service.ProfileType[] loadProfile) {
        this.loadProfile = loadProfile;
    }

    public com.cannontech.multispeak.service.ProfileType getLoadProfile(int i) {
        return this.loadProfile[i];
    }

    public void setLoadProfile(int i, com.cannontech.multispeak.service.ProfileType _value) {
