...
public class GetAllCustomersResponse  implements java.io.Serializable {
    private com.cannontech.multispeak.service.ArrayOfCustomer getAllCustomersResult;

    public GetAllCustomersResponse() {
    }

    public GetAllCustomersResponse(
           com.cannontech.multispeak.service.ArrayOfCustomer getAllCustomersResult) {
     ...
     */
    public com.cannontech.multispeak.service.ArrayOfCustomer getGetAllCustomersResult() {
        return getAllCustomersResult;
    }
     ...
     */
    public void setGetAllCustomersResult(com.cannontech.multispeak.service.ArrayOfCustomer getAllCustomersResult) {
        this.getAllCustomersResult = getAllCustomersResult;
    }
        ...
        _equals = true && 
            ((this.getAllCustomersResult==null && other.getGetAllCustomersResult()==null) || 
             (this.getAllCustomersResult!=null &&
              this.getAllCustomersResult.equals(other.getGetAllCustomersResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetAllCustomersResult() != null) {
            _hashCode += getGetAllCustomersResult().hashCode();
        }
