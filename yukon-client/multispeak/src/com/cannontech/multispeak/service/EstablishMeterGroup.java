...
public class EstablishMeterGroup  implements java.io.Serializable {
    private com.cannontech.multispeak.service.MeterGroup meterGroup;

    public EstablishMeterGroup() {
    }

    public EstablishMeterGroup(
           com.cannontech.multispeak.service.MeterGroup meterGroup) {
     ...
     * @return meterGroup
     */
    public com.cannontech.multispeak.service.MeterGroup getMeterGroup() {
        return meterGroup;
    }
     ...
     * @param meterGroup
     */
    public void setMeterGroup(com.cannontech.multispeak.service.MeterGroup meterGroup) {
        this.meterGroup = meterGroup;
    }
