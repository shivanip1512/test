/**
 * GetModifiedServiceLocations.java
 *
...
public class GetModifiedServiceLocations  implements java.io.Serializable {
    private java.lang.String previousSessionID;
    private java.lang.String lastReceived;

    public GetModifiedServiceLocations() {
    }
    ...
    /**
     * Gets the previousSessionID value for this GetModifiedServiceLocations.
     * 
    ...
    /**
     * Sets the previousSessionID value for this GetModifiedServiceLocations.
     * 
    ...
    /**
     * Gets the lastReceived value for this GetModifiedServiceLocations.
     * 
     * @return lastReceived
     */
    ...
    /**
     * Sets the lastReceived value for this GetModifiedServiceLocations.
     * 
     * @param lastReceived
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetModifiedServiceLocations)) return false;
        GetModifiedServiceLocations other = (GetModifiedServiceLocations) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetModifiedServiceLocations.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.multispeak.org/Version_3.0", ">GetModifiedServiceLocations"));
