...
public class MeterChangedNotification  implements java.io.Serializable {
    private com.cannontech.multispeak.ArrayOfMeter changedMeters;

    public MeterChangedNotification() {
    }

    public MeterChangedNotification(
           com.cannontech.multispeak.ArrayOfMeter changedMeters) {
     ...
     */
    public com.cannontech.multispeak.ArrayOfMeter getChangedMeters() {
        return changedMeters;
    }
     ...
     * @param changedMeters
     */
    public void setChangedMeters(com.cannontech.multispeak.ArrayOfMeter changedMeters) {
        this.changedMeters = changedMeters;
    }
