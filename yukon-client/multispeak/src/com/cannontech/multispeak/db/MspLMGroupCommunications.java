...
public class MspLMGroupCommunications {
    ...
    public enum MspLMGroupStatus {
        FAILED("Failed"), OFFLINE("Offline"), ONLINE("Online");
    ...
    public MspLMGroupCommunications(Integer lmGroupId, Integer routeId, Integer transmitterId, boolean disableFlag) {
        super();
