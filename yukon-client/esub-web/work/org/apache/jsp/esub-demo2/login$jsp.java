...
public class login$jsp extends HttpJspBase {
    ...
    public void _jspService(HttpServletRequest request, HttpServletResponse  response)
        ...
        try {
            ...
            // begin [file="/esub-demo2/login.jsp";from=(0,2);to=(3,0)]
                
                      //Check whether this is a second attempt
                      String lastAttemptFailed = request.getParameter("failed");
            // end
            // HTML // begin [file="/esub-demo2/login.jsp";from=(3,2);to=(82,2)]
            ...
            // end
            // begin [file="/esub-demo2/login.jsp";from=(82,4);to=(85,2)]
                
                 		  if( lastAttemptFailed != null )
                		   {
                		
            // end
            // HTML // begin [file="/esub-demo2/login.jsp";from=(85,4);to=(92,2)]
                out.write("\r\n \t\t \r\n   \t\t\t <div align=\"center\">\r\n    \t\t\t<font FACE=\"Arial\" color=Red size=2>\r\n       \t\t\t Login Failed\r\n    \t\t\t</font>\r\n\t\t\t</div>\r\n\t\t");

            // end
            // begin [file="/esub-demo2/login.jsp";from=(92,4);to=(94,2)]
                
                 		  }
                		
            // end
            // HTML // begin [file="/esub-demo2/login.jsp";from=(94,4);to=(186,0)]
