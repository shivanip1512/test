...
public HEnergyExchangeCustomer[] getEnergyExchangeCustomers() {
	String queryStr = "SELECT LMCUSTOMERDEVICEID, YUKONPAOBJECT.PAONAME FROM LMENERGYEXCHANGECUSTOMERLIST, YUKONPAOBJECT";
    queryStr += " WHERE LMENERGYEXCHANGECUSTOMERLIST.DEVICEID = " + deviceId + " AND LMCUSTOMERDEVICEID = YUKONPAOBJECT.PAOBJECTID ";
