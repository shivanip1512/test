...
public enum ConstraintError {
    ...
    OUTSIDE_SEASON_SCHEDULE(100) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("startTime", constraintViolation.getDatetimeParams().get(0), "scheduleId", constraintViolation
                .getIntegerParams().get(0));
        }
    },
    ...
    EXCEEDED_DAILY_CONTROL_HOURS(103) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("groupName", constraintViolation.getStringParams().get(0), "numHours", constraintViolation
                .getDoubleParams().get(0));
        }
    },
    ...
    MIN_RESTART_TIME_VIOLATION(109) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("paoName", constraintViolation.getStringParams().get(0), "numHours", constraintViolation
                .getDoubleParams().get(0));
        }
    },
    MAXIMUM_DAILY_OPERATIONS_REACHED(110) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("paoName", constraintViolation.getStringParams().get(0), "maxDailyOps", constraintViolation
                .getIntegerParams().get(0));
        }
    },
    ...
    STOP_TIME_OUTSIDE_CONTROL_WINDOW(113) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("proposedStop", constraintViolation.getDatetimeParams().get(0), "availableStart",
                constraintViolation.getDatetimeParams().get(1), "availableStop", constraintViolation
                    .getDatetimeParams().get(2));
        }
    },
    START_TIME_OUTSIDE_CONTROL_WINDOW(114) {

        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("proposedStart", constraintViolation.getDatetimeParams().get(0), "availableStart",
                constraintViolation.getDatetimeParams().get(1), "availableStop", constraintViolation
                    .getDatetimeParams().get(2));
        }
    },
    PROPOSED_START_AFTER_STOP(115) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("proposedStart", constraintViolation.getDatetimeParams().get(0), "proposedStop",
                constraintViolation.getDatetimeParams().get(1));
        }
    },
    ...
    PROPOSED_START_TOO_SOON(121) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("proposedStart", constraintViolation.getDatetimeParams().get(0), "minutesFromNow",
                constraintViolation.getDoubleParams().get(0), "offsetMinutes", constraintViolation.getDoubleParams()
                    .get(1));
        }
    },
    ...
    CANNOT_EXTEND_STOP_TIME(123) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("currentStop", constraintViolation.getDatetimeParams().get(0), "proposedStop",
                constraintViolation.getDatetimeParams().get(1));
        }
    },
    ...
    EXCEEDED_DAILY_CONTROL_HOURS_MSG_2(128) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("paoName", constraintViolation.getStringParams().get(0), "maxHours", constraintViolation
                .getDoubleParams().get(0));
        }
    },
    EXCEEDED_DAILY_CONTROL_HOURS_MSG_3(129) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("paoName", constraintViolation.getStringParams().get(0), "currentHours", constraintViolation
                .getDoubleParams().get(0));
        }
    },
    ...
    LOAD_GROUP_CANNOT_CONTROL_IN_WINDOW_ADJUST(146) {
        ...
        Map<String, Object> getViolationParameters(ConstraintViolation constraintViolation) {
            return map("areaStart", constraintViolation.getDatetimeParams().get(0), "areaStop", constraintViolation
                .getDatetimeParams().get(1), "duration", constraintViolation.getIntegerParams().get(0));
        }
    },
    ...
    static {
        Builder<Integer, ConstraintError> byDefinitionIdBuilder = ImmutableMap.builder();
