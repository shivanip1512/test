...
public class AssetAvailabilityPlcPingServiceImpl implements AssetAvailabilityPlcPingService{
    private static final Logger log = YukonLogManager.getLogger(AssetAvailabilityPlcPingServiceImpl.class);
    ...
    public void readDevices(Set<? extends YukonPao> devices, String resultId) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                log.info("PLC test thread completed.");
            }
        };
