 ...
 */
public abstract class LoadGroupBackingFieldBase implements DemandResponseBackingField<LMGroupBase> {
    ...
    @Override
    public Object getValue(LMGroupBase group, YukonUserContext userContext) {
        if(group != null || handleNull()) {
            return getGroupValue((LMDirectGroupBase) group, userContext);
        } else {
