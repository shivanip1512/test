...
public java.awt.Component getTableCellRendererComponent(javax.swing.JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) 
{
	...
	if( model instanceof SelectableLMTableModel )
		handleColor( (SelectableLMTableModel)model, row, column, table, isSelected );
 ...
 */
private void handleColor(SelectableLMTableModel model, int row, int column, javax.swing.JTable table, boolean isSelected ) 
{
