...
public static void main(java.lang.String[] args) {
	try {
		...
		Series400ConfigPanel aSeries400ConfigPanel;
		aSeries400ConfigPanel = new Series400ConfigPanel();
		frame.getContentPane().add("Center", aSeries400ConfigPanel);
		frame.setSize(aSeries400ConfigPanel.getSize());
