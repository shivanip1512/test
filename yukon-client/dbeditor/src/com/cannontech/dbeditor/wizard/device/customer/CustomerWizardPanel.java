...
{
	private CICustomerBasePanel ciCustomerBasePanel;
 ...
 */
public CICustomerBasePanel getCiCustomerBasePanel() 
{
	if( ciCustomerBasePanel == null )
		ciCustomerBasePanel = new CICustomerBasePanel();
		
	return ciCustomerBasePanel;
}
/**
 * Insert the method's description here.
...
protected com.cannontech.common.gui.util.DataInputPanel getNextInputPanel(com.cannontech.common.gui.util.DataInputPanel currentInputPanel) 
{
	...
	{
		return getCiCustomerBasePanel();
	}
	else if( currentInputPanel == getCiCustomerBasePanel() )
	{
