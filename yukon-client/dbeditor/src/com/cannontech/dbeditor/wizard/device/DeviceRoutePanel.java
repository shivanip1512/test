...
public class DeviceRoutePanel extends com.cannontech.common.gui.util.DataInputPanel {
...
public Object getValue(Object val)
{
	...
	if (val instanceof MCT310 || val instanceof MCT310IL || val instanceof MCT310ID)
	{
		...
		com.cannontech.database.data.point.PointBase newPoint =
			com.cannontech.database.data.point.PointFactory.createPoint(com.cannontech.database.data.point.PointTypes.PULSE_ACCUMULATOR_POINT);
		...
		((com.cannontech.database.data.point.AccumulatorPoint) newPoint).setPointAccumulator(
	...
	else if (val instanceof RepeaterBase)
	{
		...
		String routeType = com.cannontech.database.data.pao.RouteTypes.STRING_CCU;
...
public void setValue(Object val) {
	...
	synchronized(cache)
	{
		...
		{
			routeType = ((com.cannontech.database.data.lite.LiteYukonPAObject)allRoutes.get(i)).getType();
