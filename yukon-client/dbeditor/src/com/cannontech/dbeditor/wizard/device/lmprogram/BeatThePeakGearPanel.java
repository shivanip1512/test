...
public class BeatThePeakGearPanel extends GenericGearPanel 
{
    ...
    private static enum TierIndicator{
        YELLOW(2), RED(4);
        private final int tier;
        
        TierIndicator(Integer tier){
            this.tier = tier;
        }
        ...
        private static Integer tierOf(String tier){
            for(TierIndicator ti : TierIndicator.values()){
                if(tier.equals(ti.toString()))
                    return ti.tier;
            }
            return null;
        }
        
        private static String nameOf(Integer tier){
            for(TierIndicator t : TierIndicator.values()){
                if( tier.equals(t.tier) )
                    return t.toString();
            }
            return null;
        }
...
private void initialize() {
    try {
        ...
        java.awt.GridBagConstraints constraintsJComboBoxBtpLed = new java.awt.GridBagConstraints();
        ...
        //Timeout
        java.awt.GridBagConstraints constraintsJLabelTimeout = new java.awt.GridBagConstraints();
        ...
        java.awt.GridBagConstraints constraintsJCSpinFieldTimeout = new java.awt.GridBagConstraints();
        ...
        java.awt.GridBagConstraints constraintsJLabelMinutesTimeout = new java.awt.GridBagConstraints();
        ...
        java.awt.GridBagConstraints constraintsJCSpinFieldResend = new java.awt.GridBagConstraints();
        ...
        java.awt.GridBagConstraints constraintsJLabelMinutesResend = new java.awt.GridBagConstraints();
...
public void setValue(Object o) 
{
    ...
    getJComboBoxIndicator().setSelectedItem(tierName);    
}
...
private javax.swing.JComboBox getJComboBoxIndicator() {
    if (ivjJComboBoxIndicator == null) {
        try {
            ...
            for( TierIndicator value : TierIndicator.values()){               
...
private com.klg.jclass.field.JCSpinField getJCSpinFieldTimeout() {
    if (ivjJCSpinFieldTimeout == null) {
        try {
            ...
            ivjJCSpinFieldTimeout.setDataProperties(
...
private com.klg.jclass.field.JCSpinField getJCSpinFieldResend() {
    if (ivjJCSpinFieldResend == null) {
        try {
            ...
            ivjJCSpinFieldResend.setDataProperties(
                    new com.klg.jclass.field.DataProperties(
                        new com.klg.jclass.field.validate.JCIntegerValidator(
                        null, new Integer(0), new Integer(99999), null, true, 
                        null, new Integer(1), "#,##0.###;-#,##0.###", false, 
...
private javax.swing.JPanel getJPanelChangeMethod() {
    if (ivjJPanelChangeMethod == null) {
        try {
            ...
            constraintsJLabelChangeDuration.gridx = 1; constraintsJLabelChangeDuration.gridy = 3;
            ...
            constraintsJCSpinFieldChangeDuration.gridx = 2; constraintsJCSpinFieldChangeDuration.gridy = 3;
            ...
            constraintsJLabelMinutesChDur.gridx = 3; constraintsJLabelMinutesChDur.gridy = 3;
            ...
            getJPanelChangeMethod().add(getJLabelChangeDurationMinutes(), constraintsJLabelMinutesChDur);

            //Priority Change   
            java.awt.GridBagConstraints constraintsJLabelChangePriority = new java.awt.GridBagConstraints();
            constraintsJLabelChangePriority.gridx = 1; constraintsJLabelChangePriority.gridy = 3;
            ...
            constraintsJCSpinFieldChangePriority.gridx = 2; constraintsJCSpinFieldChangePriority.gridy = 3;
