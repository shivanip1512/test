...
public class HoneywellCycleGearPanel extends GenericGearPanel {
    ...
    public HoneywellCycleGearPanel() {
        initialize();
    }
    ...
    private javax.swing.JComboBox<Integer> getJComboBoxCyclePeriod() {
        if (ivjJComboBoxCyclePeriod == null) {
            try {
                ivjJComboBoxCyclePeriod = new javax.swing.JComboBox<Integer>();
    ...
    private JCSpinField getJCSpinFieldChangeDuration() {
        if (changeDurationSpinField == null) {
            try {
                ...
                changeDurationSpinField.setDataProperties(new DataProperties(new JCIntegerValidator(null, 0, 99999,
                    null, true, null, 1, "#,##0.###;-#,##0.###", false, false, false, null, 3), new MutableValueModel(
    ...
    private JCSpinField getJCSpinFieldChangePriority() {
        if (changePrioritySpinField == null) {
            try {
                ...
                changePrioritySpinField.setDataProperties(new DataProperties(new JCIntegerValidator(null, 0, 9999,
                    null, true, null, 1, "#,##0.###;-#,##0.###", false, false, false, null, 0), new MutableValueModel(
                    Integer.class, 0), new JCInvalidInfo(true, 2, new Color(0, 0, 0, 255),
                    new Color(255, 255, 255, 255))));
            } catch (Throwable ivjExc) {
                handleException(ivjExc);
    ...
    private JCSpinField getJCSpinFieldChangeTriggerNumber() {
        if (changeTriggerNumberSpinField == null) {
            try {
                ...
                changeTriggerNumberSpinField.setDataProperties(new DataProperties(new JCIntegerValidator(null, 1,
                    99999, null, true, null, 1, "#,##0.###;-#,##0.###", false, false, false, null, 1),
                    new MutableValueModel(Integer.class, 0), new JCInvalidInfo(true, 2, new Color(0, 0, 0, 255),
                        new Color(255, 255, 255, 255))));
            } catch (Throwable ivjExc) {
                handleException(ivjExc);
            }
    ...
    private JCSpinField getJCSpinFieldPercentReduction() {
        if (percentReductionSpinField == null) {
            try {
                ...
                percentReductionSpinField.setDataProperties(new DataProperties(new JCIntegerValidator(null, 0, 100,
                    null, true, null, 1, "#,##0.###;-#,##0.###", false, false, false, null, 100),
                    new MutableValueModel(Integer.class, 0), new JCInvalidInfo(true, 2, new Color(0, 0, 0, 255),
                        new Color(255, 255, 255, 255))));
    ...
    public Object getValue(Object gearObj) {
        HoneywellCycleGear gear = (HoneywellCycleGear) gearObj;
    ...
    private void initialize() {
        try {
            setName("HoneywellCycleGearPanel");
