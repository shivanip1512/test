 ...
 * @author: 
 */
public class AddDisconnectOptionPanel extends com.cannontech.common.gui.util.DataInputPanel {
...
class IvjEventHandler implements java.awt.event.ActionListener, javax.swing.event.CaretListener {
		public void actionPerformed(java.awt.event.ActionEvent e) {
			if (e.getSource() == AddDisconnectOptionPanel.this.getJCheckBoxEnableDisconnect()) 
				connEtoC2(e);
		};
		public void caretUpdate(javax.swing.event.CaretEvent e) {
			if (e.getSource() == AddDisconnectOptionPanel.this.getJTextFieldDisconnectAddress()) 
				connEtoC1(e);
		};
	};
 ...
 */
public AddDisconnectOptionPanel() {
	super();
	initialize();
}
/**
...
public static void main(java.lang.String[] args) {
	try {
		...
		AddDisconnectOptionPanel aDeviceMCT400SeriesOptionsPanel;
		aDeviceMCT400SeriesOptionsPanel = new AddDisconnectOptionPanel();
