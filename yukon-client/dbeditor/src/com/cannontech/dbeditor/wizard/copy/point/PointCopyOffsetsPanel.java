...
public Object getValue(Object val) 
{
	...
	if(type == PointType.Status)
	{
		...
		((StatusPoint) val).getPointStatusControl().setControlType(controlType);
		...
		if (((StatusPoint) val).getPointStatusControl().hasControl()) {
			((StatusPoint) val).getPointStatusControl().setControlOffset(controlOffset);
		}
