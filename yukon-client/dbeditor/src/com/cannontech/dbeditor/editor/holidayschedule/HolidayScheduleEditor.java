package com.cannontech.dbeditor.editor.holidayschedule;
 ...
 */
public class HolidayScheduleEditor extends com.cannontech.common.editor.PropertyPanel implements com.cannontech.common.editor.IMultiPanelEditor
{
	private DataInputPanel[] inputPanels;
	private String[] inputPanelTabNames;
public HolidayScheduleEditor() {
	super();
	initialize();
}
/**
...
public Object[] createNewPanel(int panelIndex)
{
	...
	{
		case 0: 
			objs[0] = new com.cannontech.dbeditor.wizard.holidayschedule.HolidayScheduleBasePanel();
			objs[1] = "General";
			break;
	}
...
private void initialize() {
	try {
		// user code begin {1}
		// user code end
		setName("HolidayScheduleEditorPanel");
...
public String toString() {
	return "Holiday Schedule Editor";
}
/**
 * 
 */
