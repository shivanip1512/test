...
/**
 * Return the TransmittersScrollPane property value.
 * @return javax.swing.JScrollPane
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private javax.swing.JScrollPane getAssignedDevicesScrollPane() {
...
/**
 * Return the TransmittersTable property value.
 * @return javax.swing.JTable
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private javax.swing.JTable getDeviceVerificationTable() 
{
	if (ivjVerifyDevicesTable == null) 
	{
		try 
		{
			ivjVerifyDevicesTable = new javax.swing.JTable();
			...
			ivjVerifyDevicesTable.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
			...
			javax.swing.table.TableColumn nameColumn = getDeviceVerificationTable().getColumnModel().getColumn(DeviceVerificationAssignmentTableModel.DEVICELITEPAO_COLUMN);
			javax.swing.table.TableColumn resendOnFailColumn = getDeviceVerificationTable().getColumnModel().getColumn(DeviceVerificationAssignmentTableModel.RESENDONFAIL_COLUMN);
...
public Object getValue(Object o) 
{
	...
	Vector assignedDevices = new Vector();
...
public void jButtonAdd_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
	...
	Object[] selectedForVerification = getAvailableList().getSelectedValues();
	...
	for(int h = 0; h < selectedForVerification.length; h++)
	{
		LiteYukonPAObject thePAO = (LiteYukonPAObject)selectedForVerification[h];
		...
		{
			if(devID.intValue() == (((LiteYukonPAObject)allAvailable.elementAt(y)).getLiteID()))
...
public static void main(java.lang.String[] args) {
	try {
		...
		DeviceVerificationAssignmentPanel aRTMVerificationPanel;
		aRTMVerificationPanel = new DeviceVerificationAssignmentPanel();
		frame.setContentPane(aRTMVerificationPanel);
		frame.setSize(aRTMVerificationPanel.getSize());
...
public Vector populateAvailableList()
{
