...
public class DeviceEditorPanel extends com.cannontech.common.editor.PropertyPanel implements com.cannontech.common.editor.IMultiPanelEditor
{
	...
	private static final int[][] EDITOR_TYPES =
	{
		{   //0 - DeviceBaseEditorPanel
			...
			PAOGroups.VIRTUAL_SYSTEM, PAOGroups.DCT_501, PAOGroups.RTU_DNP, PAOGroups.ION_7700,
		...
		{ 	//1 - DeviceMeterGroupEditorPanel
			...
			PAOGroups.LANDISGYRS4, PAOGroups.MCT310, PAOGroups.MCT318, PAOGroups.MCT360,
      ...
      {   //2 - CapBankController
		...
		{   //6 - Alarm
			...
			PAOGroups.DCT_501, PAOGroups.DNP_CBC_6510, PAOGroups.RTU_DNP, PAOGroups.ION_7700
		},
		{   //7 - CapBank
			PAOGroups.CAPBANK
		},
