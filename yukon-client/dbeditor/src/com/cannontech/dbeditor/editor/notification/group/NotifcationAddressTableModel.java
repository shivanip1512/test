...
public class NotifcationAddressTableModel extends AbstractTableModel implements ICTITableRenderer
{
	...
	public Object getValueAt(int row, int col) 
	{
		...
		switch( col )
		{
		 	...
		 	case COL_TYPE:
		 		return 
		 			YukonSpringHook.getBean(YukonListDao.class).getYukonListEntry(
	...
	public Color getCellForegroundColor(int row, int col)
	{
		...
		YukonListEntry entry =
			YukonSpringHook.getBean(YukonListDao.class).getYukonListEntry( lcn.getNotificationCategoryID() );
