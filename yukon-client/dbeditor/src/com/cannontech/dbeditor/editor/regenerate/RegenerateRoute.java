...
public static void main(String[] args) {
   ...
   resetRptSettings(routes,false,null);
    ...
    for (int k = 0; k < changingRoutes.size(); k++) {
        ...
        ccu.getCarrierRoute().setCcuVariableBits(new Integer(variable1));
            ...
            for (int j = 0; j < repeatVector.size(); j++) {
                ...
                com.cannontech.database.db.route.RepeaterRoute rpt =
                    ((com.cannontech.database.db.route.RepeaterRoute) repeatVector.get(j));
            ...
            if (usedFixedBits.get(nextFixedBit) == null)
                ...
                usedFixedBits.set(nextFixedBit,
                    new Integer(-1));
