...
private com.klg.jclass.field.JCSpinField getMeterDialsSpinner() {
    if (meterDialsSpinner == null) {
        try {
            ...
            meterDialsSpinner.setPreferredSize(new java.awt.Dimension(20,22));
            meterDialsSpinner.setMinimumSize(new java.awt.Dimension(20,22));
        } catch (java.lang.Throwable ivjExc) {
            handleException(ivjExc);
        }
    }
...
private javax.swing.JPanel getJPanelHolder() {
	if (ivjJPanelHolder == null) {
		try {
            ...
            constraintJLabelMeterDials.insets = new java.awt.Insets(3, 0, 7, 12);
            ...
            constraintsMeterDialsSpinner.ipadx = 20;
            constraintsMeterDialsSpinner.insets = new java.awt.Insets(2, 2, 5, 100);
