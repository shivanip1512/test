 ...
 */
package com.cannontech.dbeditor.editor.tou;
 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class TOUEditorPanel extends com.cannontech.common.editor.PropertyPanel implements com.cannontech.common.editor.IMultiPanelEditor
{
	private DataInputPanel[] inputPanels;
	private String[] inputPanelTabNames;
	
	
public TOUEditorPanel() {
	super();
	initialize();
}
/**
 * Insert the method's description here.
 * Creation date: (9/23/2003 1:17:24 PM)
 * @return Object[]
 * 
...
public Object[] createNewPanel(int panelIndex)
{
	...
	objs[0] = new TOUScheduleBasePanel();
	objs[1] = "General";
