package com.cannontech.dbeditor.editor.baseline;

import com.cannontech.common.gui.util.DataInputPanel;



public class BaselineEditorPanel extends com.cannontech.common.editor.PropertyPanel implements com.cannontech.common.editor.IMultiPanelEditor
{
	private DataInputPanel[] inputPanels;
	private String[] inputPanelTabNames;
	
	
public BaselineEditorPanel() {
	super();
	initialize();
}
/**
...
public Object[] createNewPanel(int panelIndex)
{
	...
	{
		case 0: 
			objs[0] = new com.cannontech.dbeditor.wizard.baseline.BaselineMainPanel();
			objs[1] = "General";
			break;
	}
