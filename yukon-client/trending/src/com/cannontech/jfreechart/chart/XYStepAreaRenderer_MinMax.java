...
public class XYStepAreaRenderer_MinMax extends XYStepAreaRenderer {
     ...
     */
    public XYStepAreaRenderer_MinMax(int type, XYToolTipGenerator toolTipGenerator, XYURLGenerator urlGenerator) {
    ...
    public void drawItem(Graphics2D g2, XYItemRendererState state, Rectangle2D dataArea, PlotRenderingInfo info,
        ...
        if (this.plotMinMaxValues) {
            if (minMaxValues != null
                && (y == minMaxValues[series].getMaximumValue() || y == minMaxValues[series].getMinimumValue())) {
