 ...
 * @author snebben
 */
public class PowerFailData extends ReportDataBase
{
	/** Class fields */
	...
	private class PowerFail
	{
		public String collGroup = null;
		public String deviceName = null;
		public String pointName = null;
		public Integer pointValue = null;
		public PowerFail(String collGroup_, String deviceName_, String pointName_, Integer pointValue_)
		{
	...
	public void addDataRow(ResultSet rset)
	{
		try
		{
			...
			PowerFail powerFail = new PowerFail(collGrp, paoName, pointName, pointValue);
	...
	public StringBuffer buildSQLStatement()
	{
		StringBuffer sql = new StringBuffer	("SELECT DMG.COLLECTIONGROUP, PAO.PAONAME, P.POINTNAME, P.POINTID" + 
			" RPH.VALUE FROM YUKONPAOBJECT PAO, DEVICEMETERGROUP DMG, POINT P, RAWPOINTHISTORY RPH "+
			" WHERE PAO.PAOBJECTID = DMG.DEVICEID AND P.PAOBJECTID = PAO.PAOBJECTID" +
			" P.POINTID = RPH.POINTID AND P.POINTOFFSET = 20 AND RPH.TIMESTAMP > ? " + 
			" AND RPH.TIMESTAMP < ?" );
		return sql;
	}
	...
	{
		return "Power Fail Reads By Collection Group";
	}
	/* (non-Javadoc)
