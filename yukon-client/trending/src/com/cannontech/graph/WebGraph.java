...
public class WebGraph implements Runnable {
    ...
    private void createGDefReports(com.cannontech.database.data.lite.LiteGraphDefinition liteGraphDef) {
        ...
        com.cannontech.database.data.graph.GraphDefinition gDef =
            new com.cannontech.database.data.graph.GraphDefinition();
        ...
        if (gDef != null) {
            ...
            StringBuffer buf =
                new StringBuffer("<HTML><LINK REL=\"stylesheet\" HREF=\"CannonStyle.ccs\" TYPE=\"text/css\"><CENTER>");
    ...
    public void stop() {
        try {
            AsyncDynamicDataSource dataSource =
                (AsyncDynamicDataSource) YukonSpringHook.getBean("asyncDynamicDataSource");
            dataSource.removeDBChangeListener(dbChangeListener);
