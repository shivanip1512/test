...
<%@page import="com.cannontech.core.roleproperties.SerialNumberValidation"%>
        ...
        if(liteEC != null){
            ...
            if (accountInfo != null) { // ensure there is a new instance of StarsCustAccountInformation for each request
                ...
                if (accountInfo != null) {
                    ...
                    LiteAccountInfo currentLiteAcctInfo = starsCustAccountInformationDao.getById(account.getAccountID(), liteEC.getEnergyCompanyId());
