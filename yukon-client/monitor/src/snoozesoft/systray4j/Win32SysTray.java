...
class Win32SysTray implements SysTrayAccess
{
    private boolean libraryLoaded = false;
    
    private final String libName = "systray4j";
    ...
    Win32SysTray()
    {
        ...
        catch( UnsatisfiedLinkError e ) { libraryLoaded = false; }
    }
    ...
    {
        return addMainMenuNative( menu, iconFileName, toolTip );
    }

    public int addSubMenu( SubMenu menu )
    {
        return addSubMenuNative( menu );
    }
    ...
    private native int
    addMainMenuNative( SysTrayMenu menu, String iconFileName, String toolTip );
