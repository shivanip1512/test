...
private javax.swing.JLabel getImageNameLabel() {
	if (ivjImageNameLabel == null) {
		try {
			...
			ivjImageNameLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
private javax.swing.JPanel getJPanel1() {
	if (ivjJPanel1 == null) {
		try {
			...
			constraintsImageLabel.gridx = 0; constraintsImageLabel.gridy = 0;
			...
			java.awt.GridBagConstraints constraintsImageNameLabel = new java.awt.GridBagConstraints();
			constraintsImageNameLabel.gridx = 1; constraintsImageNameLabel.gridy = 0;
			constraintsImageNameLabel.fill = java.awt.GridBagConstraints.HORIZONTAL;
			constraintsImageNameLabel.weightx = 1.0;
			constraintsImageNameLabel.insets = new java.awt.Insets(4, 4, 4, 4);
			getJPanel1().add(getImageNameLabel(), constraintsImageNameLabel);
			// user code begin {1}
			// user code end
		} catch (java.lang.Throwable ivjExc) {
			// user code begin {2}
...
public Object getValue(Object o) {
	...
	staticImage.setAbsoluteImagePath( getImageNameLabel().getText());
...
public void setValue(Object o) {
	...
	getImageNameLabel().setText(staticImage.getAbsoluteImagePath());
