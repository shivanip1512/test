...
public class TextColorPointPanel extends DataInputPanel implements ActionListener, TreeSelectionListener {
...
public Object getValue(Object o) {
    ...
    dynamicText.setColorPointID(getPointSelectionPanel().getSelectedPoint().getLiteID());
    dynamicText.setCustomColorMap(map);
//    lineElement.setControlEnabled(getControlCheckBox().isSelected());
    return dynamicText;
}
/**
...
public void setValue(Object o) 
{
    ...
    map = new HashMap( dynamicText.getCustomColorMap());
...
private JLabel getPreviewLabel()
{
    if (previewLabel == null)
    {
        try
        {
            ...
            previewLabel.setText("State Colors:");
