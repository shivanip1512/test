 ...
 *
 */
public class AppMessageTypeA extends DataMessage implements AppMessage, java.io.Serializable {
	...
	private transient final float[] resolutionScale = {0.1f, 1, 10f, 100f};
	...
	public AppMessageTypeA( char[] msg ) {
		super(msg);
