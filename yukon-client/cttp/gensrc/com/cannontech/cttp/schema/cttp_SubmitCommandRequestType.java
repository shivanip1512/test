/**
 * cttp_SubmitCommandRequestType.java
 *
...
public class cttp_SubmitCommandRequestType extends com.altova.xml.Node {
	public cttp_SubmitCommandRequestType() {
		super();
	}

	public cttp_SubmitCommandRequestType(cttp_SubmitCommandRequestType node) {
		super(node);
	}

	public cttp_SubmitCommandRequestType(org.w3c.dom.Node node) {
		super(node);
	}

	public cttp_SubmitCommandRequestType(org.w3c.dom.Document doc) {
		super(doc);
	}
