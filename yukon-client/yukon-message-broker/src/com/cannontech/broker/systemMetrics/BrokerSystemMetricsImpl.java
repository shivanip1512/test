...
import com.cannontech.common.systemMetrics.SystemMetrics;
import com.cannontech.core.dynamic.exception.DispatchNotConnectedException;
import com.google.common.util.concurrent.AtomicDouble;

/**
 * Spring Bean that monitors the JVM CPU usage and reports it as Point data for Broker Service.
 * This is different than the SystemMetrics used by other service as Broker Service do not depend on common context.
 * Hence the autowired dependencies have to be removed.
 * 
 * Logging of system metrics is done by this, for point data insertion message is send to service manager.
 * A service in service manager does the point insertion.
 */
@ManagedResource
public class BrokerSystemMetricsImpl extends Observable implements Runnable, SystemMetrics {
     ...
     */
    public BrokerSystemMetricsImpl() {
    ...
    public void run() {
        try {
            ...
            try {
                ...
                sendMessageForPointInsertion(loadAverageAttribute, loadAverage);
            ...
            try {
                ...
                sendMessageForPointInsertion(memoryAttribute, memory);
    ...
    private void sendMessageForPointInsertion(Attribute attribute, double value) {
