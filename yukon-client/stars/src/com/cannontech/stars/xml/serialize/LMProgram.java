...
public class LMProgram implements java.io.Serializable {
    ...
    **/
    ...
    public LMProgram() {
        super();
    } //-- com.cannontech.stars.xml.serialize.LMProgram()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.cannontech.stars.xml.serialize.LMProgram unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cannontech.stars.xml.serialize.LMProgram) Unmarshaller.unmarshal(com.cannontech.stars.xml.serialize.LMProgram.class, reader);
    } //-- com.cannontech.stars.xml.serialize.LMProgram unmarshal(java.io.Reader) 
