 ...
 * XML Schema.
 * $Id: StarsAppliancesDescriptor.java,v 1.31 2003/03/30 01:20:46 zyao Exp $
 */
 ...
 * 
 * 
 * @version $Revision: 1.31 $ $Date: 2003/03/30 01:20:46 $
**/
public class StarsAppliancesDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public StarsAppliancesDescriptor() {
        super();
        xmlName = "stars-Appliances";
        ...
        handler = (new XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    StarsAppliances target = (StarsAppliances) object;
                    target.addStarsAppliance( (StarsAppliance) value);
                }
                catch (Exception ex) {
    ...
    **/
    ...
    {
        return com.cannontech.stars.xml.serialize.StarsAppliances.class;
