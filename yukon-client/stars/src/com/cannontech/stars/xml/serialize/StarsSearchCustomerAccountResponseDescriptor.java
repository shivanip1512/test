...
**/
public class StarsSearchCustomerAccountResponseDescriptor extends StarsCustAccountInfoDescriptor {
    ...
    public StarsSearchCustomerAccountResponseDescriptor() {
        super();
        setExtendsWithoutFlatten(new StarsCustAccountInfoDescriptor());
