...
**/
public class StarsYukonSwitchCommandDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public StarsYukonSwitchCommandDescriptor() {
        super();
        xmlName = "stars-YukonSwitchCommand";
    ...
    **/
    ...
    {
        return com.cannontech.stars.xml.serialize.StarsYukonSwitchCommand.class;
