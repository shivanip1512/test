...
insert into YukonListEntry values (1018,1005,-1,'ExpressStat',1301);
...
insert into YukonListEntry values (1110,1005,-1,'EnergyPro',3100);
...
insert into CustomerFAQ values(7,1063,'How much credit do I receive if I opt out while controlling?','You will receive credit for the portion of time you were controlled.');
