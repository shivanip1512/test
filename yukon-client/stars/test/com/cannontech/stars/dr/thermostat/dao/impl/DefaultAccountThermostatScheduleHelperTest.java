...
public class DefaultAccountThermostatScheduleHelperTest {
    ...
    @Test
    public void testEnergyProDefaultSchedule(){
        AccountThermostatSchedule schedule = datsHelper.getDefaultAccountThermostatSchedule(SchedulableThermostatType.ENERGY_PRO);
        
        //check values for residential expressstat schedule
        Assert.assertEquals(0, schedule.getAccountId());
        Assert.assertEquals(SchedulableThermostatType.ENERGY_PRO.name(), schedule.getScheduleName());
        Assert.assertEquals(SchedulableThermostatType.ENERGY_PRO, schedule.getThermostatType());
        Assert.assertEquals(SchedulableThermostatType.ENERGY_PRO.getDefaultThermostatScheduleMode(), schedule.getThermostatScheduleMode());
