...
insert into yukonroleproperty values (-10311, -103, 'Control LM device', 'true', 'Allow the ability to control an LM device')

insert into yukonroleproperty values (-10312, -103, 'Read Cap Control device', 'true', 'Allow the ability to read values from a Cap Control device')
insert into yukonroleproperty values (-10313, -103, 'Write to Cap Control device', 'true', 'Allow the ability to write values to a Cap Control device')
insert into yukonroleproperty values (-10314, -103, 'Control Cap Control device', 'true', 'Allow the ability to control a Cap Control device')

insert into yukonroleproperty values (-10315, -103, 'Execute Command', 'true', 'Allow the general ability to execute commands')
/**********************/