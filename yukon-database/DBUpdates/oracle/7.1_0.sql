...
ALTER TABLE MSPVendor
MODIFY (ValidateCertificate CHAR(1) NOT NULL);

INSERT INTO DBUpdates VALUES ('YUK-18615', '7.1.0', SYSDATE);
/* @end YUK-18615 */
...
/**************************************************************/
INSERT INTO CTIDatabase VALUES ('7.1', '13-AUG-2018', 'Latest Update', 0, SYSDATE);
