...
UPDATE POINT SET STATEGROUPID = 8 WHERE PAObjectID IN (SELECT PAObjectID FROM YukonPAObject WHERE Type = 'CRLY-856') AND POINTOFFSET = 67 AND POINTTYPE = 'Status';
UPDATE POINT SET STATEGROUPID = 8 WHERE PAObjectID IN (SELECT PAObjectID FROM YukonPAObject WHERE Type IN ('CRL-520fAXe','CRL-520fRXe','CRL-520fAXeD','CRL-520fRXeD','CRL-530S4x')) AND POINTOFFSET = 106 AND POINTTYPE = 'Status';
