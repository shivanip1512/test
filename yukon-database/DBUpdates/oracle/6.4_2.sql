...
INSERT ALL 
    INTO State (StateGroupId, RawState, Text, ForegroundColor, BackgroundColor, ImageId) VALUES (-17, 17, 'Bad Active Relay', 3, 6, 0)
    INTO State (StateGroupId, RawState, Text, ForegroundColor, BackgroundColor, ImageId) VALUES (-17, 18, 'NC Lockout', 4, 6, 0)
    INTO State (StateGroupId, RawState, Text, ForegroundColor, BackgroundColor, ImageId) VALUES (-17, 19, 'Control Accepted', 5, 6, 0)
    INTO State (StateGroupId, RawState, Text, ForegroundColor, BackgroundColor, ImageId) VALUES (-17, 20, 'Auto Mode', 7, 6, 0)
    INTO State (StateGroupId, RawState, Text, ForegroundColor, BackgroundColor, ImageId) VALUES (-17, 21, 'Reclose Block', 8, 6, 0)
SELECT 1 FROM dual;
/* End YUK-14250 */
...
/**************************************************************/
INSERT INTO CTIDatabase VALUES ('6.4', '08-MAY-2015', 'Latest Update', 2, SYSDATE);