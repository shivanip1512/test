...
ADD UvSetPointTemp FLOAT;
UPDATE DYNAMICCCTWOWAYCBC 
SET UvSetPointTemp = UvSetPoint;
ALTER TABLE DYNAMICCCTWOWAYCBC
MODIFY UvSetPoint NULL;
UPDATE DYNAMICCCTWOWAYCBC 
SET UvSetPoint = NULL;
ALTER TABLE DYNAMICCCTWOWAYCBC 
MODIFY UvSetPoint FLOAT;
UPDATE DYNAMICCCTWOWAYCBC 
SET UvSetPoint = UvSetPointTemp;
ALTER TABLE DYNAMICCCTWOWAYCBC 
DROP COLUMN UvSetPointTemp;
ALTER TABLE DYNAMICCCTWOWAYCBC
MODIFY UvSetPoint NOT NULL;

ALTER TABLE DYNAMICCCTWOWAYCBC 
ADD OvSetPointTemp FLOAT;
UPDATE DYNAMICCCTWOWAYCBC 
SET OvSetPointTemp = OvSetPoint;
ALTER TABLE DYNAMICCCTWOWAYCBC
MODIFY OvSetPoint NULL;
UPDATE DYNAMICCCTWOWAYCBC 
SET OvSetPoint = NULL;
ALTER TABLE DYNAMICCCTWOWAYCBC 
MODIFY OvSetPoint FLOAT;
UPDATE DYNAMICCCTWOWAYCBC 
SET OvSetPoint = OvSetPointTemp;
ALTER TABLE DYNAMICCCTWOWAYCBC 
DROP COLUMN OvSetPointTemp;
ALTER TABLE DYNAMICCCTWOWAYCBC
MODIFY OvSetPoint NOT NULL;

ALTER TABLE DYNAMICCCTWOWAYCBC 
ADD NeutralCurrentAlarmSetPointTmp FLOAT;
UPDATE DYNAMICCCTWOWAYCBC 
SET NeutralCurrentAlarmSetPointTmp = NeutralCurrentAlarmSetPoint;
ALTER TABLE DYNAMICCCTWOWAYCBC
MODIFY NeutralCurrentAlarmSetPoint NULL;
UPDATE DYNAMICCCTWOWAYCBC 
SET NeutralCurrentAlarmSetPoint = NULL;
ALTER TABLE DYNAMICCCTWOWAYCBC 
MODIFY NeutralCurrentAlarmSetPoint FLOAT;
UPDATE DYNAMICCCTWOWAYCBC 
SET NeutralCurrentAlarmSetPoint = NeutralCurrentAlarmSetPointTmp;
ALTER TABLE DYNAMICCCTWOWAYCBC 
DROP COLUMN NeutralCurrentAlarmSetPointTmp;
ALTER TABLE DYNAMICCCTWOWAYCBC
MODIFY NeutralCurrentAlarmSetPoint NOT NULL;
/* End YUK-11135 */
