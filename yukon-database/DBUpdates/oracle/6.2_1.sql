...
DROP INDEX INDX_ECOBEERECONREPORT_EC_UNQ;
...
SELECT 
    ROW_NUMBER() OVER(ORDER BY C.DeviceConfigCategoryID) + (SELECT NVL(MAX(DeviceConfigCategoryItemID), 1) FROM DeviceConfigCategoryItem),
...
/**************************************************************/
INSERT INTO CTIDatabase VALUES ('6.2', '13-JUN-2014', 'Latest Update', 1, SYSDATE);