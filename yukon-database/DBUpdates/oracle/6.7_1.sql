...
BEGIN
    ...
    INSERT INTO DeviceConfigCategory 
        SELECT
            ...
            CASE
                ...
                ELSE DCC.Description || CHR(13) || CHR(10) || 'Auto created for select RFN meters during 6.7.1 upgrade'
            END
    ...
    INSERT INTO DeviceConfiguration 
        SELECT
            ...
            DC.Name || ' (auto-created for select RFN meters)',
            CASE
                WHEN DC.Description IS NULL THEN 'Auto created for select RFN meters during 6.7.1 upgrade'
                ELSE DC.Description || CHR(13) || CHR(10) || 'Auto created for select RFN meters during 6.7.1 upgrade'
            END
        FROM 
            DeviceConfiguration DC
