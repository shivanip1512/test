...
BEGIN
    ...
    SELECT
        ...
        CASE
            ...
            ELSE DCC.Description + char(13) + char(10) + 'Auto created to split DELIVERED_KVAR from KVAR during 6.7.1 upgrade'
        END
    ...
    SELECT
        ...
        CASE
            ...
            ELSE DC.Description + char(13) + char(10) + 'Auto created to split DELIVERED_KVAR from KVAR during 6.7.1 upgrade'
        END
    FROM DeviceConfiguration DC
...
BEGIN
    ...
    SELECT
        ...
        CASE
            ...
            ELSE DCC.Description + char(13) + char(10) + 'Auto created to split DELIVERED_DEMAND from DEMAND during 6.7.1 upgrade'
        END
    FROM DeviceConfigCategory DCC
    JOIN #DeviceConfigCategoryIDs DCCID ON DCC.DeviceConfigCategoryId = DCCID.DeviceConfigCategoryId
    ...
    SELECT
        ...
        CASE
            ...
            ELSE DC.Description + char(13) + char(10) + 'Auto created to split DELIVERED_DEMAND from DEMAND during 6.7.1 upgrade'
        END
    FROM DeviceConfiguration DC
    JOIN #DeviceConfigurationIDs DCID ON DC.DeviceConfigurationID = DCID.DeviceConfigurationId
    ...
    FROM DeviceConfigDeviceTypes DCDT
    JOIN #DeviceConfigurationIDs DCID ON DCDT.DeviceConfigurationId = DCID.DeviceConfigurationId
    WHERE DCDT.PaoType IN ('RFN-410CL','RFN-410FD','RFN-410FL','RFN-410FX','RFN-420CD','RFN-420CL',
                           'RFN-420FD','RFN-420FL','RFN-420FRD','RFN-420FRX','RFN-420FX','RFN-430A3D',
                           'RFN-430A3K','RFN-430A3T','RFN-430A3R','RFN-430KV','RFN-510FL','RFN-520FAX',
                           'RFN-520FAXD','RFN-520FRX','RFN-520FRXD','RFN-530FAX','RFN-530FRX','RFN-530S4X')
...
/**************************************************************/
INSERT INTO CTIDatabase VALUES ('6.7', '01-AUG-2017', 'Latest Update', 1, GETDATE());