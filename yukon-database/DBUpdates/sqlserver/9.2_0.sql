...
/* @start YUK-25744 */
UPDATE POINT SET ARCHIVETYPE = 'On Change'
    WHERE POINTNAME IN('RFN Meter Reading Archive Requests Received',
                       'RFN Meter Reading Archive Requests Pt Data Generated Count',
                       'RFN LCR Reading Archive Requests Received',
                       'RFN LCR Reading Archive Requests Queue Size',
                       'RFN Meter Reading Archive Requests Queue Size',
                       'RFN LCR Reading Archive Point Data Generated Count');

INSERT INTO DBUpdates VALUES ('YUK-25744', '9.2.0', GETDATE());
/* @end YUK-25744 */
