#ifndef RWDBDATEVECTORI_H
#define RWDBDATEVECTORI_H
...
{
public:
   RWDBDateVectorImp(size_t n);
   size_t entries() const;

   virtual ~RWDBDateVectorImp();
   virtual void* firstElement() const;
   virtual RWDBVendorDate at(size_t n);
   virtual RWDBDateVectorImp* clone();
