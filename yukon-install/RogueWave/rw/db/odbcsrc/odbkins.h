...
class RWDBAccessExport RWDBODBCBulkInserterImp : public RWDBBulkInserterImp
{
public:
        RWDBODBCBulkInserterImp(const RWDBStatus& stat, const RWDBTable& tab, const RWDBConnection& conn);
        ~RWDBODBCBulkInserterImp();
...
private:
// not implemented
    RWDBODBCBulkInserterImp( const RWDBODBCBulkInserterImp& );
    RWDBODBCBulkInserterImp& operator=( const RWDBODBCBulkInserterImp& );
