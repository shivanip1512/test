...
#ifdef  __TURBOC__
#  define RWINET_EXPORT_TEMPLATE
#endif


/* For backwards compatibility: */
#if defined(_RWINETCLASSDLL) && !defined(_RWINETDLL)
# define _RWINETDLL 1
#endif
...
#if defined(_RWINETDLL)
#  if !defined(__LARGE__) && !defined(__WIN32__)
#    error   Must use large or flat memory model when compiling or using the Inter.Net Library DLL!
#  endif
#  if defined(_RWINETBUILDDLL)
     // Compiling the DLL.
#    ifndef _MSC_VER
#      define RWINETExport _export	        /* Mark classes as exported */
#      ifdef RWINET_EXPORT_TEMPLATE
#        define RWINETExportTemplate _export	/* Mark template insts as exported */
#      else
#        define RWINETExportTemplate 
#      endif
#    else /* Microsoft: */
#      define RWINETExport __declspec(dllexport)
#      define RWINETExportTemplate              
#      define RWINETHuge
#    endif
#  else
     // Using the DLL.
#    ifndef _MSC_VER
#      define RWINETExport _import     
#    else /* Microsoft: */
#      define RWINETExport  __declspec(dllimport)
#      define RWINETExportTemplate 
#    endif 
#    ifdef RWINET_EXPORT_TEMPLATE
#      define RWINETExportTemplate _import
#    else
#      define RWINETExportTemplate 
#    endif
...
//
#ifdef _MSC_VER
#define RWINETExportFunc(ReturnType) RWINETExport ReturnType
#else
#define RWINETExportFunc(ReturnType) ReturnType RWINETExport 
#endif
