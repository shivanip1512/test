...
BOOST_AUTO_TEST_CASE(test_findBoolValueForKey)
{
...

    {
        const boost::optional<bool> value =
            dc.findValue<bool>("foo_nonexistent");
    ...
    {
        const boost::optional<bool> value =
            dc.findValue<bool>("foo_true_titlecase");
    ...
    {
        const boost::optional<bool> value =
            dc.findValue<bool>("foo_true_lowercase");
