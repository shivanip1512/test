...
class IM_EX_CONFIG MCTStrings
{
public:
    static const std::string Bronze;
    static const std::string Lead;
    ...
    static const std::string ChannelMultiplier4;

    static const std::string RelayATimer;
    static const std::string RelayBTimer;
