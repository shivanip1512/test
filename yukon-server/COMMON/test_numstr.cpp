...
BOOST_AUTO_UNIT_TEST(test_float)
{
    ...
    numstr_test_helper(f = 0.0, 3, 12,                 "0.000",    "       0.000",    "00000000.000",
                                                  "0.000e+000",    "  0.000e+000",    "0.00000e+000");
...
*/
    ...
    numstr_test_helper(d = 0.1234, 3, 12,              "0.123",    "       0.123",    "00000000.123",
                                                  "1.234e-001",    "  1.234e-001",    "1.23400e-001");

    numstr_test_helper(d = 0.1234, 6, 12,           "0.123400",    "    0.123400",    "00000.123400",
                                               "1.234000e-001",   "1.234000e-001",   "1.234000e-001");

    numstr_test_helper(d = 0.1234, 6, 15,           "0.123400", "       0.123400", "00000000.123400",
                                               "1.234000e-001", "  1.234000e-001", "1.23400000e-001");

    numstr_test_helper(d = 1.0, 3, 12,                 "1.000",    "       1.000",    "00000001.000",
                                                  "1.000e+000",    "  1.000e+000",    "1.00000e+000");

    numstr_test_helper(d = 1.0, 6, 12,              "1.000000",    "    1.000000",    "00001.000000",
                                               "1.000000e+000",   "1.000000e+000",   "1.000000e+000");

    numstr_test_helper(d = 1.0, 6, 15,              "1.000000", "       1.000000", "00000001.000000",
                                               "1.000000e+000", "  1.000000e+000", "1.00000000e+000");

    numstr_test_helper(d = 76389.2384, 3, 12,      "76389.238",    "   76389.238",    "00076389.238",
                                                  "7.639e+004",    "  7.639e+004",    "7.63892e+004");

    numstr_test_helper(d = 76389.2384, 6, 12,   "76389.238400",    "76389.238400",    "76389.238400",
                                               "7.638924e+004",   "7.638924e+004",   "7.638924e+004");
