...
"command=6:flags=0::type=expresscom,8,8.000:xcchargecents=(none),1,1.000:xcdisplaycost=(none),1,1.000:xcdisplayusage=(none),1,1.000:xcoptionalstring=Channel 1,-2147483648,0.000:xcutilchan=(none),1,1.000:xcutilinfo=(none),1,1.000",
