...
"command=8:flags=0::sa_f1bit=(none),0,0.000:serial=(none),200148000,200148000.000:type=expresscom,8,8.000:xccontroltime=(none),3600,3600.000:xccpp=(none),1,1.000:xcdeltavalues=(none),1,1.000:xcleave=(none),254,254.000:xcminheat=(none),71,71.000:xcreturn=(none),255,255.000:xcsleep=(none),4,4.000:xcwake=(none),2,2.000",
...
"command=8:flags=0::sa_f1bit=(none),0,0.000:serial=(none),200148000,200148000.000:type=expresscom,8,8.000:xccelsius=(none),1,1.000:xccontroltime=(none),3600,3600.000:xccpp=(none),1,1.000:xcdeltavalues=(none),1,1.000:xcleave=(none),3,3.000:xcmaxcool=(none),29,29.000:xcmode=(none),1,1.000:xcsleep=(none),254,254.000:xcwake=(none),1,1.000",
