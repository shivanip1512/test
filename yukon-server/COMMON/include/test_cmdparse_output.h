...
"command=putconfig,6,6.000:type=expresscom,8,8.000:xcdata= 0x33,-2147483648,0.000",
"command=control,8,8.000:flag=(none),0,0.000:offset=(none),0,0.000:sa_dlc_mode=(none),0,0.000:sa_f0bit=(none),1,1.000:sa_f1bit=(none),0,0.000:typ=expresscom,8,8.000:xcbacklight=(none),1,1.000:xcbacklightcycle=(none),0,0.000:xcbacklightduty=(none),0,0.000:xcbacklightperiod=(none),0,0.000"
};
#endif
