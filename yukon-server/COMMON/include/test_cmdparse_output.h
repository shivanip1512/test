...
"command=putconfig,6,6.000:type=versacom,0,0.000",
...
"command=scan,9,9.000:scantype=(none),3,3.000:type=versacom,0,0.000",
"command=scan,9,9.000:scantype=(none),0,0.000:type=versacom,0,0.000",
...
"command=getconfig,5,5.000:rolenum=(none),1,1.000:type=versacom,0,0.000",
"command=putconfig,6,6.000:led=(none),224,224.000:type=versacom,0,0.000",
...
"command=putvalue,2,2.000:flag=(none),272,272.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:ied=TRUE,-2147483648,0.000:scan=TRUE,-2147483648,0.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:ied=TRUE,-2147483648,0.000:time=TRUE,-2147483648,0.000:type=versacom,0,0.000",
"command=getvalue,1,1.000:flag=(none),4128,4128.000:offset=(none),0,0.000:type=versacom,0,0.000",
"command=getvalue,1,1.000:flag=(none),4352,4352.000:offset=(none),0,0.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:sync=TRUE,-2147483648,0.000:time=TRUE,-2147483648,0.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:time=TRUE,-2147483648,0.000:type=versacom,0,0.000",
...
"command=getconfig,5,5.000:type=versacom,0,0.000",
"command=putconfig,6,6.000:type=emetcon,7,7.000",
"command=getconfig,5,5.000:multchannel=(none),1,1.000:multiplier=(none),1,1.000:type=versacom,0,0.000",
...
"command=putvalue,2,2.000:flag=(none),80,80.000:kyz_offset=(none),1,1.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:model=TRUE,-2147483648,0.000:type=versacom,0,0.000",
"command=getvalue,1,1.000:flag=(none),256,256.000:offset=(none),0,0.000:type=versacom,0,0.000",
"command=getvalue,1,1.000:flag=(none),32,32.000:offset=(none),0,0.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:interval=intervals,-2147483648,0.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:model=TRUE,-2147483648,0.000:type=versacom,0,0.000",
"analogoffset=(none),1,1.000:analogvalue=(none),3,3.000:command=putvalue,2,2.000:flag=(none),128,128.000:type=versacom,0,0.000",
"command=putvalue,2,2.000:flag=(none),64,64.000:kyz_offset=(none),1,1.000:type=versacom,0,0.000",
"command=putstatus,4,4.000:flag=(none),16,16.000:type=versacom,0,0.000",
"command=putstatus,4,4.000:flag=(none),16,16.000:type=versacom,0,0.000",
"command=putvalue,2,2.000:flag=(none),528,528.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:rawloc=(none),147,147.000:type=versacom,0,0.000",
"command=getconfig,5,5.000:rawlen=(none),2,2.000:rawloc=(none),591922,591922.000:type=versacom,0,0.000",
"command=putconfig,6,6.000:rawdata=ƒ92,-2147483648,0.000:rawloc=(none),38947,38947.000:type=emetcon,7,7.000",
"command=getvalue,1,1.000:flag=(none),0,0.000:lp_channel=(none),2,2.000:lp_command=peak,-2147483648,0.000:lp_date_start=12/31/2003,-2147483648,0.000:lp_peaktype=interval,-2147483648,0.000:lp_range=(none),31,31.000:offset=(none),0,0.000:type=versacom,0,0.000"
};
#endif
