...
#define TAG_CONSTRAINT_VIOLATED              0x04000000        // This SIGNAL message has violated a constraint (alarm MAY be set)
...
// Masks
#define MASK_RESETTABLE_TAGS                 0x0003FF00        // Tags which are reset upon any setPoint operation
