...
BOOST_AUTO_TEST_CASE(test_SocketAddress_compare)
{
    ...
    BOOST_CHECK_EQUAL(addr41.toString(), "127.0.0.1");
    BOOST_CHECK_EQUAL(addr42.toString(), "127.0.0.2");
    BOOST_CHECK_EQUAL(addr4mapped1.toString(), "::ffff:127.0.0.1");
    BOOST_CHECK_EQUAL(addr61.toString(), "::1");
    BOOST_CHECK_EQUAL(addr62.toString(), "::2");
