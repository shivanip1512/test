...
BOOST_AUTO_TEST_CASE(test_nextScheduledTimeAlignedOnRate_specialValues)
{
    ...
    BOOST_CHECK_EQUAL( CtiTime::CtiTime(CtiDate::CtiDate(1,1,2000), 2, 0, 0), nextScheduledTimeAlignedOnRate( originTime, 7200 )); //Aligned on hour
    BOOST_CHECK_EQUAL( CtiTime::CtiTime(CtiDate::CtiDate(1,1,2000), 3, 0, 0), nextScheduledTimeAlignedOnRate( originTime, 10800 )); //Aligned on hour
...
BOOST_AUTO_TEST_CASE(test_nextScheduledTimeAlignedOnRate_specialValues_india)
{
    const auto tzOverride = Cti::Test::set_to_india_timezone();
...
BOOST_AUTO_TEST_CASE(test_convertBytesToHexString)
{
    ...
    // normal vector data
    {
        ...
        BOOST_CHECK_EQUAL( result.size(), 2 * input.size() );
        BOOST_CHECK_EQUAL(
           result,
           "f9a6d72d7284cc51d4b0379ac30659562d4de98f3b7ce48f13c69f1ec5d939cb"
           "22435b8511724fe9753b0ba35bf00beaed1f6c250325c6db4ffe1a28605474f9"
           "6fc3037dd5b24bbd726b8b8a6a34d563b1c0655e0eb67c8c038883810ca92b37"
           "254d2820ce81d21a7b8b04f7249a18fdb8e2da930459bfef38cb91d6b1b72fa9"
           "c6f3773e877bf7ab55ec151bd6bed13cd44a0a51e6543a9ea9c8651b0e294e13"
    ...
    // normal array data
    {
        ...
        const auto result = convertBytesToHexString( { input, input + sizeof( input ) } );

        BOOST_CHECK_EQUAL( result.size(), 2 * sizeof( input ) );
        BOOST_CHECK_EQUAL(
           result,
           "f9a6d72d7284cc51d4b0379ac30659562d4de98f3b7ce48f13c69f1ec5d939cb"
           "22435b8511724fe9753b0ba35bf00beaed1f6c250325c6db4ffe1a28605474f9"
