...
test_common.exe:    $(COMMON_TEST_FULLBUILD) $(COMMON_TEST_OBJS)  Makefile
	...
	$(CC) $(CFLAGS) $(INCLPATHS) $(RWLINKFLAGS)  /Fe..\$(BIN)\$(_TargetF) \
        $(COMMON_TEST_OBJS) -link /subsystem:console $(COMPILEBASE)\lib\ctibase.lib $(BOOST_LIBS) $(BOOST_TEST_LIBS) $(RWLIBS) $(LINKFLAGS) $(OPENSSL_LIBS)
	@%cd ..
...
dllbase.obj:	precompiled.h dsm2.h cticonnect.h yukon.h types.h \
		...
		thread.h CtiPCPtrQueue.h encryption.h xml.h devicetypes.h \
		pointtypes.h PointAttribute.h thread_monitor.h smartmap.h \
