...
void CtiToLower( std::string& str)
{
	std::transform(str.begin(),str.end(),str.begin(),::tolower);
}
void CtiToUpper( std::string& str)
{
	std::transform(str.begin(),str.end(),str.begin(),::toupper);
}

string trim_right ( std::string & source , std::string t)
{
    std::string str = source;
    return source = str.erase ( str.find_last_not_of ( t ) + 1 ) ;
}

string trim_left ( std::string & source ,std::string t)
{
    std::string str = source;
    return source = str.erase ( 0 , source.find_first_not_of ( t ) ) ;
}

string trim ( std::string & source , std::string t)
{
    std::string str = source;
...
int stringContainsIgnoreCase(const std::string& str, const std::string& frag)
{
    std::string s1 = str;
    std::string s2 = frag;
...
string::size_type findStringIgnoreCase(std::string str, std::string sub)
{
    std::transform(str.begin(), str.end(), str.begin(), ::tolower);
