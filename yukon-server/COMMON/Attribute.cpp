...
const Attribute Attribute::DeliveredDemand                                  = Attribute( "DELIVERED_DEMAND" );
...
const Attribute Attribute::DeliveredkVAr                                    = Attribute( "DELIVERED_KVAR" );
...
const Attribute Attribute::LoadSideVoltageDetected                          = Attribute( "LOAD_SIDE_VOLTAGE_DETECTED_WHILE_DISCONNECTED" );
...
const Attribute Attribute::PeakDemandDaily                                  = Attribute( "PEAK_DEMAND_DAILY" );
...
const Attribute Attribute::PowerFactorDelivered                             = Attribute( "DELIVERED_POWER_FACTOR" );
const Attribute Attribute::PowerFactorReceived                              = Attribute( "RECEIVED_POWER_FACTOR" );
const Attribute Attribute::PowerFactorAnglePhaseA                           = Attribute( "POWER_FACTOR_ANGLE_PHASE_A" );
const Attribute Attribute::PowerFactorAnglePhaseB                           = Attribute( "POWER_FACTOR_ANGLE_PHASE_B" );
const Attribute Attribute::PowerFactorAnglePhaseC                           = Attribute( "POWER_FACTOR_ANGLE_PHASE_C" );
...
const Attribute Attribute::ScadaOverrideClear                               = Attribute( "SCADA_OVERRIDE_CLEAR" );
...
const Attribute Attribute::ScadaOverrideMode                                = Attribute( "SCADA_OVERRIDE_MODE" );
