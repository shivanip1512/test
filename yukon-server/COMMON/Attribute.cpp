...
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakKw,               "DELIVERED_COIN_POWER_FACTOR_PEAK_KW" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakKw,                "RECEIVED_COIN_POWER_FACTOR_PEAK_KW" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVAr,             "DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVAr,              "RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakTotalkVAr,              "SUM_COIN_POWER_FACTOR_PEAK_KVAR" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakKVA,              "DELIVERED_COIN_POWER_FACTOR_PEAK_KVA" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakKVA,               "RECEIVED_COIN_POWER_FACTOR_PEAK_KVA" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakKVA,                    "SUM_COIN_POWER_FACTOR_PEAK_KVA" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakKwRateA,          "DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_A" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakKwRateA,           "RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_A" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakKwRateA,                "SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_A" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVArRateA,        "DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_A" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVArRateA,         "RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_A" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVArRateA,              "SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_A" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVARateA,         "DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_A" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVARateA,          "RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_A" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVARateA,               "SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_A" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakKwRateB,          "DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_B" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakKwRateB,           "RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_B" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakKwRateB,                "SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_B" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVArRateB,        "DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_B" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVArRateB,         "RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_B" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVArRateB,              "SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_B" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVARateB,         "DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_B" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVARateB,          "RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_B" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVARateB,               "SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_B" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakKwRateC,          "DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_C" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakKwRateC,           "RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_C" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakKwRateC,                "SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_C" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVArRateC,        "DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_C" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVArRateC,         "RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_C" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVArRateC,              "SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_C" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVARateC,         "DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_C" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVARateC,          "RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_C" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVARateC,               "SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_C" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakKwRateD,          "DELIVERED_COIN_POWER_FACTOR_PEAK_KW_RATE_D" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakKwRateD,           "RECEIVED_COIN_POWER_FACTOR_PEAK_KW_RATE_D" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakKwRateD,                "SUM_COIN_POWER_FACTOR_PEAK_KW_RATE_D" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVArRateD,        "DELIVERED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_D" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVArRateD,         "RECEIVED_COIN_POWER_FACTOR_PEAK_KVAR_RATE_D" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVArRateD,              "SUM_COIN_POWER_FACTOR_PEAK_KVAR_RATE_D" );
INIT_ATTRIBUTE( DeliveredCoincidentPowerFactorPeakkVARateD,         "DELIVERED_COIN_POWER_FACTOR_PEAK_KVA_RATE_D" );
INIT_ATTRIBUTE( ReceivedCoincidentPowerFactorPeakkVARateD,          "RECEIVED_COIN_POWER_FACTOR_PEAK_KVA_RATE_D" );
INIT_ATTRIBUTE( SumCoincidentPowerFactorPeakkVARateD,               "SUM_COIN_POWER_FACTOR_PEAK_KVA_RATE_D" );
