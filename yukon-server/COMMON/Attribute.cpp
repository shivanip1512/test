...
INIT_ATTRIBUTE( kVAQ1Q2,                                            "KVA_Q1_Q2" );
INIT_ATTRIBUTE( kVAQ3Q4,                                            "KVA_Q3_Q4" );
INIT_ATTRIBUTE( kVAQ1Q3,                                            "KVA_Q1_Q3" );
INIT_ATTRIBUTE( kVAQ2Q4,                                            "KVA_Q2_Q4" );
...
INIT_ATTRIBUTE( kVArQ1Q3,                                           "KVAR_Q1_Q3" );
INIT_ATTRIBUTE( kVArQ2Q4,                                           "KVAR_Q2_Q4" );
INIT_ATTRIBUTE( kVArQ1Q4,                                           "KVAR_Q1_Q4" );
INIT_ATTRIBUTE( kVArQ2Q3,                                           "KVAR_Q2_Q3" );
...
INIT_ATTRIBUTE( PowerFactorSum,                                     "SUM_POWER_FACTOR" );
INIT_ATTRIBUTE( PowerFactorReceived,                                "RECEIVED_POWER_FACTOR" );
