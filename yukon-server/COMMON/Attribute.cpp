...
INIT_ATTRIBUTE( CoincidentPowerFactorDeliveredPeakKw,               "POWER_FACTOR_COIN_DELIVERED_PEAK_KW" );
INIT_ATTRIBUTE( CoincidentPowerFactorReceivedPeakKw,                "POWER_FACTOR_COIN_RECEIVED_PEAK_KW" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvarQ12,                   "POWER_FACTOR_COIN_PEAK_KVAR_Q12" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvarQ34,                   "POWER_FACTOR_COIN_PEAK_KVAR_Q34" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakTotalKvar,                 "POWER_FACTOR_COIN_PEAK_TOTAL_KVAR" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ14,                    "POWER_FACTOR_COIN_PEAK_KVA_Q14" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ23,                    "POWER_FACTOR_COIN_PEAK_KVA_Q23" );
...
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ14RateA,               "POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_A" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ23RateA,               "POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_A" );
...
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ14RateB,               "POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_B" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ23RateB,               "POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_B" );
...
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ14RateC,               "POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_C" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ23RateC,               "POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_C" );
...
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ14RateD,               "POWER_FACTOR_COIN_PEAK_KVA_Q14_RATE_D" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakKvaQ23RateD,               "POWER_FACTOR_COIN_PEAK_KVA_Q23_RATE_D" );
INIT_ATTRIBUTE( CoincidentPowerFactorPeakTotalKvaRateD,             "POWER_FACTOR_COIN_PEAK_TOTAL_KVA_RATE_D" );
