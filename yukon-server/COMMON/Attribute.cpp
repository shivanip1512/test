...
INIT_ATTRIBUTE( PowerFactorQ1234,                                   "AVERAGE_POWER_FACTOR_Q1234" );
INIT_ATTRIBUTE( PowerFactorAverage,                                 "AVERAGE_POWER_FACTOR" );
INIT_ATTRIBUTE( PowerFactorFrozen,                                  "AVERAGE_POWER_FACTOR_FROZEN" );
INIT_ATTRIBUTE( PowerFactorAverageRateA,                            "AVERAGE_POWER_FACTOR_RATE_A" );
INIT_ATTRIBUTE( PowerFactorFrozenRateA,                             "AVERAGE_POWER_FACTOR_FROZEN_RATE_A" );
INIT_ATTRIBUTE( PowerFactorAverageRateB,                            "AVERAGE_POWER_FACTOR_RATE_B" );
INIT_ATTRIBUTE( PowerFactorFrozenRateB,                             "AVERAGE_POWER_FACTOR_FROZEN_RATE_B" );
INIT_ATTRIBUTE( PowerFactorAverageRateC,                            "AVERAGE_POWER_FACTOR_RATE_C" );
INIT_ATTRIBUTE( PowerFactorFrozenRateC,                             "AVERAGE_POWER_FACTOR_FROZEN_RATE_C" );
INIT_ATTRIBUTE( PowerFactorAverageRateD,                            "AVERAGE_POWER_FACTOR_RATE_D" );
INIT_ATTRIBUTE( PowerFactorFrozenRateD,                             "AVERAGE_POWER_FACTOR_FROZEN_RATE_D" );
