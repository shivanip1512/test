...
ERRSTRUCT CTIErrors[] = {
    ...
    { ErrPortDialupConnect_Port,    "Dialup connection failed. Port in error",      ERRTYPECOMM,     " N/A"},
    { ErrPortDialupConnect_Device,  "Dialup connection failed. Device in error",    ERRTYPESYSTEM,   " N/A"},
