...
static const std::map<YukonError_t, error_info> CtiErrors = {
        ...
        { ClientErrors::UnsupportedDevice,           ei{ ERRTYPESYSTEM,   "Device not supported by Porter"              } },
        ...
        { ClientErrors::InvalidWaterNode,            ei{ ERRTYPESYSTEM,   "Invalid water node device."                  } },
