...
static int abortFunction( CtiPort *port )
{
    ...
    return CtiHayesModem::AS_NOERROR;
}
 ...
 */
    ...
    while( SpaceUsedInTXBuffer( _port ) > AS_NOERROR )
        ;
