...
struct test_Mct440_2132B : test_Mct440_2132BDevice
{
    test_Mct440_2132B() : test_Mct440_2132BDevice(TYPEMCT440_2132B, "Test MCT-440-2132B") {}
};
...
namespace std {
    ...
    std::ostream& operator<<(std::ostream& out, const test_Mct440_2132BDevice::ReadDescriptor &rd);
    std::ostream& operator<<(std::ostream& out, const std::vector<boost::tuples::tuple<unsigned, unsigned, int>> &rd);
    bool operator==(const test_Mct440_2132BDevice::value_locator &lhs, const boost::tuples::tuple<unsigned, unsigned, int> &rhs);
}

namespace boost {
namespace test_tools {
    //  defined in rtdb/test_main.cpp
    bool operator!=(const test_Mct440_2132BDevice::ReadDescriptor &lhs, const std::vector<boost::tuples::tuple<unsigned, unsigned, int>> &rhs);
}
}

BOOST_AUTO_TEST_CASE(test_mct440_2132b_decodeGetValueInstantLineData)
{
    INMESS                         InMessage;
    ...
    unsigned char test_data[8] = {0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8};
