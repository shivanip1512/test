...
INT CtiDeviceAlphaPPlus::generateCommandScan( CtiXfer  &Transfer, list< CtiMessage* > &traceList )
{
...
INT CtiDeviceAlphaPPlus::generateCommandLoadProfile( CtiXfer  &Transfer, list< CtiMessage* > &traceList )
{
