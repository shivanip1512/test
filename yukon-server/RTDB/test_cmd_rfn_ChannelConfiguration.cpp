...
const std::vector<RfnChannelConfigurationCommand::MetricIds> allMetrics = {
        ...
        {  151,   152,   153,   154,   155,   156,   157,   158,   159,   160,   161,   162,   163,   164,   184,   210,
           240,   256,   257,  1001,  1002,  1003,  1004,  1005,  1006,  1007,  1008,  1009,  1010,  1011,  1012,  1013,
...
const std::vector< std::vector< std::string > > allDescriptions = list_of<std::vector< std::string >>
        ...
        (list_of("Voltage Angle Phase A, Rate A (1106)")
        ...
        (list_of("Q hour total/sum, Rate B (2063)")
        ...
        (list_of("Var received, peak demand coincident, Rate C (3037)")
        ...
        (list_of("Var hour received, Rate D (4022)")
        ...
        (list_of("PF Phase C, Rate D (4164)")
