...
const std::vector< std::vector< std::string > > allDescriptions = list_of<std::vector< std::string >>
        ...
        (list_of("Watts Phase B (151)")
                ...
                ("Sum Watts (330)")
                ("Net Watts (331)")
                ("Vars Quadrant 1, Quadrant 3 (340)")
                ("Vars Quadrant 2, Quadrant 4 (341)")
                ("Vars Quadrant 1, Quadrant 4 (342)")
                ("Vars Quadrant 2, Quadrant 3 (343)")
                ("Sum Vars (344)")
                ("Net Vars (345)")
                ("VA Quadrant 1, Quadrant 2 (350)")
                ("VA Quadrant 3, Quadrant 4 (351)")
                ("VA Quadrant 1, Quadrant 3 (352)")
                ("VA Quadrant 2, Quadrant 4 (353)")
                ("Sum VA (354)")
                ("Net VA (355)")
