...
//{  Brace matching for BOOST_FIXTURE_TEST_SUITE
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Command_Loop, BSt));
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_Model, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
        BOOST_CHECK_EQUAL(BSt.Function, 0x00);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_Install, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
        BOOST_CHECK_EQUAL(BSt.Function, 0x00);
        BOOST_CHECK_EQUAL(BSt.Length,   8);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_GroupAddressEnable, BSt));
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_GroupAddressInhibit, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_Raw, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
        BOOST_CHECK_EQUAL(BSt.Function, 0x00);
        BOOST_CHECK_EQUAL(BSt.Length,   0);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Control_Shed, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
        BOOST_CHECK_EQUAL(BSt.Function, 0x00);
        BOOST_CHECK_EQUAL(BSt.Length,   0);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Control_Restore, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
        BOOST_CHECK_EQUAL(BSt.Function, 0x00);
        BOOST_CHECK_EQUAL(BSt.Length,   0);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Control_Connect, BSt));
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Control_Disconnect, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x20);  //  Q_ARML
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_ARMC, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_ARML, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_TSync, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_Raw, BSt));
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetValue_PFCount, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutValue_ResetPFCount, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
        BOOST_CHECK_EQUAL(BSt.Function, 0x20);
        BOOST_CHECK_EQUAL(BSt.Length,   2);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetStatus_Internal, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutStatus_Reset, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_Multiplier, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_Multiplier, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
        BOOST_CHECK_EQUAL(BSt.Function, 0x90);
        BOOST_CHECK_EQUAL(BSt.Length,   2);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_Options, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_Time, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_TSync, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
        BOOST_CHECK_EQUAL(BSt.Function, 0x49);
        BOOST_CHECK_EQUAL(BSt.Length,   5);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_UniqueAddress, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_GroupAddress, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_GroupAddress_GoldSilver, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_GroupAddress_Bronze, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
        BOOST_CHECK_EQUAL(BSt.Function, 0x28);
        BOOST_CHECK_EQUAL(BSt.Length,   1);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_GroupAddress_Lead, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write | 0x80);  //  Q_ARMC
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetValue_KWH, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Scan_Accum, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
        BOOST_CHECK_EQUAL(BSt.Function, 0x89);
        BOOST_CHECK_EQUAL(BSt.Length,   3);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetValue_Demand, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Scan_Integrity, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
        BOOST_CHECK_EQUAL(BSt.Function, 0x86);
        BOOST_CHECK_EQUAL(BSt.Length,   6);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::Scan_LoadProfile, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
        BOOST_CHECK_EQUAL(BSt.Function, 0x00);
        BOOST_CHECK_EQUAL(BSt.Length,   0);
    }
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutStatus_ResetOverride, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetStatus_LoadProfile, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::GetConfig_LoadProfileInterval, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Read);
    ...
    {
        BOOST_REQUIRE(lmt.getOperation(EmetconProtocol::PutConfig_LoadProfileInterval, BSt));
        BOOST_CHECK_EQUAL(BSt.IO, EmetconProtocol::IO_Write);
