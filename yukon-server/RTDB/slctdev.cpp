...
const DeviceLookup deviceFactory {
    ...
    { TYPE_WRL420CL,     MakeDeviceFunc(makeDevice<Wrl420clDevice>) },
    { TYPE_RFN420CD,     MakeDeviceFunc(makeDevice<Rfn420cdDevice>) },
    { TYPE_WRL420CD,     MakeDeviceFunc(makeDevice<Wrl420cdDevice>) },
    ...
    //  SETO Device
    { TYPE_RFN530S4X_DER,   MakeDeviceFunc(makeDevice<Rfn530S4X_Der>) },
    //  Electronic meters
