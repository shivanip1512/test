...
{
    setDynamicInfo(CtiTableDynamicPaoInfo::Key_RFN_Holiday1, holidays[0].asStringMDY());
    setDynamicInfo(CtiTableDynamicPaoInfo::Key_RFN_Holiday2, holidays[1].asStringMDY());
    setDynamicInfo(CtiTableDynamicPaoInfo::Key_RFN_Holiday3, holidays[2].asStringMDY());
}
