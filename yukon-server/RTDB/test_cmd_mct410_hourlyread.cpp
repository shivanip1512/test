...
BOOST_AUTO_TEST_SUITE( test_cmd_mct410_hourlyread )
...
BOOST_AUTO_TEST_CASE(test_command_single_day_read_dst_active)
{
...

    {
        ...
        {
            { CtiTime(CtiDate(12, 8, 2010),  0), 74564, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 23), 74562, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 22), 74559, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 21), 74555, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 20), 74550, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 19), 74544, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 18), 74537, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 17), 74529, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 16), 74520, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 15), 74510, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 14), 74499, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(11, 8, 2010), 13), 74439, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 12), 74359, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 11), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010), 10), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  9), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  8), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  7), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  6), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  5), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  4), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  3), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  2), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 8, 2010),  1), 73639, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...
BOOST_AUTO_TEST_CASE(test_command_single_day_read_dst_inactive)
{
...

    {
        ...
        expected_pointdata expected[] =
        {
            { CtiTime(CtiDate(12, 2, 2010),  0), 74564, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 23), 74563, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 22), 74561, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 21), 74558, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 20), 74554, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 19), 74549, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 18), 74543, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 17), 74536, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 16), 74528, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 15), 74519, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 14), 74509, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(11, 2, 2010), 13), 74498, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(11, 2, 2010), 12), 74438, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010), 11), 74358, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010), 10), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  9), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  8), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  7), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  6), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  5), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  4), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  3), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  2), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(11, 2, 2010),  1), 73638, NormalQuality, PulseAccumulatorPointType,  1 }
        };
...
BOOST_AUTO_TEST_CASE(test_command_single_day_read_dst_fall_2010)
{
...

    {
        ...
        expected_pointdata expected[] =
        {
            { CtiTime(CtiDate(8, 11, 2010),  0), 74564, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 23), 74563, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 22), 74561, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 21), 74558, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 20), 74554, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 19), 74549, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 18), 74543, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 17), 74536, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 16), 74528, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 15), 74519, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 14), 74509, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(7, 11, 2010), 13), 74498, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(7, 11, 2010), 12), 74438, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010), 11), 74358, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010), 10), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  9), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  8), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  7), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  6), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  5), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  4), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  3), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  2), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(7, 11, 2010),  1), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            //  the only way to create this time (1:00 AM CDT) on the fall-back DST day
            { CtiTime(CtiDate(7, 11, 2010),  0) + 3600, 73638, NormalQuality, PulseAccumulatorPointType,  1 }
        };
...
BOOST_AUTO_TEST_CASE(test_command_single_day_read_dst_spring_2011)
{
...

    {
        ...
        expected_pointdata expected[] =
        {
            { CtiTime(CtiDate(14, 3, 2011),  0), 74564, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 23), 74562, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 22), 74559, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 21), 74555, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 20), 74550, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 19), 74544, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 18), 74537, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 17), 74529, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 16), 74520, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 15), 74510, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(13, 3, 2011), 14), 74499, NormalQuality, PulseAccumulatorPointType, 1 },
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(13, 3, 2011), 13), 74439, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011), 12), 74359, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011), 11), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011), 10), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  9), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  8), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  7), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  6), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  5), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  4), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  3), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            //  The Time That Shall Not Be Created
            //{ CtiTime(CtiDate(13, 3, 2011),  2), 73638, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(13, 3, 2011),  1), 73639, NormalQuality, PulseAccumulatorPointType,  1 }
        };
...
BOOST_AUTO_TEST_CASE(test_command_single_day_read_channel_2)
{
...

    {
        ...
        expected_pointdata expected[] =
        {
            { CtiTime(CtiDate(12, 8, 2010),  0), 74564, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 23), 74562, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 22), 74559, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 21), 74555, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 20), 74550, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 19), 74544, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 18), 74537, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 17), 74529, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 16), 74520, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 15), 74510, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 14), 74499, NormalQuality, PulseAccumulatorPointType, 2 }
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(11, 8, 2010), 13), 74439, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 12), 74359, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 11), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010), 10), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  9), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  8), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  7), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  6), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  5), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  4), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  3), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  2), 73639, NormalQuality, PulseAccumulatorPointType, 2 },
            { CtiTime(CtiDate(11, 8, 2010),  1), 73639, NormalQuality, PulseAccumulatorPointType, 2 }
        };
...
BOOST_AUTO_TEST_CASE(test_command_single_day_read_yesterday)
{
...

    {
        ...
        expected_pointdata expected[] =
        {
            { CtiTime(CtiDate(17, 8, 2010),  0), 74564, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 23), 74562, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 22), 74559, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 21), 74555, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 20), 74550, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 19), 74544, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 18), 74537, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 17), 74529, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 16), 74520, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 15), 74510, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 14), 74499, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(16, 8, 2010), 13), 74439, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 12), 74359, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 11), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010), 10), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  9), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  8), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  7), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  6), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  5), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  4), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  3), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  2), 73639, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(16, 8, 2010),  1), 73639, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...
BOOST_AUTO_TEST_CASE(test_command_multi_day_read_dst_active)
{
...

    {
        ...
        expected_pointdata expected[] =
        {
            { CtiTime(CtiDate(13, 8, 2010),  0), 74564, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 23), 74562, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 22), 74559, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 21), 74555, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 20), 74550, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 19), 74544, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 18), 74537, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 17), 74529, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 16), 74520, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 15), 74510, NormalQuality, PulseAccumulatorPointType, 1 },
            { CtiTime(CtiDate(12, 8, 2010), 14), 74499, NormalQuality, PulseAccumulatorPointType, 1 }
        };
...

    {
        ...
        expected_pointdata expected[] =
        {
            ...
            { CtiTime(CtiDate(12, 8, 2010), 13), 74439, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010), 12), 74359, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010), 11), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010), 10), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  9), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  8), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  7), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  6), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  5), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  4), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  3), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  2), 73639, NormalQuality, PulseAccumulatorPointType,  1 },
            { CtiTime(CtiDate(12, 8, 2010),  1), 73639, NormalQuality, PulseAccumulatorPointType,  1 }
        };
...
BOOST_AUTO_TEST_CASE(test_execute_bad_parameters)
{
...

    {
        ...
        Mct410HourlyReadCommand hourlyRead(start, start, 0);

        try
        {
            hourlyRead.execute(execute_time);

            BOOST_FAIL("Mct410HourlyReadCommand::execute() did not throw");
        }
...

    {
        ...
        Mct410HourlyReadCommand hourlyRead(start, start, 3);
...

    {
        ...
        Mct410HourlyReadCommand hourlyRead(CtiDate::neg_infin, end, 1);
...
BOOST_AUTO_TEST_CASE(test_decode_bad_weekday)
{
...

    {
        ...
        try
        {
            ...
            BOOST_FAIL("Mct410HourlyReadCommand::decode() did not throw");
        }
        catch( DlcCommand::CommandException &ex )
        {
...
{
    struct test : Mct410HourlyReadCommand
    {
        using Mct410HourlyReadCommand::requestDayBegin;
    };
    ...
    try
    {
        ...
        BOOST_FAIL("Mct410HourlyReadCommand::requestDayBegin() did not throw");
    }
    catch( DlcCommand::CommandException &ex )
    {
        BOOST_CHECK_EQUAL(ex.error_code,        BADPARAM);
...
BOOST_AUTO_TEST_CASE(test_request_day_end)
{
    struct test : Mct410HourlyReadCommand
    {
        using Mct410HourlyReadCommand::requestDayEnd;
    };
    ...
    try
    {
        ...
        BOOST_FAIL("Mct410HourlyReadCommand::requestDayEnd() did not throw");
    }
    catch( DlcCommand::CommandException &ex )
    {
        BOOST_CHECK_EQUAL(ex.error_code,        BADPARAM);
...
BOOST_AUTO_TEST_CASE(test_validate_date)
{
    struct test : Mct410HourlyReadCommand
    {
        using Mct410HourlyReadCommand::validateDate;
    };
...
BOOST_AUTO_TEST_CASE(test_convert_delta)
{
    struct test : Mct410HourlyReadCommand
    {
        using Mct410HourlyReadCommand::convertDelta;
    };
