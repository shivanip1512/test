...
BOOST_AUTO_TEST_CASE(test_send_no_items)
{
    ...
    RfnCentronSetLcdConfigurationCommand lcdConfiguration(metrics);
...
BOOST_AUTO_TEST_CASE(test_send_3_items)
{
    ...
    // execute
    {
        ...
        std::vector<unsigned char> exp = boost::assign::list_of
                (0x70)(0x00)(0x03)(0x00)(0x00)(0x01)(0x01)(0x02)(0x02);
...
BOOST_AUTO_TEST_CASE(test_send_all_items)
{
    ...
    // execute
    {
        ...
        std::vector<unsigned char> exp = boost::assign::list_of
                (0x70)(0x00)(0x25)(0x00)(0x00)(0x01)(0x01)(0x02)(0x02)(0x03)
