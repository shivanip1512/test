...
BOOST_AUTO_TEST_CASE(test_createDeviceType)
{
    std::vector<std::string> expected = boost::assign::list_of
        ...
        ("class Cti::Devices::RfnDevice")
        ("class Cti::Devices::RfnDevice")
        ("class Cti::Devices::Rfn420FocusDevice")
        ("class Cti::Devices::Rfn420FocusDevice")
        ("class Cti::Devices::Rfn420FocusDevice")
        ("class Cti::Devices::Rfn420FocusDevice")
        ("class Cti::Devices::Rfn420FocusDevice")
...
BOOST_AUTO_TEST_CASE(test_DeviceFactory)
{
    ...
    std::vector<std::pair<std::string, std::string>> dbTypesToTypenames = boost::assign::list_of
        ...
        (std::make_pair("rfn-420fl",                      "class Cti::Devices::Rfn420FocusDevice"))
        (std::make_pair("rfn-420fx",                      "class Cti::Devices::Rfn420FocusDevice"))
        (std::make_pair("rfn-420fd",                      "class Cti::Devices::Rfn420FocusDevice"))
        (std::make_pair("rfn-420frx",                     "class Cti::Devices::Rfn420FocusDevice"))
        (std::make_pair("rfn-420frd",                     "class Cti::Devices::Rfn420FocusDevice"))
