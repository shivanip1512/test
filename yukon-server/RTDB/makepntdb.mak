...
$(RTDB_PNT_FULLBUILD) :
	...
	$(CC) $(CCOPTS) $(DLLFLAGS) $(PARALLEL) $(PCHFLAGS) $(INCLPATHS) /D_DLL_PNTDB -Fo$(OBJ)\ -c $[StrReplace,.obj,.cpp,$(YUKONPNTDLLOBJS)]
...
.cpp.obj:
        @echo:
        @echo Compiling cpp to obj
        $(CC) $(CCOPTS) $(DLLFLAGS) $(PCHFLAGS) $(INCLPATHS) /D_DLL_PNTDB -Fo$(OBJ)\ -c $<
