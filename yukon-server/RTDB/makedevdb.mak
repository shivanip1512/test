...
$(RTDB_DEVDB_FULLBUILD) :
	...
	$(CC) $(CCOPTS) $(DLLFLAGS) $(PARALLEL) $(PCHFLAGS) $(INCLPATHS) /D_DLL_DEVDB -Fo$(OBJ)\ -c $[StrReplace,.obj,.cpp,$(YUKONDEVDLLOBJS)]
...
.cpp.obj:
        @echo:
        @echo Compiling cpp to obj
        $(CC) $(CCOPTS) $(DLLFLAGS) $(PCHFLAGS) $(INCLPATHS) /D_DLL_DEVDB -Fo$(OBJ)\ -c $<
