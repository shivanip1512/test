...
MessagePtr<Thrift::LMConstraintViolation>::type serialize( const ::ConstraintViolation& imsg )
{
    ...
    omsg->__set__datetimeParams                 ( transformContainer<std::vector<int64_t>>( imsg.getDateTimeParams(), CtiTimeToMilliseconds ));
...
MessagePtr<::ConstraintViolation>::type deserialize( const Thrift::LMConstraintViolation& imsg )
{
    MessagePtr<::ConstraintViolation>::type omsg( new ::ConstraintViolation(
                                                  ...
                                                  imsg._integerParams,
                                                  imsg._stringParams,
                                                  transformContainer<std::vector<CtiTime>>( imsg._datetimeParams, MillisecondsToCtiTime )));
...
MessagePtr<Thrift::LMEnergyExchangeControl>::type serialize( const ::CtiLMEnergyExchangeControlMsg& imsg )
{
    ...
    omsg->__set__pricesOffered                  ( vector<int32_t>( imsg.getPricesOffered().begin(), imsg.getPricesOffered().end() ));
...
MessagePtr<::CtiLMEnergyExchangeControlMsg>::type deserialize( const Thrift::LMEnergyExchangeControl& imsg )
{
    MessagePtr<::CtiLMEnergyExchangeControlMsg>::type omsg( new ::CtiLMEnergyExchangeControlMsg(
                                                  ...
                                                  vector<LONG>( imsg._pricesOffered.begin(), imsg._pricesOffered.end() )));
...
MessagePtr<Thrift::LMControlAreas>::type serialize( const ::CtiLMControlAreaMsg& imsg )
{
    ...
    omsg->__set__controlAreas                   ( transformContainer<vector<Thrift::LMControlAreaItem>>( *imsg.getControlAreas(), serializeFromPtr ));
...
MessagePtr<Thrift::LMControlAreaItem>::type serialize( const ::CtiLMControlArea& imsg )
{
    ...
    omsg->__set__defDailyStartTime              ( CtiTimeToMilliseconds( imsg.getDefDailyStartTime() ));
    omsg->__set__defDailyStopTime               ( CtiTimeToMilliseconds( imsg.getDefDailyStopTime() ));
    ...
    omsg->__set__currentDailyStartTime          ( CtiTimeToMilliseconds( imsg.getCurrentDailyStartTime() ));
    omsg->__set__currentDailyStopTime           ( CtiTimeToMilliseconds( imsg.getCurrentDailyStopTime() ));
    omsg->__set__lmControlAreaTriggers          ( transformContainer<vector<Thrift::LMControlAreaTrigger>>( imsg.getLMControlAreaTriggers(), serializeFromPtr ));
