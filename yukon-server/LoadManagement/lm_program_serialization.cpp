...
MessagePtr<Thrift::LMProgramBase>::type serialize( const ::CtiLMProgramBase& imsg )
{
    ...
    omsg->__set__lmProgramControlWindows        ( transformContainer<vector<Thrift::LMProgramControlWindow>>( imsg.getLMProgramControlWindows(), serializeFromPtr ));
...
MessagePtr<Thrift::LMProgramControlWindow>::type serialize( const ::CtiLMProgramControlWindow& imsg )
{
    ...
    omsg->__set__availableStartTime             ( imsg.getAvailableStartTime().seconds() );
    omsg->__set__availableStopTime              ( imsg.getAvailableStopTime().seconds() );
...
MessagePtr<Thrift::LMProgramCurtailment>::type serialize( const ::CtiLMProgramCurtailment& imsg )
{
    ...
    omsg->__set__lmProgramCurtailmentCustomers  ( transformContainer<vector<Thrift::LMCurtailCustomer>>( imsg.getLMProgramCurtailmentCustomers(), serializeFromPtr ));
...
MessagePtr<Thrift::LMProgramDirect>::type serialize( const ::CtiLMProgramDirect& imsg )
{
    ...
    omsg->__set__lmProgramDirectGears           ( transformContainer<vector<Thrift::LMProgramDirectGear>>( imsg.getLMProgramDirectGears(), serializeFromPtr ));
    ...
    std::vector<Thrift::GenericMessage> activeMasters;
    ...
    std::vector<Thrift::GenericMessage> activeSubordinates;
...
MessagePtr<Thrift::LMProgramEnergyExchange>::type serialize( const ::CtiLMProgramEnergyExchange& imsg )
{
    ...
    omsg->__set__canceledMsg                    ( imsg.getCanceledMsg() );
    omsg->__set__stoppedEarlyMsg                ( imsg.getStoppedEarlyMsg() );
    omsg->__set__lmEnergyExchangeOffers         ( transformContainer<vector<Thrift::LMEnergyExchangeOffer>>( imsg.getLMEnergyExchangeOffers(), serializeFromPtr ));
    omsg->__set__lmEnergyExchangeCustomers      ( transformContainer<vector<Thrift::LMEnergyExchangeCustomer>>( imsg.getLMEnergyExchangeCustomers(), serializeFromPtr ));
...
MessagePtr<Thrift::LMEnergyExchangeOffer>::type serialize( const ::CtiLMEnergyExchangeOffer& imsg )
{
    ...
    omsg->__set__lmEnergyExchangeOfferRevisions ( transformContainer<vector<Thrift::LMEnergyExchangeOfferRevision>>( imsg.getLMEnergyExchangeOfferRevisions(), serializeFromPtr ));
...
MessagePtr<Thrift::LMEnergyExchangeOfferRevision>::type serialize( const ::CtiLMEnergyExchangeOfferRevision& imsg )
{
    ...
    omsg->__set__additionalInfo                 ( imsg.getAdditionalInfo() );
    omsg->__set__lmEnergyExchangeHourlyOffers   ( transformContainer<vector<Thrift::LMEnergyExchangeHourlyOffer>>( imsg.getLMEnergyExchangeHourlyOffers(), serializeFromPtr ));
...
MessagePtr<Thrift::LMEnergyExchangeCustomer>::type serialize( const ::CtiLMEnergyExchangeCustomer& imsg )
{
    ...
    omsg->__set__baseMessage                    ( *serialize( static_cast<const ::CtiLMCICustomerBase&>(imsg) ));
    omsg->__set__lmEnergyExchangeCustomerReplies( transformContainer<vector<Thrift::LMEnergyExchangeCustomerReply>>( imsg.getLMEnergyExchangeCustomerReplies(), serializeFromPtr ));
...
MessagePtr<Thrift::LMEnergyExchangeCustomerReply>::type serialize( const ::CtiLMEnergyExchangeCustomerReply& imsg )
{
    ...
    omsg->__set__lmEnergyExchangeHourlyCustomers( transformContainer<vector<Thrift::LMEnergyExchangeHourlyCustomer>>( imsg.getLMEnergyExchangeHourlyCustomers(), serializeFromPtr ));
