...
BOOST_AUTO_TEST_CASE( test_scan_request )
{
...

    {
        ...
        CtiFDRDestination pointDestination(fdrPoint->getPointID(), "MasterId:2;SlaveId:30;POINTTYPE:Status;Offset:2", "Test Destination");
    ...
    const byte_str expected(
        ...
        "00 04 00 00 40 01 00 00 01 02 28 02 00 01 00 00 4b 23 "
        "02 00 00 14 01 28 01 00 00 00 00 13 00 00 00    dc 34");
