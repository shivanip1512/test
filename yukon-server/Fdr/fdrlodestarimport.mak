...
fdrlodestarimport.dll: fdrlodestarimport.obj fdrlodestarimport.mak
                @%cd $(OBJ)
                @echo Building  ..\$@
...
clean:
                -del fdrlodestarimport.obj fdrlodestarimportt.dll fdrlodestarimport.ilk fdrlodestarimport.pdb fdrlodestarimport.lib fdrlodestarimport.exp
