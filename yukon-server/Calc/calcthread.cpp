...
CtiCalculateThread::CtiCalculateThread() :
    _periodicThreadFunc  (Cti::WorkerThread::Function(&CtiCalculateThread::periodicThread,   this).name("periodicThread")),
    _onUpdateThreadFunc  (Cti::WorkerThread::Function(&CtiCalculateThread::onUpdateThread,   this).name("onUpdateThread")),
    _historicalThreadFunc(Cti::WorkerThread::Function(&CtiCalculateThread::historicalThread, this).name("historicalThread")),
    _baselineThreadFunc  (Cti::WorkerThread::Function(&CtiCalculateThread::baselineThread,   this).name("baselineThread"))
{
}
