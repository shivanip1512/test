...
CtiCalcLogicService::CtiCalcLogicService(LPCTSTR szName, LPCTSTR szDisplay, DWORD dwType ) :
    ...
    _inputFunc (Cti::WorkerThread::Function(&CtiCalcLogicService::_inputThread,  this).name("_inputThread")),
    _outputFunc(Cti::WorkerThread::Function(&CtiCalcLogicService::_outputThread, this).name("_outputThread"))
{
    m_pThis = this;
}
