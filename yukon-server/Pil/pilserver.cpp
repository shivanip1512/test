...
PilServer::PilServer(CtiDeviceManager *DM, CtiPointManager *PM, CtiRouteManager *RM) :
    ...
    _rfnRequestId(0),
    _resultThread        (WorkerThread::Function(&PilServer::resultThread,         this).name("_resultThread")),
    _nexusThread         (WorkerThread::Function(&PilServer::nexusThread,          this).name("_nexusThread")),
    _nexusWriteThread    (WorkerThread::Function(&PilServer::nexusWriteThread,     this).name("_nexusWriteThread")),
    _vgConnThread        (WorkerThread::Function(&PilServer::vgConnThread,         this).name("_vgConnThread")),
    _schedulerThread     (WorkerThread::Function(&PilServer::schedulerThread,      this).name("_schedulerThread")),
    _periodicActionThread(WorkerThread::Function(&PilServer::periodicActionThread, this).name("_periodicActionThread"))
{
