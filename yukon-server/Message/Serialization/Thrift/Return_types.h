...
class Return {
 public:
  ...
  static const char* ascii_fingerprint; // = "A701A63FFCB2DBF6156775D600A82321";
  static const uint8_t binary_fingerprint[16]; // = {0xA7,0x01,0xA6,0x3F,0xFC,0xB2,0xDB,0xF6,0x15,0x67,0x75,0xD6,0x00,0xA8,0x23,0x21};
