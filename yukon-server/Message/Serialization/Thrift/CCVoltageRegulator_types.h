...
class CCVoltageRegulator {
 public:
  ...
  static const char* ascii_fingerprint; // = "C1EF3CA1AB399EFA499138D224A62CBE";
  static const uint8_t binary_fingerprint[16]; // = {0xC1,0xEF,0x3C,0xA1,0xAB,0x39,0x9E,0xFA,0x49,0x91,0x38,0xD2,0x24,0xA6,0x2C,0xBE};
