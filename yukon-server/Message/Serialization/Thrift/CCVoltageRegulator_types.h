...
class CCVoltageRegulatorItem : public virtual ::apache::thrift::TBase {
 public:
  ...
  CCVoltageRegulatorItem() noexcept
                         : _parentId(0),
                           _lastTapOperation(0),
                           _lastTapOperationTime(0),
                           _regulatorType(0),
                           _recentTapOperation(0),
                           _lastOperatingMode(0),
                           _lastCommandedOperatingMode(0) {
  }
