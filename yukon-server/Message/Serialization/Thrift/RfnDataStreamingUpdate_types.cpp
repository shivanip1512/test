...
RfnDataStreamingUpdateReply::RfnDataStreamingUpdateReply(const RfnDataStreamingUpdateReply& other2) noexcept {
  success = other2.success;
}
RfnDataStreamingUpdateReply& RfnDataStreamingUpdateReply::operator=(const RfnDataStreamingUpdateReply& other3) noexcept {
