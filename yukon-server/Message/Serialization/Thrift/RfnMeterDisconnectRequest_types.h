...
class RfnMeterDisconnectRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnMeterDisconnectRequest() noexcept
                            : action(static_cast<RfnMeterDisconnectCmdType::type>(0)) {
  }
...
class RfnMeterDisconnectInitialReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnMeterDisconnectInitialReply(const RfnMeterDisconnectInitialReply&) noexcept;
  RfnMeterDisconnectInitialReply& operator=(const RfnMeterDisconnectInitialReply&) noexcept;
  RfnMeterDisconnectInitialReply() noexcept
                                 : replyType(static_cast<RfnMeterDisconnectInitialReplyType::type>(0)) {
  }
...
class RfnMeterDisconnectConfirmationReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnMeterDisconnectConfirmationReply(const RfnMeterDisconnectConfirmationReply&) noexcept;
  RfnMeterDisconnectConfirmationReply& operator=(const RfnMeterDisconnectConfirmationReply&) noexcept;
  RfnMeterDisconnectConfirmationReply() noexcept
                                      : replyType(static_cast<RfnMeterDisconnectConfirmationReplyType::type>(0)),
                                        state(static_cast<RfnMeterDisconnectState::type>(0)) {
  }
