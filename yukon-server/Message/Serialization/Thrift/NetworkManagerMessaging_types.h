...
class NetworkManagerRequestHeader : public virtual ::apache::thrift::TBase {
 public:
  ...
  NetworkManagerRequestHeader() noexcept
                              : clientGuid(),
                                sessionId(0),
                                messageId(0),
                                groupId(0),
...
class NetworkManagerRequestAck : public virtual ::apache::thrift::TBase {
 public:
  ...
  NetworkManagerRequestAck() noexcept {
  }
...
class NetworkManagerCancelRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  NetworkManagerCancelRequest() noexcept
                              : clientGuid(),
                                sessionId(0),
                                type(static_cast<NetworkManagerCancelType::type>(0)) {
  }
...
class NetworkManagerCancelRequestAck : public virtual ::apache::thrift::TBase {
 public:
  ...
  NetworkManagerCancelRequestAck() noexcept {
  }
...
class NetworkManagerCancelResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  NetworkManagerCancelResponse() noexcept
                               : clientGuid(),
                                 sessionId(0) {
  }
