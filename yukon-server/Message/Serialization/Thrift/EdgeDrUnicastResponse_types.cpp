...
void EdgeDrUnicastResponse::__set_paoToE2eId(const std::map<int32_t, int16_t> & val) {
  this->paoToE2eId = val;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i4 = 0; _i4 < _size0; ++_i4)
            {
              ...
              int16_t& _val6 = this->paoToE2eId[_key5];
...
uint32_t EdgeDrUnicastResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_I16, static_cast<uint32_t>(this->paoToE2eId.size()));
    std::map<int32_t, int16_t> ::const_iterator _iter7;
