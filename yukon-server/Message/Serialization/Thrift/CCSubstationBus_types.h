...
class CCSubstationBus {
 public:
  ...
  static const char* ascii_fingerprint; // = "600F7031AE0D59102A83C54C5AF2CB7A";
  static const uint8_t binary_fingerprint[16]; // = {0x60,0x0F,0x70,0x31,0xAE,0x0D,0x59,0x10,0x2A,0x83,0xC5,0x4C,0x5A,0xF2,0xCB,0x7A};
