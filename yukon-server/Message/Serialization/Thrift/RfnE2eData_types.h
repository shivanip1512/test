...
class RfnE2eDataRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnE2eDataRequest() noexcept
                    : e2eProtocol(static_cast<RfnE2eProtocol::type>(0)),
                      applicationServiceId(0),
                      priority(static_cast<RfnE2eMessagePriority::type>(0)),
                      security(),
                      payload() {
  }
...
class RfnE2eDataConfirm : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnE2eDataConfirm() noexcept
                    : e2eProtocol(static_cast<RfnE2eProtocol::type>(0)),
                      applicationServiceId(0),
                      replyType(static_cast<RfnE2eDataReplyType::type>(0)) {
  }
