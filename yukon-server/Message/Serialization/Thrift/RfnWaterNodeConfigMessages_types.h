...
class RfnSetChannelConfigRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnSetChannelConfigRequest() noexcept
                             : reportingInterval(0),
                               recordingInterval(0) {
  }
...
class RfnSetChannelConfigReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnSetChannelConfigReply() noexcept
                           : reply(static_cast<SetChannelConfigReplyType::type>(0)) {
  }
...
class RfnGetChannelConfigRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnGetChannelConfigRequest() noexcept {
  }
...
class RfnGetChannelConfigReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnGetChannelConfigReply() noexcept
                           : timestamp(0),
                             recordingInterval(0),
                             reportingInterval(0),
                             reply(static_cast<GetChannelConfigReplyType::type>(0)) {
  }
