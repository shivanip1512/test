...
const std::map<int, const char*> _RfnE2eProtocol_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kRfnE2eProtocolValues, _kRfnE2eProtocolNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _RfnE2eMessagePriority_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kRfnE2eMessagePriorityValues, _kRfnE2eMessagePriorityNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _RfnE2eDataReplyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(11, _kRfnE2eDataReplyTypeValues, _kRfnE2eDataReplyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->e2eProtocol = static_cast<RfnE2eProtocol::type>(ecast2);
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->priority = static_cast<RfnE2eMessagePriority::type>(ecast3);
          isset_priority = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t RfnE2eDataRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->e2eProtocol));
  xfer += oprot->writeFieldEnd();
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->e2eProtocol = static_cast<RfnE2eProtocol::type>(ecast6);
          isset_e2eProtocol = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->priority = static_cast<RfnE2eMessagePriority::type>(ecast7);
          isset_priority = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->e2eProtocol = static_cast<RfnE2eProtocol::type>(ecast10);
          isset_e2eProtocol = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->replyType = static_cast<RfnE2eDataReplyType::type>(ecast11);
