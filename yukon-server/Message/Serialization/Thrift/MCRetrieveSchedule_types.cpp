...
const char* MCRetrieveSchedule::ascii_fingerprint = "B7CC136C0F37E2CBD102A8E8A5B37C46";
const uint8_t MCRetrieveSchedule::binary_fingerprint[16] = {0xB7,0xCC,0x13,0x6C,0x0F,0x37,0xE2,0xCB,0xD1,0x02,0xA8,0xE8,0xA5,0xB3,0x7C,0x46};
