...
const std::map<int, const char*> _SetChannelConfigReplyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kSetChannelConfigReplyTypeValues, _kSetChannelConfigReplyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _GetChannelConfigReplyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kGetChannelConfigReplyTypeValues, _kGetChannelConfigReplyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->reply = static_cast<SetChannelConfigReplyType::type>(ecast2);
          isset_reply = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t RfnSetChannelConfigReply::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->reply));
  xfer += oprot->writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->reply = static_cast<GetChannelConfigReplyType::type>(ecast22);
          isset_reply = true;
        } else {
          xfer += iprot->skip(ftype);
        }
