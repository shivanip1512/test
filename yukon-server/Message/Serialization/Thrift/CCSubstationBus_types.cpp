...
const char* CCCapBank::ascii_fingerprint = "0FFBBE469082D939A4E5F2BF83DABCBB";
const uint8_t CCCapBank::binary_fingerprint[16] = {0x0F,0xFB,0xBE,0x46,0x90,0x82,0xD9,0x39,0xA4,0xE5,0xF2,0xBF,0x83,0xDA,0xBC,0xBB};
...
const char* CCFeeder::ascii_fingerprint = "5F4D1BBC3DA1938526695BE2A65535CE";
const uint8_t CCFeeder::binary_fingerprint[16] = {0x5F,0x4D,0x1B,0xBC,0x3D,0xA1,0x93,0x85,0x26,0x69,0x5B,0xE2,0xA6,0x55,0x35,0xCE};
...
uint32_t CCFeeder::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 20:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->_lastOperationTime);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->_ccCapbanks.resize(_size0);
            uint32_t _i4;
            for (_i4 = 0; _i4 < _size0; ++_i4)
            {
              xfer += this->_ccCapbanks[_i4].read(iprot);
            }
...
uint32_t CCFeeder::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("_lastOperationTime", ::apache::thrift::protocol::T_I32, 20);
  xfer += oprot->writeI32(this->_lastOperationTime);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("_ccCapbanks", ::apache::thrift::protocol::T_LIST, 49);
  {
    ...
    std::vector<CCCapBank> ::const_iterator _iter5;
    for (_iter5 = this->_ccCapbanks.begin(); _iter5 != this->_ccCapbanks.end(); ++_iter5)
    {
...
const char* CCSubstationBusItem::ascii_fingerprint = "C12FD9B065E94E539175EA3535A74B98";
const uint8_t CCSubstationBusItem::binary_fingerprint[16] = {0xC1,0x2F,0xD9,0xB0,0x65,0xE9,0x4E,0x53,0x91,0x75,0xEA,0x35,0x35,0xA7,0x4B,0x98};
...
uint32_t CCSubstationBusItem::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 14:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->_lastCurrentVarPointUpdateTime);
          isset__lastCurrentVarPointUpdateTime = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 16:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->_estimatedVarLoadPointValue);
          isset__estimatedVarLoadPointValue = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->_ccFeeders.resize(_size6);
            uint32_t _i10;
            for (_i10 = 0; _i10 < _size6; ++_i10)
            {
              xfer += this->_ccFeeders[_i10].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t CCSubstationBusItem::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("_lastCurrentVarPointUpdateTime", ::apache::thrift::protocol::T_I32, 14);
  xfer += oprot->writeI32(this->_lastCurrentVarPointUpdateTime);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("_estimatedVarLoadPointValue", ::apache::thrift::protocol::T_I32, 16);
  xfer += oprot->writeI32(this->_estimatedVarLoadPointValue);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("_lastOperationTime", ::apache::thrift::protocol::T_I32, 23);
  xfer += oprot->writeI32(this->_lastOperationTime);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("_ccFeeders", ::apache::thrift::protocol::T_LIST, 56);
  {
    ...
    for (_iter11 = this->_ccFeeders.begin(); _iter11 != this->_ccFeeders.end(); ++_iter11)
    {
...
const char* CCSubstationBus::ascii_fingerprint = "0C14F5E0A2E78EB41BDA0FB71588ED2C";
const uint8_t CCSubstationBus::binary_fingerprint[16] = {0x0C,0x14,0xF5,0xE0,0xA2,0xE7,0x8E,0xB4,0x1B,0xDA,0x0F,0xB7,0x15,0x88,0xED,0x2C};
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->_ccSubstationBuses.resize(_size12);
            uint32_t _i16;
            for (_i16 = 0; _i16 < _size12; ++_i16)
            {
              xfer += this->_ccSubstationBuses[_i16].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t CCSubstationBus::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("_ccSubstationBuses", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<CCSubstationBusItem> ::const_iterator _iter17;
    for (_iter17 = this->_ccSubstationBuses.begin(); _iter17 != this->_ccSubstationBuses.end(); ++_iter17)
    {
