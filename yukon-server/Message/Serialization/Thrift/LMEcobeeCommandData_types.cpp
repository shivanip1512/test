...
const std::map<int, const char*> _LMEcobeeTemperatureTypes_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kLMEcobeeTemperatureTypesValues, _kLMEcobeeTemperatureTypesNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->_temperatureOption = (LMEcobeeTemperatureTypes::type)ecast2;
    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->_temperatureOption = (LMEcobeeTemperatureTypes::type)ecast5;
          isset__temperatureOption = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
LMEcobeeRestore::LMEcobeeRestore(const LMEcobeeRestore& other8) {
  _groupId = other8._groupId;
  _restoreTime = other8._restoreTime;
}
LMEcobeeRestore& LMEcobeeRestore::operator=(const LMEcobeeRestore& other9) {
