...
const char* NotifAlarm::ascii_fingerprint = "7581FA8360D6B3DB529BCDA736EBD292";
const uint8_t NotifAlarm::binary_fingerprint[16] = {0x75,0x81,0xFA,0x83,0x60,0xD6,0xB3,0xDB,0x52,0x9B,0xCD,0xA7,0x36,0xEB,0xD2,0x92};
