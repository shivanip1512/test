...
const std::map<int, const char*> _RfnMeterDisconnectCmdType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kRfnMeterDisconnectCmdTypeValues, _kRfnMeterDisconnectCmdTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _RfnMeterDisconnectInitialReplyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kRfnMeterDisconnectInitialReplyTypeValues, _kRfnMeterDisconnectInitialReplyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _RfnMeterDisconnectConfirmationReplyType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(9, _kRfnMeterDisconnectConfirmationReplyTypeValues, _kRfnMeterDisconnectConfirmationReplyTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _RfnMeterDisconnectState_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(8, _kRfnMeterDisconnectStateValues, _kRfnMeterDisconnectStateNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->action = static_cast<RfnMeterDisconnectCmdType::type>(ecast0);
          isset_action = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->replyType = static_cast<RfnMeterDisconnectInitialReplyType::type>(ecast3);
...
RfnMeterDisconnectInitialReply::RfnMeterDisconnectInitialReply(const RfnMeterDisconnectInitialReply& other4) noexcept {
  replyType = other4.replyType;
}
RfnMeterDisconnectInitialReply& RfnMeterDisconnectInitialReply::operator=(const RfnMeterDisconnectInitialReply& other5) noexcept {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->replyType = static_cast<RfnMeterDisconnectConfirmationReplyType::type>(ecast6);
          isset_replyType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->state = static_cast<RfnMeterDisconnectState::type>(ecast7);
          isset_state = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
RfnMeterDisconnectConfirmationReply::RfnMeterDisconnectConfirmationReply(const RfnMeterDisconnectConfirmationReply& other8) noexcept {
  replyType = other8.replyType;
  state = other8.state;
}
RfnMeterDisconnectConfirmationReply& RfnMeterDisconnectConfirmationReply::operator=(const RfnMeterDisconnectConfirmationReply& other9) noexcept {
