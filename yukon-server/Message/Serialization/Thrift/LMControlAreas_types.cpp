...
const char* LMControlAreaItem::ascii_fingerprint = "BADB1F13D505A3E1ACEBDD00E5C72295";
const uint8_t LMControlAreaItem::binary_fingerprint[16] = {0xBA,0xDB,0x1F,0x13,0xD5,0x05,0xA3,0xE1,0xAC,0xEB,0xDD,0x00,0xE5,0xC7,0x22,0x95};
...
uint32_t LMControlAreaItem::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 11:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->_defDailyStartTime);
      ...
      case 12:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->_defDailyStopTime);
      ...
      case 20:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->_currentDailyStartTime);
      ...
      case 21:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->_currentDailyStopTime);
...
uint32_t LMControlAreaItem::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("_defDailyStartTime", ::apache::thrift::protocol::T_I64, 11);
  xfer += oprot->writeI64(this->_defDailyStartTime);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("_defDailyStopTime", ::apache::thrift::protocol::T_I64, 12);
  xfer += oprot->writeI64(this->_defDailyStopTime);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("_currentDailyStartTime", ::apache::thrift::protocol::T_I64, 20);
  xfer += oprot->writeI64(this->_currentDailyStartTime);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("_currentDailyStopTime", ::apache::thrift::protocol::T_I64, 21);
  xfer += oprot->writeI64(this->_currentDailyStopTime);
  xfer += oprot->writeFieldEnd();
...
const char* LMControlAreas::ascii_fingerprint = "B800B210CD90FAC3BF495689D662E534";
const uint8_t LMControlAreas::binary_fingerprint[16] = {0xB8,0x00,0xB2,0x10,0xCD,0x90,0xFA,0xC3,0xBF,0x49,0x56,0x89,0xD6,0x62,0xE5,0x34};
