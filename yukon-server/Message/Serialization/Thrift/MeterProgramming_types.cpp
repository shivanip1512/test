...
const std::map<int, const char*> _Source_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(4, _kSourceValues, _kSourceNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _ProgrammingStatus_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(7, _kProgrammingStatusValues, _kProgrammingStatusNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
MeterProgramStatusArchiveRequest::~MeterProgramStatusArchiveRequest() noexcept {
}
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status = static_cast<ProgrammingStatus::type>(ecast0);
          isset_status = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->source = static_cast<Source::type>(ecast1);
          isset_source = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
uint32_t MeterProgramStatusArchiveRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->source));
  xfer += oprot->writeFieldEnd();
