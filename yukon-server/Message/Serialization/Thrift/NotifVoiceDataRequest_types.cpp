...
const char* NotifVoiceDataRequest::ascii_fingerprint = "F1F1E1D345DB32BD1B0C809FB95C6187";
const uint8_t NotifVoiceDataRequest::binary_fingerprint[16] = {0xF1,0xF1,0xE1,0xD3,0x45,0xDB,0x32,0xBD,0x1B,0x0C,0x80,0x9F,0xB9,0x5C,0x61,0x87};
