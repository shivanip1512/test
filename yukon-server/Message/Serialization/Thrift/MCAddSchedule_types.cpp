...
MCAddSchedule::~MCAddSchedule() noexcept {
}


void MCAddSchedule::__set__baseMessage(const  ::Cti::Messaging::Serialization::Thrift::Message& val) {
  this->_baseMessage = val;
}

void MCAddSchedule::__set__schedule(const  ::Cti::Messaging::Serialization::Thrift::MCSchedule& val) {
  this->_schedule = val;
}

void MCAddSchedule::__set__script(const std::string& val) {
  this->_script = val;
}
...
MCAddSchedule::MCAddSchedule(const MCAddSchedule& other0) {
  _baseMessage = other0._baseMessage;
  _schedule = other0._schedule;
  _script = other0._script;
}
MCAddSchedule& MCAddSchedule::operator=(const MCAddSchedule& other1) {
  _baseMessage = other1._baseMessage;
  _schedule = other1._schedule;
  _script = other1._script;
  return *this;
}
void MCAddSchedule::printTo(std::ostream& out) const {
