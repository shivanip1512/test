...
const std::map<int, const char*> _NetworkManagerMessageLifetime_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kNetworkManagerMessageLifetimeValues, _kNetworkManagerMessageLifetimeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _NetworkManagerCancelType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kNetworkManagerCancelTypeValues, _kNetworkManagerCancelTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _NetworkManagerMessageCancelStatus_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kNetworkManagerMessageCancelStatusValues, _kNetworkManagerMessageCancelStatusNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->lifetime = static_cast<NetworkManagerMessageLifetime::type>(ecast0);
...
uint32_t NetworkManagerRequestHeader::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.lifetime) {
    ...
    xfer += oprot->writeI32(static_cast<int32_t>(this->lifetime));
    xfer += oprot->writeFieldEnd();
  }
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = static_cast<NetworkManagerCancelType::type>(ecast5);
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i21 = 0; _i21 < _size17; ++_i21)
            {
              ...
              _val23 = static_cast<NetworkManagerMessageCancelStatus::type>(ecast24);
            }
...
uint32_t NetworkManagerCancelResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("messageIds", ::apache::thrift::protocol::T_MAP, 3);
  {
    ...
    for (_iter25 = this->messageIds.begin(); _iter25 != this->messageIds.end(); ++_iter25)
    {
      ...
      xfer += oprot->writeI32(static_cast<int32_t>(_iter25->second));
    }
