...
class CCDeleteItem {
 public:
  ...
  static const char* ascii_fingerprint; // = "D230CB5FB2A450EB422C72ADE81EF40B";
  static const uint8_t binary_fingerprint[16]; // = {0xD2,0x30,0xCB,0x5F,0xB2,0xA4,0x50,0xEB,0x42,0x2C,0x72,0xAD,0xE8,0x1E,0xF4,0x0B};
