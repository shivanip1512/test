...
const std::map<int, const char*> _EdgeUnicastPriority_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kEdgeUnicastPriorityValues, _kEdgeUnicastPriorityNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->queuePriority = static_cast<EdgeUnicastPriority::type>(ecast5);
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->networkPriority = static_cast<EdgeUnicastPriority::type>(ecast6);
...
uint32_t EdgeDrUnicastRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->queuePriority));
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("networkPriority", ::apache::thrift::protocol::T_I32, 5);
  xfer += oprot->writeI32(static_cast<int32_t>(this->networkPriority));
  xfer += oprot->writeFieldEnd();
