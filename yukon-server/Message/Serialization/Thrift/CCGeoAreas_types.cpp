...
const char* CCGeoAreas::ascii_fingerprint = "EB28931D63E3D8C81EAAB13E49E638A0";
const uint8_t CCGeoAreas::binary_fingerprint[16] = {0xEB,0x28,0x93,0x1D,0x63,0xE3,0xD8,0xC8,0x1E,0xAA,0xB1,0x3E,0x49,0xE6,0x38,0xA0};
