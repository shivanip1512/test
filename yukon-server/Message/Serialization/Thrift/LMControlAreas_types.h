...
class LMControlAreaItem {
 public:
  ...
  static const char* ascii_fingerprint; // = "BADB1F13D505A3E1ACEBDD00E5C72295";
  static const uint8_t binary_fingerprint[16]; // = {0xBA,0xDB,0x1F,0x13,0xD5,0x05,0xA3,0xE1,0xAC,0xEB,0xDD,0x00,0xE5,0xC7,0x22,0x95};
  ...
  int32_t _minResponseTime;
   ::Cti::Messaging::Serialization::Thrift::Timestamp _defDailyStartTime;
   ::Cti::Messaging::Serialization::Thrift::Timestamp _defDailyStopTime;
  ...
  int32_t _currentPriority;
   ::Cti::Messaging::Serialization::Thrift::Timestamp _currentDailyStartTime;
   ::Cti::Messaging::Serialization::Thrift::Timestamp _currentDailyStopTime;
  ...
  void __set__defDailyStartTime(const  ::Cti::Messaging::Serialization::Thrift::Timestamp val) {
    _defDailyStartTime = val;
  }

  void __set__defDailyStopTime(const  ::Cti::Messaging::Serialization::Thrift::Timestamp val) {
  ...
  void __set__currentDailyStartTime(const  ::Cti::Messaging::Serialization::Thrift::Timestamp val) {
    _currentDailyStartTime = val;
  }

  void __set__currentDailyStopTime(const  ::Cti::Messaging::Serialization::Thrift::Timestamp val) {
...
class LMControlAreas {
 public:
  ...
  static const char* ascii_fingerprint; // = "B800B210CD90FAC3BF495689D662E534";
  static const uint8_t binary_fingerprint[16]; // = {0xB8,0x00,0xB2,0x10,0xCD,0x90,0xFA,0xC3,0xBF,0x49,0x56,0x89,0xD6,0x62,0xE5,0x34};
