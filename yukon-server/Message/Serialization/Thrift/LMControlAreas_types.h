...
class LMControlAreaTrigger : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LMControlAreaTrigger() noexcept;
  int32_t _paoId;
...
class LMProgramControlWindow : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMProgramControlWindow(const LMProgramControlWindow&) noexcept;
  LMProgramControlWindow& operator=(const LMProgramControlWindow&) noexcept;
  LMProgramControlWindow() noexcept
                         : _paoId(0),
                           _windowNumber(0),
  ...
  virtual ~LMProgramControlWindow() noexcept;
  int32_t _paoId;
 ...
 public:
  ...
  LMProgramBase() noexcept
                : _paoId(0),
                  ...
                  _reductionTotal(0),
                  _startedControlling(0),
                  _lastControlSent(0),
                  _manualControlReceivedFlag(0) {
  }

  virtual ~LMProgramBase() noexcept;
  int32_t _paoId;
...
class LMCICustomerBase : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LMCICustomerBase() noexcept;
  int32_t _customerId;
...
class LMCurtailCustomer : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LMCurtailCustomer() noexcept;
 ...
 public:
  ...
  LMProgramCurtailment() noexcept
                       : _minNotifyTime(0),
                         ...
                         _curtailReferenceId(0),
                         _actionDateTime(0),
                         _notificationDateTime(0),
                         _curtailmentStartTime(0),
                         _curtailmentStopTime(0),
                         _runStatus(),
                         _additionalInfo() {
  }

  virtual ~LMProgramCurtailment() noexcept;
...
class LMProgramDirectGear : public virtual ::apache::thrift::TBase {
 public:
  ...
  virtual ~LMProgramDirectGear() noexcept;
 ...
 public:
  ...
  LMGroupBase() noexcept
              : _paoId(0),
                ...
                _alarmInhibit(0),
                _controlInhibit(0),
                _groupControlState(0),
                _currentHoursDaily(0),
                _currentHoursMonthly(0),
                _currentHoursSeasonal(0),
                _currentHoursAnnually(0),
                _lastControlSent(0),
                _controlStartTime(0),
                _controlCompleteTime(0),
                _nextControlTime(0),
                _internalState(0),
                _dailyOps(0),
                _lastStopTimeSent(0) {
...
class LMGroupDigiSEP : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupDigiSEP() noexcept {
  }

  virtual ~LMGroupDigiSEP() noexcept;
...
class LMGroupEcobee : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupEcobee() noexcept {
  }

  virtual ~LMGroupEcobee() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupHoneywell : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupHoneywell() noexcept {
  }

  virtual ~LMGroupHoneywell() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupNest : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupNest() noexcept {
  }

  virtual ~LMGroupNest() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupItron : public virtual ::apache::thrift::TBase {
 public:

  LMGroupItron(const LMGroupItron&);
  LMGroupItron& operator=(const LMGroupItron&);
  LMGroupItron() noexcept {
  }

  virtual ~LMGroupItron() noexcept;
  LMGroupBase _baseMessage;

  void __set__baseMessage(const LMGroupBase& val);

  bool operator == (const LMGroupItron & rhs) const
  {
    if (!(_baseMessage == rhs._baseMessage))
      return false;
    return true;
  ...
  bool operator < (const LMGroupItron & ) const;
...
class LMGroupMeterDisconnect : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupMeterDisconnect() noexcept {
  }

  virtual ~LMGroupMeterDisconnect() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupEmetcon : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupEmetcon() noexcept {
  }

  virtual ~LMGroupEmetcon() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupExpresscom : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupExpresscom() noexcept {
  }

  virtual ~LMGroupExpresscom() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupGolay : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupGolay() noexcept {
  }

  virtual ~LMGroupGolay() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupMacro : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupMacro() noexcept {
  }

  virtual ~LMGroupMacro() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupPoint : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupPoint() noexcept {
  }

  virtual ~LMGroupPoint() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupRipple : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupRipple() noexcept
                : _shedTime(0) {
  }

  virtual ~LMGroupRipple() noexcept;
  LMGroupBase _baseMessage;
  int32_t _shedTime;
...
class LMGroupSA105 : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupSA105() noexcept {
  }

  virtual ~LMGroupSA105() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupSA205 : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupSA205() noexcept {
  }

  virtual ~LMGroupSA205() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupSA305 : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupSA305() noexcept {
  }

  virtual ~LMGroupSA305() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupSADigital : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupSADigital() noexcept {
  }

  virtual ~LMGroupSADigital() noexcept;
  LMGroupBase _baseMessage;
...
class LMGroupVersacom : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMGroupVersacom() noexcept {
  }

  virtual ~LMGroupVersacom() noexcept;
  LMGroupBase _baseMessage;
 ...
 public:
  ...
  LMProgramDirect() noexcept
                  : _currentGearNumber(0),
                    ...
                    _startedRampingOut(0),
                    _triggerOffset(0),
                    _triggerRestoreOffset(0),
                    _constraintOverride(0),
                    _originSource() {
  }

  virtual ~LMProgramDirect() noexcept;
  LMProgramBase _baseMessage;
...
class LMEnergyExchangeHourlyOffer : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEnergyExchangeHourlyOffer(const LMEnergyExchangeHourlyOffer&) noexcept;
  LMEnergyExchangeHourlyOffer& operator=(const LMEnergyExchangeHourlyOffer&) noexcept;
  LMEnergyExchangeHourlyOffer() noexcept
                              : _offerId(0),
                                _revisionNumber(0),
                                _hour(0),
                                _price(0),
  ...
  virtual ~LMEnergyExchangeHourlyOffer() noexcept;
  int32_t _offerId;
...
class LMEnergyExchangeOfferRevision : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEnergyExchangeOfferRevision() noexcept
                                : _offerId(0),
                                  _revisionNumber(0),
                                  _actionDatetime(0),
                                  _notificationDatetime(0),
                                  _offerexpirationDatetime(0),
                                  _additionalInfo() {
  }

  virtual ~LMEnergyExchangeOfferRevision() noexcept;
  int32_t _offerId;
  int32_t _revisionNumber;
   ::Cti::Messaging::Serialization::Thrift::Timestamp _actionDatetime;
   ::Cti::Messaging::Serialization::Thrift::Timestamp _notificationDatetime;
...
class LMEnergyExchangeOffer : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEnergyExchangeOffer() noexcept
                        : _paoId(0),
                          _offerId(0),
                          _runStatus(),
                          _offerDate(0) {
  ...
  virtual ~LMEnergyExchangeOffer() noexcept;
  int32_t _paoId;
  int32_t _offerId;
  std::string _runStatus;
...
class LMEnergyExchangeHourlyCustomer : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEnergyExchangeHourlyCustomer(const LMEnergyExchangeHourlyCustomer&) noexcept;
  LMEnergyExchangeHourlyCustomer& operator=(const LMEnergyExchangeHourlyCustomer&) noexcept;
  LMEnergyExchangeHourlyCustomer() noexcept
                                 : _customerId(0),
                                   _offerId(0),
                                   _revisionNumber(0),
                                   _hour(0),
  ...
  virtual ~LMEnergyExchangeHourlyCustomer() noexcept;
  int32_t _customerId;
  int32_t _offerId;
  int32_t _revisionNumber;
  int32_t _hour;
...
class LMEnergyExchangeCustomerReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEnergyExchangeCustomerReply() noexcept
                                : _customerId(0),
                                  _offerId(0),
                                  _acceptStatus(),
                                  _acceptDatetime(0),
  ...
  virtual ~LMEnergyExchangeCustomerReply() noexcept;
  int32_t _customerId;
  int32_t _offerId;
...
class LMEnergyExchangeCustomer : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEnergyExchangeCustomer() noexcept {
  }

  virtual ~LMEnergyExchangeCustomer() noexcept;
  LMCICustomerBase _baseMessage;
...
class LMProgramEnergyExchange : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMProgramEnergyExchange() noexcept
                          : _minNotifyTime(0),
                            _heading(),
                            _messageHeader(),
                            _messageFooter(),
  ...
  virtual ~LMProgramEnergyExchange() noexcept;
  LMProgramBase _baseMessage;
  int32_t _minNotifyTime;
  std::string _heading;
  std::string _messageHeader;
 ...
 public:
  ...
  LMControlAreaItem() noexcept
                    : _paoId(0),
                      ...
                      _defDailyStopTime(0),
                      _requireAllTriggersActiveFlag(0),
                      _nextCheckTime(0),
  ...
  virtual ~LMControlAreaItem() noexcept;
  int32_t _paoId;
  std::string _paoCategory;
  std::string _paoClass;
  std::string _paoName;
...
class LMControlAreas : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMControlAreas() noexcept
                 : _msgInfoBitMask(0) {
  }

  virtual ~LMControlAreas() noexcept;
