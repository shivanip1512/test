...
const char* CCItemCommand::ascii_fingerprint = "94C53A165871CC6EF3F40A8AFBACA498";
const uint8_t CCItemCommand::binary_fingerprint[16] = {0x94,0xC5,0x3A,0x16,0x58,0x71,0xCC,0x6E,0xF3,0xF4,0x0A,0x8A,0xFB,0xAC,0xA4,0x98};
