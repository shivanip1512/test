...
class LMEcobeeCycleControlCommand : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEcobeeCycleControlCommand(const LMEcobeeCycleControlCommand&) noexcept;
  LMEcobeeCycleControlCommand& operator=(const LMEcobeeCycleControlCommand&) noexcept;
  LMEcobeeCycleControlCommand() noexcept
                              : _programId(0),
                                _groupId(0),
                                _dutyCycle(0),
...
class LMEcobeeSetpointControlCommand : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEcobeeSetpointControlCommand(const LMEcobeeSetpointControlCommand&) noexcept;
  LMEcobeeSetpointControlCommand& operator=(const LMEcobeeSetpointControlCommand&) noexcept;
  LMEcobeeSetpointControlCommand() noexcept
                                 : _programId(0),
                                   _groupId(0),
                                   _controlStartDateTime(0),
                                   _controlEndDateTime(0),
                                   _temperatureOption(static_cast<LMEcobeeTemperatureTypes::type>(0)),
                                   _isMandatory(0),
...
class LMEcobeePlusControlCommand : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEcobeePlusControlCommand(const LMEcobeePlusControlCommand&) noexcept;
  LMEcobeePlusControlCommand& operator=(const LMEcobeePlusControlCommand&) noexcept;
  LMEcobeePlusControlCommand() noexcept
                             : _programId(0),
                               _groupId(0),
                               _controlStartDateTime(0),
                               _controlEndDateTime(0),
                               _temperatureOption(static_cast<LMEcobeeTemperatureTypes::type>(0)),
                               _randomTimeSeconds(0) {
  }
...
class LMEcobeeRestore : public virtual ::apache::thrift::TBase {
 public:
  ...
  LMEcobeeRestore(const LMEcobeeRestore&) noexcept;
  LMEcobeeRestore& operator=(const LMEcobeeRestore&) noexcept;
  LMEcobeeRestore() noexcept
                  : _groupId(0),
                    _restoreTime(0) {
  }
