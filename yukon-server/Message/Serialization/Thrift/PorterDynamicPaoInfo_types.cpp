...
const std::map<int, const char*> _DynamicPaoInfoDurationKeys_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kDynamicPaoInfoDurationKeysValues, _kDynamicPaoInfoDurationKeysNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _DynamicPaoInfoTimestampKeys_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(1, _kDynamicPaoInfoTimestampKeysValues, _kDynamicPaoInfoTimestampKeysNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _DynamicPaoInfoPercentageKeys_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(1, _kDynamicPaoInfoPercentageKeysValues, _kDynamicPaoInfoPercentageKeysNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
DynamicPaoInfoRequest::~DynamicPaoInfoRequest() noexcept {
}
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            for (_i4 = 0; _i4 < _size0; ++_i4)
            {
              ...
              _elem5 = static_cast<DynamicPaoInfoDurationKeys::type>(ecast6);
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            for (_i11 = 0; _i11 < _size7; ++_i11)
            {
              ...
              _elem12 = static_cast<DynamicPaoInfoTimestampKeys::type>(ecast13);
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            for (_i18 = 0; _i18 < _size14; ++_i18)
            {
              ...
              _elem19 = static_cast<DynamicPaoInfoPercentageKeys::type>(ecast20);
...
uint32_t DynamicPaoInfoRequest::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("_durationKeys", ::apache::thrift::protocol::T_SET, 2);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter21)));
    }
  ...
  xfer += oprot->writeFieldBegin("_timestampKeys", ::apache::thrift::protocol::T_SET, 3);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>((*_iter22)));
    }
    xfer += oprot->writeSetEnd();
  }
  xfer += oprot->writeFieldEnd();
...
DynamicPaoInfoResponse::~DynamicPaoInfoResponse() noexcept {
}
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i30 = 0; _i30 < _size26; ++_i30)
            {
              ...
              _key31 = static_cast<DynamicPaoInfoDurationKeys::type>(ecast33);
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i38 = 0; _i38 < _size34; ++_i38)
            {
              ...
              _key39 = static_cast<DynamicPaoInfoTimestampKeys::type>(ecast41);
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i46 = 0; _i46 < _size42; ++_i46)
            {
              ...
              _key47 = static_cast<DynamicPaoInfoPercentageKeys::type>(ecast49);
...
uint32_t DynamicPaoInfoResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("_durationValues", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter50->first));
  ...
  xfer += oprot->writeFieldBegin("_timestampValues", ::apache::thrift::protocol::T_MAP, 3);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter51->first));
  ...
  xfer += oprot->writeFieldBegin("_percentageValues", ::apache::thrift::protocol::T_MAP, 4);
  {
    ...
    {
      xfer += oprot->writeI32(static_cast<int32_t>(_iter52->first));
