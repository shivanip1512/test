...
const char* QueueData::ascii_fingerprint = "E1B099B9CBD6C096D77302BA258A2D57";
const uint8_t QueueData::binary_fingerprint[16] = {0xE1,0xB0,0x99,0xB9,0xCB,0xD6,0xC0,0x96,0xD7,0x73,0x02,0xBA,0x25,0x8A,0x2D,0x57};
