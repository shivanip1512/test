...
const std::map<int, const char*> _EdgeBroadcastMessagePriority_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kEdgeBroadcastMessagePriorityValues, _kEdgeBroadcastMessagePriorityNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->priority = static_cast<EdgeBroadcastMessagePriority::type>(ecast0);
