...
class RfnDataStreamingUpdate : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnDataStreamingUpdate() noexcept
                         : paoId(0),
                           json() {
  }
...
class RfnDataStreamingUpdateReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnDataStreamingUpdateReply(const RfnDataStreamingUpdateReply&) noexcept;
  RfnDataStreamingUpdateReply& operator=(const RfnDataStreamingUpdateReply&) noexcept;
  RfnDataStreamingUpdateReply() noexcept
                              : success(0) {
  }
