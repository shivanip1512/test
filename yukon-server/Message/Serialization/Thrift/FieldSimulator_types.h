...
class FieldSimulatorSettings : public virtual ::apache::thrift::TBase {
 public:
  ...
  FieldSimulatorSettings() noexcept
                         : _deviceGroup(),
                           _deviceConfigFailureRate(0) {
  }
...
class FieldSimulatorStatusRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  FieldSimulatorStatusRequest(const FieldSimulatorStatusRequest&) noexcept;
  FieldSimulatorStatusRequest& operator=(const FieldSimulatorStatusRequest&) noexcept;
  FieldSimulatorStatusRequest() noexcept {
  }
...
class FieldSimulatorStatusResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  FieldSimulatorStatusResponse() noexcept {
  }
...
class FieldSimulatorConfigurationRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  FieldSimulatorConfigurationRequest() noexcept {
  }
...
class FieldSimulatorConfigurationResponse : public virtual ::apache::thrift::TBase {
 public:
  ...
  FieldSimulatorConfigurationResponse() noexcept
                                      : _success(0) {
  }
