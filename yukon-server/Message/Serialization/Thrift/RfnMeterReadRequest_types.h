...
class RfnMeterReadReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnMeterReadReply(const RfnMeterReadReply&);
  RfnMeterReadReply& operator=(const RfnMeterReadReply&);
  RfnMeterReadReply() : replyType((RfnMeterReadingReplyType::type)0) {
  }
...
class ChannelData : public virtual ::apache::thrift::TBase {
 public:
  ...
  ChannelData() : channelNumber(0), status((ChannelDataStatus::type)0), unitOfMeasure(), value(0) {
  }
...
class RfnMeterReadingData : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnMeterReadingData() : timeStamp(0), recordInterval(0) {
  }
...
class RfnMeterReadDataReply : public virtual ::apache::thrift::TBase {
 public:
  ...
  RfnMeterReadDataReply() : replyType((RfnMeterReadingDataReplyType::type)0) {
  }
