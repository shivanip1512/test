...
const char* CCObjectMove::ascii_fingerprint = "FB3360CB613BBC42D2DDBC5F23D09D01";
const uint8_t CCObjectMove::binary_fingerprint[16] = {0xFB,0x33,0x60,0xCB,0x61,0x3B,0xBC,0x42,0xD2,0xDD,0xBC,0x5F,0x23,0xD0,0x9D,0x01};
