...
/* StoreQueue casts queue into a CtiCountedPCPtrQueue<RWCollectable>*
   and creates a RWCountedPointer< CtiCountedPCPtrQueue<RWCollectable> > and stores
   it according to threadid - until ReleaseQueue is called for the same thread
   any output generated by the extensions declared here will be put onto the
   a stored queue. Would a c++ interface be better? */
