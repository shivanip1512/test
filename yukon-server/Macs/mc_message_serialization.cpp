...
struct MCMessageFactoryRegister
{
    MCMessageFactoryRegister()
    {
        ...
        g_messageFactory.registerSerializer <::CtiMCVerifyScript,     Thrift::MCVerifyScript>     ( &serialize, &deserialize, "MCVerifyScript" );
...
{
    MessagePtr<Thrift::MCVerifyScript>::type omsg( new Thrift::MCVerifyScript );
...
{
    MessagePtr<::CtiMCVerifyScript>::type omsg( new ::CtiMCVerifyScript );
