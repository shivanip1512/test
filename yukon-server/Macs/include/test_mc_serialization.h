...
struct TestCase<CtiMCSchedule> : public TestCase<CtiMessage>
{
    ...
    void Populate()
    {
        ...
        imsg.setStartDay          ( GenerateRandom( _startDay,      0, 32               ));
        imsg.setStartMonth        ( GenerateRandom( _startMonth                         ));
        imsg.setStartYear         ( GenerateRandom( _startYear                          ));
        imsg.setStartTime         ( GenerateRandom( _startTime,     8, 9                ));
        imsg.setStopTime          ( GenerateRandom( _stopTime,      8, 9                ));
        imsg.setValidWeekDays     ( GenerateRandom( _validWeekDays, 8, 9                ));
...
template<>
struct TestCase<CtiMCVerifyScript> : public TestCase<CtiMessage>
{
    void Create()
    {
        _imsg.reset( new CtiMCVerifyScript );
        _omsg.reset( new CtiMCVerifyScript );
    }
    ...
    void Populate()
    {
        ...
        CtiMCVerifyScript &imsg = dynamic_cast<CtiMCVerifyScript&>(*_imsg);
    ...
    void Compare()
    {
        ...
        CtiMCVerifyScript &imsg = dynamic_cast<CtiMCVerifyScript&>(*_imsg),
                          &omsg = dynamic_cast<CtiMCVerifyScript&>(*_omsg);
...
struct TestCase<CtiMCOverrideRequest> : public TestCase<CtiMessage>
{
    ...
    void Populate()
    {
        ...
        GenerateRandom( (int&)imsg._action, 0, 6 );
        GenerateRandom( imsg._id );
