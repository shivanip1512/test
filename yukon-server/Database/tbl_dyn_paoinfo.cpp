...
const CtiTableDynamicPaoInfo::key_map_t   CtiTableDynamicPaoInfo::_key_map =
    boost::assign::map_list_of
        ...
        (Key_RFN_SundaySchedule,     "rfn sunday schedule")
        (Key_RFN_HolidaySchedule,    "rfn holiday schedule")

        (Key_RFN_DefaultTOURate,     "rfn default tou rate")

        (Key_RFN_Schedule1Rate0,     "rfn schedule 1 rate 0")
        (Key_RFN_Schedule1Time1,     "rfn schedule 1 time 1")
        (Key_RFN_Schedule1Rate1,     "rfn schedule 1 rate 1")
        (Key_RFN_Schedule1Time2,     "rfn schedule 1 time 2")
        (Key_RFN_Schedule1Rate2,     "rfn schedule 1 rate 2")
        (Key_RFN_Schedule1Time3,     "rfn schedule 1 time 3")
        (Key_RFN_Schedule1Rate3,     "rfn schedule 1 rate 3")
        (Key_RFN_Schedule1Time4,     "rfn schedule 1 time 4")
        (Key_RFN_Schedule1Rate4,     "rfn schedule 1 rate 4")
        (Key_RFN_Schedule1Time5,     "rfn schedule 1 time 5")
        (Key_RFN_Schedule1Rate5,     "rfn schedule 1 rate 5")

        (Key_RFN_Schedule2Rate0,     "rfn schedule 2 rate 0")
        (Key_RFN_Schedule2Time1,     "rfn schedule 2 time 1")
        (Key_RFN_Schedule2Rate1,     "rfn schedule 2 rate 1")
        (Key_RFN_Schedule2Time2,     "rfn schedule 2 time 2")
        (Key_RFN_Schedule2Rate2,     "rfn schedule 2 rate 2")
        (Key_RFN_Schedule2Time3,     "rfn schedule 2 time 3")
        (Key_RFN_Schedule2Rate3,     "rfn schedule 2 rate 3")
        (Key_RFN_Schedule2Time4,     "rfn schedule 2 time 4")
        (Key_RFN_Schedule2Rate4,     "rfn schedule 2 rate 4")
        (Key_RFN_Schedule2Time5,     "rfn schedule 2 time 5")
        (Key_RFN_Schedule2Rate5,     "rfn schedule 2 rate 5")

        (Key_RFN_Schedule3Rate0,     "rfn schedule 3 rate 0")
        (Key_RFN_Schedule3Time1,     "rfn schedule 3 time 1")
        (Key_RFN_Schedule3Rate1,     "rfn schedule 3 rate 1")
        (Key_RFN_Schedule3Time2,     "rfn schedule 3 time 2")
        (Key_RFN_Schedule3Rate2,     "rfn schedule 3 rate 2")
        (Key_RFN_Schedule3Time3,     "rfn schedule 3 time 3")
        (Key_RFN_Schedule3Rate3,     "rfn schedule 3 rate 3")
        (Key_RFN_Schedule3Time4,     "rfn schedule 3 time 4")
        (Key_RFN_Schedule3Rate4,     "rfn schedule 3 rate 4")
        (Key_RFN_Schedule3Time5,     "rfn schedule 3 time 5")
        (Key_RFN_Schedule3Rate5,     "rfn schedule 3 rate 5")

        (Key_RFN_Schedule4Rate0,     "rfn schedule 4 rate 0")
        (Key_RFN_Schedule4Time1,     "rfn schedule 4 time 1")
        (Key_RFN_Schedule4Rate1,     "rfn schedule 4 rate 1")
        (Key_RFN_Schedule4Time2,     "rfn schedule 4 time 2")
        (Key_RFN_Schedule4Rate2,     "rfn schedule 4 rate 2")
        (Key_RFN_Schedule4Time3,     "rfn schedule 4 time 3")
        (Key_RFN_Schedule4Rate3,     "rfn schedule 4 rate 3")
        (Key_RFN_Schedule4Time4,     "rfn schedule 4 time 4")
        (Key_RFN_Schedule4Rate4,     "rfn schedule 4 rate 4")
        (Key_RFN_Schedule4Time5,     "rfn schedule 4 time 5")
        (Key_RFN_Schedule4Rate5,     "rfn schedule 4 rate 5")
        ...
        (Key_RFN_ConnectDelay,              "rfn connect delay")
        (Key_RFN_MaxDisconnects,            "rfn max disconnects")
        (Key_RFN_DisconnectMinutes,         "rfn disconnect minutes")
        (Key_RFN_ConnectMinutes,            "rfn connect minutes")   
        ;
