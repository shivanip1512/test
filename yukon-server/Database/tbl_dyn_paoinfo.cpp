...
const auto KeyNames = Cti::make_bimap<Dpi::PaoInfoKeys, std::string>
( {
    ...
    { Dpi::Key_RFN_ChannelConfigFiltered,    "rfn channel config filtered" }
} );

typedef CtiTableDynamicPaoInfoIndexed DpiIndexed;

//  !!!  Any changes to these strings will require a DB update - this is what the DB keys on  !!!
const auto KeyNamesIndexed = Cti::make_bimap<DpiIndexed::PaoInfoKeysIndexed, std::string>
( {
