...
const CtiTableDynamicPaoInfo::key_map_t   CtiTableDynamicPaoInfo::_key_map =
    boost::assign::map_list_of
        ...
        (Key_RFN_Schedule1MidnightRate,     "rfn schedule 1 midnight rate")
        ...
        (Key_RFN_Schedule2MidnightRate,     "rfn schedule 2 midnight rate")
        ...
        (Key_RFN_Schedule3MidnightRate,     "rfn schedule 3 midnight rate")
        ...
        (Key_RFN_Schedule4MidnightRate,     "rfn schedule 4 midnight rate")
