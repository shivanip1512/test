...
BOOST_AUTO_TEST_CASE(test_getKeyString)
{
    ...
    const test_cases[] =
    {
        ...
        { CtiTableDynamicPaoInfo::Key_RFN_Schedule1Rate0,                    "rfn schedule 1 midnight rate" },
        ...
        { CtiTableDynamicPaoInfo::Key_RFN_Schedule2Rate0,                    "rfn schedule 2 midnight rate" },
        ...
        { CtiTableDynamicPaoInfo::Key_RFN_Schedule3Rate0,                    "rfn schedule 3 midnight rate" },
        ...
        { CtiTableDynamicPaoInfo::Key_RFN_Schedule4Rate0,                    "rfn schedule 4 midnight rate" },
