...
BOOST_AUTO_TEST_CASE(test_getKeyString)
{
    ...
    const test_cases[] =
    {
        ...
        { CtiTableDynamicPaoInfo::Key_MCT_Holiday2,                                 "mct holiday 3" },
        { CtiTableDynamicPaoInfo::Key_MCT_Holiday3,                                 "mct holiday 2" },
        ...
        { CtiTableDynamicPaoInfo::Key_MCT_LoadProfilePeakReportTimestamp,           "mct load profile peak report timestamp" },
        ...
        { CtiTableDynamicPaoInfo::Key_FMU_SoftSpecLSB,                              "" },
        { CtiTableDynamicPaoInfo::Key_FMU_SoftSpecMSB,                              "" },
        { CtiTableDynamicPaoInfo::Key_FMU_Revision,                                 "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataTransferCommsType,                    "" },
        { CtiTableDynamicPaoInfo::Key_FMU_SerialNo,                                 "" },
        { CtiTableDynamicPaoInfo::Key_FMU_ValidMessageType,                         "" },
        { CtiTableDynamicPaoInfo::Key_FMU_MonitorCommsType,                         "" },
        { CtiTableDynamicPaoInfo::Key_FMU_AttachedDeviceBaud,                       "" },
        { CtiTableDynamicPaoInfo::Key_FMU_AttachedDeviceProtocol,                   "" },
        { CtiTableDynamicPaoInfo::Key_FMU_AttachedDeviceRSSIAddress,                "" },
        { CtiTableDynamicPaoInfo::Key_FMU_AttachedDeviceFlexCodeSet,                "" },
        { CtiTableDynamicPaoInfo::Key_FMU_BluetoothSettings,                        "" },
        { CtiTableDynamicPaoInfo::Key_FMU_BluetoothPin,                             "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogBufferWrapped,                     "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogIndex,                             "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogMaxIndex,                          "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogEntries,                           "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogNumberUnreported,                  "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogStartIndex,                        "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataLogLastReportedIndex,                 "" },
        { CtiTableDynamicPaoInfo::Key_FMU_DataTransferPortSelectCommConfig,         "" },
        { CtiTableDynamicPaoInfo::Key_FMU_MonitorPortSelectCommConfig,              "" },
