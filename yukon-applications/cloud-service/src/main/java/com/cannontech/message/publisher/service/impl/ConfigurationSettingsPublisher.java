 ...
 */
@Service
public class ConfigurationSettingsPublisher extends PublisherBase {
    Logger log = (Logger) LogManager.getLogger(ConfigurationSettingsPublisher.class);
    ...
    public void publishMessage() {
        ...
        while (!requestSendSuccessfully) {
            try {
                ...
                log.error("Interrupted when waiting for sending request for configuration settings " + e);
            }
