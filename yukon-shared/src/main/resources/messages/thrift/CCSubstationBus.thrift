...
struct CCFeeder {
   ...
   20: required     Types.Timestamp                 _lastOperationTime;
...
struct CCSubstationBusItem {
   ...
   14: required     Types.Timestamp                 _lastCurrentVarPointUpdateTime;
   15: required     i32                             _estimatedVarLoadPointId;
   16: required     double                          _estimatedVarLoadPointValue;
   ...
   23: required     Types.Timestamp                 _lastOperationTime;
