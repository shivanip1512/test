...
public class AutomationSetup {
		...
		public static void setBasicConfiguration()throws IOException{
			...
			//Log4j configuration
			basicConfiguration.setlog4jPath(System.getProperty("user.dir")+ File.separatorChar + "configs" + File.separatorChar +"log4j2.properties");
			...
			basicConfiguration.setconfigPropertyFilePath(System.getProperty("user.dir")+ File.separatorChar + "configs" + File.separatorChar + "configuration.properties");
			basicConfiguration.setEndpoint(
					ReadPropertyFile.getPropertyValue("baseURI", basicConfiguration.getconfigPropertyFilePath()));
			String updatedValue=ReadPropertyFile.updateProperty("testLogPath", testLog , basicConfiguration.getconfigPropertyFilePath());
	       	String updatedValue2=ReadPropertyFile.updateProperty("log4j.appender.fileAppender.File", testLog , log4jPath);
