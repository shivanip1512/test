...
public class CalcAnalogPointApiDoc extends PointApiDocBase {
    ...
    @Test(dependsOnMethods = { "Test_CalcAnalogPoint_01_Create" })
    public void Test_CalcAnalogPoint_02_Update() {
        pointId = updatePartialDoc();
    }

    @Test(dependsOnMethods = { "Test_CalcAnalogPoint_01_Create" })
    public void Test_CalcAnalogPoint_03_Get() {
        getDoc();
    }
    
    @Test(dependsOnMethods = { "Test_CalcAnalogPoint_02_Update" })
    public void Test_CalcAnalogPoint_04_Copy() {
        copyPointId = copyDoc();
    }

    @Test(dependsOnMethods = { "Test_CalcAnalogPoint_04_Copy" })
    public void Test_CalcAnalogPoint_05_Delete() {
        deleteDoc();
    ...
    protected MockPointType getMockPointType() {
        return MockPointType.CalcAnalog;
    }

    @Override
    protected List<FieldDescriptor> getFieldDescriptors() {
        return buildCalcAnalogPointDescriptor();
    }
