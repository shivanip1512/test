...
public class LoadGroupHoneywellAPITest {
	 ...
	 */
	@Test(dependsOnMethods = "loadGroupHoneywell_01_Create")
	public void loadGroupHoneywell_08_CopyWithInvalidRouteId(ITestContext context) {

		MockLoadGroupCopy loadGroupCopy = MockLoadGroupCopy.builder()
				.name(LoadGroupHelper.getCopiedLoadGroupName(MockPaoType.LM_GROUP_HONEYWELL)).build();
