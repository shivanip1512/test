...
public class EcobeeCycleGearValidationAPITest {
    ...
    public void gearValidation_03_ControlPercentLessThanMinValue() {
        ...
        mockLoadProgram = buildMockLoadProgram();
        MockEcobeeCycleGearFields mockEcobeeCycleGearFields = (MockEcobeeCycleGearFields) mockLoadProgram.getGears()
                .get(0).getFields();

        mockEcobeeCycleGearFields.setControlPercent(-2);
        ...
        assertTrue(ValidationHelper.validateFieldError(createResponse, "gears[0].fields.controlPercent",
                "Must be between 5 and 100."), "Expected Error not found: Must be between 5 and 100.");
    }
    ...
    public void gearValidation_04_ControlPercentGreaterThanMaxValue() {
        ...
        mockEcobeeCycleGearFields.setControlPercent(101);
    ...
    public void gearValidation_05_BlankMandatory() {
        ...
        mockEcobeeCycleGearFields.setMandatory(null);
    ...
    public void gearValidation_06_CapacityReductionLessThanMinValue() {
        ...
        mockEcobeeCycleGearFields.setCapacityReduction(-2);
    ...
    public void gearValidation_07_CapacityReductionGreaterThanMaxValue() {
        ...
        mockEcobeeCycleGearFields.setCapacityReduction(101);
    ...
    public void gearValidation_08_WhenToChangeFieldAsBlank() {
        ...
        mockEcobeeCycleGearFields.setWhenToChangeFields(null);
    ...
    public void gearValidation_09_WhenToChangePriorityLessThanMinValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.Priority);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setChangePriority(-1);
    ...
    public void gearValidation_10_WhenToChangePriorityGreaterThanMaxValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.Priority);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setChangePriority(100000);
    ...
    public void gearValidation_11_DurationInMinutesLessThanMinValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.Duration);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setChangeDurationInMinutes(-1);
    ...
    public void gearValidation_12_ChangeDurationInMinutesGreaterThanMaxValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.Duration);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setChangeDurationInMinutes(100000);
    ...
    public void gearValidation_13_TriggerNumberAndOffsetAsBlank() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.TriggerOffset);
    ...
    public void gearValidation_14_TriggerNumberLessThanMinValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.TriggerOffset);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setTriggerNumber(0);
    ...
    public void gearValidation_15_TriggerNumberGreaterThanMaxValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.TriggerOffset);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setTriggerNumber(100000);
    ...
    public void gearValidation_16_TriggerOffsetLessThanMinValue() {
        ...
        mockEcobeeCycleGearFields.getWhenToChangeFields().setWhenToChange(MockWhenToChange.TriggerOffset);
        mockEcobeeCycleGearFields.getWhenToChangeFields().setTriggerOffset(-100005.000000);
