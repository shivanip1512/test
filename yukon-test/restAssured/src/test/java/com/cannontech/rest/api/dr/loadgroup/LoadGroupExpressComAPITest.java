...
public class LoadGroupExpressComAPITest {
    ...
    public void loadGroupExpresscom_06_PhysicalAddressValidation(String splinter, String geoId, String subId, String zip, String user,
        ...
        loadGroup.setSplinter(Integer.valueOf(splinter));
