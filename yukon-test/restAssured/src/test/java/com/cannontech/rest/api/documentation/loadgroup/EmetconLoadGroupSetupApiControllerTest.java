...
public class EmetconLoadGroupSetupApiControllerTest extends LoadGroupApiDocBase {
    ...
    public void Test_LmEmetcon_Delete() {
        ...
        LoadGroupHelper.deleteLoadGroup(LoadGroupHelper.getCopiedLoadGroupName(MockPaoType.LM_GROUP_EMETCON), copyPaoId);
    }
