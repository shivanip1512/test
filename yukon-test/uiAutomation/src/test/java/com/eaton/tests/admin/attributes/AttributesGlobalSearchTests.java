...
public class AttributesGlobalSearchTests extends SeleniumTestSetup {
    ...
    @Test(groups = { TestConstants.Priority.HIGH, TestConstants.Features.ATTRIBUTES })
    public void attributesGlobalSearch_SearchAttributesAndEnter_NavigatesToSearchPage() {
        globalSearchPage.getSearchBoxElement().setSearchValueAndEnter("Attributes");
        
        boolean pageLoaded = waitForUrlToLoad(Urls.SEARCH + Urls.SEARCH_PARAM + "Attributes", Optional.empty());
    ...
    public void attributesGlobalSearch_SearchAndSelectAttributResult_NavigatesToAttributesListPage() {
        globalSearchPage.getSearchBoxElement().setSearchValueAndClickResult("Attributes");
        
        boolean pageLoaded = waitForUrlToLoad(Urls.Admin.ATTRIBUTES_LIST, Optional.empty());
    ...
    public void attributesGlobalSearch_SearchCommResults_ContainsCommChannel() {
        ...
        searchBox.setSearchValue("Attributes");
        List<String> results = searchBox.getSearchResults();
        
        assertThat(results).contains("Attributes");
    }        
}