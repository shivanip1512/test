...
public class MeterWRL420cLDeleteTests extends SeleniumTestSetup {
    ...
    public void meterWRL420cLDetail_deleteSuccess() {
        final int DEVICEID = 1233;
    	final String EXPECTED_MSG = "Meter AT Delete " + MeterConstants.WRL420CL.getMeterType() + " deleted successfully.";
