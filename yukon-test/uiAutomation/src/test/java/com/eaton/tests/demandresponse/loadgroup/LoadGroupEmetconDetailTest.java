...
//        softly.assertThat(sectionValues.get(2).toUpperCase())
//                .isEqualTo(getResponse.path("LM_GROUP_EMETCON.addressUsage").toString() + " " + "ADDRESS");
//        softly.assertThat("RELAY_" + sectionValues.get(3).toUpperCase())
//                .isEqualTo(getResponse.path("LM_GROUP_EMETCON.relayUsage").toString());
//
//        softly.assertAll();
//    }
}