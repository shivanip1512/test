...
public class CommChannelUdpEditTests extends SeleniumTestSetup {
    ...
    public void commChannelUdpEdit_InfoFieldsValuesCorrect() {											
        ...
        softly.assertThat(editModal.getPortNumber().getInputValue()).isEqualTo("5889");											
    ...
    public void commChannelUdpEdit_ConfigurationFieldsValuesCorrect() {	
        ...
        softly.assertThat(editModal.getCarrierDetectWait().getInputValue()).isEqualTo("544");	
        softly.assertThat(editModal.getEncryptionKey().getInputValue()).isEqualTo("00112233445566778899aabbccddeeff");	
