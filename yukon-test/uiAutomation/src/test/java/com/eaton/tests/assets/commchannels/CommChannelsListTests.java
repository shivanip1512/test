...
public class CommChannelsListTests extends SeleniumTestSetup{
    ...
    public void beforeClass() {
        ...
        names = listPage.getTable().getDataRowsTextByCellIndex(0);
        types = listPage.getTable().getDataRowsTextByCellIndex(1);
        statuses = listPage.getTable().getDataRowsTextByCellIndex(2);
}      
    ...
    public void commChannelList_SortNamesAscCorrectly() {                        
        ...
        List<String> namesList = listPage.getTable().getDataRowsTextByCellIndex(0);
    ...
    public void commChannelList_SortTypesAscCorrectly() {                
        ...
        List<String> typesList = listPage.getTable().getDataRowsTextByCellIndex(1);
