...
public class EditAttributeAssignmentTests extends SeleniumTestSetup {
    ...
    public void editAttributeAssignment_AttrNameDeviceType_Validation() {
        ...
        assertThat(page.getAttrAsgmtErrorMsg()).isEqualTo("There was an error assigning Attribute: " + attrName + " to the following device types: " + dtValue.toUpperCase() + ". Please see logs for more detail.");
    }
}
