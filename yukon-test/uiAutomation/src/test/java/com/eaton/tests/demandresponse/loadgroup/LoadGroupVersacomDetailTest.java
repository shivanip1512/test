	...
	private DriverExtensions driverExt;
	 ...
	 @Test(groups = {TestConstants.Priority.HIGH, TestConstants.DemandResponse.DEMAND_RESPONSE})
	    ...
	    public void ldGrpVersacomDetail_AssertValues_Success() {
	        ...
	        String addressUsageElement1 = addressUsageRespenseElement1.substring(0, 1).toUpperCase() + addressUsageRespenseElement1.substring(1).toLowerCase();
	        String addressUsageRespenseElement2 = getResponse.path("LM_GROUP_VERSACOM.addressUsage[1]").toString();
	        String addressUsageElement2 = addressUsageRespenseElement2.substring(0, 1).toUpperCase() + addressUsageRespenseElement2.substring(1).toLowerCase();
