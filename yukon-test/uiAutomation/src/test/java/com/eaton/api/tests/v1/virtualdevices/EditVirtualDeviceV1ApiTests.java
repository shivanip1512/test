...
public class EditVirtualDeviceV1ApiTests {
	...
	public void editVirtualDeviceApi_AllFields_200Success() {
	...
	public void editVirtualDeviceApi_NoName_422Unprocessable() {
		JSONObject request = new VirtualDeviceCreateBuilder.Builder(Optional.of("")).build();

		ExtractableResponse<?> response = ApiCallHelper.patch(APIs.VirtualDevice.UPDATE_VIRTUALDEVICE + virDevId,
				request.toString());
	...
	public void editVirtualDeviceApi_DuplicateName_422Unprocessable() {
		...
		new VirtualDeviceCreateBuilder.Builder(Optional.of(name)).create();
	...
	@Test(groups = { TestConstants.Priority.CRITICAL, TestConstants.API, TestConstants.Features.ASSETS,
			TestConstants.Features.VIRTUAL_DEVICES })
	public void editVirtualDeviceApi_InvalidVirDevicerId_400BadRequest() {
		String invalidId = faker.number().digits(2) + "$" + "S";

		JSONObject request = new VirtualDeviceCreateBuilder.Builder(Optional.of(virDevName))
				.build();

		ExtractableResponse<?> response = ApiCallHelper.patch(APIs.VirtualDevice.UPDATE_VIRTUALDEVICE + invalidId,
				request.toString());
	...
	public void editVirtualDeviceApi_EmptyId_404NotFound() {
		...
		ExtractableResponse<?> response = ApiCallHelper.patch(APIs.VirtualDevice.UPDATE_VIRTUALDEVICE,
				request.toString());
