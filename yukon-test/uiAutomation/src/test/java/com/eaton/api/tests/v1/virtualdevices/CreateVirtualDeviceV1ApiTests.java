...
public class CreateVirtualDeviceV1ApiTests {
	...
	public void createVirtualDeviceApi_NoName_422Unprocessable() {
		...
		ExtractableResponse<?> createResponse = ApiCallHelper.post(APIs.VirtualDevice.CREATE_VIRTUALDEVICE,
				request.toString());
	...
	public void createVirtualDeviceApi_MissingName_422Unprocessable() {
		JSONObject request = new VirtualDeviceCreateBuilder.Builder(Optional.of(faker.lorem().characters(8)))
				.build();
