...
public class RFN420cLMeterDetailsPage extends PageBase {
	
	private Panels panels;

    public RFN420cLMeterDetailsPage(DriverExtensions driverExt, int id) {
        super(driverExt);
    ...
    public RFN420cLMeterDetailsPage(DriverExtensions driverExt) {
        super(driverExt);
    }
