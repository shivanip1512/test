...
public class MCT420cLMeterDetailsPage extends PageBase {
	
	private Panels panels;

    public MCT420cLMeterDetailsPage(DriverExtensions driverExt, int id) {
        super(driverExt);
    ...
    public MCT420cLMeterDetailsPage(DriverExtensions driverExt) {
        super(driverExt);
    }
