...
public class PulseAccumulatorPointCreateBuilder {

	public static class Builder {
        private Faker faker = new Faker();

        private static final String POINTTYPE = "PulseAccumulator";
        ...
        public Builder(Optional<String> pointName) {
            ...
            this.pointName = pointName.orElse("Pulse Accumulator Point " + uuid);
        }
