...
public class DemandAccumulatorPointCreateBuilder {

	public static class Builder {
        private Faker faker = new Faker();

        private static final String POINTTYPE = "DemandAccumulator";
        ...
        public Builder(Optional<String> pointName) {
            ...
            this.pointName = pointName.orElse("Demand Accumulator Point " + uuid);
        }
