...
public class EcobeeCycleGearBuilder {

    public static class Builder {

        private Faker faker = new Faker();
        private static final String GEAR_TYPE = GearEnums.GearType.EcobeeCycle.getGearType();
    ...
    public static Builder gearBuilder() {
        ...
        return new EcobeeCycleGearBuilder.Builder(Optional.empty()).withGearNumber(Optional.empty())
