...
public class LoadGroupHoneywellCreateBuilder {
    
    public static class Builder {
        private Faker faker = new Faker();
        
        private static final String TYPE = "LM_GROUP_HONEYWELL";
        private String name;
    ...
    public static Builder buildLoadGroup() {
        return new LoadGroupHoneywellCreateBuilder.Builder(Optional.empty())
