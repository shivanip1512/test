...
public class CommChannelTiming {
    ...
    public CommChannelTiming(Integer preTxWait, Integer rtsToTxWait, Integer postTxWait, Integer receiveDataWait, Integer extraTimeOut) {
