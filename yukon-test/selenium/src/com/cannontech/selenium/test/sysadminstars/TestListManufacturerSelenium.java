 ...
 * @author Kevin Krile
 */
public class TestListManufacturerSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListManufacturerSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Manufacturer");
