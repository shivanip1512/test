 ...
 * @author Kevin Krile
 */
public class TestListFuelTypeSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListFuelTypeSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Fuel Type");
