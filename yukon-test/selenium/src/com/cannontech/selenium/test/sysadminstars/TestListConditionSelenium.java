 ...
 * @author Kevin Krile
 */
public class TestListConditionSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListConditionSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("General Condition");
