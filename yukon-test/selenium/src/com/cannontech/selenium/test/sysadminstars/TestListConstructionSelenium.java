 ...
 * @author Kevin Krile
 */
public class TestListConstructionSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListConstructionSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Construction Material");
