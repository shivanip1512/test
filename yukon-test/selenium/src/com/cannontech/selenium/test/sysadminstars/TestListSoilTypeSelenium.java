 ...
 * @author Kevin Krile
 */
public class TestListSoilTypeSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListSoilTypeSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Soil Type");
