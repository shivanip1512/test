 ...
 * @author Kevin Krile
 */
public class TestListMeterVoltageSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListMeterVoltageSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Meter Voltage");
