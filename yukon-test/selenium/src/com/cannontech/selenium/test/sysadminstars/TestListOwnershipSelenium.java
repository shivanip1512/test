 ...
 * @author Kevin Krile
 */
public class TestListOwnershipSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListOwnershipSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Ownership Type");
