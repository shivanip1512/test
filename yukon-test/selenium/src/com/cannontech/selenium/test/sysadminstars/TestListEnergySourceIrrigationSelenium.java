 ...
 * @author Kevin Krile
 */
public class TestListEnergySourceIrrigationSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListEnergySourceIrrigationSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		stars.clickLinkByHeaderName("Appliance - Irrigation", "Energy Source");
