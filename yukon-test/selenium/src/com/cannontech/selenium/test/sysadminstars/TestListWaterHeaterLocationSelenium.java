 ...
 * @author Kevin Krile
 */
public class TestListWaterHeaterLocationSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListWaterHeaterLocationSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		stars.clickLinkByHeaderName("Appliance - Water Heater", "Location");
