 ...
 * @author Kevin Krile
 */
public class TestListHorsePowerSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListHorsePowerSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Horse Power");
		...
		Assert.assertEquals(true, common.isTextPresent("This list has been updated."));
		for(int i=0;i<add.length;i++)
