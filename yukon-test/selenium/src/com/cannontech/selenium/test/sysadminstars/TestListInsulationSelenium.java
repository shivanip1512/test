 ...
 * @author Kevin Krile
 */
public class TestListInsulationSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListInsulationSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Insulation Depth");
