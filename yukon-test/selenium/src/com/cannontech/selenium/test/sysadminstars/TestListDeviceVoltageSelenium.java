 ...
 * @author Kevin Krile
 */
public class TestListDeviceVoltageSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListDeviceVoltageSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Device Voltage");
