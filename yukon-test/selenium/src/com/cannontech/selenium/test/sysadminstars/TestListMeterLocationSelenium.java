 ...
 * @author Kevin Krile
 */
public class TestListMeterLocationSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListMeterLocationSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Meter Location");
