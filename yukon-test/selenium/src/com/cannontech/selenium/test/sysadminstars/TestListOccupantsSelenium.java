 ...
 * @author Kevin Krile
 */
public class TestListOccupantsSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListOccupantsSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Number of Occupants");
