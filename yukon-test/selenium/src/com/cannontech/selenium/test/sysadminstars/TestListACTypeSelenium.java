 ...
 * @author Kevin Krile
 */
public class TestListACTypeSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListACTypeSelenium.xml}
	 */
	@Test
