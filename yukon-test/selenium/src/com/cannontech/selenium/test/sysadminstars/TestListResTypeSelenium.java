 ...
 * @author Kevin Krile
 */
public class TestListResTypeSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListResTypeSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Residence Type");
