 ...
 * @author Kevin Krile
 */
public class TestListControlSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListControlSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Chance of Control");
	...
	public void removeFromList(){
		...
		for(int i=0;i<remove.length;i++) {
		    common.assertEqualsTextIsNotPresent(remove[i]);
		}
		Assert.assertEquals("This list has been updated.", common.getYukonText("This list has been updated."));
		common.end();
	}
