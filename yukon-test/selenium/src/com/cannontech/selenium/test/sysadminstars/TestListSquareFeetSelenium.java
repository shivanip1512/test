 ...
 * @author Kevin Krile
 */
public class TestListSquareFeetSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListSquareFeetSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Square Feet");
