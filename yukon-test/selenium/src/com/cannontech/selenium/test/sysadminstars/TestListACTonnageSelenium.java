 ...
 * @author Kevin Krile
 */
public class TestListACTonnageSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListACTonnageSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Tonnage");
