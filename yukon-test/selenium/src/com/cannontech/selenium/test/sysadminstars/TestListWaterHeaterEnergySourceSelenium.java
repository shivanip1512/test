 ...
 * @author Kevin Krile
 */
public class TestListWaterHeaterEnergySourceSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListWaterHeaterEnergySourceSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		stars.clickLinkByHeaderName("Appliance - Water Heater", "Energy Source");
