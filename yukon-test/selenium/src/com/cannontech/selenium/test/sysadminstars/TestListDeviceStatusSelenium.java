 ...
 * @author Kevin Krile
 */
public class TestListDeviceStatusSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListDeviceStatusSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		String[] option = getParamStrings("Option");
		...
		common.clickLinkByName("Device Status");
		...
		for(int i=0;i<add.length;i++){
			...
			common.selectDropDownMenuByAttributeName("entries[" + (Integer.valueOf(init)+i) + "].definitionId", option[i]);
		}
		...
		common.clickButtonByTitle("Add");
		common.clickFormButton("save", "save");
		Assert.assertEquals(true, common.isTextPresent("Error found, check fields."));
		common.end();
	}
	/**
