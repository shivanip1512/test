 ...
 * @author Kevin Krile
 */
public class TestListWaterHeaterNumOfGallonsSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListWaterHeaterNumOfGallonsSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Number of Gallons");
