 ...
 * @author Kevin Krile
 */
public class TestListCallTypeSelenium extends SolventSeleniumTestCase{
	/**
	...
	/**
	 * This test logs in as starsop11 and starsop21 and adds to the default list for QA_Test10 and QA_Test20
	 * Restores to the default, then adds the text entries
	 * This test depend on data in input file {@link TestListCallTypeSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Call Type");
	...
	/**
	 * This test logs in as starsop11 and starsop21 and removes from the list for QA_Test10 and QA_Test20
	 * This test depend on data in input file {@link TestListCallTypeSelenium.xml}
	 */
	@Test
