 ...
 * @author Kevin Krile
 */
public class TestListAppLocationSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListAppLocationSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Location");
