 ...
 * @author Kevin Krile
 */
public class TestListDecadeBuiltSelenium extends SolventSeleniumTestCase{
	/**
	 ...
	 * This test depend on data in input file {@link TestListDecadeBuiltSelenium.xml}
	 */
	@Test
	public void addToList(){
		...
		common.clickLinkByName("Decade Built");
