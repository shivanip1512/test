...
"%EXECUTABLE%"//US//%SERVICE_NAME% ++JvmOptions "-Djava.io.tmpdir=%CATALINA_BASE%\temp;-XX:+HeapDumpOnOutOfMemoryError;-XX:HeapDumpPath=%YUKON_SERVER_DIR%\Log" rem -Dhttp.proxyHost=specify-proxy-name -Dhttp.proxyPort=specify-port --JvmMs 256 --JvmMx 512
